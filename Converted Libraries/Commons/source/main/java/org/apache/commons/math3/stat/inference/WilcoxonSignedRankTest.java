 ...
 * @param nanStrategyspecifies the strategy that should be used for Double.NaN's
 * @param tiesStrategyspecifies the strategy that should be used for ties
 */
 ...
 * @throws DimensionMismatchException if {@code x} and {@code y} do not
 * have the same length.
 * @throws NumberIsTooLargeException if {@code exactPValue} is {@code true}and {@code x.length} > 30
