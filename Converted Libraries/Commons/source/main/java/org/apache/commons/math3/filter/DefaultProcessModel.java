 ...
 * @param stateTransitionthe state transition matrix
 * @param controlthe control matrix
 * @param processNoisethe process noise matrix
 * @param initialStateEstimatethe initial state estimate vector
 * @param initialErrorCovariancethe initial error covariance matrix
 * @throws NullArgumentExceptionif any of the input arrays is {@code null}
