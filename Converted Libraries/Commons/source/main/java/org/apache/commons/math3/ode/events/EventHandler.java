 ...
 */
  public enum Action {  /** 
 * Stop indicator.
 * <p>This value should be used as the return value of the {@link #eventOccurred eventOccurred} method when the integration should be
 * stopped after the event ending the current step.</p>
 */
  STOP,   /** 
 * Reset state indicator.
 * <p>This value should be used as the return value of the {@link #eventOccurred eventOccurred} method when the integration should
 * go on after the event ending the current step, with a new state
 * vector (which will be retrieved thanks to the {@link #resetStateresetState} method).</p>
 */
  RESET_STATE,   /** 
 * Reset derivatives indicator.
 * <p>This value should be used as the return value of the {@link #eventOccurred eventOccurred} method when the integration should
 * go on after the event ending the current step, with a new derivatives
 * vector (which will be retrieved thanks to the {@link org.apache.commons.math3.ode.FirstOrderDifferentialEquations#computeDerivatives}method).</p>
 */
  RESET_DERIVATIVES,   /** 
 * Continue indicator.
 * <p>This value should be used as the return value of the {@link #eventOccurred eventOccurred} method when the integration should go
