 ...
 */
  @SuppressWarnings("unused") private final int rank;
  /** 
 ...
 */
  @SuppressWarnings("unused") private RegressionResults(){
 ...
 * @throws OutOfRangeException if {@code index} is not in the interval{@code [0, number of parameters)}.
 */
