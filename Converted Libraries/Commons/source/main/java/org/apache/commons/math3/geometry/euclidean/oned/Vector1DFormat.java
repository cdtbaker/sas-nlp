 ...
 * {@inheritDoc} 
 */
  @Override public StringBuffer format(  final Vector<Euclidean1D> vector,  final StringBuffer toAppendTo,  final FieldPosition pos){
 ...
 * {@inheritDoc} 
 */
  @Override public Vector1D parse(  final String source) throws MathParseException {
 ...
 * {@inheritDoc} 
 */
  @Override public Vector1D parse(  final String source,  final ParsePosition pos){
