 ...
 */
@Deprecated public class RandomDataImpl implements RandomData, Serializable {
  /** 
 ...
 */
  @Deprecated RandomDataGenerator getDelegate(){
    return delegate;
  }
  /** 
 * {@inheritDoc}<p>
 ...
 * @throws NotStrictlyPositiveException if{@code numeratorDf <= 0} or {@code denominatorDf <= 0}.
 * @since 2.2
 */
 ...
 * </p>
 * @param seedthe seed value to use
 */
 ...
 * </p>
 * @param algorithmthe name of the PRNG algorithm
 * @param providerthe name of the provider
 * @throws NoSuchAlgorithmExceptionif the specified algorithm is not available
 * @throws NoSuchProviderExceptionif the specified provider is not installed
 */
