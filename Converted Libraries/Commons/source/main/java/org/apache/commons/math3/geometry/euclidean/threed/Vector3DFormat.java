 ...
 */
  @Override public StringBuffer format(  final Vector<Euclidean3D> vector,  final StringBuffer toAppendTo,  final FieldPosition pos){
 ...
 * cannot be parsed.
 */
  @Override public Vector3D parse(  final String source) throws MathParseException {
 ...
 * @return the parsed {@link Vector3D} object.
 */
  @Override public Vector3D parse(  final String source,  final ParsePosition pos){
