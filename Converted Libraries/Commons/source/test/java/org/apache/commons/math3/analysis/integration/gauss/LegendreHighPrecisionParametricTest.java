 ...
 * @version $Id$
 */
@RunWith(value=Parameterized.class) public class LegendreHighPrecisionParametricTest extends GaussianQuadratureAbstractTest {
 ...
 */
  public LegendreHighPrecisionParametricTest(  int numberOfPoints,  int maxDegree,  double eps,  double numUlps){
    super(factory.legendreHighPrecision(numberOfPoints),maxDegree,eps,numUlps);
  }
  /** 
