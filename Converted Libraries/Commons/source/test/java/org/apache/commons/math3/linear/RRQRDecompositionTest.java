...
public class RRQRDecompositionTest {
  private double[][] testData3x3NonSingular={{12,-51,4},{6,167,-68},{-4,24,-41}};
  private double[][] testData3x3Singular={{1,4,7},{2,5,8},{3,6,9}};
  private double[][] testData3x4={{12,-51,4,1},{6,167,-68,2},{-4,24,-41,3}};
  private double[][] testData4x3={{12,-51,4},{6,167,-68},{-4,24,-41},{-5,34,7}};
 ...
 * test AP = QR 
 */
  @Test public void testAPEqualQR(){
 ...
 */
  ...
  @Test(expected=SingularMatrixException.class) public void testNonInvertible(){
    RRQRDecomposition qr=new RRQRDecomposition(MatrixUtils.createRealMatrix(testData3x3Singular),3.0e-16);
