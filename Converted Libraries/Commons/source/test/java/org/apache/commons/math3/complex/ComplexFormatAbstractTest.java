...
public abstract class ComplexFormatAbstractTest {
  ...
  @Test public void testNegativeInfinity(){
  ...
  @Test public void testParseNegativeReal(){
  ...
  @Test public void testPaseNegativeInfinity(){
    String source="(-Infinity) - (Infinity)i";
  ...
  @Test public void testGetImaginaryFormat(){
    NumberFormat nf=NumberFormat.getInstance();
    ComplexFormat cf=new ComplexFormat(nf);
    Assert.assertSame(nf,cf.getImaginaryFormat());
  }
  @Test public void testGetRealFormat(){
    NumberFormat nf=NumberFormat.getInstance();
    ComplexFormat cf=new ComplexFormat(nf);
  ...
  @Test public void testForgottenImaginaryCharacter(){
