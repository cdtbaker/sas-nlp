 ...
 * @version $Id: ResizableDoubleArrayTest.java 1410121 2012-11-16 00:18:30Z erans $
 */
public class ResizableDoubleArrayTest extends DoubleArrayAbstractTest {
  ...
  @Test public void testConstructors(){
    ...
    testDa=new ResizableDoubleArray(2,2.0f,3.0f,ResizableDoubleArray.ADDITIVE_MODE);
    Assert.assertEquals(0,testDa.getNumElements());
    Assert.assertEquals(2,testDa.getCapacity());
    Assert.assertEquals(defaultExpansionFactor,testDa.getExpansionFactor(),0);
    Assert.assertEquals(3.0f,testDa.getContractionCriteria(),0);
  ...
  @Test public void testAddElements(){
    ...
    testDa=new ResizableDoubleArray(2,2.0f,2.5f,ResizableDoubleArray.ADDITIVE_MODE);
    Assert.assertEquals(2,testDa.getCapacity());
  ...
  @Override @Test public void testAddElementRolling(){
    ...
    ResizableDoubleArray testDa=new ResizableDoubleArray(2,2.0f,2.5f,ResizableDoubleArray.ADDITIVE_MODE);
    Assert.assertEquals(2,testDa.getCapacity());
    testDa.addElement(1d);
