 ...
 */
  @Test public void testPreconditions(){
    ...
    @SuppressWarnings("unused") BivariateFunction bcf=new BicubicSplineInterpolatingFunction(xval,yval,zval,zval,zval,zval);
 ...
 */
  @Test public void testSplinePartialDerivatives(){
    final int N=4;
 ...
 */
  @Test public void testMatchingPartialDerivatives(){
    final int sz=21;
