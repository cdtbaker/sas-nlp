...
public class BigFractionTest {
  ...
  @Test(expected=ConvergenceException.class) public void testGoldenRatio(){
    new BigFraction((1 + FastMath.sqrt(5)) / 2,1.0e-12,25);
  }
  @Test public void testDoubleConstructor() throws ConvergenceException {
  ...
  @Test public void testDigitLimitConstructor() throws ConvergenceException {
  ...
  @Test public void testEpsilonLimitConstructor() throws ConvergenceException {
  ...
  @Test public void testDoubleValueForLargeNumeratorAndDenominator(){
  ...
  @Test public void testBigDecimalValue(){
  ...
  @Test public void testGetReducedFraction(){
  ...
  @Test public void testSerial() throws FractionConversionException {
    BigFraction[] fractions={new BigFraction(3,4),BigFraction.ONE,BigFraction.ZERO,new BigFraction(17),new BigFraction(FastMath.PI,1000),new BigFraction(-5,2)};
