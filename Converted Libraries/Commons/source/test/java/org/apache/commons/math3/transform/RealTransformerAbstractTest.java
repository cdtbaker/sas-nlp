 ...
 * @since 3.0
 * @version $Id: RealTransformerAbstractTest.java 1244375 2012-02-15 06:30:05Z celestin $
 */
 ...
 * @param i the index of the invalid data size ({@code 0 <= i <}{@link #getNumberOfInvalidDataSizes()}
 ...
 * specified index).
 * @param i the index of the valid data size ({@code 0 <= i <}{@link #getNumberOfValidDataSizes()}
 ...
 */
  @Test public void testTransformRealInvalidDataSize(){
 ...
 */
  @Test public void testTransformReal(){
    final TransformType[] type=TransformType.values();
    for (int i=0; i < getNumberOfValidDataSizes(); i++) {
      final int n=getValidDataSize(i);
 ...
 */
  @Test public void testTransformFunction(){
    final TransformType[] type=TransformType.values();
    for (int i=0; i < getNumberOfValidDataSizes(); i++) {
      final int n=getValidDataSize(i);
      final double tol=getRelativeTolerance(i);
