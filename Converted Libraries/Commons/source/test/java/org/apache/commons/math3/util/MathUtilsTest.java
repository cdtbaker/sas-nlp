...
public final class MathUtilsTest {
  @Test public void testHash(){
    double[] testArray={Double.NaN,Double.POSITIVE_INFINITY,Double.NEGATIVE_INFINITY,1d,0d,1E-14,(1 + 1E-14),Double.MIN_VALUE,Double.MAX_VALUE};
  ...
  @Test public void testArrayHash(){
    Assert.assertEquals(0,MathUtils.hash((double[])null));
    Assert.assertEquals(MathUtils.hash(new double[]{Double.NaN,Double.POSITIVE_INFINITY,Double.NEGATIVE_INFINITY,1d,0d}),MathUtils.hash(new double[]{Double.NaN,Double.POSITIVE_INFINITY,Double.NEGATIVE_INFINITY,1d,0d}));
    Assert.assertFalse(MathUtils.hash(new double[]{1d}) == MathUtils.hash(new double[]{FastMath.nextAfter(1d,2d)}));
    Assert.assertFalse(MathUtils.hash(new double[]{1d}) == MathUtils.hash(new double[]{1d,1d}));
  }
  /** 
 ...
 */
 ...
 while (isIdentity);
  ...
  @Test public void testReduceComparedWithNormalizeAngle(){
  ...
  @Test public void testCheckNotNull1(){
    try {
      Object obj=null;
  ...
  @Test public void testCheckNotNull2(){
    try {
      double[] array=null;
  ...
  @Test public void testCopySignByte(){
  ...
  @Test(expected=MathArithmeticException.class) public void testCopySignByte2(){
