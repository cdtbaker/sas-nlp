 ...
 * @since 2.0
 * @version $Id: NaturalRankingTest.java 1454897 2013-03-10 19:02:54Z luc $
 */
public class NaturalRankingTest {
  private final double[] exampleData={20,17,30,42.3,17,50,Double.NaN,Double.NEGATIVE_INFINITY,17};
  ...
  @Test public void testNaNsMaximalTiesMinimum(){
  ...
  @Test public void testNaNsRemovedTiesSequential(){
  ...
  @Test public void testNaNsMinimalTiesAverage(){
  ...
  @Test public void testNaNsAndInfs(){
  ...
  @Test(expected=NotANumberException.class) public void testNaNsFailed(){
    double[] data={0,Double.POSITIVE_INFINITY,Double.NaN,Double.NEGATIVE_INFINITY};
    NaturalRanking ranking=new NaturalRanking(NaNStrategy.FAILED);
    ranking.rank(data);
  }
  @Test public void testNoNaNsFailed(){
    double[] data={1,2,3,4};
    NaturalRanking ranking=new NaturalRanking(NaNStrategy.FAILED);
    double[] ranks=ranking.rank(data);
