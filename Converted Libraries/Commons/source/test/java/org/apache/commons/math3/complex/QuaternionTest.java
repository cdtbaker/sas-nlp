 ...
 */
  ...
  @Test public final void testAccessors1(){
    final double q0=2;
    final double q1=5.4;
    final double q2=17;
  ...
  @Test public final void testAccessors2(){
    final double q0=2;
    final double q1=5.4;
    final double q2=17;
    final double q3=0.0005;
  ...
  @Test public final void testAccessors3(){
    final double q0=2;
    final double q1=5.4;
    final double q2=17;
    final double q3=0.0005;
  ...
  @Test(expected=DimensionMismatchException.class) public void testWrongDimension(){
  ...
  @Test public final void testDotProductQuaternionQuaternion(){
  ...
  @Test public final void testScalarMultiplyDouble(){
    final double w=1.6;
    final double x=-4.8;
  ...
  @Test public final void testAddQuaternionQuaternion(){
    final double w=4;
    final double x=-1;
    final double y=2;
    final double z=-4;
  ...
  @Test public final void testSubtractQuaternionQuaternion(){
    final double w=-2.;
    final double x=5.;
    final double y=-6.;
    final double z=2.;
  ...
  @Test public final void testNorm(){
    final double q0=2;
    final double q1=1;
    final double q2=-4;
    final double q3=3;
  ...
  @Test public final void testNormalize(){
  ...
  @Test(expected=ZeroException.class) public final void testNormalizeFail(){
    final Quaternion zeroQ=new Quaternion(0,0,0,0);
    zeroQ.normalize();
  }
  @Test public final void testObjectEquals(){
    final double one=1;
  ...
  @Test public final void testQuaternionEquals2(){
  ...
  @Test public final void testIsUnitQuaternion(){
  ...
  @Test public final void testIsPureQuaternion(){
  ...
  @Test public final void testPolarForm(){
    final Random r=new Random(48);
    final int numberOfTrials=1000;
    for (int i=0; i < numberOfTrials; i++) {
      final Quaternion q=new Quaternion(2 * (r.nextDouble() - 0.5),2 * (r.nextDouble() - 0.5),2 * (r.nextDouble() - 0.5),2 * (r.nextDouble() - 0.5));
  ...
  @Test public final void testGetInverse(){
