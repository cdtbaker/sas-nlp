 ...
 * @version $Id: MixedListUnivariateImplTest.java 1364030 2012-07-21 01:10:04Z erans $
 */
 ...
 */
  ...
  @Test public void testN0andN1Conditions(){
    ...
    u.addValue(one);
    Assert.assertTrue("Mean of n = 1 set should be value of single item n1, instead it is " + u.getMean(),u.getMean() == one);
  ...
  @Test public void testSkewAndKurtosis(){
