...
public class PrimesTest {
  ...
  @Test public void testIsPrime() throws Exception {
    for (    int i : BELOW_2) {
...
static {
  ...
  @Test public void testPrimeFactors() throws Exception {
    for (    int i : BELOW_2) {
