 ...
 * @version $Id: SummaryStatisticsTest.java 1364030 2012-07-21 01:10:04Z erans $
 */
 ...
 */
  ...
  @Test public void testN0andN1Conditions(){
    ...
    u.addValue(one);
    Assert.assertTrue("mean should be one (n = 1)",u.getMean() == one);
    Assert.assertTrue("geometric should be one (n = 1) instead it is " + u.getGeometricMean(),u.getGeometricMean() == one);
    Assert.assertTrue("Std should be zero (n = 1)",u.getStandardDeviation() == 0.0);
    Assert.assertTrue("variance should be zero (n = 1)",u.getVariance() == 0.0);
    u.addValue(twoF);
  ...
  @Test public void testNaNContracts(){
    SummaryStatistics u=createSummaryStatistics();
  ...
  @Test public void testGetSummary(){
    SummaryStatistics u=createSummaryStatistics();
  ...
  @Test public void testSetterIllegalState(){
    SummaryStatistics u=createSummaryStatistics();
    u.addValue(1);
    u.addValue(3);
    try {
 ...
 * JIRA: MATH-691
 */
  @Test public void testOverrideVarianceWithMathClass(){
