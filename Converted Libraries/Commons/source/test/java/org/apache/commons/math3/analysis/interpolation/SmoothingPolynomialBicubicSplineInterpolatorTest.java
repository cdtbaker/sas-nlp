 ...
 * @version $Id: SmoothingPolynomialBicubicSplineInterpolatorTest.java 1244107 2012-02-14 16:17:55Z erans $
 */
 ...
 */
  @Test public void testParaboloid(){
    BivariateFunction f=new BivariateFunction(){
      public double value(      double x,      double y){
        return 2 * x * x - 3 * y * y + 4 * x * y - 5 + ((int)(FastMath.abs(5 * x + 3 * y)) % 2 == 0 ? 1 : -1);
      }
    }
;
