...
public class TriDiagonalTransformerTest {
  ...
  @Test public void testAEqualQTQt(){
  ...
  @Test public void testNoAccessBelowDiagonal(){
  ...
  @Test public void testQTOrthogonal(){
  ...
  @Test public void testTTriDiagonal(){
  ...
  @Test public void testMatricesValues3(){
    checkMatricesValues(testSquare3,new double[][]{{1.0,0.0,0.0},{0.0,-0.6,0.8},{0.0,-0.8,-0.6}},new double[]{1,2.64,-0.64},new double[]{-5,-1.52});
  }
