...
public class LineTest {
  ...
  @Test public void testTransform() throws MathIllegalArgumentException {
    ...
    Transform<Euclidean2D,Euclidean1D> t1=Line.getTransform(new AffineTransform(0.0,0.5,-1.0,0.0,1.0,1.5));
    ...
    Transform<Euclidean2D,Euclidean1D> t2=Line.getTransform(new AffineTransform(0.0,0.5,-1.0,0.0,1.0,1.5));
