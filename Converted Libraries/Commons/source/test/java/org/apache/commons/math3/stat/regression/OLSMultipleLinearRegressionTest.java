 ...
 */
  @Test public void testLongly(){
    ...
    TestUtils.assertEquals(betaHat,new double[]{-3482258.63459582,15.0618722713733,-0.358191792925910E-01,-2.02022980381683,-1.03322686717359,-0.511041056535807E-01,1829.15146461355},2E-8);
 ...
 */
  protected void checkVarianceConsistency(  OLSMultipleLinearRegression model){
    ...
    TestUtils.assertEquals(StatUtils.variance(model.calculateResiduals().toArray()) * (residuals.length - 1),model.calculateErrorVariance() * (X.getRowDimension() - X.getColumnDimension()),1E-20);
  }
  /** 
 ...
 */
  ...
  @Test(expected=IllegalArgumentException.class) public void testNewSampleDataXNull(){
