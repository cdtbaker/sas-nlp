 ...
 * @version $Id: ArrayRealVectorTest.java 1358366 2012-07-06 19:31:00Z celestin $
 */
public class ArrayRealVectorTest extends RealVectorAbstractTest {
  ...
  @Test public void testGetDataRef(){
  ...
  @Test public void testPredicates(){
    Assert.assertEquals(create(new double[]{Double.NaN,1,2}).hashCode(),create(new double[]{0,Double.NaN,2}).hashCode());
    Assert.assertTrue(create(new double[]{Double.NaN,1,2}).hashCode() != create(new double[]{0,1,2}).hashCode());
  }
