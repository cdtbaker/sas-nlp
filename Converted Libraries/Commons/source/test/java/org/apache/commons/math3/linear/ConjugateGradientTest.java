...
public class ConjugateGradientTest {
  ...
  @Test(expected=NonPositiveDefiniteOperatorException.class) public void testNonPositiveDefiniteLinearOperator(){
 ...
 */
  @Test public void testUnpreconditionedResidual(){
    final int n=10;
