...
public class BigRealTest {
  ...
  @Test(expected=MathArithmeticException.class) public void testDivisionByZero(){
  ...
  @Test(expected=MathArithmeticException.class) public void testReciprocalOfZero(){
  ...
  @Test public void testSerial(){
    BigReal[] Reals={new BigReal(3.0),BigReal.ONE,BigReal.ZERO,new BigReal(17),new BigReal(FastMath.PI),new BigReal(-2.5)};
