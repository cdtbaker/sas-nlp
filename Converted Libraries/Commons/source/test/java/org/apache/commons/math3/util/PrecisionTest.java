...
public class PrecisionTest {
  ...
  @Test public void testEqualsWithAllowedDelta(){
  ...
  @Test public void testEqualsIncludingNaNWithAllowedDelta(){
  ...
  @Test public void testEqualsWithAllowedUlps(){
  ...
  @Test public void testCompareToEpsilon(){
  ...
  @Test public void testRepresentableDelta(){
  ...
  @Test public void testMath843(){
    final double afterEpsilon=FastMath.nextAfter(Precision.EPSILON,Double.POSITIVE_INFINITY);
