 ...
 */
  ...
  /** 
 * <code>y = A*x</code>
 * @param xVector of size <code>A.numColumns()</code>
 * @param yVector of size <code>A.numRows()</code>
 * @return y
 */
 ...
 * @param xVector of size <code>A.numRows()</code>
 * @param yVector of size <code>A.numColumns()</code>
 * @return y
 */
 ...
 * associated solver
 * @param bVector of size <code>A.numRows()</code>
 * @param xVector of size <code>A.numColumns()</code>
 * @return x
 * @throws MatrixSingularExceptionIf the matrix is singular
 ...
 * @param bVector of size <code>A.numColumns()</code>
 * @param xVector of size <code>A.numRows()</code>
 * @return x
 * @throws MatrixSingularExceptionIf the matrix is singular
 * @throws MatrixNotSPDExceptionIf the solver assumes that the matrix is symmetrical,
 ...
 * @param typeThe type of norm to compute
 */
 ...
 */
 ...
 else     if (this == Infinity)     return "I";
 else     throw new IllegalArgumentException("Norm must be the 1 or the Infinity norm");
  }
}
}
