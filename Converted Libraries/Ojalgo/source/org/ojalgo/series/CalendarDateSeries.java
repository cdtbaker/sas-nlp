...
public class CalendarDateSeries<V extends Number> extends AbstractSeries<CalendarDate,V,CalendarDateSeries<V>> {
  ...
  @SuppressWarnings("unused") private CalendarDateSeries(  final Comparator<? super CalendarDate> someC){
    super(someC);
    myResolution=null;
  }
  @SuppressWarnings("unused") private CalendarDateSeries(  final Map<? extends CalendarDate,? extends V> someM){
    super(someM);
    myResolution=null;
  }
  @SuppressWarnings("unused") private CalendarDateSeries(  final SortedMap<CalendarDate,? extends V> someM){
    super(someM);
    myResolution=null;
  }
  ...
  @Override public CalendarDateSeries<V> headMap(  final CalendarDate newToKey){
  ...
  @Override public CalendarDateSeries<V> headMap(  final CalendarDate newToKey,  final boolean newInclusive){
  ...
  @Override public V put(  final CalendarDate aKey,  final V aValue){
  ...
  @Override public void putAll(  final Map<? extends CalendarDate,? extends V> aMap){
  ...
  @Override public CalendarDateSeries<V> subMap(  final CalendarDate aFromKey,  final boolean inclusiveFromKey,  final CalendarDate aToKey,  final boolean inclusiveToKey){
  ...
  @Override public CalendarDateSeries<V> subMap(  final CalendarDate aFromKey,  final CalendarDate aKeyLimit){
  ...
  @Override public CalendarDateSeries<V> tailMap(  final CalendarDate aFromKey){
  ...
  @Override public CalendarDateSeries<V> tailMap(  final CalendarDate aFromKey,  final boolean inclusive){
