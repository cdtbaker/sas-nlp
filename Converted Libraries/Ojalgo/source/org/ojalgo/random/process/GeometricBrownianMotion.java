 ...
 * dX = r X dt + s X dW
 * A stochastic process is said to follow a geometric Brownian motion
 * if it satisfies this stochastic differential equation.
 * @author apete
 */
 ...
 * @param aSamplePeriod The amount of time (in which ever unit you
 * prefer) between each sample in the series.
 */
  public static GeometricBrownianMotion estimate(  final Access1D<?> aSeriesOfSamples,  final double aSamplePeriod){
    final int tmpSizeMinusOne=aSeriesOfSamples.size() - 1;
 ...
 */
  ...
  @SuppressWarnings("unused") private GeometricBrownianMotion(){
    this(ZERO,ZERO);
  }
  /** 
