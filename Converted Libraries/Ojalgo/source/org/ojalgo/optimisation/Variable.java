...
public final class Variable extends ModelEntity<Variable> {
  ...
  @Override protected void appendMiddlePart(  final StringBuilder aStringBuilder){
  ...
  @Override protected boolean validate(  final BigDecimal value,  final NumberContext context){
