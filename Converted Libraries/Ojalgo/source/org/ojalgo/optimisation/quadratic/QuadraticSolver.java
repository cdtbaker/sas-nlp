...
public static final class Builder extends AbstractBuilder<QuadraticSolver.Builder,QuadraticSolver> {
    ...
    @Override public QuadraticSolver build(    final Optimisation.Options options){
    ...
    @Override public QuadraticSolver.Builder equalities(    final MatrixStore<Double> AE,    final MatrixStore<Double> BE){
      return super.equalities(AE,BE);
    }
    @Override public QuadraticSolver.Builder inequalities(    final MatrixStore<Double> AI,    final MatrixStore<Double> BI){
      return super.inequalities(AI,BI);
    }
    @Override public QuadraticSolver.Builder inequalities(    final MatrixStore<Double> AI,    final MatrixStore<Double> BI,    final ModelEntity<?>[] originatingEntities){
      return super.inequalities(AI,BI,originatingEntities);
    }
    @Override protected Builder objective(    final MatrixStore<Double> Q,    final MatrixStore<Double> C){
  ...
  @SuppressWarnings("unchecked") static void copy(  final ExpressionsBasedModel sourceModel,  final QuadraticSolver.Builder destinationBuilder){
