 ...
 */
    @SuppressWarnings("unchecked") public B balance(){
    ...
    @SuppressWarnings("unchecked") public BaseSolver.AbstractBuilder<B,S> copy(){
      try {
 ...
 */
    ...
    @SuppressWarnings("unchecked") private void balanceObjective(){
    ...
    @Override @SuppressWarnings("unchecked") protected Object clone() throws CloneNotSupportedException {
    ...
    @SuppressWarnings("unchecked") protected B equalities(    final MatrixStore<Double> AE,    final MatrixStore<Double> BE){
      if (myAE != null) {
        myAE.below(AE);
      }
 else {
    ...
    @SuppressWarnings("unchecked") protected B inequalities(    final MatrixStore<Double> AI,    final MatrixStore<Double> BI,    final ModelEntity<?>[] originatingEntities){
      if (myAI != null) {
        myAI.below(AI);
    ...
    @SuppressWarnings("unchecked") protected B objective(    final MatrixStore<Double> C){
      myQ=null;
      myC=C.builder();
      return (B)this;
    }
    @SuppressWarnings("unchecked") protected B objective(    final MatrixStore<Double> Q,    final MatrixStore<Double> C){
      myQ=Q.builder();
      if (C != null) {
        myC=C.builder();
      }
  ...
  @SuppressWarnings("unused") private BaseSolver(  final ExpressionsBasedModel aModel,  final Options solverOptions){
  ...
  @Override public Optimisation.Result solve(){
