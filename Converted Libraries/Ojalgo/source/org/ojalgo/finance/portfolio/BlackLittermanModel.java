...
private static final class View extends FinancePortfolio {
    ...
    @SuppressWarnings("unused") private View(){
      super();
      myModel=null;
      myWeights=null;
    ...
    @Override public double getReturnVariance(){
 ...
 * @deprecated v30
 */
  @Deprecated public final void addViewWithStandardDeviation(  final List<BigDecimal> someWeights,  final BigDecimal aReturn,  final BigDecimal aStdDev){
    final View tmpView=new View(this,someWeights);
