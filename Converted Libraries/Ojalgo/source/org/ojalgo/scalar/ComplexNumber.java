...
;
  ...
  public final ComplexNumber divide(  final ComplexNumber arg){
...
@Override public ComplexNumber invert(){
return ComplexNumber.makePolar(PrimitiveMath.ONE / this.norm(),-this.phase());
}
public boolean isAbsolute(){
return this.isReal() && (this.doubleValue() >= PrimitiveMath.ZERO);
}
...
return myRealForSure || TypeUtils.isZero(i);
}
...
@Override public ComplexNumber multiply(final ComplexNumber arg){
...
@Override public ComplexNumber multiply(final double arg){
return new ComplexNumber(myRealValue * arg,i * arg);
}
...
@Override public ComplexNumber subtract(final double arg){
return new ComplexNumber(myRealValue - arg,i);
}
...
final double tmpRe=this.doubleValue();
...
final StringBuilder retVal=new StringBuilder(LEFT);
final BigDecimal tmpRe=context.enforce(new BigDecimal(this.doubleValue(),MathContext.DECIMAL64));
final BigDecimal tmpIm=context.enforce(new BigDecimal(i,MathContext.DECIMAL64));
