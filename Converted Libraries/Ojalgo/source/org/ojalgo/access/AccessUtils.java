 ...
 */
  ...
  @SuppressWarnings("unchecked") public static boolean equals(  final Access1D<?> accessA,  final Access1D<?> accessB,  final NumberContext context){
  ...
  public static boolean equals(  final Access2D<?> accessA,  final Access2D<?> accessB,  final NumberContext context){
    return (accessA.countRows() == accessB.countRows()) && (accessA.countColumns() == accessB.countColumns()) && AccessUtils.equals((Access1D<?>)accessA,(Access1D<?>)accessB,context);
  }
 ...
 */
  @Deprecated public static int size(  final int[] structure){
 ...
 */
  @Deprecated public static int size(  final int[] structure,  final int dimension){
 ...
 */
  ...
  public static int[] structure(  final StructureAnyD structure){
    ...
    for (int i=0; i < retVal.length; i++) {
      retVal[i]=(int)structure.count(i);
    }
    return retVal;
  }
  private AccessUtils(){
