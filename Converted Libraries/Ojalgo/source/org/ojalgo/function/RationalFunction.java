...
static abstract class Binary extends BinaryFunction<RationalNumber> {
    @Override public final double invoke(    final double arg1,    final double arg2){
...
static abstract class Parameter extends ParameterFunction<RationalNumber> {
    @Override public final double invoke(    final double arg,    final int param){
...
;
  public static final BinaryFunction<RationalNumber> ADD=new Binary(){
    @Override public final RationalNumber invoke(    final RationalNumber arg1,    final RationalNumber arg2){
...
;
  public static final ParameterFunction<RationalNumber> POWER=new Parameter(){
    @Override public final RationalNumber invoke(    final RationalNumber arg,    final int param){
...
;
  ...
  @Override public UnaryFunction<RationalNumber> abs(){
    return ABS;
  }
  @Override public UnaryFunction<RationalNumber> acos(){
    return ACOS;
  }
  @Override public UnaryFunction<RationalNumber> acosh(){
    return ACOSH;
  }
  @Override public BinaryFunction<RationalNumber> add(){
    return ADD;
  }
  @Override public UnaryFunction<RationalNumber> asin(){
    return ASIN;
  }
  @Override public UnaryFunction<RationalNumber> asinh(){
    return ASINH;
  }
  @Override public UnaryFunction<RationalNumber> atan(){
    return ATAN;
  }
  @Override public UnaryFunction<RationalNumber> atanh(){
    return ATANH;
  }
  @Override public UnaryFunction<RationalNumber> cardinality(){
    return CARDINALITY;
  }
  @Override public UnaryFunction<RationalNumber> conjugate(){
    return CONJUGATE;
  }
  @Override public UnaryFunction<RationalNumber> cos(){
    return COS;
  }
  @Override public UnaryFunction<RationalNumber> cosh(){
    return COSH;
  }
  @Override public BinaryFunction<RationalNumber> divide(){
    return DIVIDE;
  }
  @Override public UnaryFunction<RationalNumber> exp(){
    return EXP;
  }
  @Override public UnaryFunction<RationalNumber> expm1(){
    return EXPM1;
  }
  @Override public BinaryFunction<RationalNumber> hypot(){
    return HYPOT;
  }
  @Override public UnaryFunction<RationalNumber> invert(){
    return INVERT;
  }
  @Override public UnaryFunction<RationalNumber> log(){
    return LOG;
  }
  @Override public UnaryFunction<RationalNumber> log10(){
    return LOG10;
  }
  @Override public UnaryFunction<RationalNumber> log1p(){
    return LOG1P;
  }
  @Override public BinaryFunction<RationalNumber> max(){
    return MAX;
  }
  @Override public BinaryFunction<RationalNumber> min(){
    return MIN;
  }
  @Override public BinaryFunction<RationalNumber> multiply(){
    return MULTIPLY;
  }
  @Override public UnaryFunction<RationalNumber> negate(){
    return NEGATE;
  }
  @Override public BinaryFunction<RationalNumber> pow(){
    return POW;
  }
  @Override public ParameterFunction<RationalNumber> power(){
    return POWER;
  }
  @Override public ParameterFunction<RationalNumber> root(){
    return ROOT;
  }
  @Override public ParameterFunction<RationalNumber> scale(){
    return SCALE;
  }
  @Override public UnaryFunction<RationalNumber> signum(){
    return SIGNUM;
  }
  @Override public UnaryFunction<RationalNumber> sin(){
    return SIN;
  }
  @Override public UnaryFunction<RationalNumber> sinh(){
    return SINH;
  }
  @Override public UnaryFunction<RationalNumber> sqrt(){
    return SQRT;
  }
  @Override public UnaryFunction<RationalNumber> sqrt1px2(){
    return SQRT1PX2;
  }
  @Override public BinaryFunction<RationalNumber> subtract(){
    return SUBTRACT;
  }
  @Override public UnaryFunction<RationalNumber> tan(){
    return TAN;
  }
  @Override public UnaryFunction<RationalNumber> tanh(){
    return TANH;
  }
  @Override public UnaryFunction<RationalNumber> value(){
    return VALUE;
  }
}
