 ...
 */
  ...
  @SuppressWarnings("unused") private NumberContext(  final Format format){
 ...
 */
  ...
  @Override public Number enforce(  final Number object){
 ...
 * @deprecated v35
 */
  @Deprecated public double error(){
    return myError;
  }
 ...
 */
  ...
  @Override protected Number handleParseException(  final Format format,  final String string){
    return BigMath.ZERO;
  }
}
