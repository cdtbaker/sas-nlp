...
public final class IndexSelector {
  ...
  @SuppressWarnings("unused") private IndexSelector(){
    this(0);
  }
 ...
 */
  ...
  @Override public String toString(){
    return "Last Incl/Excl: " + myLastIncluded + "/"+ myLastExcluded+ " => "+ Arrays.toString(this.getIncluded())+ " / "+ Arrays.toString(this.getExcluded());
  }
}
