...
public static final class Big extends Rotation<BigDecimal> {
    ...
    @Override public double doubleCosineValue(){
      return cos.doubleValue();
    }
    @Override public double doubleSineValue(){
      return sin.doubleValue();
    }
    @Override public BigDecimal getCosine(){
      return cos;
    }
    @Override public BigDecimal getSine(){
      return sin;
    }
    @Override public Big invert(){
...
public static final class Complex extends Rotation<ComplexNumber> {
    ...
    @Override public ComplexNumber getCosine(){
      return cos;
    }
    @Override public ComplexNumber getSine(){
      return sin;
    }
    @Override public Complex invert(){
...
public static final class Primitive extends Rotation<Double> {
    ...
    @Override public Double getCosine(){
      return cos;
    }
    @Override public Double getSine(){
      return sin;
    }
    @Override public Primitive invert(){
  ...
  @SuppressWarnings("unused") private Rotation(){
    this(0,0);
