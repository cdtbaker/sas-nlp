 ...
 */
    @Deprecated public AggregatorCollection<BigDecimal> getAggregatorCollection(){
      return this.aggregator();
    }
    /** 
 * @deprecated Use {@link #function()} instead
 */
    @Deprecated public FunctionSet<BigDecimal> getFunctionSet(){
      return this.function();
    }
    /** 
 * @deprecated v35 Use {@link #scalar()} instead.
 */
    @Deprecated public BigDecimal getNumber(    final double value){
      return this.scalar().cast(value);
    }
    /** 
 * @deprecated v35 Use {@link #scalar()} instead.
 */
    @Deprecated public BigDecimal getNumber(    final Number value){
      return this.scalar().cast(value);
    }
    /** 
 * @deprecated v35 Use {@link #scalar()} instead.
 */
    @Deprecated public Scalar<BigDecimal> getStaticOne(){
      return this.scalar().one();
    }
    /** 
 * @deprecated v35 Use {@link #scalar()} instead.
 */
    @Deprecated public Scalar<BigDecimal> getStaticZero(){
 ...
 * @deprecated v35 Use {@link #scalar()} instead.
 */
    @Deprecated public Scalar<BigDecimal> toScalar(    final double value){
      return this.scalar().convert(value);
    }
    /** 
 * @deprecated v35 Use {@link #scalar()} instead.
 */
    @Deprecated public Scalar<BigDecimal> toScalar(    final Number value){
      return this.scalar().convert(value);
    }
...
;
  ...
  @Override public void modifyAll(  final UnaryFunction<BigDecimal> aFunc){
    final int tmpRowDim=myRowDim;
    final int tmpColDim=myColDim;
...
;
  ...
  public Scalar<BigDecimal> toScalar(  final int row,  final int column){
...
;
  ...
  public void visitColumn(  final int row,  final int column,  final VoidFunction<BigDecimal> visitor){
  ...
  public void visitDiagonal(  final int row,  final int column,  final VoidFunction<BigDecimal> visitor){
  ...
  public void visitRow(  final int row,  final int column,  final VoidFunction<BigDecimal> visitor){
