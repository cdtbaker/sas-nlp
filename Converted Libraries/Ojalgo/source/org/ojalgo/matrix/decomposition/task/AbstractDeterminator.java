...
;
  static final DeterminantTask<Double> FULL_4X4=new AbstractDeterminator(){
    public Double calculateDeterminant(    final Access2D<Double> matrix){
      ...
      return AbstractDeterminator.calculate(tmp00,tmp10,tmp20,tmp30,tmp01,tmp11,tmp21,tmp31,tmp02,tmp12,tmp22,tmp32,tmp03,tmp13,tmp23,tmp33);
    }
  }
;
  static final DeterminantTask<Double> FULL_5X5=new AbstractDeterminator(){
    public Double calculateDeterminant(    final Access2D<Double> matrix){
      ...
      return AbstractDeterminator.calculate(tmp00,tmp10,tmp20,tmp30,tmp40,tmp01,tmp11,tmp21,tmp31,tmp41,tmp02,tmp12,tmp22,tmp32,tmp42,tmp03,tmp13,tmp23,tmp33,tmp43,tmp04,tmp14,tmp24,tmp34,tmp44);
    }
  }
;
...
;
  static final DeterminantTask<Double> SYMMETRIC_4X4=new AbstractDeterminator(){
    public Double calculateDeterminant(    final Access2D<Double> matrix){
      ...
      final double tmp32=matrix.doubleValue(11L);
      final double tmp33=matrix.doubleValue(15L);
      return AbstractDeterminator.calculate(tmp00,tmp10,tmp20,tmp30,tmp10,tmp11,tmp21,tmp31,tmp20,tmp21,tmp22,tmp32,tmp30,tmp31,tmp32,tmp33);
    }
  }
;
  static final DeterminantTask<Double> SYMMETRIC_5X5=new AbstractDeterminator(){
    public Double calculateDeterminant(    final Access2D<Double> matrix){
      ...
      final double tmp43=matrix.doubleValue(19L);
      final double tmp44=matrix.doubleValue(24L);
      return AbstractDeterminator.calculate(tmp00,tmp10,tmp20,tmp30,tmp40,tmp10,tmp11,tmp21,tmp31,tmp41,tmp20,tmp21,tmp22,tmp32,tmp42,tmp30,tmp31,tmp32,tmp33,tmp43,tmp40,tmp41,tmp42,tmp43,tmp44);
    }
  }
;
  public static void main(  final String... args){
    ...
    BasicLogger.logDebug("Unwrapped",tmpDestination);
    ...
    BasicLogger.logDebug("LU",tmpDestination);
  ...
  static double calculate(  final double a00,  final double a10,  final double a20,  final double a01,  final double a11,  final double a21,  final double a02,  final double a12,  final double a22){
    return ((a00 * AbstractDeterminator.calculate(a11,a21,a12,a22)) - (a10 * AbstractDeterminator.calculate(a01,a21,a02,a22))) + (a20 * AbstractDeterminator.calculate(a01,a11,a02,a12));
  }
  static double calculate(  final double a00,  final double a10,  final double a20,  final double a30,  final double a01,  final double a11,  final double a21,  final double a31,  final double a02,  final double a12,  final double a22,  final double a32,  final double a03,  final double a13,  final double a23,  final double a33){
  ...
  static double calculate(  final double a00,  final double a10,  final double a20,  final double a30,  final double a40,  final double a01,  final double a11,  final double a21,  final double a31,  final double a41,  final double a02,  final double a12,  final double a22,  final double a32,  final double a42,  final double a03,  final double a13,  final double a23,  final double a33,  final double a43,  final double a04,  final double a14,  final double a24,  final double a34,  final double a44){
