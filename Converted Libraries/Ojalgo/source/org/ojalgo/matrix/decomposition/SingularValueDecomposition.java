...
public abstract class SingularValueDecomposition<N extends Number & Comparable<N>> extends AbstractDecomposition<N> implements SingularValue<N> {
  @SuppressWarnings("unchecked") public static final <N extends Number>SingularValue<N> make(  final Access2D<N> aTypical){
  ...
  @SuppressWarnings("unused") private SingularValueDecomposition(  final DecompositionStore.Factory<N,? extends DecompositionStore<N>> aFactory){
    this(aFactory,null);
  }
  protected SingularValueDecomposition(  final DecompositionStore.Factory<N,? extends DecompositionStore<N>> aFactory,  final BidiagonalDecomposition<N> aBidiagonal){
    super(aFactory);
  ...
  @Override public final boolean isAspectRatioNormal(){
