...
abstract class AbstractMatrix<N extends Number,I extends BasicMatrix<N>> extends Object implements BasicMatrix<N>, Serializable {
  ...
  @SuppressWarnings("unused") private AbstractMatrix(){
    this(null);
  ...
  public I add(  final Number aNmbr){
    final PhysicalStore<N> retVal=myPhysicalFactory.makeZero(this.getRowDim(),this.getColDim());
    retVal.fillMatching(myStore,myPhysicalFactory.function().add(),myPhysicalFactory.getNumber(aNmbr));
    return this.getFactory().instantiate(retVal);
  }
  public I conjugate(){
  ...
  public I divide(  final Number aNmbr){
    final PhysicalStore<N> retVal=myPhysicalFactory.makeZero(this.getRowDim(),this.getColDim());
    retVal.fillMatching(myStore,myPhysicalFactory.function().divide(),myPhysicalFactory.getNumber(aNmbr));
    return this.getFactory().instantiate(retVal);
  }
...
final PhysicalStore<N> retVal=myPhysicalFactory.makeZero(this.getRowDim(),this.getColDim());
retVal.fillMatching(myStore,myPhysicalFactory.function().multiply(),myPhysicalFactory.getNumber(aNmbr));
return this.getFactory().instantiate(retVal);
}
...
final PhysicalStore<N> retVal=myPhysicalFactory.makeZero(this.getRowDim(),this.getColDim());
retVal.fillMatching(myStore,myPhysicalFactory.function().subtract(),myPhysicalFactory.getNumber(value));
return this.getFactory().instantiate(retVal);
}
