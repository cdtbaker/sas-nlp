...
public final class JamaMatrix extends Object implements BasicMatrix<Double>, PhysicalStore<Double>, Serializable {
  ...
  @SuppressWarnings("unused") private JamaMatrix(){
    super();
    myDelegate=null;
  ...
  public List<Double> asList(){
    ...
    return new AbstractList<Double>(){
      @Override public Double get(      final int someIndex){
        return JamaMatrix.this.getDelegate().get(someIndex / tmpColDim,someIndex % tmpColDim);
      }
      @Override public Double set(      final int someIndex,      final Double aValue){
...
;
  ...
  @SuppressWarnings("unchecked") @Override public final boolean equals(  final Object anObject){
  ...
  public void fillMatching(  final Access1D<Double> leftArg,  final BinaryFunction<Double> function,  final Access1D<Double> rightArg){
    if (leftArg == this) {
      if (function == ADD) {
        ...
        ArrayUtils.fillMatching(myDelegate.getArray(),myDelegate.getArray(),function,JamaMatrix.convert(rightArg,myDelegate.getRowDimension()).getArray());
      }
    }
      ...
      if (function == ADD) {
        ...
        ArrayUtils.fillMatching(myDelegate.getArray(),JamaMatrix.convert(leftArg,myDelegate.getRowDimension()).getArray(),function,myDelegate.getArray());
      }
 else {
        ArrayUtils.fillMatching(myDelegate.getArray(),JamaMatrix.convert(leftArg,myDelegate.getRowDimension()).getArray(),function,myDelegate.getArray());
      }
      ...
      ArrayUtils.fillMatching(myDelegate.getArray(),JamaMatrix.convert(leftArg,myDelegate.getRowDimension()).getArray(),function,JamaMatrix.convert(rightArg,myDelegate.getRowDimension()).getArray());
    }
  }
  ...
  public boolean isAbsolute(  final int row,  final int column){
    return myDelegate.get(row,column) >= ZERO;
  }
  ...
  public boolean isZero(  final int row,  final int column){
    return TypeUtils.isZero(myDelegate.get(row,column));
  }
  ...
  public void modifyDiagonal(  final int row,  final int column,  final UnaryFunction<Double> function){
    ArrayUtils.modifyDiagonal(myDelegate.getArray(),row,column,function);
  }
  ...
  public void modifyOne(  final int row,  final int column,  final UnaryFunction<Double> function){
  ...
  public PrimitiveScalar toScalar(  final int row,  final int column){
    return new PrimitiveScalar(myDelegate.get(row,column));
  }
  ...
  public void visitColumn(  final int row,  final int column,  final VoidFunction<Double> visitor){
    ArrayUtils.visitColumn(myDelegate.getArray(),row,column,visitor);
  }
  ...
  public void visitDiagonal(  final int row,  final int column,  final VoidFunction<Double> visitor){
    ArrayUtils.visitDiagonal(myDelegate.getArray(),row,column,visitor);
  }
  ...
  public void visitRow(  final int row,  final int column,  final VoidFunction<Double> visitor){
    ArrayUtils.visitRow(myDelegate.getArray(),row,column,visitor);
  }
