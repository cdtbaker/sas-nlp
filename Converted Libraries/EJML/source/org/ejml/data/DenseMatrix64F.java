 ...
 */
  public void set(  int numRows,  int numCols,  boolean rowMajor,  double... data){
    ...
    if (numRows != this.numRows || numCols != this.numCols)     throw new IllegalArgumentException("Unexpected matrix shape.");
    if (length > this.data.length)     throw new IllegalArgumentException("The length of this matrix's data array is too small.");
    if (rowMajor) {
 ...
 */
  @SuppressWarnings({"unchecked"}) public DenseMatrix64F copy(){
