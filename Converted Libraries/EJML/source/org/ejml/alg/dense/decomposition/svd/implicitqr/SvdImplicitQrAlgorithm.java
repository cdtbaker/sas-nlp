 ...
 */
  ...
  public void initParam(  int M,  int N){
    if (N > M)     throw new RuntimeException("Must be a square or tall matrix");
    this.N=N;
 ...
 */
  public void performImplicitSingleStep(  double scale,  double lambda,  boolean byAngle){
    ...
    if (bulge != 0)     removeBulgeLeft(x2 - 1,false);
    incrementSteps();
  }
  /** 
 ...
 */
  public void exceptionShift(){
    ...
    nextExceptional=steps + exceptionalThresh;
  }
  /** 
