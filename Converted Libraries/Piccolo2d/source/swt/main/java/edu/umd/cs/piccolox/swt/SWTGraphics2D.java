 ...
 */
  public void setFont(  final Font font){
    final String fontString="name=" + font.getFamily() + ";bold="+ font.isBold()+ ";italic="+ font.isItalic()+ ";size="+ font.getSize();
...
gc.setLineWidth(getTransformedLineWidth());
gc.drawLine((int)(transformedX1 + 0.5),(int)(transformedY1 + 0.5),(int)(transformedX2 + 0.5),(int)(transformedY2 + 0.5));
}
/** 
...
transform.transform(TEMP_POINT,TEMP_POINT);
gc.copyArea((int)TEMP_RECT.getX(),(int)TEMP_RECT.getY(),(int)TEMP_RECT.getWidth(),(int)TEMP_RECT.getHeight(),(int)TEMP_POINT.getX(),(int)TEMP_POINT.getY());
}
/** 
...
gc.setLineWidth(getTransformedLineWidth());
gc.drawRoundRectangle((int)(tx + 0.5),(int)(ty + 0.5),(int)(twidth + 0.5),(int)(theight + 0.5),(int)(tarcWidth + 0.5),(int)(tarcHeight + 0.5));
}
/** 
 * {@inheritDoc} 
 */
...
final double tarcHeight=TEMP_RECT.getHeight();
gc.setLineWidth(getTransformedLineWidth());
gc.fillRoundRectangle((int)(tx + 0.5),(int)(ty + 0.5),(int)(twidth + 0.5),(int)(theight + 0.5),(int)(tarcWidth + 0.5),(int)(tarcHeight + 0.5));
}
/** 
 * {@inheritDoc} 
 */
...
SWTShapeManager.transform(TEMP_RECT,transform);
gc.setLineWidth(getTransformedLineWidth());
gc.drawOval((int)(TEMP_RECT.getX() + 0.5),(int)(TEMP_RECT.getY() + 0.5),(int)(TEMP_RECT.getWidth() + 0.5),(int)(TEMP_RECT.getHeight() + 0.5));
}
/** 
 * {@inheritDoc} 
 */
...
TEMP_RECT.setRect(x,y,width,height);
SWTShapeManager.transform(TEMP_RECT,transform);
gc.fillOval((int)(TEMP_RECT.getX() + 0.5),(int)(TEMP_RECT.getY() + 0.5),(int)(TEMP_RECT.getWidth() + 0.5),(int)(TEMP_RECT.getHeight() + 0.5));
}
/** 
 * {@inheritDoc} 
 */
public void drawArc(final int x,final int y,final int width,final int height,final int startAngle,final int extent){
 ...
 */
public void drawArc(final double x,final double y,final double width,final double height,final double startAngle,final double extent){
TEMP_RECT.setRect(x,y,width,height);
SWTShapeManager.transform(TEMP_RECT,transform);
gc.setLineWidth(getTransformedLineWidth());
gc.drawArc((int)(TEMP_RECT.getX() + 0.5),(int)(TEMP_RECT.getY() + 0.5),(int)(TEMP_RECT.getWidth() + 0.5),(int)(TEMP_RECT.getHeight() + 0.5),(int)(startAngle + 0.5),(int)(startAngle + extent + 0.5));
}
/** 
 * {@inheritDoc} 
 */
public void fillArc(final int x,final int y,final int width,final int height,final int startAngle,final int extent){
drawArc((double)x,(double)y,(double)width,(double)height,(double)startAngle,(double)extent);
}
/** 
 ...
 * @param extent the angular extent of the arc, relative to the start angle.
 */
public void fillArc(final double x,final double y,final double width,final double height,final double startAngle,final double extent){
TEMP_RECT.setRect(x,y,width,height);
SWTShapeManager.transform(TEMP_RECT,transform);
gc.drawArc((int)(TEMP_RECT.getX() + 0.5),(int)(TEMP_RECT.getY() + 0.5),(int)(TEMP_RECT.getWidth() + 0.5),(int)(TEMP_RECT.getHeight() + 0.5),(int)(startAngle + 0.5),(int)(startAngle + extent + 0.5));
}
 ...
 */
public void drawImage(final org.eclipse.swt.graphics.Image image,final int srcX,final int srcY,final int srcW,final int srcH,final double destX,final double destY,final double destW,final double destH){
 ...
 * horizontally
 */
public void fillGradientRectangle(final double x,final double y,final double width,final double height,final boolean vertical){
TEMP_RECT.setRect(x,y,width,height);
SWTShapeManager.transform(TEMP_RECT,transform);
SWTShapeManager.awtToSWT(TEMP_RECT,SWT_RECT);
