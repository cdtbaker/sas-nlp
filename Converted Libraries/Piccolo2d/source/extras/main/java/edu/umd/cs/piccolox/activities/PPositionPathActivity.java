 ...
 */
  public PPositionPathActivity(  final long duration,  final long stepRate,  final Target target,  final float[] knots,  final Point2D[] positions){
 ...
 * @param positions points along the path
 */
  public PPositionPathActivity(  final long duration,  final long stepRate,  final int loopCount,  final int mode,  final Target target,  final float[] knots,  final Point2D[] positions){
...
target.setPosition(start.getX() + zeroToOne * (end.getX() - start.getX()),start.getY() + zeroToOne * (end.getY() - start.getY()));
}
}
