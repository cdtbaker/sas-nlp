 ...
 * finished
 */
  public PTransformActivity(  final long duration,  final long stepRate,  final Target target,  final AffineTransform destination){
 ...
 */
  public PTransformActivity(  final long duration,  final long stepRate,  final int loopCount,  final int mode,  final Target target,  final AffineTransform destination){
 ...
 */
  public void setRelativeTargetValue(  final float zeroToOne){
    ...
    STATIC_TRANSFORM.setTransform(source[0] + zeroToOne * (destination[0] - source[0]),source[1] + zeroToOne * (destination[1] - source[1]),source[2] + zeroToOne * (destination[2] - source[2]),source[3] + zeroToOne * (destination[3] - source[3]),source[4] + zeroToOne * (destination[4] - source[4]),source[5] + zeroToOne * (destination[5] - source[5]));
