 ...
 */
  public PAffineTransform(  final double m00,  final double m10,  final double m01,  final double m11,  final double m02,  final double m12){
 ...
 * @param m12 the Y coordinate translation element of the 3x3 matrix
 */
  public PAffineTransform(  final float m00,  final float m10,  final float m01,  final float m11,  final float m02,  final float m12){
    super(m00,m10,m01,m11,m02,m12);
  }
  /** 
...
case AffineTransform.TYPE_TRANSLATION:
  result.setRect(rectSrc.getX() + getTranslateX(),rectSrc.getY() + getTranslateY(),rectSrc.getWidth(),rectSrc.getHeight());
break;
...
scale=getScaleX();
result.setRect(rectSrc.getX() * scale + getTranslateX(),rectSrc.getY() * scale + getTranslateY(),rectSrc.getWidth() * scale,rectSrc.getHeight() * scale);
break;
default :
...
result.setRect((rectSrc.getX() - getTranslateX()) / scale,(rectSrc.getY() - getTranslateY()) / scale,rectSrc.getWidth() / scale,rectSrc.getHeight() / scale);
break;
default :
final double[] pts=rectToArray(rectSrc);
try {
