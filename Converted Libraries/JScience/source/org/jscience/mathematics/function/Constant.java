 ...
 */
  @SuppressWarnings("unchecked") public static <R extends Ring<R>>Constant<R> valueOf(  R value){
    Constant<R> cst=FACTORY.object();
    cst._termToCoef.put(Term.ONE,value);
    return cst;
  }
  @SuppressWarnings("unchecked") private static final ObjectFactory<Constant> FACTORY=new ObjectFactory<Constant>(){
