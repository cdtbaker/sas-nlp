 ...
 */
  public final Variable<X> getVariable(  String symbol){
    for (    Variable<X> v : this.getVariables()) {
      if (symbol.equals(v.getSymbol()))       return v;
    }
    return null;
  }
  /** 
 ...
 */
  public final Y evaluate(  X arg){
    ...
    if (vars.size() != 1)     throw new FunctionException("This function is not monovariate");
 ...
 */
  public final Y evaluate(  X... args){
    List<Variable<X>> vars=getVariables();
    if (vars.size() != args.length)     throw new IllegalArgumentException("Found " + args.length + " arguments, but "+ vars.size()+ "required");
    LocalContext.enter();
    try {
 ...
 */
  public <Z>Function<Z,Y> compose(  Function<Z,X> that){
    if (getVariables().size() != 1)     throw new FunctionException("This function is not monovariate");
 ...
 * @return <code>this - that</code>.
 */
  @SuppressWarnings("unchecked") public Function<X,Y> minus(  Function<X,Y> that){
    if (that instanceof GroupAdditive) {
      Function thatOpposite=(Function)((GroupAdditive)that).opposite();
 ...
 * @return <code>this / that</code>.
 */
  @SuppressWarnings("unchecked") public Function<X,Y> divide(  Function<X,Y> that){
    if (that instanceof GroupMultiplicative) {
      Function thatInverse=(Function)((GroupMultiplicative)that).inverse();
 ...
 */
  public Function<X,Y> pow(  int n){
    if (n <= 0)     throw new IllegalArgumentException("n: " + n + " zero or negative values not allowed");
 ...
 */
  ...
  @SuppressWarnings("unchecked") static final List merge(  List left,  List right){
    if (left.containsAll(right))     return left;
    if (right.containsAll(left))     return right;
...
;
    private Function _f;
    private Function _g;
    @SuppressWarnings("unchecked") public static <X,Y>Function<X,Y> newInstance(    Function f,    Function g){
      Compose compose=FACTORY.object();
      compose._f=f;
      compose._g=g;
      return compose;
    }
    @Override public List getVariables(){
      return _g.getVariables();
    }
    @Override @SuppressWarnings("unchecked") public Object evaluate(){
      return evaluate(_g.evaluate());
    }
    @SuppressWarnings("unchecked") public Function differentiate(    Variable v){
      Function fd=_f.differentiate(v);
      Function gd=_g.differentiate(v);
      return fd.compose(_g).times(gd);
    }
    public Text toText(){
      return TextBuilder.newInstance().append('(').append(_f).append(')').append('o').append('(').append(_g).append(')').toText();
    }
    @Override public boolean equals(    Object obj){
      if (!(obj instanceof Compose))       return false;
...
;
    private Function _f;
    private Variable _v;
    @SuppressWarnings("unchecked") public static <X,Y>Function<X,Y> newInstance(    Function f,    Variable v){
    ...
    public Text toText(){
      return TextBuilder.newInstance().append("d[").append(_f).append("]/d").append(_v.getSymbol()).toText();
    }
    @Override public boolean equals(    Object obj){
      if (!(obj instanceof Derivative))       return false;
...
;
    ...
    public Text toText(){
      return TextBuilder.newInstance().append("S[").append(_f).append("·d").append(_v.getSymbol()).append(']').toText();
    }
    @Override public boolean equals(    Object obj){
      if (!(obj instanceof Integral))       return false;
...
;
    ...
    @SuppressWarnings("unchecked") @Override public Object evaluate(){
      Object y2=_g.evaluate();
      Object y1=_f.evaluate();
      if (!(y1 instanceof GroupAdditive))       throw new FunctionException(y1.getClass() + " is not an additive group");
      return ((GroupAdditive)y1).plus(y2);
    }
    @SuppressWarnings("unchecked") @Override public Function differentiate(    Variable v){
      return _f.differentiate(v).plus(_g.differentiate(v));
    }
    @SuppressWarnings("unchecked") @Override public Function integrate(    Variable v){
      return _f.integrate(v).plus(_g.integrate(v));
    }
    public Text toText(){
      return TextBuilder.newInstance().append('(').append(_f).append(")").append('+').append('(').append(_g).append(')').toText();
    }
    @Override public boolean equals(    Object obj){
...
;
    ...
    @SuppressWarnings("unchecked") @Override public Object evaluate(){
      Object y2=_g.evaluate();
      if (!(y2 instanceof GroupAdditive))       throw new FunctionException(y2.getClass() + " is not an additive group");
...
;
    ...
    @SuppressWarnings("unchecked") @Override public Object evaluate(){
      Object y2=_g.evaluate();
      Object y1=_f.evaluate();
      if (!(y1 instanceof GroupMultiplicative))       throw new FunctionException(y1.getClass() + " is not a multiplicative group");
...
;
    ...
    @SuppressWarnings("unchecked") @Override public Object evaluate(){
      Object y2=_g.evaluate();
      if (!(y2 instanceof GroupMultiplicative))       throw new FunctionException(y2.getClass() + " is not a multiplicative group");
    ...
    @Override public boolean equals(    Object obj){
      if (!(obj instanceof Divide))       return false;
