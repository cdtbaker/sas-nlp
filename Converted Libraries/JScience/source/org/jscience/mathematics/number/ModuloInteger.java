 ...
 */
  static final XMLFormat<ModuloInteger> XML=new XMLFormat<ModuloInteger>(ModuloInteger.class){
    @Override public ModuloInteger newInstance(    Class<ModuloInteger> cls,    InputElement xml) throws XMLStreamException {
 ...
 */
  public static void setModulus(  LargeInteger modulus){
    if ((modulus != null) && (!modulus.isPositive()))     throw new IllegalArgumentException("modulus: " + modulus + " has to be greater than 0");
    MODULUS.set(modulus);
  }
  /** 
 ...
 */
  public boolean equals(  Object that){
    return (that instanceof ModuloInteger) ? _value.equals(((ModuloInteger)that)._value) : false;
  }
  /** 
 ...
 */
  ...
  @Override public boolean isLargerThan(  ModuloInteger that){
  ...
  @Override public int compareTo(  ModuloInteger that){
  ...
  public ModuloInteger inverse(){
    LargeInteger modulus=MODULUS.get();
    if (modulus == null)     throw new ArithmeticException("Modulus not set");
...
;
  ...
  @Override public ModuloInteger copy(){
