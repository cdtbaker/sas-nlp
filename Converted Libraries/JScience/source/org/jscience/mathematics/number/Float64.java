 ...
 */
  static final XMLFormat<Float64> XML=new XMLFormat<Float64>(Float64.class){
    @Override public Float64 newInstance(    Class<Float64> cls,    InputElement xml) throws XMLStreamException {
      return Float64.valueOf(xml.getAttribute("value",0.0));
    }
    public void write(    Float64 float64,    OutputElement xml) throws XMLStreamException {
 ...
 */
  ...
  @Override public int compareTo(  Float64 that){
    return compareTo(that._value);
  }
  @Override public Float64 copy(){
