 ...
 */
  static final XMLFormat<Integer64> XML=new XMLFormat<Integer64>(Integer64.class){
    @Override public Integer64 newInstance(    Class<Integer64> cls,    InputElement xml) throws XMLStreamException {
      return Integer64.valueOf(xml.getAttribute("value",0L));
    }
    public void write(    Integer64 integer64,    OutputElement xml) throws XMLStreamException {
 ...
 */
  ...
  @Override public int compareTo(  Integer64 that){
    return compareTo(that._value);
  }
  @Override public Integer64 copy(){
