 ...
 */
  private static LocalContext.Reference<PhysicalModel> Current=new LocalContext.Reference<PhysicalModel>();
  /** 
 * Holds the dimensional model.
 */
  private static final Dimension.Model DIMENSIONAL_MODEL=new Dimension.Model(){
 ...
 */
  ...
  /** 
 * Returns the current physical model (default: instance of {@link StandardModel}).
