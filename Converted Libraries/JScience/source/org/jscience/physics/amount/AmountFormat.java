 ...
 */
  private static final LocalContext.Reference<AmountFormat> CURRENT=new LocalContext.Reference<AmountFormat>(new PlusMinusError(2));
  /** 
 * Default constructor.
 */
 ...
 */
    ...
    @SuppressWarnings("unchecked") @Override public Appendable format(    Amount arg0,    Appendable arg1) throws IOException {
      if (arg0.getUnit() instanceof Currency)       return formatMoney(arg0,arg1);
      if (arg0.isExact()) {
    ...
    @Override public Amount<?> parse(    CharSequence arg0,    Cursor arg1){
