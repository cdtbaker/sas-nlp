 ...
 */
  public final static Amount<Acceleration> g=Amount.valueOf(980665,SI.METRES_PER_SQUARE_SECOND).divide(100000);
  /** 
 * Holds the electron rest mass.
 */
  public final static Amount<Mass> me=Amount.valueOf(9.1093826E-31,0.0000016E-31,SI.KILOGRAM);
  /** 
 * Holds the proton rest mass.
 */
  public final static Amount<Mass> mp=Amount.valueOf(1.67262171E-27,0.00000029E-27,SI.KILOGRAM);
  /** 
 * Holds the neutron rest mass.
 */
  public final static Amount<Mass> mn=Amount.valueOf(1.67492728E-27,0.00000029E-27,SI.KILOGRAM);
  /** 
 * Holds the deuteron rest mass.
 */
  public final static Amount<Mass> md=Amount.valueOf(3.34358335E-27,0.00000057E-27,SI.KILOGRAM);
  /** 
 * Holds the muon rest mass.
 */
  public final static Amount<Mass> mμ=Amount.valueOf(1.88353140E-28,0.00000033E-28,SI.KILOGRAM);
  /** 
 ...
 * Holds {@link #c}².
 */
  public final static Amount<?> c_square=Amount.valueOf(299792458L * 299792458L,SI.METRES_PER_SECOND.pow(2));
  /** 
 * Holds the Boltzmann constant.
 * @see <a href="http://en.wikipedia.org/wiki/Boltzmanns_constant">
     *      Wikipedia: Boltzmann constant</a>
 */
  public final static Amount<?> k=Amount.valueOf(1.3806505E-23,0.0000024E-23,SI.JOULE.divide(SI.KELVIN));
  /** 
 * Holds the Planck constant.
 * @see <a href="http://en.wikipedia.org/wiki/Plank%27s_constant">
     *      Wikipedia: Plank's constant</a>
 */
  public final static Amount<?> ℎ=Amount.valueOf(6.6260693E-34,0.0000011E-34,SI.JOULE.times(SI.SECOND));
  /** 
 ...
 */
  public final static Amount<ElectricCharge> e=Amount.valueOf(1.60217653E-19,0.00000014E-19,SI.COULOMB);
  /** 
 ...
 */
  public final static Amount<?> µ0=Amount.valueOf(1.2566370614359172953850573533118E-6,SI.NEWTON.divide(SI.AMPERE.pow(2)));
  /** 
 ...
 */
  public final static Amount<Dimensionless> α=e.pow(2).divide(ε0.times(c).times(ℎ).times(2)).to(Unit.ONE);
  /** 
 ...
 */
  public final static Amount<?> G=Amount.valueOf(6.6742E-11,0.001E-11,SI.METRE.pow(3).divide(SI.KILOGRAM).divide(SI.SECOND.pow(2)));
  /** 
 * Holds the Avogadro constant.
 * @see <a href="http://en.wikipedia.org/wiki/Avogadro%27s_number">
     *      Wikipedia: Avogadro's number</a>
 */
  public final static Amount<?> N=Amount.valueOf(6.0221415E23,0.0000010E23,Unit.ONE.divide(SI.MOLE));
  /** 
 ...
 */
  public final static Amount<?> σ=π_square.divide(60).times(k.pow(4)).divide(ℏ.pow(3).times(c.pow(2)));
  /** 
 * Holds the unified atomic mass unit (0.001 kg/mol)/N
 */
  public final static Amount<Mass> amu=Amount.valueOf(1E-3,SI.KILOGRAM.divide(SI.MOLE)).divide(N).to(SI.KILOGRAM);
  /** 
 * Holds the Rydberg constant (α²·me·c/2h).
 * @see <a href="http://en.wikipedia.org/wiki/Rydberg_constant">
     *      Wikipedia: Rydberg constant</a>
 */
  public final static Amount<?> Rinf=Amount.valueOf(10973731.568525,0.000073,SI.METRE.inverse());
  /** 
 * Holds the Bohr radius (α/(4π·Rinf))
 */
  public final static Amount<Length> a0=α.divide(π.times(Rinf).times(4)).to(SI.METRE);
  /** 
 * Holds the Hartree energy (2Rinf·h·c)
 */
  public final static Amount<?> Eh=Rinf.times(ℎ).times(c).times(2);
  /** 
 * Holds the magnetic flux quantum (h/2e)
 */
  public final static Amount<MagneticFlux> Φ0=ℎ.divide(e).divide(2).to(SI.WEBER);
  /** 
 * Holds the conductance quantum (2e²/h)
 */
  public final static Amount<ElectricConductance> G0=e.pow(2).divide(ℎ).times(2).to(ElectricConductance.UNIT);
  /** 
 * Holds the Bohr magneton (ℏ·e/2me)
 */
  public final static Amount<?> µB=e.times(ℏ).divide(me).divide(2);
  /** 
 * Holds the nuclear magneton (ℏ·e/2mp)
 */
  public final static Amount<?> µN=e.times(ℏ).divide(mp).divide(2);
  /** 
