 ...
 */
  public static final CoordinateSystem XYZ_CS=new CoordinateSystem(){
    Axis xAxis=new Axis("Geocentric X","X",SI.METRE,AxisDirection.GEOCENTRIC_X);
    Axis yAxis=new Axis("Geocentric Y","Y",SI.METRE,AxisDirection.GEOCENTRIC_Y);
    Axis zAxis=new Axis("Geocentric Z","Z",SI.METRE,AxisDirection.GEOCENTRIC_Z);
