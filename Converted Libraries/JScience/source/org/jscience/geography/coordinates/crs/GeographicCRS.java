 ...
 */
  public static final CoordinateSystem LATITUDE_LONGITUDE_CS=new CoordinateSystem(){
    Axis latitudeAxis=new Axis("Geodetic Latitude","Lat",NonSI.DEGREE_ANGLE,AxisDirection.NORTH);
    Axis longitudeAxis=new Axis("Geodetic Longitude","Long",NonSI.DEGREE_ANGLE,AxisDirection.EAST);
