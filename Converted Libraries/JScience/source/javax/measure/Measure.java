 ...
 */
  public long longValue(  Unit<Q> unit) throws ArithmeticException {
    ...
    if (java.lang.Double.isNaN(doubleValue) || (doubleValue < java.lang.Long.MIN_VALUE) || (doubleValue > java.lang.Long.MAX_VALUE))     throw new ArithmeticException(doubleValue + " " + unit+ " cannot be represented as long");
 ...
 */
  public int intValue(  Unit<Q> unit){
    ...
    if ((longValue > java.lang.Integer.MAX_VALUE) || (longValue < java.lang.Integer.MIN_VALUE))     throw new ArithmeticException("Overflow");
 ...
 */
  public String toString(){
    if (getUnit() instanceof CompoundUnit)     return MeasureFormat.DEFAULT.formatCompound(doubleValue(getUnit()),getUnit(),new StringBuffer(),null).toString();
...
private static final class Double<Q extends Quantity> extends Measure<java.lang.Double,Q> {
    ...
    @Override public java.lang.Double getValue(){
      return _value;
    }
    @Override public Measure<java.lang.Double,Q> to(    Unit<Q> unit){
      if ((unit == _unit) || (unit.equals(_unit)))       return this;
      return new Double<Q>(doubleValue(unit),unit);
    }
    public double doubleValue(    Unit<Q> unit){
      if ((unit == _unit) || (unit.equals(_unit)))       return _value;
...
private static final class Long<Q extends Quantity> extends Measure<java.lang.Long,Q> {
    ...
    @Override public java.lang.Long getValue(){
      return _value;
    }
    @Override public Measure<java.lang.Long,Q> to(    Unit<Q> unit){
      if ((unit == _unit) || (unit.equals(_unit)))       return this;
...
private static final class Float<Q extends Quantity> extends Measure<java.lang.Float,Q> {
    ...
    @Override public java.lang.Float getValue(){
      return _value;
    }
    @Override public Measure<java.lang.Float,Q> to(    Unit<Q> unit){
      if ((unit == _unit) || (unit.equals(_unit)))       return this;
...
private static final class Integer<Q extends Quantity> extends Measure<java.lang.Integer,Q> {
    ...
    @Override public java.lang.Integer getValue(){
      return _value;
    }
    @Override public Measure<java.lang.Integer,Q> to(    Unit<Q> unit){
      if ((unit == _unit) || (unit.equals(_unit)))       return this;
