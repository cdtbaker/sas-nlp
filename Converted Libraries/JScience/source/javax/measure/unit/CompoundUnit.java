 ...
 */
  CompoundUnit(  Unit<Q> high,  Unit<Q> low){
    if (!high.getStandardUnit().equals(low.getStandardUnit()))     throw new IllegalArgumentException("Both units do not have the same system unit");
    _high=high;
    _low=low;
  }
  /** 
 ...
 */
  ...
  @Override public Unit<? super Q> getStandardUnit(){
