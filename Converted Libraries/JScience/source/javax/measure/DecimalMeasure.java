 ...
 */
  @SuppressWarnings("unchecked") public static <Q extends Quantity>DecimalMeasure<Q> valueOf(  CharSequence csq){
 ...
 */
  @Override public DecimalMeasure<Q> to(  Unit<Q> unit){
    return to(unit,null);
  }
  /** 
 * Returns the decimal measure equivalent to this measure but stated in the 
 ...
 */
  public DecimalMeasure<Q> to(  Unit<Q> unit,  MathContext mathContext){
    ...
    if (cvtr instanceof RationalConverter) {
      ...
      BigDecimal result=mathContext == null ? _value.multiply(dividend).divide(divisor) : _value.multiply(dividend,mathContext).divide(divisor,mathContext);
  ...
  public double doubleValue(  Unit<Q> unit){
    if ((unit == _unit) || (unit.equals(_unit)))     return _value.doubleValue();
