...
private static class Configuration {
    ...
    private final static Configuration defaultConfig=new Configuration(new Range(20000,20000,10),new Range(2,2,10));
 ...
 */
    public static Configuration parse(    String[] args){
      if (args.length == 0) {
        ...
        System.err.println("MergeExample <size start> <size step> <size steps> <parallel start> <parallel step>" + " <parallel steps>");
        System.err.println("example: MergeExample 20000 10000 3 1 1 4");
        System.err.println("example: will run with arrays of sizes 20000, 30000, 40000" + " and parallelism: 1, 2, 3, 4");
        return null;
      }
    }
    /** 
