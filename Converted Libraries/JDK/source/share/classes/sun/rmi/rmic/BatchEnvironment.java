 ...
 */
  public String errorString(  String err,  Object arg0,  Object arg1,  Object arg2){
    if (err.startsWith("rmic.") || err.startsWith("warn.rmic.")) {
      String result=Main.getText(err,(arg0 != null ? arg0.toString() : null),(arg1 != null ? arg1.toString() : null),(arg2 != null ? arg2.toString() : null));
      ...
      public Iterator<String> iterator(){
        return new Iterator<String>(){
          ...
          public String next(){
            ...
            pos=end + 1;
            if (beg == end && emptyPathDefault != null)             return emptyPathDefault;
 else             return path.substring(beg,end);
          }
          public void remove(){
 ...
 */
    ...
    private void addDirectory(    String dir,    boolean warn){
      ...
      for (      String direntry : new File(dir).list()) {
        ...
        if (canonicalized.endsWith(".jar") || canonicalized.endsWith(".zip"))         addFile(dir + File.separator + direntry,warn);
      }
    }
    public Path addFiles(    String files,    boolean warn){
      if (files != null)       for (      String file : new PathIterator(files,emptyPathDefault))       addFile(file,warn);
      return this;
    }
