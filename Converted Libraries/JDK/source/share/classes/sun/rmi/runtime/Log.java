...
static {
    boolean useOld=Boolean.valueOf(java.security.AccessController.doPrivileged(new sun.security.action.GetPropertyAction("sun.rmi.log.useOld"))).booleanValue();
...
private static class LoggerLog extends Log {
    private static final Handler alternateConsole=java.security.AccessController.doPrivileged(new java.security.PrivilegedAction<Handler>(){
      public Handler run(){
