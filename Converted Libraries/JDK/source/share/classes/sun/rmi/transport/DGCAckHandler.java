 ...
 */
  private static final long dgcAckTimeout=AccessController.doPrivileged(new GetLongAction("sun.rmi.dgc.ackTimeout",300000));
  /** 
 ...
 */
  private static final Map<UID,DGCAckHandler> idTable=Collections.synchronizedMap(new HashMap<UID,DGCAckHandler>());
