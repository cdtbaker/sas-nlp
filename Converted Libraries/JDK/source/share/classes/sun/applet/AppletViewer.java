...
case AppletPanel.APPLET_LOADING_COMPLETED:
{
          ...
          if (a != null)           AppletPanel.changeFrameAppContext(frame,SunToolkit.targetToAppContext(a));
...
if (eventList == null) {
 ...
 else     System.out.println("Unrecognized event name: " + events[i]);
  }
 ...
 * @deprecated
 */
@Deprecated public static void main(String argv[]){
Main.main(argv);
}
