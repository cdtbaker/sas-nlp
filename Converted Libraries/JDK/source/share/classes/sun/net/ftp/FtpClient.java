...
public abstract class FtpClient implements java.io.Closeable {
  ...
  public static enum TransferType {  ASCII,   BINARY,   EBCDIC}
  /** 
 ...
 * @return the {@code Proxy}, this client is using, or {@code null}if none is used.
 * @see #setProxy(Proxy)
 */
 ...
 * @return the {@link java.io.OutputStream} from the data connection or{@code null} if the command was unsuccessful.
 * @throws IOException if an error occured during the transmission.
 ...
 * @param path the pathname of the directory to list, or {@code null}for the current working directory.
 ...
 * @param path the pathname of the directory to list or {@code null}for the current working directoty.
 ...
 * @return the name the latest transfered file remote name, or{@code null} if that information is unavailable.
 */
 ...
 * server.
 * @return a {@code String} describing the OS, or {@code null}if the operation was not successful.
 * @throws IOException if an error occured during the transmission.
 * @throws FtpProtocolException if the command was rejected by the server
 */
 ...
 * @param cmd the command for which the help is requested or{@code null} for the general help
