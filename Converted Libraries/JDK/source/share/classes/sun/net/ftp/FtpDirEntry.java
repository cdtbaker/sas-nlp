...
public class FtpDirEntry {
  public enum Type {  FILE,   DIR,   PDIR,   CDIR,   LINK}
  public enum Permission {  USER(0),   GROUP(1),   OTHERS(2);   int value;
  Permission(  int v){
    value=v;
  }
}
 ...
 * @return a {@code String} containing the user name or{@code null} if that information is not available.
 */
 ...
 * @param user The user name of the owner of the file, or {@code null}if that information is not available.
 ...
 * @return a {@code String} containing the group name or{@code null} if that information is not available.
 */
 ...
 * used from inside a {@link java.net.FtpDirParser} implementation.
 * @param group The name of the group to which the file belong, or {@code null}if that information is not available.
 * @return this FtpDirEntry
 */
 ...
 */
  ...
  /** 
 * Sets the size of that file. Intended mostly to be used from inside an{@link java.net.FtpDirParser} implementation.
 ...
 */
  ...
  /** 
 * Sets the type of the file. Intended mostly to be used from inside an{@link java.net.FtpDirParser} implementation.
 ...
 * @param lastModified The Date representing the last modification time, or{@code null} if that information is not available.
 * @return this FtpDirEntry
 */
 ...
 * Intended mostly to be used from inside a {@link java.net.FtpDirParser}implementation.
 ...
 * @return The Date representing the creation time, or {@code null}if the server didn't provide that information.
 */
 ...
 * @param created the Date representing the creation time for that file, or{@code null} if that information is not available.
 * @return this FtpDirEntry
 */
 ...
 * The {@code toString} method for class {@code FtpDirEntry}returns a string consisting of the name of the file, followed by its
