...
class MimeLauncher extends Thread {
  ...
  InputStream is;
  String execPath;
  MimeLauncher(  MimeEntry M,  java.net.URLConnection uc,  InputStream is,  String tempFileTemplate,  String threadName) throws ApplicationLaunchException {
    super(threadName);
    m=M;
    this.uc=uc;
    this.is=is;
  ...
  private boolean findExecutablePath(  String str){
    ...
    String execPathList;
    execPathList=java.security.AccessController.doPrivileged(new sun.security.action.GetPropertyAction("exec.path"));
