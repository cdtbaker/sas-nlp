...
public class NegotiatorImpl extends Negotiator {
  private static final boolean DEBUG=java.security.AccessController.doPrivileged(new sun.security.action.GetBooleanAction("sun.security.krb5.debug"));
 ...
 */
  @Override public byte[] firstToken(){
    return oneToken;
  }
  /** 
 ...
 */
  @Override public byte[] nextToken(  byte[] token) throws IOException {
    try {
