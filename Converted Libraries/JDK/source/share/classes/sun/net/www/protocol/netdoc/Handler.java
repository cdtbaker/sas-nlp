...
public class Handler extends URLStreamHandler {
  ...
  public synchronized URLConnection openConnection(  URL u) throws IOException {
    ...
    URL ru;
    Boolean tmp=java.security.AccessController.doPrivileged(new sun.security.action.GetBooleanAction("newdoc.localonly"));
    boolean localonly=tmp.booleanValue();
    String docurl=java.security.AccessController.doPrivileged(new sun.security.action.GetPropertyAction("doc.url"));
