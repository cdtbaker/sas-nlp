...
dx2*=rh;
dy2*=rh;
if (adjustfill && sg2d.strokeState < SunGraphics2D.STROKE_CUSTOM && sg2d.strokeHint != SunHints.INTVAL_STROKE_PURE) {
...
outrenderer.drawParallelogram(sg2d,rx,ry,rx + rw,ry + rh,px,py,dx1,dy1,dx2,dy2,lw1 / len1,lw2 / len2);
}
}
/** 
