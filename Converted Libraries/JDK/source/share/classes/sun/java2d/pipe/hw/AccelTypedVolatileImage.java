 ...
 * @param width width
 * @param height width
 * @param transparency type of {@link java.awt.Transparency transparency}requested for the image
 ...
 */
  ...
  /** 
 * {@inheritDoc}This method will throw {@code UnsupportedOperationException} if it this
 * image's destination surface can not be rendered to.
 */
  @Override public Graphics2D createGraphics(){
