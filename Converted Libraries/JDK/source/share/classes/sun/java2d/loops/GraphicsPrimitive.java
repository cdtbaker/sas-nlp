 ...
 */
  ...
  public synchronized static final int makeUniqueID(  int primTypeID,  SurfaceType src,  CompositeType cmp,  SurfaceType dst){
 ...
 */
  ...
  final boolean satisfiesSameAs(  GraphicsPrimitive other){
    return (methodSignature == other.methodSignature && sourceType.equals(other.sourceType) && compositeType.equals(other.compositeType) && destType.equals(other.destType));
  }
...
public static class TraceReporter extends Thread {
  ...
  public String toString(){
    if (cachedname == null) {
      ...
      cachedname=(getClass().getName() + "::" + sig+ "("+ simplename(sourceType)+ ", "+ simplename(compositeType)+ ", "+ simplename(destType)+ ")");
    }
    return cachedname;
  }
}
