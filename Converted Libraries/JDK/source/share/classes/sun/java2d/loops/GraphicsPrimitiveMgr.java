...
static {
    initIDs(GraphicsPrimitive.class,SurfaceType.class,CompositeType.class,SunGraphics2D.class,java.awt.Color.class,java.awt.geom.AffineTransform.class,XORComposite.class,java.awt.AlphaComposite.class,java.awt.geom.Path2D.class,java.awt.geom.Path2D.Float.class,sun.awt.SunHints.class);
 ...
 */
  ...
  public synchronized static GraphicsPrimitive locate(  int primTypeID,  SurfaceType srctype,  CompositeType comptype,  SurfaceType dsttype){
  ...
  public synchronized static GraphicsPrimitive locatePrim(  int primTypeID,  SurfaceType srctype,  CompositeType comptype,  SurfaceType dsttype){
    SurfaceType src, dst;
    CompositeType cmp;
