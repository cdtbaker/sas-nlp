 ...
 * which always returns the same value from its{@link StateTracker#isCurrent isCurrent} method.
 * <ul>
 ...
 * <li>Otherwise the current state is {@link State#STABLE STABLE}and this StateTracker will indicate whether or not the
