 ...
 * @throws IllegalStateException if the current state is{@link State#UNTRACKABLE UNTRACKABLE}
 * @see #setUntrackable
 * @since 1.7
 */
 ...
 * @throws IllegalStateException if the current state is{@link State#IMMUTABLE IMMUTABLE}
 * @see #setImmutable
 * @since 1.7
 */
