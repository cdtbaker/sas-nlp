 ...
 */
  ...
  void strokeTo(  Shape src,  AffineTransform at,  BasicStroke bs,  boolean thin,  NormMode normalize,  boolean antialias,  PathConsumer2D pc2d){
    ...
    strokeTo(src,at,lw,normalize,bs.getEndCap(),bs.getLineJoin(),bs.getMiterLimit(),bs.getDashArray(),bs.getDashPhase(),pc2d);
  }
...
Renderer r=new Renderer(3,3,clip.getLoX(),clip.getLoY(),clip.getWidth(),clip.getHeight(),PathIterator.WIND_EVEN_ODD);
