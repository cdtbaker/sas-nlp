...
public abstract class VSyncedBSManager {
  ...
  private static final boolean vSyncLimit=Boolean.valueOf((String)java.security.AccessController.doPrivileged(new sun.security.action.GetPropertyAction("sun.java2d.vsynclimit","true")));
...
private static final class NoLimitVSyncBSMgr extends VSyncedBSManager {
    @Override boolean checkAllowed(    BufferStrategy bs){
      return true;
    }
    @Override void relinquishVsync(    BufferStrategy bs){
    }
  }
  /** 
...
private static final class SingleVSyncedBSMgr extends VSyncedBSManager {
    ...
    @Override public synchronized boolean checkAllowed(    BufferStrategy bs){
      if (strategy != null) {
    ...
    @Override public synchronized void relinquishVsync(    BufferStrategy bs){
      if (strategy != null) {
