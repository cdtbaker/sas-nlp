  ...
  ExecutableInputMethodManager(){
    ...
    try {
      if (toolkit instanceof InputMethodSupport) {
        InputMethodDescriptor hostAdapterDescriptor=((InputMethodSupport)toolkit).getInputMethodAdapterDescriptor();
...
synchronized (javaInputMethodLocatorList) {
      ...
      try {
        AccessController.doPrivileged(new PrivilegedExceptionAction(){
          public Object run(){
            for (            InputMethodDescriptor descriptor : ServiceLoader.loadInstalled(InputMethodDescriptor.class)) {
