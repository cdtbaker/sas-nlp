...
static {
    ...
    if (inputStyle == null) {
      inputStyle=Toolkit.getDefaultToolkit().getProperty("java.awt.im.style",null);
    }
 ...
 */
  ...
  public void dispatchEvent(  AWTEvent event){
    if (event instanceof InputMethodEvent) {
      if (((Component)event.getSource()).getInputMethodRequests() == null || (useBelowTheSpotInput() && !dispatchingCommittedText)) {
