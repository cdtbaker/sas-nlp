 ...
 */
  public DataFlavor[] getAvailableDataFlavors(){
    ...
    return DataTransferer.getInstance().getFlavorsForFormatsAsArray(formats,flavorMap);
  }
  /** 
 ...
 */
  ...
  private static Set formatArrayAsDataFlavorSet(  long[] formats){
    return (formats == null) ? null : DataTransferer.getInstance().getFlavorsForFormatsAsSet(formats,flavorMap);
  }
