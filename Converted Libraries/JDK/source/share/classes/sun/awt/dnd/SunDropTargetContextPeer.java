 ...
 */
  public boolean isDataFlavorSupported(  DataFlavor df){
    ...
    if (localTransferable != null) {
      ...
      return DataTransferer.getInstance().getFlavorsForFormats(currentT,DataTransferer.adaptFlavorMap(currentDT.getFlavorMap())).containsKey(df);
    }
  }
  /** 
 * @return the data
 ...
 */
  ...
  private int handleEnterMessage(  final Component component,  final int x,  final int y,  final int dropAction,  final int actions,  final long[] formats,  final long nativeCtxt){
 ...
 */
  ...
  private int handleMotionMessage(  final Component component,  final int x,  final int y,  final int dropAction,  final int actions,  final long[] formats,  final long nativeCtxt){
 ...
 */
  private void handleDropMessage(  final Component component,  final int x,  final int y,  final int dropAction,  final int actions,  final long[] formats,  final long nativeCtxt){
 ...
 */
  public synchronized void acceptDrop(  int dropOperation){
    if (dropOperation == DnDConstants.ACTION_NONE)     throw new IllegalArgumentException("invalid acceptDrop() action");
    if (dropStatus != STATUS_WAIT) {
...
protected static class EventDispatcher {
    ...
    EventDispatcher(    SunDropTargetContextPeer peer,    int dropAction,    int actions,    long[] formats,    long nativeCtxt,    boolean dispatchType){
      this.peer=peer;
