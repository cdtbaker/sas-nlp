...
public class ShellFolderColumnInfo {
  ...
  /** 
 * Allowed values are {@link SwingConstants#LEFT}, {@link SwingConstants#RIGHT}, {@link SwingConstants#LEADING},{@link SwingConstants#TRAILING}, {@link SwingConstants#CENTER}
 */
 ...
 */
  ...
  public ShellFolderColumnInfo(  String title,  Integer width,  Integer alignment,  boolean visible,  SortOrder sortOrder,  Comparator comparator,  boolean compareByColumn){
    this.title=title;
    this.width=width;
  ...
  public ShellFolderColumnInfo(  String title,  Integer width,  Integer alignment,  boolean visible,  SortOrder sortOrder,  Comparator comparator){
