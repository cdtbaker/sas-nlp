...
public class PerfDataBufferPrologue extends AbstractPerfDataBufferPrologue {
  ...
  final static int PERFDATA_PROLOG_ACCESSIBLE_SIZE=1;
  ...
  final static int PERFDATA_PROLOG_ENTRYOFFSET_SIZE=4;
  final static int PERFDATA_PROLOG_NUMENTRIES_OFFSET=28;
  final static int PERFDATA_PROLOG_NUMENTRIES_SIZE=4;
  final static int PERFDATA_PROLOG_SIZE=32;
