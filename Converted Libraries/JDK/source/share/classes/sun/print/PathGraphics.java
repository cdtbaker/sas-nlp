 ...
 */
  public abstract void redrawRegion(  Rectangle2D region,  double scaleX,  double scaleY,  Shape clip,  AffineTransform devTransform) throws PrinterException ;
  /** 
 ...
 */
  ...
  protected static SoftReference<Hashtable<Font2DHandle,Object>> fontMapRef=new SoftReference<Hashtable<Font2DHandle,Object>>(null);
...
synchronized (fontMap) {
  ...
  private static char[] getGlyphToCharMapForFont(  Font2D font2D){
    ...
    for (char c=0; c < 0xFFFF; c++) {
      ...
      if (glyph != missingGlyph && glyph < numGlyphs && (glyphToCharMap[glyph] == CharToGlyphMapper.INVISIBLE_GLYPH_ID)) {
