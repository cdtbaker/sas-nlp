 ...
 * non-existent page.
 * @exception java.awt.print.PrinterExceptionthrown when the print job is terminated.
 */
...
private class MessageQ {
  ...
  private void translateOutputProps(){
    ...
    props.setProperty(ORIENT_PROP,(pageAttributes.getOrientationRequested() == OrientationRequestedType.PORTRAIT) ? PORTRAIT : LANDSCAPE);
