 ...
 */
  @Override public Path watchable(){
    return dir;
  }
  /** 
 ...
 */
  @SuppressWarnings("unchecked") final void signalEvent(  WatchEvent.Kind<?> kind,  Object context){
...
synchronized (this) {
  ...
  @Override public final List<WatchEvent<?>> pollEvents(){
synchronized (this) {
  ...
  @Override public final boolean reset(){
synchronized (this) {
...
private static class Event<T> implements WatchEvent<T> {
    ...
    @Override public WatchEvent.Kind<T> kind(){
      return kind;
    }
