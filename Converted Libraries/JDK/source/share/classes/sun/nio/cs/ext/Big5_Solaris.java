...
synchronized (Big5_Solaris.class) {
      ...
      Big5.initb2c();
      b2c=Big5.b2c.clone();
      int[] sol=new int[]{0xF9D6,0x7881,0xF9D7,0x92B9,0xF9D8,0x88CF,0xF9D9,0x58BB,0xF9DA,0x6052,0xF9DB,0x7CA7,0xF9DC,0x5AFA};
...
synchronized (Big5_Solaris.class) {
      ...
      int[] sol=new int[]{0x7881,0xF9D6,0x92B9,0xF9D7,0x88CF,0xF9D8,0x58BB,0xF9D9,0x6052,0xF9DA,0x7CA7,0xF9DB,0x5AFA,0xF9DC};
      for (int i=0; i < sol.length; ) {
        int c=sol[i++];
