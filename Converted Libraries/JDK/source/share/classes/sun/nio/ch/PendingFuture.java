 ...
 */
  ...
  @Override public V get() throws ExecutionException, InterruptedException {
    if (!haveResult) {
  ...
  @Override public V get(  long timeout,  TimeUnit unit) throws ExecutionException, InterruptedException, TimeoutException {
    if (!haveResult) {
      boolean needToWait=prepareForWait();
