...
public class FileChannelImpl extends FileChannel {
  ...
  public static FileChannel open(  FileDescriptor fd,  boolean readable,  boolean writable,  boolean append,  Object parent){
...
synchronized (Unmapper.class) {
  ...
  public MappedByteBuffer map(  MapMode mode,  long position,  long size) throws IOException {
    ...
    int imode=-1;
    if (mode == MapMode.READ_ONLY)     imode=MAP_RO;
 else     if (mode == MapMode.READ_WRITE)     imode=MAP_RW;
 ...
 else         return Util.newMappedByteBuffer(0,0,dummy,null);
      }
