...
public class FileLockImpl extends FileLock {
  ...
  public synchronized void release() throws IOException {
    ...
    if (valid) {
      if (ch instanceof FileChannelImpl)       ((FileChannelImpl)ch).release(this);
 else       if (ch instanceof AsynchronousFileChannelImpl)       ((AsynchronousFileChannelImpl)ch).release(this);
