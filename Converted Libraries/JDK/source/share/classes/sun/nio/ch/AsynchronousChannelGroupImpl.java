 ...
 */
  ...
  @Override public final boolean isTerminated(){
...
synchronized (shutdownNowLock) {
  ...
  @Override public final void shutdownNow() throws IOException {
    shutdown.set(true);
synchronized (shutdownNowLock) {
      if (!terminateInitiated) {
        terminateInitiated=true;
 ...
 */
  ...
  @Override public final boolean awaitTermination(  long timeout,  TimeUnit unit) throws InterruptedException {
 ...
 */
  @Override public final void execute(  Runnable task){
