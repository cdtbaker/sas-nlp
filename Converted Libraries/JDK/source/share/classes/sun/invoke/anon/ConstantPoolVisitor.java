...
/** 
 * A visitor called by {@link ConstantPoolParser#parse(ConstantPoolVisitor)}when a constant pool entry is parsed.
 * <p>
 ...
 * </tr><tr>
 * <td>{@link #CONSTANT_Integer}, {@link #CONSTANT_Float},{@link #CONSTANT_Long}, {@link #CONSTANT_Double}</td>
 ...
 * </tr><tr>
 * <td>{@link #CONSTANT_Fieldref},{@link #CONSTANT_Methodref},{@link #CONSTANT_InterfaceMethodref}</td>
 ...
 * @param index the constant pool index
 * @param tag one of {@link #CONSTANT_Integer},{@link #CONSTANT_Float},{@link #CONSTANT_Long},
 ...
 * @param index the constant pool index
 * @param tag one of {@link #CONSTANT_String},{@link #CONSTANT_Class},
 ...
 */
  public void visitDescriptor(  int index,  byte tag,  String memberName,  String signature,  int memberNameIndex,  int signatureIndex){
  }
  /** 
 ...
 */
  public void visitMemberRef(  int index,  byte tag,  String className,  String memberName,  String signature,  int classNameIndex,  int descriptorIndex){
  }
  public static final byte CONSTANT_None=0, CONSTANT_Utf8=1, CONSTANT_Integer=3, CONSTANT_Float=4, CONSTANT_Long=5, CONSTANT_Double=6, CONSTANT_Class=7, CONSTANT_String=8, CONSTANT_Fieldref=9, CONSTANT_Methodref=10, CONSTANT_InterfaceMethodref=11, CONSTANT_NameAndType=12;
