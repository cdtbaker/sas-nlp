...
public enum Wrapper {BOOLEAN(Boolean.class,boolean.class,'Z',(Boolean)false,new boolean[0],Format.unsigned(1)), BYTE(Byte.class,byte.class,'B',(Byte)(byte)0,new byte[0],Format.signed(8)), SHORT(Short.class,short.class,'S',(Short)(short)0,new short[0],Format.signed(16)), CHAR(Character.class,char.class,'C',(Character)(char)0,new char[0],Format.unsigned(16)), INT(Integer.class,int.class,'I',(Integer)(int)0,new int[0],Format.signed(32)), LONG(Long.class,long.class,'J',(Long)(long)0,new long[0],Format.signed(64)), FLOAT(Float.class,float.class,'F',(Float)(float)0,new float[0],Format.floating(32)), DOUBLE(Double.class,double.class,'D',(Double)(double)0,new double[0],Format.floating(64)), OBJECT(Object.class,Object.class,'L',null,new Object[0],Format.other(1)), VOID(Void.class,void.class,'V',null,null,Format.other(0)); private final Class<?> wrapperType;
...
public String detailString(){
  return simpleName + java.util.Arrays.asList(wrapperType,primitiveType,basicTypeChar,zero,"0x" + Integer.toHexString(format));
}
...
public static Wrapper forPrimitiveType(Class<?> type){
  ...
  if (w != null)   return w;
  if (type.isPrimitive())   throw new InternalError();
...
public static Wrapper forWrapperType(Class<?> type){
  ...
  if (w != null)   return w;
  for (  Wrapper x : values())   if (x.wrapperType == type)   throw new InternalError();
...
public static Wrapper forBasicType(char type){
  ...
  for (  Wrapper x : values())   if (w.basicTypeChar == type)   throw new InternalError();
...
public static char basicTypeChar(Class<?> type){
 ...
 else   return forPrimitiveType(type).basicTypeChar();
}
/** 
...
private <T>T convert(Object x,Class<T> type,boolean isCast){
  if (this == OBJECT) {
    @SuppressWarnings("unchecked") T result=(T)x;
    return result;
  }
  ...
  @SuppressWarnings("unchecked") T result=(T)wrap(x);
...
if (a.getClass() != arrayType()) arrayType().cast(a);
