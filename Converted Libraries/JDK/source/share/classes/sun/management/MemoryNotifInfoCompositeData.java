...
public class MemoryNotifInfoCompositeData extends LazyCompositeData {
  ...
  protected CompositeData getCompositeData(){
    final Object[] memoryNotifInfoItemValues={memoryNotifInfo.getPoolName(),MemoryUsageCompositeData.toCompositeData(memoryNotifInfo.getUsage()),new Long(memoryNotifInfo.getCount())};
    try {
...
static {
  ...
  public static String getPoolName(  CompositeData cd){
    ...
    if (poolname == null) {
      throw new IllegalArgumentException("Invalid composite data: " + "Attribute " + POOL_NAME + " has null value");
    }
    return poolname;
  }
