...
public class StackTraceElementCompositeData extends LazyCompositeData {
  ...
  public static StackTraceElement from(  CompositeData cd){
    ...
    return new StackTraceElement(getString(cd,CLASS_NAME),getString(cd,METHOD_NAME),getString(cd,FILE_NAME),getInt(cd,LINE_NUMBER));
  }
  ...
  protected CompositeData getCompositeData(){
    final Object[] stackTraceElementItemValues={ste.getClassName(),ste.getMethodName(),ste.getFileName(),new Integer(ste.getLineNumber()),new Boolean(ste.isNativeMethod())};
    try {
...
static {
  ...
  private static final String[] stackTraceElementItemNames={CLASS_NAME,METHOD_NAME,FILE_NAME,LINE_NUMBER,NATIVE_METHOD};
  /** 
