 ...
 */
  ...
  public void createNewEntry(  SnmpMibSubRequest req,  SnmpOid rowOid,  int depth) throws SnmpStatusException {
    if (factory != null)     factory.createNewEntry(req,rowOid,depth,this);
 else     throw new SnmpStatusException(SnmpStatusException.snmpRspNoAccess);
  }
  ...
  public synchronized void addEntry(  SnmpOid rowOid,  ObjectName objname,  Object entry) throws SnmpStatusException {
    if (!(entry instanceof JvmRTBootClassPathEntryMBean))     throw new ClassCastException("Entries for Table \"" + "JvmRTBootClassPathTable" + "\" must implement the \""+ "JvmRTBootClassPathEntryMBean"+ "\" interface.");
