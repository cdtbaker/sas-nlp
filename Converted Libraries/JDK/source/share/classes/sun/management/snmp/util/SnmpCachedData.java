 ...
 * immutable.
 * @param lastUpdated Time stamp as returned by{@link System#currentTimeMillis System.currentTimeMillis()}
 ...
 */
  ...
  /** 
 * Time stamp as returned by{@link System#currentTimeMillis System.currentTimeMillis()}
 */
 ...
 */
  ...
  public SnmpOid getNext(  SnmpOid index){
    ...
    if ((insertion > -1) && (insertion < indexes.length))     return indexes[insertion];
 else     return null;
  }
