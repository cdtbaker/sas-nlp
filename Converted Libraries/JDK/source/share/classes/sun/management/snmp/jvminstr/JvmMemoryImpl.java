 ...
 * "
 */
  final static EnumJvmMemoryGCVerboseLevel JvmMemoryGCVerboseLevelVerbose=new EnumJvmMemoryGCVerboseLevel("verbose");
 ...
 */
  public void checkJvmMemoryGCCall(  EnumJvmMemoryGCCall x) throws SnmpStatusException {
    if (x.intValue() != JvmMemoryGCCallStart.intValue())     throw new SnmpStatusException(SnmpDefinitions.snmpRspWrongValue);
  }
  /** 
 ...
 */
  public EnumJvmMemoryGCVerboseLevel getJvmMemoryGCVerboseLevel() throws SnmpStatusException {
    if (ManagementFactory.getMemoryMXBean().isVerbose())     return JvmMemoryGCVerboseLevelVerbose;
 else     return JvmMemoryGCVerboseLevelSilent;
  }
  /** 
 ...
 */
  public void setJvmMemoryGCVerboseLevel(  EnumJvmMemoryGCVerboseLevel x) throws SnmpStatusException {
    if (JvmMemoryGCVerboseLevelVerbose.intValue() == x.intValue())     ManagementFactory.getMemoryMXBean().setVerbose(true);
 ...
 */
  public Long getJvmMemoryPendingFinalCount() throws SnmpStatusException {
    final long val=ManagementFactory.getMemoryMXBean().getObjectPendingFinalizationCount();
