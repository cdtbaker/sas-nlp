...
if (((bitmap[0] & mask0) == (byte)0x00) && ((bitmap[1] & mask1) == (byte)0x00)) setBit(bitmap,1,Byte1.other);
}
...
log.debug("getJvmThreadInstState","[State=" + state + ",isInNative="+ inNative+ ",isSuspended="+ suspended+ "]");
