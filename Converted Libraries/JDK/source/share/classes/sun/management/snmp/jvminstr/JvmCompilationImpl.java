 ...
 */
  public EnumJvmJITCompilerTimeMonitoring getJvmJITCompilerTimeMonitoring() throws SnmpStatusException {
    if (getCompilationMXBean().isCompilationTimeMonitoringSupported())     return JvmJITCompilerTimeMonitoringSupported;
 ...
 */
  public Long getJvmJITCompilerTimeMs() throws SnmpStatusException {
    final long t;
    if (getCompilationMXBean().isCompilationTimeMonitoringSupported())     t=getCompilationMXBean().getTotalCompilationTime();
 else     t=0;
    return new Long(t);
  }
  /** 
