 ...
 */
  public AlgIdDSA(  BigInteger p,  BigInteger q,  BigInteger g){
    ...
    if (p != null || q != null || g != null) {
      if (p == null || q == null || g == null)       throw new ProviderException("Invalid parameters for DSS/DSA" + " Algorithm ID");
      try {
        this.p=p;
        this.q=q;
        this.g=g;
 ...
 */
  protected void decodeParams() throws IOException {
    ...
    if (params.data.available() != 0)     throw new IOException("AlgIdDSA params, extra=" + params.data.available());
  }
