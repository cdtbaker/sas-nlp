 ...
 */
  ...
  @Override public X500Principal getCertificateIssuer(){
    return certIssuer;
  }
 ...
 */
  ...
  private void parse(  DerValue derVal) throws CRLException, IOException {
    ...
    if (derVal.data.available() == 0)     return;
 ...
 */
  ...
  public Map<String,java.security.cert.Extension> getExtensions(){
    ...
    HashMap<String,java.security.cert.Extension> map=new HashMap<String,java.security.cert.Extension>(exts.size());
