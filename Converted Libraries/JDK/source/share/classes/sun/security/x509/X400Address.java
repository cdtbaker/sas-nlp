 ...
 */
 ...
 else     if (inputName.getType() != NAME_X400)     constraintType=NAME_DIFF_TYPE;
 else     throw new UnsupportedOperationException("Narrowing, widening, and match are not supported for X400Address.");
