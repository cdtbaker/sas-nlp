 ...
 */
  public String toGeneralizedTimeString(){
    ...
    return zeroPad(Integer.toString(calendar.get(Calendar.YEAR)),4) + zeroPad(Integer.toString(calendar.get(Calendar.MONTH) + 1),2) + zeroPad(Integer.toString(calendar.get(Calendar.DAY_OF_MONTH)),2)+ zeroPad(Integer.toString(calendar.get(Calendar.HOUR_OF_DAY)),2)+ zeroPad(Integer.toString(calendar.get(Calendar.MINUTE)),2)+ zeroPad(Integer.toString(calendar.get(Calendar.SECOND)),2)+ 'Z';
  }
  /** 
 ...
 */
  ...
  public boolean greaterThan(  KerberosTime time){
    return kerberosTime > time.kerberosTime || kerberosTime == time.kerberosTime && microSeconds > time.microSeconds;
  }
 ...
 */
  ...
  public static int getDefaultSkew(){
    ...
    try {
      ...
      if ((tdiff=c.getDefaultIntValue("clockskew","libdefaults")) == Integer.MIN_VALUE) {
