    ...
    if (credentialsList != null) {
      if (credentialsList.isEmpty()) {
        ...
        for (int i=0; i < credentialsList.size(); i++) {
          ...
          if (match(c.sname.getNameStrings(),tmp.sname.getNameStrings()) && ((c.sname.getRealmString()).equalsIgnoreCase(tmp.sname.getRealmString()))) {
            matched=true;
 ...
 */
  ...
  public static String getDefaultCacheName(){
    ...
    String user_name=java.security.AccessController.doPrivileged(new sun.security.action.GetPropertyAction("user.name"));
