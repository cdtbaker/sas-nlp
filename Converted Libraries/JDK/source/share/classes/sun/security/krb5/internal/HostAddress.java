...
public class HostAddress implements Cloneable {
  ...
  public boolean equals(  Object obj){
    ...
    if (addrType != h.addrType || (address != null && h.address == null) || (address == null && h.address != null))     return false;
 ...
 */
  ...
  private int getAddrType(  InetAddress inetAddress){
    int addressType=0;
    if (inetAddress instanceof Inet4Address)     addressType=Krb5.ADDRTYPE_INET;
...
case Krb5.ADDRTYPE_CHAOS:
  if (new_address.length != 2)   throw new KrbApErrException(0,"Invalid CHAOSnet address");
break;
