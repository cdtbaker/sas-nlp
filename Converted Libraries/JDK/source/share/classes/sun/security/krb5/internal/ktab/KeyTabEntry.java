...
public class KeyTabEntry implements KeyTabConstants {
  ...
  public int entryLength(){
    ...
    int size=principalComponentSize + realmSize + realmLen+ totalPrincipalLength+ principalTypeSize+ timestampSize+ keyVersionSize+ keyTypeSize+ keySize+ keyblock.length;
    if (DEBUG) {
