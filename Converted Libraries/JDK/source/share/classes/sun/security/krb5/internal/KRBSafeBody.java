...
public class KRBSafeBody {
  ...
  public KRBSafeBody(  byte[] new_userData,  KerberosTime new_timestamp,  Integer new_usec,  Integer new_seqNumber,  HostAddress new_sAddress,  HostAddress new_rAddress){
 ...
 */
  public byte[] asn1Encode() throws Asn1Exception, IOException {
    ...
    if (timestamp != null)     bytes.write(DerValue.createTag(DerValue.TAG_CONTEXT,true,(byte)0x01),timestamp.asn1Encode());
    if (usec != null) {
