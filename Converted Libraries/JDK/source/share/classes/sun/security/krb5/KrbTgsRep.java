...
public class KrbTgsRep extends KrbKdcRep {
  ...
  KrbTgsRep(  byte[] ibuf,  KrbTgsReq tgsReq) throws KrbException, IOException {
    ...
    byte[] enc_tgs_rep_bytes=rep.encPart.decrypt(tgsReq.tgsReqKey,tgsReq.usedSubkey() ? KeyUsage.KU_ENC_TGS_REP_PART_SUBKEY : KeyUsage.KU_ENC_TGS_REP_PART_SESSKEY);
