...
final class P11KeyAgreement extends KeyAgreementSpi {
  ...
  protected byte[] engineGenerateSecret() throws IllegalStateException {
    ...
    try {
      ...
      CK_ATTRIBUTE[] attributes=new CK_ATTRIBUTE[]{new CK_ATTRIBUTE(CKA_CLASS,CKO_SECRET_KEY),new CK_ATTRIBUTE(CKA_KEY_TYPE,CKK_GENERIC_SECRET)};
      attributes=token.getAttributes(O_GENERATE,CKO_SECRET_KEY,CKK_GENERIC_SECRET,attributes);
      long keyID=token.p11.C_DeriveKey(session.id(),new CK_MECHANISM(mechanism,publicValue),privateKey.keyID,attributes);
