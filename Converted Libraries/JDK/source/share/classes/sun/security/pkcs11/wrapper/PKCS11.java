 ...
 */
  public native long[] C_GenerateKeyPair(  long hSession,  CK_MECHANISM pMechanism,  CK_ATTRIBUTE[] pPublicKeyTemplate,  CK_ATTRIBUTE[] pPrivateKeyTemplate) throws PKCS11Exception ;
  /** 
 ...
 * @postconditions
 */
  public native long C_UnwrapKey(  long hSession,  CK_MECHANISM pMechanism,  long hUnwrappingKey,  byte[] pWrappedKey,  CK_ATTRIBUTE[] pTemplate) throws PKCS11Exception ;
  /** 
 ...
 * @postconditions
 */
  public native long C_DeriveKey(  long hSession,  CK_MECHANISM pMechanism,  long hBaseKey,  CK_ATTRIBUTE[] pTemplate) throws PKCS11Exception ;
  /** 
