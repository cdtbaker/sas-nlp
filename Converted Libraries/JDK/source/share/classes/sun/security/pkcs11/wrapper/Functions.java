...
private static class Flags {
  ...
  private static final Flags slotInfoFlags=new Flags(new long[]{CKF_TOKEN_PRESENT,CKF_REMOVABLE_DEVICE,CKF_HW_SLOT},new String[]{"CKF_TOKEN_PRESENT","CKF_REMOVABLE_DEVICE","CKF_HW_SLOT"});
  /** 
 ...
 */
  ...
  private static final Flags sessionInfoFlags=new Flags(new long[]{CKF_RW_SESSION,CKF_SERIAL_SESSION},new String[]{"CKF_RW_SESSION","CKF_SERIAL_SESSION"});
  /** 
 ...
 */
  ...
  private static final Flags mechanismInfoFlags=new Flags(new long[]{CKF_HW,CKF_ENCRYPT,CKF_DECRYPT,CKF_DIGEST,CKF_SIGN,CKF_SIGN_RECOVER,CKF_VERIFY,CKF_VERIFY_RECOVER,CKF_GENERATE,CKF_GENERATE_KEY_PAIR,CKF_WRAP,CKF_UNWRAP,CKF_DERIVE,CKF_EC_F_P,CKF_EC_F_2M,CKF_EC_ECPARAMETERS,CKF_EC_NAMEDCURVE,CKF_EC_UNCOMPRESS,CKF_EC_COMPRESS,CKF_EXTENSION},new String[]{"CKF_HW","CKF_ENCRYPT","CKF_DECRYPT","CKF_DIGEST","CKF_SIGN","CKF_SIGN_RECOVER","CKF_VERIFY","CKF_VERIFY_RECOVER","CKF_GENERATE","CKF_GENERATE_KEY_PAIR","CKF_WRAP","CKF_UNWRAP","CKF_DERIVE","CKF_EC_F_P","CKF_EC_F_2M","CKF_EC_ECPARAMETERS","CKF_EC_NAMEDCURVE","CKF_EC_UNCOMPRESS","CKF_EC_COMPRESS","CKF_EXTENSION"});
  /** 
