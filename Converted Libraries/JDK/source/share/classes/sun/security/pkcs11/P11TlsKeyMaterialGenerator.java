...
public final class P11TlsKeyMaterialGenerator extends KeyGeneratorSpi {
  ...
  protected SecretKey engineGenerateKey(){
    ...
    try {
      ...
      if (keyBits != 0) {
        attributes=new CK_ATTRIBUTE[]{new CK_ATTRIBUTE(CKA_CLASS,CKO_SECRET_KEY),new CK_ATTRIBUTE(CKA_KEY_TYPE,keyType),new CK_ATTRIBUTE(CKA_VALUE_LEN,expandedKeyBits >> 3)};
      }
 else {
