 ...
 */
@Deprecated public synchronized void setConfiguration(String config){
if (provider != null) {
 ...
 * instance.
 */
@Deprecated public synchronized Provider getProvider(){
if (provider == null) {
 ...
 */
EMAIL_PROTECTION}
public static enum DbMode {READ_WRITE("NSS_InitReadWrite"), READ_ONLY("NSS_Init"), NO_DB("NSS_NoDB_Init"); final String functionName;
