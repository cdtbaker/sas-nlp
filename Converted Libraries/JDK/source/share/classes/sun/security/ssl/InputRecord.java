 ...
 */
  ...
  private static final byte[] v2NoCipher={(byte)0x80,(byte)0x03,(byte)0x00,(byte)0x00,(byte)0x01};
 ...
 */
  private void readV3Record(  InputStream s,  OutputStream o) throws IOException {
    ...
    if (contentLen < 0 || contentLen > maxLargeRecordSize - headerSize) {
      throw new SSLProtocolException("Bad InputRecord size" + ", count = " + contentLen + ", buf.length = "+ buf.length);
    }
