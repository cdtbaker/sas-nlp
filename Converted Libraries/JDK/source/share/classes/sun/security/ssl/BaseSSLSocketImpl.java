 ...
 * @see java.net.Socket#sendUrgentDataAt this point, there seems to be no specific requirement to support
 ...
 * discarded.
 * @see java.net.Socket#setOOBInlineSetting OOBInline does not have any effect on SSLSocket,
