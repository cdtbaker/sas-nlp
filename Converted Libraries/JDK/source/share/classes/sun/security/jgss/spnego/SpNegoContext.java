...
public class SpNegoContext implements GSSContextSpi {
  ...
  static final boolean DEBUG=java.security.AccessController.doPrivileged(new sun.security.action.GetBooleanAction("sun.security.spnego.debug")).booleanValue();
  /** 
 ...
 */
  public final boolean getDelegPolicyState(){
    if (isInitiator() && mechContext != null && mechContext instanceof ExtendedGSSContext && (state == STATE_IN_PROCESS || state == STATE_DONE)) {
...
byte[] tok=null;
if (mechContext == null) {
GSSName serverName=factory.manager.createName(peerName.toString(),peerName.getStringNameType(),internal_mech);
