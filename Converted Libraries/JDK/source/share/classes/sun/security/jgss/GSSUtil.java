...
static {
    DEBUG=(AccessController.doPrivileged(new GetBooleanAction("sun.security.jgss.debug"))).booleanValue();
  }
 ...
 */
  public static Vector searchSubject(  final GSSNameSpi name,  final Oid mech,  final boolean initiate,  final Class credCls){
