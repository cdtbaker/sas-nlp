...
static {
  ...
  private void importName(  GSSManagerImpl gssManager,  Object appName) throws GSSException {
    ...
    if ((bytes[pos++] != 0x04) || (bytes[pos++] != 0x01))     throw new GSSExceptionImpl(GSSException.BAD_NAME,"Exported name token id is corrupted!");
 ...
 */
  public boolean equals(  GSSName other) throws GSSException {
    ...
    if (!(other instanceof GSSNameImpl))     return equals(gssManager.createName(other.toString(),other.getStringNameType()));
