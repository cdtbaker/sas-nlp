...
class EndEntityChecker {
  ...
  private final static Collection<String> KU_SERVER_SIGNATURE=Arrays.asList("DHE_DSS","DHE_RSA","ECDHE_ECDSA","ECDHE_RSA","RSA_EXPORT","UNKNOWN");
  private final static Collection<String> KU_SERVER_ENCRYPTION=Arrays.asList("RSA");
  private final static Collection<String> KU_SERVER_KEY_AGREEMENT=Arrays.asList("DH_DSS","DH_RSA","ECDH_ECDSA","ECDH_RSA");
