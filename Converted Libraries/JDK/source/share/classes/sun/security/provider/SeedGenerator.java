 ...
 */
    ...
    private void init() throws IOException {
      ...
      try {
        devRandom=java.security.AccessController.doPrivileged(new java.security.PrivilegedExceptionAction<InputStream>(){
    ...
    @Override void getSeedBytes(    byte[] result){
      ...
      try {
        while (read < len) {
          ...
          if (count < 0)           throw new InternalError("URLSeedGenerator " + deviceName + " reached end of file");
          read+=count;
        }
      }
