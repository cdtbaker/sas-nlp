...
public final class OCSPResponse {
  public enum ResponseStatus {  SUCCESSFUL,   MALFORMED_REQUEST,   INTERNAL_ERROR,   TRY_LATER,   UNUSED,   SIG_REQUIRED,   UNAUTHORIZED}
...
final static class SingleResponse implements OCSP.RevocationStatus {
    ...
    @Override public Map<String,java.security.cert.Extension> getSingleExtensions(){
