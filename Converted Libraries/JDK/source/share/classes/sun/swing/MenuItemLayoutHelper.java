 ...
 */
  ...
  private Icon getIcon(  String propertyPrefix){
    ...
    if (!isColumnLayout || !useCheckAndArrow || iconFactory == null || !iconFactory.isCompatible(checkIcon,propertyPrefix)) {
      icon=mi.getIcon();
    }
    return icon;
  }
  ...
  protected void calcWidthsAndHeights(){
    ...
    if (isColumnLayout) {
      ...
      SwingUtilities.layoutCompoundLabel(mi,fm,text,icon,verticalAlignment,horizontalAlignment,verticalTextPosition,horizontalTextPosition,viewRect,iconRect,textRect,gap);
 ...
 */
  ...
  public static boolean isColumnLayout(  boolean isLeftToRight,  JMenuItem mi){
    assert (mi != null);
    return isColumnLayout(isLeftToRight,mi.getHorizontalAlignment(),mi.getHorizontalTextPosition(),mi.getVerticalTextPosition());
  }
  /** 
 ...
 */
  ...
  protected void layoutIconAndTextInLabelRect(  LayoutResult lr){
    ...
    SwingUtilities.layoutCompoundLabel(mi,fm,text,icon,verticalAlignment,horizontalAlignment,verticalTextPosition,horizontalTextPosition,lr.labelRect,lr.iconRect,lr.textRect,gap);
  }
 ...
 */
  private void calcTextAndIconYPositions(  LayoutResult lr){
    if (verticalAlignment == SwingUtilities.TOP) {
      ...
      lr.textRect.y=(int)(viewRect.y + viewRect.height - (float)lr.labelRect.height / 2 - (float)lr.textRect.height / 2);
      lr.iconRect.y=(int)(viewRect.y + viewRect.height - (float)lr.labelRect.height / 2 - (float)lr.iconRect.height / 2);
    }
  }
  /** 
...
public static class LayoutResult {
    ...
    public LayoutResult(    Rectangle iconRect,    Rectangle textRect,    Rectangle accRect,    Rectangle checkRect,    Rectangle arrowRect,    Rectangle labelRect){
...
public static class ColumnAlignment {
    ...
    public static final ColumnAlignment LEFT_ALIGNMENT=new ColumnAlignment(SwingConstants.LEFT,SwingConstants.LEFT,SwingConstants.LEFT,SwingConstants.LEFT,SwingConstants.LEFT);
    public static final ColumnAlignment RIGHT_ALIGNMENT=new ColumnAlignment(SwingConstants.RIGHT,SwingConstants.RIGHT,SwingConstants.RIGHT,SwingConstants.RIGHT,SwingConstants.RIGHT);
