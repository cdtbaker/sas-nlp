 ...
 */
@SuppressWarnings("serial") public class MaximizableInternalFrame extends JInternalFrame {
...
private class FixedMenuBarLayout extends BoxLayout {
  ...
  private static Object WP_MINBUTTON, WP_RESTOREBUTTON, WP_CLOSEBUTTON, WP_MDIMINBUTTON, WP_MDIRESTOREBUTTON, WP_MDICLOSEBUTTON;
static {
    if (JConsole.IS_WIN) {
      try {
