...
@SuppressWarnings("serial") public class OperationEntry extends JPanel {
  ...
  private void setPanel(  boolean isCallable,  JButton button,  XOperations xoperations){
    try {
      ...
      for (int i=0; i < params.length; i++) {
        ...
        add(inputs[i]=new XTextField(Utils.getReadableClassName(defaultTextValue),Utils.getClass(params[i].getType()),fieldWidth,isCallable,button,xoperations));
