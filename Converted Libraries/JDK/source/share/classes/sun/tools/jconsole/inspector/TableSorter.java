...
@SuppressWarnings("serial") public class TableSorter extends DefaultTableModel implements MouseListener {
  ...
  @Override public void newDataAvailable(  TableModelEvent e){
  ...
  @SuppressWarnings("unchecked") private int compare(  Object o1,  Object o2){
    if (o1 == o2)     return 0;
    if (o1 == null)     return 1;
    if (o2 == null)     return -1;
  ...
  private boolean compareS(  Object s1,  Object s2,  boolean isAscending){
    if (isAscending)     return (compare(s1,s2) > 0);
 else     return (compare(s1,s2) < 0);
  }
  ...
  @SuppressWarnings("unchecked") private void setRow(  Vector data,  int row){
