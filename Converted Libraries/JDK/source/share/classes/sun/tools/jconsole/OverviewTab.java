...
@SuppressWarnings("serial") class OverviewTab extends Tab {
  JPanel gridPanel;
  ...
  public OverviewTab(  VMPanel vmPanel){
    ...
    LabeledComponent lc=new LabeledComponent(Resources.getText("Time Range:"),getMnemonicInt("Time Range:"),timeComboBox);
    controlPanel.add(lc);
