...
@SuppressWarnings("serial") class ThreadTab extends Tab implements ActionListener, DocumentListener, ListSelectionListener {
  ...
  public ThreadTab(  VMPanel vmPanel){
    ...
    controlPanel.add(new LabeledComponent(Resources.getText("Time Range:"),getMnemonicInt("Time Range:"),timeComboBox));
    ...
    separator.setPreferredSize(new Dimension(separator.getPreferredSize().width,filterTF.getPreferredSize().height));
          ...
          try {
            ...
            if (ti != null) {
              if (ti.getLockName() == null) {
                sb.append(Resources.getText("Name State",ti.getThreadName(),ti.getThreadState().toString()));
              }
 else               if (ti.getLockOwnerName() == null) {
                sb.append(Resources.getText("Name State LockName",ti.getThreadName(),ti.getThreadState().toString(),ti.getLockName()));
              }
 else {
                sb.append(Resources.getText("Name State LockName LockOwner",ti.getThreadName(),ti.getThreadState().toString(),ti.getLockName(),ti.getLockOwnerName()));
              }
              sb.append(Resources.getText("BlockedCount WaitedCount",ti.getBlockedCount(),ti.getWaitedCount()));
            ...
            public void run(){
              ...
              if (deadlockedThreads != null) {
                for (int i=0; i < deadlockedThreads.length; i++) {
                  ...
                  threadlistSP.setBorder(null);
                  textAreaSP.setBorder(null);
                  JSplitPane splitPane=new JSplitPane(JSplitPane.HORIZONTAL_SPLIT,threadlistSP,textAreaSP);
