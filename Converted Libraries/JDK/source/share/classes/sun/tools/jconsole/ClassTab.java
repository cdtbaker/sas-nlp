...
@SuppressWarnings("serial") class ClassTab extends Tab implements ActionListener {
  ...
  public ClassTab(  VMPanel vmPanel){
    ...
    loadedClassesMeter.plotter.createSequence(totalLoadedPlotterKey,totalLoadedPlotterName,totalLoadedPlotterColor,true);
    ...
    bottomPanel.setBorder(new CompoundBorder(new TitledBorder(Resources.getText("Details")),new EmptyBorder(10,10,10,10)));
