...
@SuppressWarnings("serial") class SummaryTab extends Tab {
      ...
      append(newDivider);
{
        ...
        if (sunOSMBean != null) {
          ...
          String[] kbStrings2=formatKByteStrings(sunOSMBean.getTotalPhysicalMemorySize(),sunOSMBean.getFreePhysicalMemorySize(),sunOSMBean.getTotalSwapSpaceSize(),sunOSMBean.getFreeSwapSpaceSize());
