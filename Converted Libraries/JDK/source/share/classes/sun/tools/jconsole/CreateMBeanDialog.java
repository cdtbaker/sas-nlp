...
@SuppressWarnings("serial") public class CreateMBeanDialog extends InternalDialog implements ActionListener {
  JConsole jConsole;
  ...
  public CreateMBeanDialog(  JConsole jConsole){
    ...
    updateConnections();
    centerPanel.add(new LabeledComponent(Resources.getText("Manage Hotspot MBeans " + "in: "),connections));
      ...
      new Thread("CreateMBeanDialog.actionPerformed"){
        public void run(){
          try {
            ...
            statusBar.setText(Resources.getText("Error: MBeans already " + "exist"));
          }
catch (          InstanceNotFoundException e) {
            statusBar.setText(Resources.getText("Error: MBeans do not " + "exist"));
          }
catch (          Exception e) {
