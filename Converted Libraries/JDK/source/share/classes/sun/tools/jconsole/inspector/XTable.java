...
public abstract class XTable extends JTable {
  ...
  public XTable(){
    super();
    @SuppressWarnings("serial") final TableSorter sorter=new TableSorter();
    setModel(sorter);
 ...
 */
  ...
  @Override public boolean isCellEditable(  int row,  int col){
    return ((isTableEditable() && isColumnEditable(col) && isWritable(row)&& Utils.isEditableType(getClassName(row))));
  }
