 ...
 */
int getIncrement(){
if ((left.op == IDENT) && type.isType(TC_INT) && (right.op == INTVAL)) if ((op == ASGADD) || (op == ASGSUB)) if (((IdentifierExpression)left).field.isLocal()) {
...
if (updater == null) {
return (getIncrement() != NOINC) ? 3 : right.costInline(thresh,env,ctx) + left.costInline(thresh,env,ctx) + 4;
}
 else {
