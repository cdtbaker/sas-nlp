 ...
 */
  ...
  private static String sortKey(  ConstantPoolData f){
    ...
    if (f instanceof StringExpressionConstantData)     return (String)((StringExpressionConstantData)f).str.getValue();
    ...
    if (f instanceof NameAndTypeConstantData)     return ((NameAndTypeConstantData)f).name + " " + ((NameAndTypeConstantData)f).type;
