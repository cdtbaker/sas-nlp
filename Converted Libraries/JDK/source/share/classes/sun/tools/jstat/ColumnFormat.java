...
public class ColumnFormat extends OptionFormat {
  ...
  public void printFormat(  int indentLevel){
    ...
    System.out.println(indent + indentAmount + "name="+ name+ ";data="+ expression.toString()+ ";header="+ header+ ";format="+ format+ ";width="+ width+ ";scale="+ scale.toString()+ ";align="+ align.toString());
