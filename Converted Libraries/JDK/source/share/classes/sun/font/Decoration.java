 ...
 */
  ...
  private static final int VALUES_MASK=AttributeValues.getMask(EFOREGROUND,EBACKGROUND,ESWAP_COLORS,ESTRIKETHROUGH,EUNDERLINE,EINPUT_METHOD_HIGHLIGHT,EINPUT_METHOD_UNDERLINE);
 ...
 */
    ...
    Shape getOutline(    Label label,    float x,    float y){
      ...
      if (strikethrough) {
        Stroke stStroke=new BasicStroke(cm.strikethroughThickness,BasicStroke.CAP_BUTT,BasicStroke.JOIN_MITER);
