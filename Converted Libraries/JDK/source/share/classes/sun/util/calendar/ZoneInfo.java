...
static {
    String oldmapping=AccessController.doPrivileged(new sun.security.action.GetPropertyAction("sun.timezone.ids.oldmapping","false")).toLowerCase(Locale.ROOT);
 ...
 */
  ...
  @Override public boolean observesDaylightTime(){
 ...
 */
  public static String[] getAvailableIDs(  int rawOffset){
    ...
    loop:     for (int index=0; index < rawOffsets.length; index++) {
 ...
 */
  public boolean equals(  Object obj){
    ...
    return (getID().equals(that.getID()) && (getLastRawOffset() == that.getLastRawOffset()) && (checksum == that.checksum));
  }
  /** 
