...
abstract class Host extends SimpleNode implements Serializable {
  ...
  public void buildAclEntries(  PrincipalImpl owner,  AclImpl acl){
    ...
    try {
      ...
      if (SNMP_LOGGER.isLoggable(Level.FINEST)) {
        SNMP_LOGGER.logp(Level.FINEST,Host.class.getName(),"buildAclEntries","Cannot create ACL entry; got exception",e);
      }
    ...
    try {
      ...
      if (SNMP_LOGGER.isLoggable(Level.FINEST)) {
        SNMP_LOGGER.logp(Level.FINEST,Host.class.getName(),"buildAclEntries","Cannot create ACL entry; got exception",a);
      }
      return;
    }
  }
  ...
  public void buildTrapEntries(  Hashtable<InetAddress,Vector<String>> dest){
    ...
    try {
      ...
      if (SNMP_LOGGER.isLoggable(Level.FINEST)) {
        SNMP_LOGGER.logp(Level.FINEST,Host.class.getName(),"buildTrapEntries","Cannot create TRAP entry; got exception",e);
      }
      return;
    }
  ...
  public void buildInformEntries(  Hashtable<InetAddress,Vector<String>> dest){
    ...
    try {
      ...
      if (SNMP_LOGGER.isLoggable(Level.FINEST)) {
        SNMP_LOGGER.logp(Level.FINEST,Host.class.getName(),"buildTrapEntries","Cannot create INFORM entry; got exception",e);
      }
      return;
    }
    Vector<String> list=null;
