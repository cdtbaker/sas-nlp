 ...
 */
  public static String BinToChar(  String bin){
    ...
    for (int i=0; i < binLength; i++)     value[i]=(char)Integer.parseInt(bin.substring(8 * i,8 * i + 8),2);
 ...
 */
  public static String HexToChar(  String hex){
    ...
    for (int i=0; i < hexLength; i++)     value[i]=(char)Integer.parseInt(hex.substring(2 * i,2 * i + 2),16);
    return new String(value);
  }
  /** 
