...
interface ParserTreeConstants {
  ...
  public String[] jjtNodeName={"SecurityDefs","AclBlock","AclItem","Communities","Community","Access","Managers","Host","HostName","IpAddress","IpV6Address","IpMask","NetMask","NetMaskV6","TrapBlock","TrapItem","TrapCommunity","TrapInterestedHost","HostTrap","Enterprise","TrapNum","InformBlock","InformItem","InformCommunity","InformInterestedHost","HostInform"};
}
