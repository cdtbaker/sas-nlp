 ...
 * provided that {@code mbeanInterfaceType} is a class constant like{@code SomeMBean.class}.
 ...
 */
  public <T>StandardMBeanSupport(  T resource,  Class<T> mbeanInterfaceType) throws NotCompliantMBeanException {
    super(resource,mbeanInterfaceType);
  }
  @Override MBeanIntrospector<Method> getMBeanIntrospector(){
    return StandardMBeanIntrospector.getInstance();
  }
  @Override Object getCookie(){
    return null;
  }
  @Override public void register(  MBeanServer mbs,  ObjectName name){
  }
  ...
  @Override public MBeanInfo getMBeanInfo(){
    ...
    if (StandardMBeanIntrospector.isDefinitelyImmutableInfo(resourceClass))     return mbi;
