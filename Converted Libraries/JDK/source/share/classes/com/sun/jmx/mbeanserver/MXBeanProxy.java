...
public class MXBeanProxy {
  public MXBeanProxy(  Class<?> mxbeanInterface){
    if (mxbeanInterface == null)     throw new IllegalArgumentException("Null parameter");
...
private static class GetHandler extends Handler {
    ...
    @Override Object invoke(    MBeanServerConnection mbsc,    ObjectName name,    Object[] args) throws Exception {
