 ...
 */
  abstract Object invokeM2(  M m,  Object target,  Object[] args,  Object cookie) throws InvocationTargetException, IllegalAccessException, MBeanException ;
  /** 
 ...
 */
 ...
 else     throw new MBeanException((Exception)t,(t == null ? null : t.toString()));
  }
  /** 
 ...
 */
    MBeanInfo makeMBeanInfo(    Class<?> mbeanInterface,    String description){
      ...
      final Descriptor descriptor=DescriptorCache.getInstance().union(classNameDescriptor,mbeanDescriptor,annotatedDescriptor);
 ...
 */
  final MBeanInfo getMBeanInfo(  Object resource,  PerInterface<M> perInterface){
    ...
    if (notifs == null || notifs.length == 0)     return mbi;
 else {
