 ...
 * @param openType the Open Type (for example, {@codeArrayType.getArrayType(SimpleType.STRING)})
 * @throws NullPointerException if either argument is null.
 */
  protected MXBeanMapping(  Type javaType,  OpenType<?> openType){
    if (javaType == null || openType == null)     throw new NullPointerException("Null argument");
 ...
 */
  ...
  private static Class<?> makeOpenClass(  Type javaType,  OpenType<?> openType){
    if (javaType instanceof Class<?> && ((Class<?>)javaType).isPrimitive())     return (Class<?>)javaType;
    try {
