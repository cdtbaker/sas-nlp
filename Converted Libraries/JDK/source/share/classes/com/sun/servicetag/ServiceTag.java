 ...
 */
  ...
  private void setInstanceURN(  String instanceURN){
    ...
    if (instanceURN.length() > MAX_URN_LEN) {
      throw new IllegalArgumentException("instanceURN \"" + instanceURN + "\" exceeds maximum length "+ MAX_URN_LEN);
    }
  ...
  private void setProductName(  String productName){
    ...
    if (productName.length() > MAX_PRODUCT_NAME_LEN) {
      throw new IllegalArgumentException("productName \"" + productName + "\" exceeds maximum length "+ MAX_PRODUCT_NAME_LEN);
    }
  ...
  private void setProductVersion(  String productVersion){
    ...
    if (productVersion.length() > MAX_PRODUCT_VERSION_LEN) {
      throw new IllegalArgumentException("productVersion \"" + productVersion + "\" exceeds maximum length "+ MAX_PRODUCT_VERSION_LEN);
    }
  ...
  private void setProductURN(  String productURN){
    ...
    if (productURN.length() > MAX_URN_LEN) {
      throw new IllegalArgumentException("productURN \"" + productURN + "\" exceeds maximum length "+ MAX_URN_LEN);
    }
  ...
  private void setProductParentURN(  String productParentURN){
    ...
    if (productParentURN.length() > MAX_URN_LEN) {
      throw new IllegalArgumentException("productParentURN \"" + productParentURN + "\" exceeds maximum length "+ MAX_URN_LEN);
    }
  ...
  private void setProductParent(  String productParent){
    ...
    if (productParent.length() > MAX_PRODUCT_PARENT_LEN) {
      throw new IllegalArgumentException("productParent \"" + productParent + "\" exceeds maximum length "+ MAX_PRODUCT_PARENT_LEN);
    }
  ...
  void setProductDefinedInstanceID(  String productDefinedInstanceID){
    ...
    if (productDefinedInstanceID.length() > MAX_URN_LEN) {
      throw new IllegalArgumentException("productDefinedInstanceID \"" + productDefinedInstanceID + "\" exceeds maximum length "+ MAX_URN_LEN);
    }
  ...
  private void setProductVendor(  String productVendor){
    ...
    if (productVendor.length() > MAX_PRODUCT_VENDOR_LEN) {
      throw new IllegalArgumentException("productVendor \"" + productVendor + "\" exceeds maximum length "+ MAX_PRODUCT_VENDOR_LEN);
    }
  ...
  private void setPlatformArch(  String platformArch){
    ...
    if (platformArch.length() > MAX_PLATFORM_ARCH_LEN) {
      throw new IllegalArgumentException("platformArch \"" + platformArch + "\" exceeds maximum length "+ MAX_PLATFORM_ARCH_LEN);
    }
  ...
  private void setContainer(  String container){
    ...
    if (container.length() > MAX_CONTAINER_LEN) {
      throw new IllegalArgumentException("container \"" + container + "\" exceeds maximum length "+ MAX_CONTAINER_LEN);
    }
  ...
  private void setSource(  String source){
    ...
    if (source.length() > MAX_SOURCE_LEN) {
      throw new IllegalArgumentException("source \"" + source + "\" exceeds maximum length "+ MAX_SOURCE_LEN);
    }
    this.source=source;
  }
