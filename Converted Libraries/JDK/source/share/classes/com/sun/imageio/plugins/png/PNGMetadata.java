...
public class PNGMetadata extends IIOMetadata implements Cloneable {
  ...
  public static final String[] renderingIntentNames={"Perceptual","Relative colorimetric","Saturation","Absolute colorimetric"};
 ...
 */
  ...
  private int getNumChannels(){
    ...
    if (IHDR_colorType == PNGImageReader.PNG_COLOR_PALETTE && tRNS_present && tRNS_colorType == IHDR_colorType) {
      numChannels=4;
    }
    return numChannels;
  }
  ...
  private void mergeNativeTree(  Node root) throws IIOInvalidTreeException {
    ...
    while (node != null) {
      ...
      if (name.equals("IHDR")) {
        ...
        IHDR_bitDepth=getEnumeratedAttribute(node,"bitDepth",IHDR_bitDepths);
