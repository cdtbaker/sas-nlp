...
if (obj instanceof byte[]) {
  ...
  for (int i=0; i < bArray.length; i++)   s+=bArray[i] + " ";
  return s;
}
...
if (obj instanceof short[]) {
  ...
  for (int i=0; i < sArray.length; i++)   s+=sArray[i] + " ";
  return s;
}
return obj.toString();
}
...
if (colorModel != null && sampleModel != null) type=new ImageTypeSpecifier(colorModel,sampleModel);
