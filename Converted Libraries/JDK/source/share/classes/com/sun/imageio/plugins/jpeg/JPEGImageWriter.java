...
processWarningOccurred(currentImage,"com.sun.imageio.plugins.jpeg.JPEGImageWriterResources",Integer.toString(code));
}
/** 
...
ignoreJFIF=true;
warningOccurred(input ? WARNING_IMAGE_METADATA_JFIF_MISMATCH : WARNING_DEST_METADATA_JFIF_MISMATCH);
}
}
}
...
warningOccurred(input ? WARNING_IMAGE_METADATA_ADOBE_MISMATCH : WARNING_DEST_METADATA_ADOBE_MISMATCH);
 ...
 */
private static native void initWriterIDs(Class iosClass,Class qTableClass,Class huffClass);
/** 
 ...
 */
private native void setDest(long structPointer,ImageOutputStream ios);
/** 
