...
public class X509V1CertImpl extends X509Certificate implements Serializable {
  ...
  synchronized private static java.security.cert.CertificateFactory getFactory() throws java.security.cert.CertificateException {
 ...
 */
  public X509V1CertImpl(  byte[] certData) throws CertificateException {
    try {
      ...
      wrappedCert=(java.security.cert.X509Certificate)getFactory().generateCertificate(bs);
    }
 ...
 */
  public X509V1CertImpl(  InputStream in) throws CertificateException {
    try {
      wrappedCert=(java.security.cert.X509Certificate)getFactory().generateCertificate(in);
    }
 catch (    java.security.cert.CertificateException e) {
      throw new CertificateException(e.getMessage());
    }
 ...
 */
  ...
  private synchronized void readObject(  ObjectInputStream stream) throws IOException {
    try {
      wrappedCert=(java.security.cert.X509Certificate)getFactory().generateCertificate(stream);
    }
 catch (    java.security.cert.CertificateException e) {
