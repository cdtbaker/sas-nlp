 ...
 */
  public String toString(){
    java.text.MessageFormat form=new java.text.MessageFormat(sun.security.util.ResourcesMgr.getString("UnixNumericUserPrincipal.name","sun.security.util.AuthResources"));
    Object[] source={name};
 ...
 */
  public boolean equals(  Object o){
    ...
    if (!(o instanceof UnixNumericUserPrincipal))     return false;
