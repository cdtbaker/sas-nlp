 ...
 */
  public String toString(){
    java.text.MessageFormat form=new java.text.MessageFormat(sun.security.util.ResourcesMgr.getString("NTSidUserPrincipal.name","sun.security.util.AuthResources"));
 ...
 */
  public boolean equals(  Object o){
    ...
    if (!(o instanceof NTSidUserPrincipal))     return false;
