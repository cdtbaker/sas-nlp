 ...
 */
  SubjectCodeSource(  Subject subject,  LinkedList<PolicyParser.PrincipalEntry> principals,  URL url,  Certificate[] certs){
    ...
    this.principals=(principals == null ? new LinkedList<PolicyParser.PrincipalEntry>() : new LinkedList<PolicyParser.PrincipalEntry>(principals));
 ...
 */
  public String toString(){
    ...
    if (principals != null) {
      ListIterator<PolicyParser.PrincipalEntry> li=principals.listIterator();
      while (li.hasNext()) {
        PolicyParser.PrincipalEntry pppe=li.next();
        returnMe=returnMe + rb.getString("NEWLINE") + pppe.principalClass+ " "+ pppe.principalName;
      }
    }
    return returnMe;
  }
