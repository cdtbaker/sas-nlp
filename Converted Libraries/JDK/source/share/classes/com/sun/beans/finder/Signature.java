 ...
 * @return {@code true} if this object is the same as the{@code object} argument, {@code false} otherwise
 * @see #hashCode()
 */
 ...
 * @return {@code true} if first object is the same as the second object,{@code false} otherwise
 */
 ...
 * @return {@code true} if first array is the same as the second array,{@code false} otherwise
 */
 ...
 */
  private static int addHashCode(  int code,  Object object){
    code*=37;
    return (object != null) ? code + object.hashCode() : code;
  }
}
