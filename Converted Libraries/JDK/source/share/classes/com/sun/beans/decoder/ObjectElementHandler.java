 ...
 */
  @Override public final void addAttribute(  String name,  String value){
 ...
 */
  @Override protected boolean isArgument(){
    return true;
  }
  /** 
 ...
 */
  @Override protected final ValueObject getValueObject(  Class<?> type,  Object[] args) throws Exception {
    if (this.field != null) {
    ...
    if (this.index != null) {
      ...
      name=(this.method != null) && (0 < this.method.length()) ? this.method : "new";
    }
