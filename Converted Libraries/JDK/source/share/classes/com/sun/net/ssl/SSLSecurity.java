 ...
 */
  private static Object[] getImpl1(  String algName,  String engineType,  Service service) throws NoSuchAlgorithmException {
 ...
 else       if (((typeClassCom=Class.forName("com.sun.net.ssl." + engineType + "Spi")) != null) && (checkSuperclass(implClass,typeClassCom))) {
      ...
      for (src=0, dst=0; src < kma.length; ) {
        if (!(kma[src] instanceof javax.net.ssl.KeyManager)) {
          if (kma[src] instanceof X509KeyManager) {
            kmaw[dst]=(javax.net.ssl.KeyManager)new X509KeyManagerJavaxWrapper((X509KeyManager)kma[src]);
            dst++;
          }
        }
 else {
      ...
      for (src=0, dst=0; src < tma.length; ) {
        if (!(tma[src] instanceof javax.net.ssl.TrustManager)) {
          if (tma[src] instanceof X509TrustManager) {
            tmaw[dst]=(javax.net.ssl.TrustManager)new X509TrustManagerJavaxWrapper((X509TrustManager)tma[src]);
            dst++;
          }
        }
 else {
...
final class TrustManagerFactorySpiWrapper extends TrustManagerFactorySpi {
  ...
  TrustManagerFactorySpiWrapper(  String algName,  Provider prov) throws NoSuchAlgorithmException {
    theTrustManagerFactory=javax.net.ssl.TrustManagerFactory.getInstance(algName,prov);
  }
  ...
  protected TrustManager[] engineGetTrustManagers(){
    int dst;
    int src;
    javax.net.ssl.TrustManager[] tma=theTrustManagerFactory.getTrustManagers();
    ...
    for (src=0, dst=0; src < tma.length; ) {
      if (!(tma[src] instanceof com.sun.net.ssl.TrustManager)) {
        if (tma[src] instanceof javax.net.ssl.X509TrustManager) {
          tmaw[dst]=(TrustManager)new X509TrustManagerComSunWrapper((javax.net.ssl.X509TrustManager)tma[src]);
          dst++;
        }
      }
 else {
...
final class KeyManagerFactorySpiWrapper extends KeyManagerFactorySpi {
  ...
  KeyManagerFactorySpiWrapper(  String algName,  Provider prov) throws NoSuchAlgorithmException {
    theKeyManagerFactory=javax.net.ssl.KeyManagerFactory.getInstance(algName,prov);
  }
  ...
  protected KeyManager[] engineGetKeyManagers(){
    int dst;
    int src;
    javax.net.ssl.KeyManager[] kma=theKeyManagerFactory.getKeyManagers();
    ...
    for (src=0, dst=0; src < kma.length; ) {
      if (!(kma[src] instanceof com.sun.net.ssl.KeyManager)) {
        if (kma[src] instanceof javax.net.ssl.X509KeyManager) {
          kmaw[dst]=(KeyManager)new X509KeyManagerComSunWrapper((javax.net.ssl.X509KeyManager)kma[src]);
          dst++;
        }
      }
 else {
...
final class X509KeyManagerJavaxWrapper implements javax.net.ssl.X509KeyManager {
  ...
  public String chooseClientAlias(  String[] keyTypes,  Principal[] issuers,  Socket socket){
    ...
    for (int i=0; i < keyTypes.length; i++) {
      if ((retval=theX509KeyManager.chooseClientAlias(keyTypes[i],issuers)) != null)       return retval;
    }
    return null;
  }
...
final class X509TrustManagerJavaxWrapper implements javax.net.ssl.X509TrustManager {
  ...
  public void checkClientTrusted(  java.security.cert.X509Certificate[] chain,  String authType) throws java.security.cert.CertificateException {
    if (!theX509TrustManager.isClientTrusted(chain)) {
      throw new java.security.cert.CertificateException("Untrusted Client Certificate Chain");
    }
  }
  public void checkServerTrusted(  java.security.cert.X509Certificate[] chain,  String authType) throws java.security.cert.CertificateException {
    if (!theX509TrustManager.isServerTrusted(chain)) {
      throw new java.security.cert.CertificateException("Untrusted Server Certificate Chain");
    }
  }
