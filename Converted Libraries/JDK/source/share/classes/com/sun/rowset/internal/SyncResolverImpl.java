 ...
 */
  public void setResolvedValue(  int index,  Object obj) throws SQLException {
    ...
    try {
      boolean bool=true;
      if (((crsSync.getObject(index)).toString()).equals(obj.toString()) || ((crsRes.getObject(index)).toString()).equals(obj.toString())) {
 ...
 */
  private CachedRowSet buildCachedRow() throws SQLException {
    ...
    try {
      if (crsSync.getCommand() != null)       crsRow.setCommand(crsSync.getCommand());
    }
 catch (    SQLException sqle) {
    }
    try {
 ...
 * @since 1.6
 */
  public void updateNCharacterStream(  String columnName,  java.io.Reader x,  int length) throws SQLException {
    throw new UnsupportedOperationException("Operation not yet supported");
  }
  /** 
