 ...
 */
  public void writeXML(  WebRowSet caller,  java.io.Writer wrt) throws SQLException {
 ...
 * @see XmlWriter#writeXML
 */
  public void writeXML(  WebRowSet caller,  java.io.OutputStream oStream) throws SQLException {
    stack=new java.util.Stack();
...
if (bd != null) writer.write(bd.toString());
 else emptyTag("null");
}
