 ...
 */
  ...
  @Override public VirtualMachine virtualMachine(){
 ...
 */
  ...
  @Override public int suspendPolicy(){
    return jdiEventSet.suspendPolicy();
  }
 ...
 */
  @Override public EventIterator eventIterator(){
 ...
 */
  ...
  @Override public boolean addAll(  Collection<? extends Event> coll){
    throw new UnsupportedOperationException();
  }
