 ...
 */
  ...
  public boolean equals(  Object obj){
    if ((obj != null) && (obj instanceof StackFrameImpl)) {
      ...
      return (id == other.id) && (thread().equals(other.thread())) && (location().equals(other.location()))&& super.equals(obj);
    }
 else {
      return false;
    }
...
synchronized (vm.state()) {
        ...
        try {
          thisObject=JDWP.StackFrame.ThisObject.waitForReply(vm,ps).objectThis;
        }
...
slotVals[0]=new JDWP.StackFrame.SetValues.SlotInfo(variable.slot(),value);
PacketStream ps;
synchronized (vm.state()) {
validateStackFrame();
