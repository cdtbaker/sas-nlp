...
public class CommandInterpreter {
  ...
  private void commandStep(  StringTokenizer t) throws NoSessionException {
    ...
    try {
      ...
      env.failure("No linenumber information available -- " + "Try \"stepi\" to step by instructions.");
    }
  }
  ...
  private void commandNext() throws NoSessionException {
    ...
    try {
      ...
      env.failure("No linenumber information available -- " + "Try \"nexti\" to step by instructions.");
    }
  }
 ...
 */
  ...
  private void commandLocals() throws NoSessionException {
    ...
    try {
      ...
      env.failure("Local variable information not available." + " Compile with -g to generate variable information");
      return;
    }
    OutputSink out=env.getOutputSink();
