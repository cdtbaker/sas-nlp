 ...
 */
    ...
    LineStratum lineStratum(    ReferenceTypeImpl refType,    int jplsLine){
      ...
      if (lti < 0) {
        ...
        return new LineStratum(sti,lti,refType,jplsLine);
      }
    }
  }
class LineStratum {
    ...
    public boolean equals(    Object obj){
      if ((obj != null) && (obj instanceof LineStratum)) {
        ...
        return (lti == other.lti) && (sti == other.sti) && (lineNumber() == other.lineNumber())&& (refType.equals(other.refType));
      }
 else {
        return false;
      }
 ...
 */
  void storeStratum(  String stratumId){
    if (stratumIndex > 0) {
      if ((stratumTable[stratumIndex - 1].fileIndex == fileIndex) && (stratumTable[stratumIndex - 1].lineIndex == lineIndex)) {
        --stratumIndex;
      }
    }
    assureStratumTableSize();
