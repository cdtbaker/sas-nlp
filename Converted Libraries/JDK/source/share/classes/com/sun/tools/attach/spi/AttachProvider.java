 ...
 * @throws SecurityExceptionIf a security manager has been installed and it denies{@link com.sun.tools.attach.AttachPermission AttachPermission}<tt>("createAttachProvider")</tt>
 */
  protected AttachProvider(){
    SecurityManager sm=System.getSecurityManager();
    if (sm != null)     sm.checkPermission(new AttachPermission("createAttachProvider"));
  }
  /** 
 ...
 * @throws SecurityExceptionIf a security manager has been installed and it denies{@link com.sun.tools.attach.AttachPermission AttachPermission}<tt>("attachVirtualMachine")</tt>, or other permission
 * required by the implementation.
 * @throws AttachNotSupportedExceptionIf the identifier cannot be parsed, or it corresponds to
 ...
 * @throws SecurityExceptionIf a security manager has been installed and it denies{@link com.sun.tools.attach.AttachPermission AttachPermission}<tt>("attachVirtualMachine")</tt>, or other permission
 * required by the implementation.
 * @throws AttachNotSupportedExceptionIf the descriptor's {@link com.sun.tools.attach.VirtualMachineDescriptor#provider() provider()} method
