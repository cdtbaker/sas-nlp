...
static {
    try {
      ...
      Method getEngineMethod=managerClass.getMethod("getEngineByName",new Class[]{String.class});
 ...
 */
  public synchronized void executeQuery(  String query,  ObjectVisitor visitor) throws OQLException {
    ...
    executeQuery(new OQLQuery(selectExpr,isInstanceOf,className,identifier,whereExpr),visitor);
  }
  private void executeQuery(  OQLQuery q,  ObjectVisitor visitor) throws OQLException {
  ...
  private void init(  Snapshot snapshot) throws RuntimeException {
    ...
    try {
      ...
      evalMethod=engineClass.getMethod("eval",new Class[]{Reader.class});
      evalMethod.invoke(engine,new Object[]{new InputStreamReader(strm)});
      Class<?> invocableClass=Class.forName("javax.script.Invocable");
      evalMethod=engineClass.getMethod("eval",new Class[]{String.class});
      invokeMethod=invocableClass.getMethod("invokeFunction",new Class[]{String.class,Object[].class});
      Method putMethod=engineClass.getMethod("put",new Class[]{String.class,Object.class});
      putMethod.invoke(engine,new Object[]{"heap",call("wrapHeapSnapshot",new Object[]{snapshot})});
    }
 catch (    Exception e) {
