 ...
 */
  ...
  @Override public void vmStartEvent(  VMStartEvent se){
    Thread.yield();
    MessageOutput.lnprint("VM Started:");
  }
  @Override public void vmDeathEvent(  VMDeathEvent e){
  }
  @Override public void vmDisconnectEvent(  VMDisconnectEvent e){
  }
  @Override public void threadStartEvent(  ThreadStartEvent e){
  }
  @Override public void threadDeathEvent(  ThreadDeathEvent e){
  }
  @Override public void classPrepareEvent(  ClassPrepareEvent e){
  }
  @Override public void classUnloadEvent(  ClassUnloadEvent e){
  }
  @Override public void breakpointEvent(  BreakpointEvent be){
    Thread.yield();
    MessageOutput.lnprint("Breakpoint hit:");
  }
  @Override public void fieldWatchEvent(  WatchpointEvent fwe){
  ...
  @Override public void stepEvent(  StepEvent se){
    Thread.yield();
    MessageOutput.lnprint("Step completed:");
  }
  @Override public void exceptionEvent(  ExceptionEvent ee){
    Thread.yield();
  ...
  @Override public void methodEntryEvent(  MethodEntryEvent me){
    Thread.yield();
  ...
  @Override public boolean methodExitEvent(  MethodExitEvent me){
    Thread.yield();
  ...
  @Override public void vmInterrupted(){
    Thread.yield();
  ...
  @Override public void receivedEvent(  Event event){
  }
      ...
      Thread.currentThread().setPriority(Thread.NORM_PRIORITY);
{
 ...
 else       if (token.equals("-v") || token.startsWith("-v:") || token.startsWith("-verbose")|| token.startsWith("-D")|| token.startsWith("-X")|| token.equals("-noasyncgc")|| token.equals("-prof")|| token.equals("-verify")|| token.equals("-noverify")|| token.equals("-verifyremote")|| token.equals("-verbosegc")|| token.startsWith("-ms")|| token.startsWith("-mx")|| token.startsWith("-ss")|| token.startsWith("-oss")) {
