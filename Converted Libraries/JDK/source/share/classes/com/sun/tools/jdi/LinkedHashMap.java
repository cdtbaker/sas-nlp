 ...
 */
  public LinkedHashMap(  int initialCapacity,  float loadFactor){
    ...
    if ((loadFactor > 1) || (loadFactor <= 0))     throw new IllegalArgumentException("Illegal Load factor: " + loadFactor);
 ...
 */
  public boolean containsKey(  Object key){
    ...
    if (key != null) {
      ...
      for (Entry e=tab[index]; e != null; e=e.next)       if (e.hash == hash && e.key.equals(key))       return true;
    }
 else {
      for (Entry e=tab[0]; e != null; e=e.next)       if (e.key == null)       return true;
    }
    return false;
  }
  /** 
 ...
 */
  private Entry getEntry(  Object key){
    ...
    if (key != null) {
      int hash=key.hashCode();
      int index=(hash & 0x7FFFFFFF) % tab.length;
      for (Entry e=tab[index]; e != null; e=e.next)       if ((e.hash == hash) && e.key.equals(key))       return e;
    }
 else {
      for (Entry e=tab[0]; e != null; e=e.next)       if (e.key == null)       return e;
    }
    return null;
  }
  /** 
 ...
 */
  public int indexOf(  Object key){
    int i=0;
    if (key == null) {
      for (Entry e=header.after; e != header; e=e.after, i++)       if (e.key == null)       return i;
    }
 else {
      for (Entry e=header.after; e != header; e=e.after, i++)       if (key.equals(e.key))       return i;
    }
    return -1;
  }
  /** 
 ...
 */
  public Object put(  int index,  Object key,  Object value){
    ...
    if (index == count)     return putAhead(key,value,header);
 else {
      for (int i=0; i < index; i++)       e=e.after;
 ...
 */
  public boolean equals(  Object o){
    ...
    if (!(o instanceof LinkedHashMap))     return false;
    ...
    while (i1.hasNext()) {
      ...
      if ((key1 == null ? key2 == null : key1.equals(key2)) && (value1 == null ? value2 == null : value1.equals(value2))) {
        continue;
      }
 else {
        return false;
 ...
 */
    ...
    public Object next(){
      ...
      if (entry == LinkedHashMap.this.header)       throw new NoSuchElementException();
