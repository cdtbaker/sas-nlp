...
abstract public class TypeComponentImpl extends MirrorImpl implements TypeComponent {
  ...
  public boolean isPackagePrivate(){
    return !isModifierSet(VMModifiers.PRIVATE | VMModifiers.PROTECTED | VMModifiers.PUBLIC);
  }
