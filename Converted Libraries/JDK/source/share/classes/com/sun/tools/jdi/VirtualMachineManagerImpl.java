...
synchronized (lock) {
  ...
  protected VirtualMachineManagerImpl(){
    ...
    ServiceLoader<Connector> connectorLoader=ServiceLoader.load(Connector.class,Connector.class.getClassLoader());
    ...
    ServiceLoader<TransportService> transportLoader=ServiceLoader.load(TransportService.class,TransportService.class.getClassLoader());
    Iterator<TransportService> transportServices=transportLoader.iterator();
