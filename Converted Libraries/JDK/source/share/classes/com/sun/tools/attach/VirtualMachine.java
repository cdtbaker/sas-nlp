 ...
 * @param providerThe attach provider creating this class.
 * @param idThe abstract identifier that identifies the Java virtual machine.
 * @throws NullPointerExceptionIf <code>provider</code> or <code>id</code> is <code>null</code>.
 */
 ...
 * @throws SecurityExceptionIf a security manager has been installed and it denies{@link com.sun.tools.attach.AttachPermission AttachPermission}<tt>("attachVirtualMachine")</tt>, or another permission
 * required by the implementation.
 * @throws AttachNotSupportedExceptionIf the <code>attachVirtualmachine</code> method of all installed
 ...
 * @throws NullPointerExceptionIf <code>id</code> is <code>null</code>.
 */
 ...
 * @param vmdThe virtual machine descriptor.
 * @return  A VirtualMachine representing the target VM.
 * @throws SecurityExceptionIf a security manager has been installed and it denies{@link com.sun.tools.attach.AttachPermission AttachPermission}<tt>("attachVirtualMachine")</tt>, or another permission
 * required by the implementation.
 * @throws AttachNotSupportedExceptionIf the attach provider's <code>attachVirtualmachine</code>
 * throws <code>AttachNotSupportedException</code>.
 * @throws IOExceptionIf an I/O error occurs
 * @throws NullPointerExceptionIf <code>vmd</code> is <code>null</code>.
 */
 ...
 * @param agentLibraryThe name of the agent library.
 * @param optionsThe options to provide to the <code>Agent_OnAttach</code>
 * function (can be <code>null</code>).
 * @throws AgentLoadExceptionIf the agent library does not exist, or cannot be loaded for
 * another reason.
 * @throws AgentInitializationExceptionIf the <code>Agent_OnAttach</code> function returns an error
 * @throws IOExceptionIf an I/O error occurs
 * @throws NullPointerExceptionIf <code>agentLibrary</code> is <code>null</code>.
 ...
 * thrown. The return value from the <code>Agent_OnAttach</code> can then be
 * obtained by invoking the {@link com.sun.tools.attach.AgentInitializationException#returnValue() returnValue}method on the exception. </p>
 * @param agentPathThe full path of the agent library.
 * @param optionsThe options to provide to the <code>Agent_OnAttach</code>
 * function (can be <code>null</code>).
 * @throws AgentLoadExceptionIf the agent library does not exist, or cannot be loaded for
 * another reason.
 * @throws AgentInitializationExceptionIf the <code>Agent_OnAttach</code> function returns an error
 * @throws IOExceptionIf an I/O error occurs
 * @throws NullPointerExceptionIf <code>agentPath</code> is <code>null</code>.
 * @see com.sun.tools.attach.AgentInitializationException#returnValue()
 */
 ...
 * </tt></blockquote>
 * @param agentPathThe full path to the agent library.
 * @throws AgentLoadExceptionIf the agent library does not exist, or cannot be loaded for
 * another reason.
 * @throws AgentInitializationExceptionIf the <code>Agent_OnAttach</code> function returns an error
 * @throws IOExceptionIf an I/O error occurs
 ...
 * @param agentPath to the JAR file containing the agent.
 * @param optionsThe options to provide to the agent's <code>agentmain</code>
 * method (can be <code>null</code>).
 * @throws AgentLoadExceptionIf the agent does not exist, or cannot be started in the manner
 * specified in the {@link java.lang.instrument} specification.
 * @throws AgentInitializationExceptionIf the <code>agentmain</code> throws an exception
 * @throws IOExceptionIf an I/O error occurs
 * @throws NullPointerExceptionIf <code>agent</code> is <code>null</code>.
 */
 ...
 */
  public boolean equals(  Object ob){
    ...
    if (!(ob instanceof VirtualMachine))     return false;
