...
private static class Cache extends ObjectReferenceImpl.Cache {
  ...
  public List<ReferenceType> visibleClasses(){
    ...
    try {
      ...
      if (classes == null) {
        JDWP.ClassLoaderReference.VisibleClasses.ClassInfo[] jdwpClasses=JDWP.ClassLoaderReference.VisibleClasses.process(vm,this).classes;
        ...
        if (local != null) {
          ...
          if ((vm.traceFlags & vm.TRACE_OBJREFS) != 0) {
            vm.printTrace(description() + " temporarily caching visible classes (count = " + classes.size()+ ")");
          }
        }
      }
    }
