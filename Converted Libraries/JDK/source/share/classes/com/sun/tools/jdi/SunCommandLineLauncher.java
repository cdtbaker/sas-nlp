  ...
  public VirtualMachine launch(  Map<String,? extends Connector.Argument> arguments) throws IOException, IllegalConnectorArgumentsException, VMStartException {
    ...
    try {
      if (home.length() > 0) {
        ...
        if ("SunOS".equals(System.getProperty("os.name")) && ("sparcv9".equals(os_arch) || "amd64".equals(os_arch))) {
          exePath=home + File.separator + "bin"+ File.separator+ os_arch+ File.separator+ exe;
        }
 else {
