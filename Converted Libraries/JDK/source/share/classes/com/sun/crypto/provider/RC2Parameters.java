...
public final class RC2Parameters extends AlgorithmParametersSpi {
  ...
  protected void engineInit(  byte[] encoded) throws IOException {
    ...
    if (val.tag == DerValue.tag_Sequence) {
      ...
      if (version < 0 || version > 1024) {
        throw new IOException("RC2 parameter parsing error: " + "version number out of legal range (0-1024): " + version);
      }
      if (version > 255) {
    ...
    if (iv.length != 8) {
      throw new IOException("RC2 parameter parsing error: iv length " + "must be 8 bits, actual: " + iv.length);
    }
  ...
  protected AlgorithmParameterSpec engineGetParameterSpec(  Class paramSpec) throws InvalidParameterSpecException {
    if (RC2ParameterSpec.class.isAssignableFrom(paramSpec)) {
      return (iv == null ? new RC2ParameterSpec(effectiveKeySize) : new RC2ParameterSpec(effectiveKeySize,iv));
    }
 else {
      throw new InvalidParameterSpecException("Inappropriate parameter specification");
    }
