  ...
  protected Key engineTranslateKey(  Key key) throws InvalidKeyException {
    try {
      if (key instanceof javax.crypto.interfaces.DHPublicKey) {
        ...
        DHPublicKeySpec dhPubKeySpec=(DHPublicKeySpec)engineGetKeySpec(key,DHPublicKeySpec.class);
        ...
        DHPrivateKeySpec dhPrivKeySpec=(DHPrivateKeySpec)engineGetKeySpec(key,DHPrivateKeySpec.class);
