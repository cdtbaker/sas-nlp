 ...
 */
  public boolean implies(  Permission p){
    if (!(p instanceof ExecOptionPermission))     return false;
 ...
 * @serial include
 */
private static class ExecOptionPermissionCollection extends PermissionCollection implements java.io.Serializable {
