 ...
 * @return  A {@code Set} containing the open associations, or an empty{@code Set} if there are none.
 ...
 * @param backlogThe maximum number number of pending connections
 * @return  This channel
 * @throws ClosedChannelExceptionIf this channel is closed
 ...
 * @throws SecurityExceptionIf a security manager has been installed and its {@link java.lang.SecurityManager#checkListen(int) checkListen} method
 ...
 * @return  This channel
 * @throws ClosedChannelExceptionIf this channel is closed
 * @throws NotYetBoundExceptionIf this channel is not yet bound
 ...
 * @throws ClosedChannelExceptionIf this channel is closed
 * @throws NotYetBoundExceptionIf this channel is not yet bound
 * @throws IllegalUnbindException {@code address} is not bound to the channel's socket, or the
 ...
 * @param associationThe association to shutdown
 * @return  This channel
 * @throws ClosedChannelExceptionIf this channel is closed
 * @throws IOExceptionIf some other I/O error occurs
 */
 ...
 * @param associationThe association whose option should be retrieved, or {@code null}if this option should be retrieved at the channel's socket level.
 ...
 * association must be given.
 * @param nameThe socket option
 * @param associationThe association whose option should be set, or {@code null}if this option should be set at the channel's socket level.
 ...
 * @param bufferThe buffer into which bytes are to be transferred
 * @param attachmentThe object to attach to the receive operation; can be{@code null}
 * @param handlerA handler to handle notifications from the SCTP stack, or{@code null} to ignore any notifications.
 ...
 * channel
 * @throws SecurityExceptionIf a security manager has been installed and it does not permit
 ...
 * @param bufferThe buffer containing the message to be sent
 ...
 * output buffer
 * @throws InvalidStreamExceptonIf {@code streamNumber} is negative, or if an association already
 ...
 * @param associationThe association to branch off
