 ...
 * @param providerThe selector provider for this channel
 */
 ...
 * @throws UnsupportedOperationExceptionIf the SCTP protocol is not supported
 ...
 * </pre></blockquote>
 * @param remoteThe remote address to which the new channel is to be connected
 * @param maxOutStreamsThe number of streams that the application wishes to be able
 * to send to. Must be non negative and no larger than {@code 65536}.{@code 0} to use the endpoints default value.
 * @param maxInStreamsThe maximum number of inbound streams the application is prepared
 ...
 * @throws java.nio.channels.AsynchronousCloseExceptionIf another thread closes this channel
 * while the connect operation is in progress
 * @throws java.nio.channels.ClosedByInterruptExceptionIf another thread interrupts the current thread
 * while the connect operation is in progress, thereby
 * closing the channel and setting the current thread's
 * interrupt status
 * @throws java.nio.channels.UnresolvedAddressExceptionIf the given remote address is not fully resolved
 * @throws java.nio.channels.UnsupportedAddressTypeExceptionIf the type of the given remote address is not supported
 * @throws SecurityExceptionIf a security manager has been installed
 ...
 * @param localThe local address to bind the socket, or {@code null} to
 * bind the socket to an automatically assigned socket address
 * @return  This channel
 * @throws java.nio.channels.AlreadyConnectedExceptionIf this channel is already connected
 * @throws java.nio.channels.ClosedChannelExceptionIf this channel is closed
 * @throws java.nio.channels.ConnectionPendingExceptionIf a non-blocking connection operation is already in progress on this channel
 * @throws java.nio.channels.AlreadyBoundExceptionIf this channel is already bound
 * @throws java.nio.channels.UnsupportedAddressTypeExceptionIf the type of the given address is not supported
 * @throws IOExceptionIf some other I/O error occurs
 */
 ...
 * lists.
 * @param addressThe address to add to the bound addresses for the socket
 * @return  This channel
 * @throws java.nio.channels.ClosedChannelExceptionIf this channel is closed
 * @throws java.nio.channels.ConnectionPendingExceptionIf a non-blocking connection operation is already in progress on
 * this channel
 * @throws java.nio.channels.NotYetBoundExceptionIf this channel is not yet bound
 * @throws java.nio.channels.AlreadyBoundExceptionIf this channel is already bound to the given address
 * @throws IllegalArgumentExceptionIf address is {@code null} or the {@link java.net.InetAddress#isAnyLocalAddress wildcard} address
 * @throws IOExceptionIf some other I/O error occurs
 */
 ...
 * address lists.
 * @param addressThe address to remove from the bound addresses for the socket
 * @return  This channel
 * @throws java.nio.channels.ClosedChannelExceptionIf this channel is closed
 * @throws java.nio.channels.ConnectionPendingExceptionIf a non-blocking connection operation is already in progress on
 * this channel
 * @throws java.nio.channels.NotYetBoundExceptionIf this channel is not yet bound
 * @throws IllegalArgumentExceptionIf address is {@code null} or the {@link java.net.InetAddress#isAnyLocalAddress wildcard} address
 * @throws IllegalUnbindExceptionIf {@code address} is not bound to the channel's socket. or
 ...
 * @param remoteThe remote peer to which this channel is to be connected
 ...
 * @param remoteThe remote peer to which this channel is to be connected
 * @param maxOutStreamsMust be non negative and no larger than {@code 65536}.{@code 0} to use the endpoints default value.
 * @param maxInStreamsMust be non negative and no larger than {@code 65536}.{@code 0} to use the endpoints default value.
 * @return  {@code true} if a connection was established, {@code false} if
 ...
 * connected
 * @throws java.nio.channels.NoConnectionPendingExceptionIf this channel is not connected and a connection operation
 ...
 * @return  This channel
 * @throws java.nio.channels.NotYetConnectedExceptionIf this channel is not yet connected
 * @throws java.nio.channels.ClosedChannelExceptionIf this channel is closed
 * @throws IOExceptionIf some other I/O error occurs
 */
 ...
 */
  @Override public final int validOps(){
 ...
 * @param dstThe buffer into which message bytes are to be transferred
 * @param attachmentThe object to attach to the receive operation; can be{@code null}
 * @param handlerA handler to handle notifications from the SCTP stack, or {@codenull} to ignore any notifications.
 ...
 * interrupt status
 * @throws java.nio.channels.NotYetConnectedExceptionIf this channel is not yet connected
 * @throws IllegalReceiveExceptionIf the given handler invokes the {@code receive} method of this
 * channel
 * @throws IOExceptionIf some other I/O error occurs
 */
 ...
 * @param srcThe buffer containing the message to be sent
 * @param messageInfoAncillary data about the message to be sent
 ...
 * output buffer
 * @throws InvalidStreamExceptonIf {@code streamNumner} is negative or greater than or equal to
