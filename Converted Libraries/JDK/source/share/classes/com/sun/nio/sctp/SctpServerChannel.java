 ...
 * @return  The SCTP channel for the new association, or {@code null}if this channel is in non-blocking mode and no association is
 ...
 * interrupt status
 * @throws java.nio.channels.NotYetBoundExceptionIf this channel's socket has not yet been bound
 ...
 * @param localThe local address to bind the socket, or {@code null} to
 * bind the socket to an automatically assigned socket address
 * @param backlogThe maximum number number of pending associations
 * @return  This channel
 * @throws java.nio.channels.ClosedChannelExceptionIf this channel is closed
 * @throws java.nio.channels.AlreadyBoundExceptionIf this channel is already bound
 * @throws java.nio.channels.UnsupportedAddressTypeExceptionIf the type of the given address is not supported
 ...
 * @throws java.nio.channels.NotYetBoundExceptionIf this channel is not yet bound
 * @throws IllegalArgumentExceptionIf address is {@code null} or the {@link java.net.InetAddress#isAnyLocalAddress wildcard} address
 * @throws IllegalUnbindExceptionIf the implementation does not support removing addresses from a
 ...
 * bound
 * @throws java.nio.channels.ClosedChannelExceptionIf the channel is closed
 * @throws IOExceptionIf an I/O error occurs
 */
