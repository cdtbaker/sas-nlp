...
/** 
 * This annotation is used to describe the interface attributes of the{@code provider} field for a single provider.
 ...
 * @since 1.7
 */
@Retention(RetentionPolicy.RUNTIME) @Target({ElementType.TYPE}) public @interface ProviderAttributes {Attributes value();
}
