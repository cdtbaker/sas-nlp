...
public abstract class VersionHelper {
  ...
  final static String[] PROPS=new String[]{javax.naming.Context.INITIAL_CONTEXT_FACTORY,javax.naming.Context.OBJECT_FACTORIES,javax.naming.Context.URL_PKG_PREFIXES,javax.naming.Context.STATE_FACTORIES,javax.naming.Context.PROVIDER_URL,javax.naming.Context.DNS_URL,javax.naming.ldap.LdapContext.CONTROL_FACTORIES};
...
static {
  ...
  abstract NamingEnumeration getResources(  ClassLoader cl,  String name) throws IOException ;
