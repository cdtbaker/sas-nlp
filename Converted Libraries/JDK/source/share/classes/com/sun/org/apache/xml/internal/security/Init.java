 ...
 */
  static java.util.logging.Logger log=java.util.logging.Logger.getLogger(Init.class.getName());
  /** 
 * Field _initialized 
 */
  ...
  public synchronized static void init(){
    ...
    try {
      ...
      InputStream is=(InputStream)AccessController.doPrivileged(new PrivilegedAction(){
        public Object run(){
          return getClass().getResourceAsStream("resource/config.xml");
        }
      }
);
      ...
      for (Node el=config.getFirstChild(); el != null; el=el.getNextSibling()) {
        ...
        if (tag.equals("CanonicalizationMethods")) {
          ...
          for (int i=0; i < list.length; i++) {
            ...
            try {
              ...
              if (log.isLoggable(java.util.logging.Level.FINE))               log.log(java.util.logging.Level.FINE,"Canonicalizer.register(" + URI + ", "+ JAVACLASS+ ")");
        ...
        if (tag.equals("SignatureAlgorithms")) {
          ...
          for (int i=0; i < sigElems.length; i++) {
            ...
            try {
              Class.forName(JAVACLASS);
              if (log.isLoggable(java.util.logging.Level.FINE))               log.log(java.util.logging.Level.FINE,"SignatureAlgorithm.register(" + URI + ", "+ JAVACLASS+ ")");
        ...
        if (tag.equals("ResourceResolvers")) {
          ...
          for (int i=0; i < resolverElem.length; i++) {
            ...
            if ((Description != null) && (Description.length() > 0)) {
              ...
              if (log.isLoggable(java.util.logging.Level.FINE))               log.log(java.util.logging.Level.FINE,"Register Resolver: " + JAVACLASS + ": For unknown purposes");
            }
            try {
        ...
        if (tag.equals("PrefixMappings")) {
          ...
          for (int i=0; i < nl.length; i++) {
            ...
            com.sun.org.apache.xml.internal.security.utils.ElementProxy.setDefaultPrefix(namespace,prefix);
          }
