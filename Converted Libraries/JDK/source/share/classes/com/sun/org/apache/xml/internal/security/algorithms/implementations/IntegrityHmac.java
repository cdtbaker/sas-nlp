 ...
 */
  static java.util.logging.Logger log=java.util.logging.Logger.getLogger(IntegrityHmacSHA1.class.getName());
  /** 
 * Method engineGetURI
 * @inheritDoc
 */
 ...
 */
  protected void engineInitVerify(  Key secretKey) throws XMLSignatureException {
    ...
    try {
      ...
      try {
        this._macAlgorithm=Mac.getInstance(_macAlgorithm.getAlgorithm());
      }
 catch (      Exception e) {
        if (log.isLoggable(java.util.logging.Level.FINE)) {
 ...
 */
  private static byte[] reduceBitLength(  byte completeResult[],  int length){
    ...
    if (abits > 0) {
      byte[] MASK={(byte)0x00,(byte)0x80,(byte)0xC0,(byte)0xE0,(byte)0xF0,(byte)0xF8,(byte)0xFC,(byte)0xFE};
 ...
 */
  protected void engineGetContextFromElement(  Element element){
    ...
    Text hmaclength=XMLUtils.selectDsNodeText(element.getFirstChild(),Constants._TAG_HMACOUTPUTLENGTH,0);
    if (hmaclength != null) {
