 ...
 */
  static java.util.logging.Logger log=java.util.logging.Logger.getLogger(SignatureBaseRSA.class.getName());
  /** 
 * @inheritDoc 
 */
 ...
 */
  public SignatureBaseRSA() throws XMLSignatureException {
    ...
    if (log.isLoggable(java.util.logging.Level.FINE))     log.log(java.util.logging.Level.FINE,"Created SignatureRSA using " + algorithmID);
