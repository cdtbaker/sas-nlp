 ...
 */
  static java.util.logging.Logger log=java.util.logging.Logger.getLogger(ElementProxy.class.getName());
  /** 
  ...
  public static Element createElementForFamily(  Document doc,  String namespace,  String localName){
    ...
    if (namespace == null) {
      ...
      if ((prefix == null) || (prefix.length() == 0)) {
        ...
        result.setAttributeNS(Constants.NamespaceSpecNS,ElementProxy.getDefaultPrefixBindings(namespace),namespace);
      }
    }
    return result;
  }
 ...
 */
  public int length(  String namespace,  String localname){
    ...
    while (sibling != null) {
      if (localname.equals(sibling.getLocalName()) && namespace == sibling.getNamespaceURI()) {
        number++;
      }
