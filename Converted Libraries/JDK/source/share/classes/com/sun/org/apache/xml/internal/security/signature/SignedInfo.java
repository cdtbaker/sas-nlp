 ...
 */
  public SignedInfo(  Element element,  String baseURI) throws XMLSecurityException {
    ...
    if (!(c14nMethodURI.equals(Canonicalizer.ALGO_ID_C14N_OMIT_COMMENTS) || c14nMethodURI.equals(Canonicalizer.ALGO_ID_C14N_WITH_COMMENTS) || c14nMethodURI.equals(Canonicalizer.ALGO_ID_C14N_EXCL_OMIT_COMMENTS)|| c14nMethodURI.equals(Canonicalizer.ALGO_ID_C14N_EXCL_WITH_COMMENTS))) {
      try {
        ...
        org.w3c.dom.Document newdoc=db.parse(new ByteArrayInputStream(this._c14nizedBytes));
    ...
    this._signatureAlgorithm=new SignatureAlgorithm(signatureMethod,this.getBaseURI());
  }
  /** 
 ...
 */
  public void signInOctectStream(  OutputStream os) throws CanonicalizationException, InvalidCanonicalizerException, XMLSecurityException {
    if ((this._c14nizedBytes == null)) {
      ...
      if (inclusiveNamespaces == null)       c14nizer.canonicalizeSubtree(this._constructionElement);
 else       c14nizer.canonicalizeSubtree(this._constructionElement,inclusiveNamespaces);
    }
 else {
      try {
