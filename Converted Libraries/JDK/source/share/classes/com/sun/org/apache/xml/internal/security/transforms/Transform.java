 ...
 */
  static java.util.logging.Logger log=java.util.logging.Logger.getLogger(Transform.class.getName());
  /** 
 ...
 */
  public Transform(  Document doc,  String algorithmURI,  NodeList contextNodes) throws InvalidTransformException {
    ...
    if (log.isLoggable(java.util.logging.Level.FINE)) {
      log.log(java.util.logging.Level.FINE,"Create URI \"" + algorithmURI + "\" class \""+ transformSpi.getClass()+ "\"");
 ...
 */
  ...
  private static TransformSpi getTransformSpi(  String URI) throws InvalidTransformException {
    try {
