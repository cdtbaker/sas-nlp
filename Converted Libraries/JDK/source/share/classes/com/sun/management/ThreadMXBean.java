 ...
 * @throws IllegalArgumentException if any element in the input array{@code ids} is {@code <=} {@code 0}.
 ...
 * @return {@code true}if the Java virtual machine implementation supports thread memory
 * allocation measurement;{@code false} otherwise.
 */
  public boolean isThreadAllocatedMemorySupported();
  /** 
 * Tests if thread memory allocation measurement is enabled.
 * @return {@code true} if thread memory allocation measurement is enabled;{@code false} otherwise.
 * @throws java.lang.UnsupportedOperationException if the Java virtual
