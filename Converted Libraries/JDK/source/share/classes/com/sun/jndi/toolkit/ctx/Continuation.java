 ...
 */
  public NamingException fillInException(  NamingException e){
    ...
    if (starter == null || starter.isEmpty())     e.setResolvedName(null);
 else     if (remainingName == null)     e.setResolvedName(starter);
 else     e.setResolvedName(starter.getPrefix(starter.size() - remainingName.size()));
    if ((e instanceof CannotProceedException)) {
      CannotProceedException cpe=(CannotProceedException)e;
      Hashtable env=(environment == null ? new Hashtable(11) : (Hashtable)environment.clone());
 ...
 */
  public void setErrorNNS(  Object resObj,  String remain){
    ...
    try {
      if (remain != null && !remain.equals(""))       rname.add(remain);
      rname.add("");
    }
 catch (    InvalidNameException e) {
    }
 ...
 */
  public void setError(  Object resObj,  Name remain){
    if (remain != null)     remainingName=(Name)(remain.clone());
 else     remainingName=null;
 ...
 */
  public void setContinue(  Object obj,  Name relResName,  Context currCtx){
    setContinueAux(obj,relResName,currCtx,(Name)PartialCompositeContext._EMPTY_NAME.clone());
  }
  /** 
 ...
 */
  public void setContinue(  Object obj,  Name relResName,  Context currCtx,  Name remain){
    if (remain != null)     this.remainingName=(Name)(remain.clone());
 else     this.remainingName=new CompositeName();
 ...
 * @deprecated
 */
  @Deprecated public void setContinue(  Object obj,  Object currCtx){
 ...
 */
  ...
  public String toString(){
    if (remainingName != null)     return starter.toString() + "; remainingName: '" + remainingName+ "'";
 else     return starter.toString();
  }
  public String toString(  boolean detail){
    if (!detail || this.resolvedObj == null)     return this.toString();
    return this.toString() + "; resolvedObj: " + this.resolvedObj+ "; relativeResolvedName: "+ relativeResolvedName+ "; resolvedContext: "+ resolvedContext;
  }
