...
final class LdapSchemaCtx extends HierMemDirCtx {
  ...
  static DirContext createSchemaTree(  Hashtable env,  String subschemasubentry,  LdapCtx schemaEntry,  Attributes schemaAttrs,  boolean netscapeBug) throws NamingException {
    try {
  ...
  final public void bind(  Name name,  Object obj,  Attributes attrs) throws NamingException {
    if (!setupMode) {
      if (obj != null) {
  ...
  final protected void doBind(  Name name,  Object obj,  Attributes attrs,  boolean useFactory) throws NamingException {
    if (!setupMode) {
  ...
  final public void rebind(  Name name,  Object obj,  Attributes attrs) throws NamingException {
    try {
      doLookup(name,false);
  ...
  final protected void doRebind(  Name name,  Object obj,  Attributes attrs,  boolean useFactory) throws NamingException {
    if (!setupMode) {
      throw new SchemaViolationException("Cannot bind arbitrary object; use createSubcontext()");
    }
 else {
  ...
  final protected DirContext doCreateSubcontext(  Name name,  Attributes attrs) throws NamingException {
  ...
  final private static Attributes deepClone(  Attributes orig) throws NamingException {
  ...
  final protected void doModifyAttributes(  ModificationItem[] mods) throws NamingException {
    if (setupMode) {
  ...
  final private void addServerSchema(  Attributes attrs) throws NamingException {
 ...
 * or parens.
 */
final private void deleteServerSchema(Attributes origAttrs) throws NamingException {
 ...
 */
final private void modifyServerSchema(Attributes origAttrs,Attributes newAttrs) throws NamingException {
...
return new LdapCtx(schemaEntryName,host,port,env,hasLdapsScheme);
}
