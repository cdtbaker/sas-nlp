 ...
 * @author Vincent Ryan
 */
final public class LdapReferralException extends javax.naming.ldap.LdapReferralException {
 ...
 */
  public Context getReferralContext(  Hashtable<?,?> newProps,  Control[] connCtls) throws NamingException {
    if (debug)     System.out.println("LdapReferralException.getReferralContext");
    LdapReferralContext refCtx=new LdapReferralContext(this,newProps,connCtls,reqCtls,nextName,skipThisReferral,handleReferrals);
 ...
 */
  public void retryReferral(){
    if (debug)     System.out.println("LdapReferralException.retryReferral");
    if (referralIndex > 0)     referralIndex--;
  }
  /** 
 ...
 */
  public boolean skipReferral(){
    if (debug)     System.out.println("LdapReferralException.skipReferral");
 ...
 */
  void setReferralInfo(  Vector referrals,  boolean continuationRef){
    if (debug)     System.out.println("LdapReferralException.setReferralInfo");
 ...
 */
  String getNextReferral() throws ReferralException {
    if (debug)     System.out.println("LdapReferralException.getNextReferral");
    if (hasMoreReferrals()) {
 ...
 */
  boolean hasMoreReferrals(){
    if (debug)     System.out.println("LdapReferralException.hasMoreReferrals");
 ...
 */
  void setHopCount(  int hopCount){
    if (debug)     System.out.println("LdapReferralException.setHopCount");
 ...
 */
  void setNameResolved(  boolean resolved){
    if (debug)     System.out.println("LdapReferralException.setNameResolved");
    foundEntry=resolved;
  }
  /** 
 ...
 */
  void setNamingException(  NamingException e){
    if (debug)     System.out.println("LdapReferralException.setNamingException");
    if (errorEx == null) {
      e.setRootCause(this);
      errorEx=e;
    }
 ...
 */
  String getNewRdn(){
    if (debug)     System.out.println("LdapReferralException.getNewRdn");
    return newRdn;
  }
  /** 
 ...
 */
  void setNewRdn(  String newRdn){
    if (debug)     System.out.println("LdapReferralException.setNewRdn");
    this.newRdn=newRdn;
  }
  /** 
 ...
 */
  NamingException getNamingException(){
    if (debug)     System.out.println("LdapReferralException.getNamingException");
    return errorEx;
  }
  /** 
