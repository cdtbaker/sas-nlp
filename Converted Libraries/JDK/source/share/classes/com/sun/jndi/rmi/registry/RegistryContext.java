 ...
 */
  public Reference getReference() throws NamingException {
    ...
    String url="rmi://";
    url=(host.indexOf(":") > -1) ? url + "[" + host+ "]" : url + host;
    if (port > 0) {
      url+=":" + Integer.toString(port);
    }
    RefAddr addr=new StringRefAddr(RegistryContextFactory.ADDRESS_TYPE,url);
...
class NameClassPairEnumeration implements NamingEnumeration {
  ...
  public Object nextElement(){
    try {
      ...
      throw (new java.util.NoSuchElementException("javax.naming.NamingException was thrown"));
    }
  }
  public void close(){
