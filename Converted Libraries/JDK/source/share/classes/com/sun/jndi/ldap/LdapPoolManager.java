...
public final class LdapPoolManager {
  ...
  public static final boolean trace=debug || "fine".equalsIgnoreCase(getProperty(DEBUG,null));
...
out.println("authentication types: " + (pools[NONE] != null ? "none " : "") + (pools[SIMPLE] != null ? "simple " : "")+ (pools[DIGEST] != null ? "DIGEST-MD5 " : ""));
for (int i=0; i < pools.length; i++) {
if (pools[i] != null) {
out.println((i == NONE ? "anonymous pools" : i == SIMPLE ? "simple auth pools" : i == DIGEST ? "digest pools" : "") + ":");
...
Integer val=(Integer)AccessController.doPrivileged(new PrivilegedAction(){
public Object run(){
try {
...
Long val=(Long)AccessController.doPrivileged(new PrivilegedAction(){
public Object run(){
try {
