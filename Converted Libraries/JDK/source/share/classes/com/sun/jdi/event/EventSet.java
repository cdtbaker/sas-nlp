 ...
 * more than one {@link com.sun.jdi.request.BreakpointRequest}for a given {@link Location}or you might single step to the same location as a
 ...
 * where possible,
 * to complete the processing of an event set with{@link #resume() EventSet.resume()}.
 * <P>
 ...
 * <UL>
 * <LI>{@link BreakpointEvent}<LI>{@link StepEvent}<LI>{@link MethodEntryEvent}</UL>
 * </UL>
 * @see Event
 * @see EventQueue
 * @author Robert Field
 ...
 * and that policy is returned here. See{@link com.sun.jdi.request.EventRequest} for the possible
 * policy values.
 * <p>
 * In rare cases, the suspend policy may differ from the requested
 * value if a {@link ClassPrepareEvent} has occurred in a
 * debugger system thread. See {@link ClassPrepareEvent#thread}for details.
 * @return the suspendPolicy which is either{@link com.sun.jdi.request.EventRequest#SUSPEND_ALL SUSPEND_ALL},{@link com.sun.jdi.request.EventRequest#SUSPEND_EVENT_THREAD SUSPEND_EVENT_THREAD} or{@link com.sun.jdi.request.EventRequest#SUSPEND_NONE SUSPEND_NONE}.
 */
  int suspendPolicy();
  /** 
 ...
 */
  ...
  /** 
 * Resumes threads suspended by this event set. If the {@link #suspendPolicy}is {@link com.sun.jdi.request.EventRequest#SUSPEND_ALL}, a call
 * to this method is equivalent to{@link com.sun.jdi.VirtualMachine#resume}. If the
 * suspend policy is{@link com.sun.jdi.request.EventRequest#SUSPEND_EVENT_THREAD},
 * a call to this method is equivalent to{@link com.sun.jdi.ThreadReference#resume} for the event thread.
