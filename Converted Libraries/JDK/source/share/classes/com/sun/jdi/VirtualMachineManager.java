 ...
 * <p>
 * Connections can be made using one of several different{@link com.sun.jdi.connect.Connector} objects. Each connector encapsulates
 ...
 * <TD>Debugger calls the{@link com.sun.jdi.connect.LaunchingConnector#launch(java.util.Map)}method of the default connector, obtained with {@link #defaultConnector}. The
 ...
 * <UL>
 * <LI>
 * Debugger selects a connector from the list returned by{@link #launchingConnectors} with desired characteristics
 * (for example, transport type, etc.).
 * <LI>
 * Debugger calls the{@link com.sun.jdi.connect.LaunchingConnector#launch(java.util.Map)}method of the selected connector. The
 * target VM is launched, and a connection between that VM and the
 * debugger is established. A {@link VirtualMachine} mirror is returned.
 * </UL>
 * </TD>
 ...
 * the name "xxx".
 * <LI>
 * Debugger presents the default connector parameters (obtained through{@link com.sun.jdi.connect.Connector#defaultArguments()}) to the end user,
 ...
 * of the selected to attach to the target VM. A {@link VirtualMachine}mirror is returned.
 * </UL>
 * </TD>
 * </TR>
 * <TR>
 ...
 * <LI>
 * Debugger calls{@link com.sun.jdi.connect.ListeningConnector#accept(java.util.Map)}for each selected connector to wait for
 ...
 * is the address generated by{@link com.sun.jdi.connect.ListeningConnector#accept(java.util.Map)} for that
 * transport.</LI>
 * <LI>
 ...
 * the name "xxx".
 * <LI>
 * Debugger changes the default connector parameters (obtained through{@link com.sun.jdi.connect.Connector#defaultArguments()}) to specify
 ...
 * are created the first time that {@link com.sun.jdi.Bootstrap#virtualMachineManager()} is invoked.
 * The list of all Connectors created at start-up time can be
 * obtained from the VirtualMachineManager by invoking the{@link #allConnectors allConnectors} method.
 * <p> Connectors are created at start-up time if they are
 * installed on the platform. In addition, Connectors are created
 * automatically by the VirtualMachineManager to encapsulate any{@link com.sun.jdi.connect.spi.TransportService} implementations
 ...
 * implementation. A Connector is a class that implements the{@link com.sun.jdi.connect.Connector Connector} interface. More
 * appropriately the class implements one of the specific Connector
 * types, namely {@link com.sun.jdi.connect.AttachingConnectorAttachingConnector}, {@link com.sun.jdi.connect.ListeningConnectorListeningConnector}, or {@link com.sun.jdi.connect.LaunchingConnectorLaunchingConnector}. The format of the provider configuration file
 ...
 * visible to the defining class loader for the{@link com.sun.jdi.connect.spi.TransportService} type, and that jar
 ...
 * sub-class of {@link com.sun.jdi.connect.spi.TransportServiceTransportService}. The format of the provider configuration file
 ...
 * VirtualMachineManager creates a corresponding{@link com.sun.jdi.connect.AttachingConnector} and{@link com.sun.jdi.connect.ListeningConnector}. These
 * Connectors are created to encapsulate a {@link com.sun.jdi.connect.Transport Transport} that in turn
 ...
 * For example, if the transport service {@link com.sun.jdi.connect.spi.TransportService#name() name()} method
 ...
 * name of the transport service. The {@link com.sun.jdi.connect.Connector#description() description()} method
 * of both the AttachingConnector, and the ListeningConnector, will
 * delegate to the {@link com.sun.jdi.connect.spi.TransportService#description()description()} method of the underlying transport service. Both
 ...
 * A {@link com.sun.jdi.connect.Connector$StringArgument StringArgument}named <tt>address</tt> is the connector argument to specify the
 * address to attach too, or to listen on. A{@link com.sun.jdi.connect.Connector$IntegerArgument IntegerArgument}named <tt>timeout</tt> is the connector argument to specify the
 ...
 * <p> Initialization of the virtual machine manager will fail, that is{@link com.sun.jdi.Bootstrap#virtualMachineManager()} will throw an
 ...
 * until the VM is disconnected.{@link com.sun.jdi.event.VMDisconnectEvent} is placed in the event queue
 ...
 * information and{@link VirtualMachine#description} more version information.
 ...
 * for which a {@link com.sun.jdi.connect.spi.Connection Connection}already exists. A Connection is created when a {@link com.sun.jdi.connect.Connector Connector} establishes
 ...
 * <p> The <tt>process</tt> argument specifies the{@link java.lang.Process} object for the taget VM. It may be
 * specified as <tt>null</tt>. If the target VM is launched
 * by a {@link com.sun.jdi.connect.LaunchingConnectorLaunchingConnector} the <tt>process</tt> argument should be
 * specified, otherwise calling {@link com.sun.jdi.VirtualMachine#process()}on the created virtual machine will return <tt>null</tt>.
 ...
 * method. </p>
 * @param connectionThe open connection to the target VM.
 * @param processIf launched, the {@link java.lang.Process} object for
 ...
 * @throws IllegalStateExceptionif the connection is not open
 ...
 * <p> This convenience method works as if by invoking {@link #createVirtualMachine(Connection,Process)} method and
