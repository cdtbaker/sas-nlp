 ...
 * <TR>
 * <TD>{@link ObjectReference#getValue(com.sun.jdi.Field)ObjectReference.getValue(Field)}<TD>- value of a field
 * <TR>
 * <TD>{@link StackFrame#getValue(com.sun.jdi.LocalVariable)StackFrame.getValue(LocalVariable)}<TD>- value of a variable
 * <TR>
 * <TD>{@link VirtualMachine#mirrorOf(double)VirtualMachine.mirrorOf(double)}<TD>- created in the target VM by the JDI client
 * <TR>
 * <TD>{@link com.sun.jdi.event.ModificationWatchpointEvent#valueToBe()ModificationWatchpointEvent.valueToBe()}<TD>- returned with an event
 * </TABLE></BLOCKQUOTE>
 * <P>
