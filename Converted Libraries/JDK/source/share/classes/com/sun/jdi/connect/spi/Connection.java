 ...
 * between a debugger and a target VM. A Connection is created when{@link com.sun.jdi.connect.spi.TransportService TransportService}establishes a connection and successfully handshakes with a target
 ...
 * and any attempt to invoke an I/O operation upon it will cause a{@link ClosedConnectionException} to be thrown. A connection can
 ...
 * @throws ClosedConnectionExceptionIf the connection is closed, or another thread closes
 * the connection while the readPacket is in progress.
 * @throws java.io.IOExceptionIf the length of the packet (as indictaed by the first
 ...
 * @param pktThe packet to write to the target VM.
 * @throws ClosedConnectionExceptionIf the connection is closed, or another thread closes
 * the connection while the write operation is in progress.
 * @throws java.io.IOExceptionIf an I/O error occurs.
 * @throws IllegalArgumentExceptionIf the value of the <tt>length</tt> field is invalid,
 ...
 * calls to {@link #readPacket readPacket} or {@link #writePacketwritePacket} will throw a {@link ClosedConnectionException}.
 * <p> Any thread currently blocked in an I/O operation ({@link #readPacket readPacket} or {@link #writePacket writePacket})
