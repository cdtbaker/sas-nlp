...
public final class FFT {
  ...
  private final static double[] computeTwiddleFactors(  int fftFrameSize,  int sign){
    ...
    }
{
  ...
  private final static void calc(  int fftFrameSize,  double[] data,  int sign,  double[] w){
    final int fftFrameSize2=fftFrameSize << 1;
    int nstep=2;
    if (nstep >= fftFrameSize2)     return;
    int i=nstep - 2;
    if (sign == -1)     calcF4F(fftFrameSize,data,i,nstep,w);
 else     calcF4I(fftFrameSize,data,i,nstep,w);
  }
  private final static void calcF2E(  int fftFrameSize,  double[] data,  int i,  int nstep,  double[] w){
    int jmax=nstep;
  ...
  private final static void calcF4F(  int fftFrameSize,  double[] data,  int i,  int nstep,  double[] w){
    final int fftFrameSize2=fftFrameSize << 1;
      ...
      int iii=i + w_len;
{
  ...
  private final static void calcF4I(  int fftFrameSize,  double[] data,  int i,  int nstep,  double[] w){
    final int fftFrameSize2=fftFrameSize << 1;
    int w_len=w.length >> 1;
    while (nstep < fftFrameSize2) {
      if (nstep << 2 == fftFrameSize2) {
      ...
      int iii=i + w_len;
{
  ...
  private final static void calcF4FE(  int fftFrameSize,  double[] data,  int i,  int nstep,  double[] w){
    final int fftFrameSize2=fftFrameSize << 1;
    int w_len=w.length >> 1;
    while (nstep < fftFrameSize2) {
      int jmax=nstep;
  ...
  private final static void calcF4IE(  int fftFrameSize,  double[] data,  int i,  int nstep,  double[] w){
    final int fftFrameSize2=fftFrameSize << 1;
    int w_len=w.length >> 1;
    while (nstep < fftFrameSize2) {
      int jmax=nstep;
