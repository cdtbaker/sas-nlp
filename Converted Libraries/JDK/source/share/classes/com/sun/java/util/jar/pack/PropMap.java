...
static {
  ...
  int getTime(  String s){
    ...
    if (lval < recentSecondCount * 10 && !"0".equals(sval))     Utils.log.warning("Supplied modtime appears to be seconds rather than milliseconds: " + sval);
  ...
  @Override @SuppressWarnings("unchecked") public void putAll(  Map m){
    theMap.putAll(m);
  }
  ...
  @Override @SuppressWarnings("unchecked") public Comparator<Object> comparator(){
    return (Comparator<Object>)theMap.comparator();
  }
  @Override public SortedMap<Object,Object> subMap(  Object fromKey,  Object toKey){
    return theMap.subMap(fromKey,toKey);
  }
  @Override public SortedMap<Object,Object> headMap(  Object toKey){
    return theMap.headMap(toKey);
  }
  @Override public SortedMap<Object,Object> tailMap(  Object fromKey){
    return theMap.tailMap(fromKey);
  }
  @Override public Object firstKey(){
    return theMap.firstKey();
  }
  @Override public Object lastKey(){
