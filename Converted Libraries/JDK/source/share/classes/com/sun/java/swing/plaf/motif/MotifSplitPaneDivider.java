 ...
 */
  public void paint(  Graphics g){
    ...
    if (getBasicSplitPaneUI().getOrientation() == JSplitPane.HORIZONTAL_SPLIT) {
      ...
      g.setColor(shadowColor);
      g.drawLine(x + 1,y + hThumbHeight - 1,x + hThumbWidth - 1,y + hThumbHeight - 1);
      g.drawLine(x + hThumbWidth - 1,y + 1,x + hThumbWidth - 1,y + hThumbHeight - 2);
    }
 else {
      ...
      g.setColor(shadowColor);
      g.drawLine(x + 1,y + vThumbHeight,x + vThumbWidth,y + vThumbHeight);
      g.drawLine(x + vThumbWidth,y + 1,x + vThumbWidth,y + vThumbHeight - 1);
    }
    super.paint(g);
  }
  /** 
...
private class MotifMouseHandler extends MouseHandler {
    public void mousePressed(    MouseEvent e){
      if (e.getSource() == MotifSplitPaneDivider.this && getDragger() == null && getSplitPane().isEnabled() && isInThumb(e.getX(),e.getY())) {
