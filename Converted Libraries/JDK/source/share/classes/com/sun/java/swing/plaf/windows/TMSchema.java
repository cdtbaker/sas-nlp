 ...
 */
  ...
  private static synchronized void initStates(){
    ...
    stateMap.put(Part.EP_EDITTEXT,new State[]{NORMAL,HOT,SELECTED,DISABLED,FOCUSED,READONLY,ASSIST});
    stateMap.put(Part.BP_PUSHBUTTON,new State[]{NORMAL,HOT,PRESSED,DISABLED,DEFAULTED});
    stateMap.put(Part.BP_RADIOBUTTON,new State[]{UNCHECKEDNORMAL,UNCHECKEDHOT,UNCHECKEDPRESSED,UNCHECKEDDISABLED,CHECKEDNORMAL,CHECKEDHOT,CHECKEDPRESSED,CHECKEDDISABLED});
    stateMap.put(Part.BP_CHECKBOX,new State[]{UNCHECKEDNORMAL,UNCHECKEDHOT,UNCHECKEDPRESSED,UNCHECKEDDISABLED,CHECKEDNORMAL,CHECKEDHOT,CHECKEDPRESSED,CHECKEDDISABLED,MIXEDNORMAL,MIXEDHOT,MIXEDPRESSED,MIXEDDISABLED});
    ...
    stateMap.put(Part.HP_HEADERITEM,new State[]{NORMAL,HOT,PRESSED,SORTEDNORMAL,SORTEDHOT,SORTEDPRESSED,ICONNORMAL,ICONHOT,ICONPRESSED,ICONSORTEDNORMAL,ICONSORTEDHOT,ICONSORTEDPRESSED});
    ...
    stateMap.put(Part.SBP_ARROWBTN,new State[]{UPNORMAL,UPHOT,UPPRESSED,UPDISABLED,DOWNNORMAL,DOWNHOT,DOWNPRESSED,DOWNDISABLED,LEFTNORMAL,LEFTHOT,LEFTPRESSED,LEFTDISABLED,RIGHTNORMAL,RIGHTHOT,RIGHTPRESSED,RIGHTDISABLED,UPHOVER,DOWNHOVER,LEFTHOVER,RIGHTHOVER});
    ...
    State[] frameButtonStates=new State[]{NORMAL,HOT,PUSHED,DISABLED,INACTIVENORMAL,INACTIVEHOT,INACTIVEPUSHED,INACTIVEDISABLED};
    if (ThemeReader.getInt(Control.WINDOW.toString(),Part.WP_CLOSEBUTTON.getValue(),1,Prop.IMAGECOUNT.getValue()) == 10) {
      frameButtonStates=new State[]{NORMAL,HOT,PUSHED,DISABLED,null,INACTIVENORMAL,INACTIVEHOT,INACTIVEPUSHED,INACTIVEDISABLED,null};
    }
    ...
    stateMap.put(Part.MP_BARITEM,new State[]{NORMAL,HOT,PUSHED,DISABLED,DISABLEDHOT,DISABLEDPUSHED});
    stateMap.put(Part.MP_POPUPCHECK,new State[]{CHECKMARKNORMAL,CHECKMARKDISABLED,BULLETNORMAL,BULLETDISABLED});
 ...
 */
  public static enum Prop {  COLOR(Color.class,204),   SIZE(Dimension.class,207),   FLATMENUS(Boolean.class,1001),   BORDERONLY(Boolean.class,2203),   IMAGECOUNT(Integer.class,2401),   BORDERSIZE(Integer.class,2403),   PROGRESSCHUNKSIZE(Integer.class,2411),   PROGRESSSPACESIZE(Integer.class,2412),   TEXTSHADOWOFFSET(Point.class,3402),   NORMALSIZE(Dimension.class,3409),   SIZINGMARGINS(Insets.class,3601),   CONTENTMARGINS(Insets.class,3602),   CAPTIONMARGINS(Insets.class,3603),   BORDERCOLOR(Color.class,3801),   FILLCOLOR(Color.class,3802),   TEXTCOLOR(Color.class,3803),   TEXTSHADOWCOLOR(Color.class,3818),   BGTYPE(Integer.class,4001),   TEXTSHADOWTYPE(Integer.class,4010),   TRANSITIONDURATIONS(Integer.class,6000);   private final Class type;
  private final int value;
 ...
 */
  public static enum TypeEnum {  BT_IMAGEFILE(Prop.BGTYPE,"imagefile",0),   BT_BORDERFILL(Prop.BGTYPE,"borderfill",1),   TST_NONE(Prop.TEXTSHADOWTYPE,"none",0),   TST_SINGLE(Prop.TEXTSHADOWTYPE,"single",1),   TST_CONTINUOUS(Prop.TEXTSHADOWTYPE,"continuous",2);   private TypeEnum(  Prop prop,  String enumName,  int value){
    this.prop=prop;
