 ...
 */
  public static synchronized LiteralEntry getLiteralEntry(  Comparable value){
    ...
    if (e == null) {
      if (value instanceof String)       e=new StringEntry(getUtf8Entry((String)value));
 else       e=new NumberEntry((Number)value);
...
public static abstract class Entry implements Comparable {
    ...
    public String toString(){
      ...
      if (verbose() > 4) {
        if (valueHash != 0)         valuePrint+=" hash=" + valueHash;
...
public static class DescriptorEntry extends Entry {
  ...
  public int compareTo(  Object o){
    ...
    if (x == 0) {
      ...
      if (x == 0)       x=this.nameRef.compareTo(that.nameRef);
    }
    return x;
  }
  public String stringValue(){
...
public static class MemberEntry extends Entry {
  ...
  public int compareTo(  Object o){
    ...
    if (x == 0) {
      ...
      if (x == 0)       x=this.descRef.compareTo(that.descRef);
    }
    return x;
  }
  public String stringValue(){
...
if (e1 == e || e1 == null) return probe;
probe+=stride;
if (probe >= size) probe-=size;
}
}
private void initializeIndex(){
if (verbose() > 2) System.out.println("initialize Index " + debugName + " ["+ size()+ "]");
...
if (verbose() > 2) System.out.println("sorted " + ix.dumpString());
}
/** 
...
if (idx >= 0) idx+=untypedFirstIndexByTag[tag];
return idx;
}
...
indexUntyped=null;
if (indexByTagAndClass != null) indexByTagAndClass[tag]=null;
}
/** 
...
if (indexByTagAndClass == null) indexByTagAndClass=new Index[CONSTANT_Limit][];
...
if (e.equals(methodRef)) return ord;
if (e.descRef.nameRef.equals(nameRef)) ord++;
}
...
static final byte TAGS_IN_ORDER[]={CONSTANT_Utf8,CONSTANT_Integer,CONSTANT_Float,CONSTANT_Long,CONSTANT_Double,CONSTANT_String,CONSTANT_Class,CONSTANT_Signature,CONSTANT_NameandType,CONSTANT_Fieldref,CONSTANT_Methodref,CONSTANT_InterfaceMethodref};
