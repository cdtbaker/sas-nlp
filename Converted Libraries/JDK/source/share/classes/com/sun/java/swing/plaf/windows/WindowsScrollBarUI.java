 ...
 * @since 1.6
 */
  @Override protected ArrowButtonListener createArrowButtonListener(){
    if (XPStyle.isVista()) {
  ...
  protected void paintThumb(  Graphics g,  JComponent c,  Rectangle thumbBounds){
    ...
    if (xp != null) {
      ...
      if (!sb.isEnabled()) {
        ...
        if ((incrButton != null && incrButton.getModel().isRollover()) || (decrButton != null && decrButton.getModel().isRollover())) {
          state=State.HOVER;
        }
      }
...
private class WindowsArrowButton extends BasicArrowButton {
    ...
    public void paint(    Graphics g){
      ...
      if (xp != null) {
        ...
        State state=null;
        boolean jointRollover=XPStyle.isVista() && (isThumbRollover() || (this == incrButton && decrButton.getModel().isRollover()) || (this == decrButton && incrButton.getModel().isRollover()));
...
g.drawImage(image,xCounter,yCounter,xCounter + width,yCounter + height,xOffset,yOffset,xOffset + width,yOffset + height,null);
if (yOffset != 0) {
yCounter-=yOffset;
yOffset=0;
}
