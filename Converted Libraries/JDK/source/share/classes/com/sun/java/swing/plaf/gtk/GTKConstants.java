 ...
 */
  public enum IconSize {  INVALID,   MENU,   SMALL_TOOLBAR,   LARGE_TOOLBAR,   BUTTON,   DND,   DIALOG}
  /** 
 * Java representation of native GtkTextDirection enum
 */
  public enum TextDirection {  NONE,   LTR,   RTL}
  /** 
 ...
 */
  public enum StateType {  NORMAL,   ACTIVE,   PRELIGHT,   SELECTED,   INSENSITIVE}
  /** 
 * Java representation of native GtkExpanderStyle enum
 */
  public enum ExpanderStyle {  COLLAPSED,   SEMI_COLLAPSED,   SEMI_EXPANDED,   EXPANDED}
  /** 
 * Java representation of native GtkPositionType enum
 */
  public enum PositionType {  LEFT,   RIGHT,   TOP,   BOTTOM}
  /** 
