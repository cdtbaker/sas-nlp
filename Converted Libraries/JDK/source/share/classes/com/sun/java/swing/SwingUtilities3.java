 ...
 */
  ...
  private static final Map<Container,Boolean> vsyncedMap=Collections.synchronizedMap(new WeakHashMap<Container,Boolean>());
  /** 
...
private static class EventQueueDelegateFromMap implements EventQueueDelegate.Delegate {
    ...
    @SuppressWarnings("unchecked") public EventQueueDelegateFromMap(    Map<String,Map<String,Object>> objectMap){
    ...
    @Override public void afterDispatch(    AWTEvent event,    Object handle) throws InterruptedException {
    ...
    @Override public Object beforeDispatch(    AWTEvent event) throws InterruptedException {
    ...
    @Override public AWTEvent getNextEvent(    EventQueue eventQueue) throws InterruptedException {
