...
public class WindowsTableHeaderUI extends BasicTableHeaderUI {
  ...
  @Override protected void rolloverColumnUpdated(  int oldColumn,  int newColumn){
    if (XPStyle.getXP() != null) {
...
private class XPDefaultRenderer extends DefaultTableCellHeaderRenderer {
    ...
    public Component getTableCellRendererComponent(    JTable table,    Object value,    boolean isSelected,    boolean hasFocus,    int row,    int column){
      ...
      contentRight+=5;
      Icon sortIcon;
      if (WindowsLookAndFeel.isOnVista() && ((sortIcon=getIcon()) instanceof javax.swing.plaf.UIResource || sortIcon == null)) {
        contentTop+=1;
        setIcon(null);
        sortIcon=null;
...
if (draggedColumn != null && column == SwingUtilities2.convertColumnIndexToView(header.getColumnModel(),draggedColumn.getModelIndex())) {
state=State.PRESSED;
}
