...
static {
    try {
      serverSocketCtor=(Constructor<ServerSocket>)ServerSocket.class.getDeclaredConstructor(SocketImpl.class);
 ...
 * @return  a new Socket
 * @throws UnsupportedOperationExceptionIf SDP is not supported
 ...
 * @throws UnsupportedOperationExceptionIf SDP is not supported or not supported by the default selector
 * provider
 * @throws IOExceptionIf an I/O error occurs.
 */
