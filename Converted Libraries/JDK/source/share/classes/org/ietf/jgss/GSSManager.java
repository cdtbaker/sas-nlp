 ...
 * implementing the following three GSS-API interfaces: {@link GSSName GSSName}, {@link GSSCredential GSSCredential}, and {@link GSSContext GSSContext}. It also has methods to query for the list
 * of available mechanisms and the nametypes that each mechanism
 * supports.<p>
 * An instance of the default <code>GSSManager</code> subclass
 * may be obtained through the static method {@link #getInstance()getInstance}, but applications are free to instantiate other subclasses
 ...
 * usage:  {@link #addProviderAtFront(Provider,Oid) addProviderAtFront} and{@link #addProviderAtEnd(Provider,Oid) addProviderAtEnd}. These methods
 ...
 * through this GSSManager. The default GSSManager obtained from the{@link #getInstance() getInstance()} method includes the Oid
 ...
 * the returned list will contain at least the following nametypes:{@link GSSName#NT_HOSTBASED_SERVICE GSSName.NT_HOSTBASED_SERVICE},{@link GSSName#NT_EXPORT_NAME GSSName.NT_EXPORT_NAME}, and the
 ...
 * returned in this list when the indicated nametype is one of{@link GSSName#NT_HOSTBASED_SERVICE GSSName.NT_HOSTBASED_SERVICE},{@link GSSName#NT_EXPORT_NAME GSSName.NT_EXPORT_NAME}, or
 ...
 * the overloaded form of this method {@link #createName(byte[],Oid) createName}.
 ...
 * @throws GSSException containing the following
 * major error codes:{@link GSSException#BAD_NAMETYPE GSSException.BAD_NAMETYPE},{@link GSSException#BAD_NAME GSSException.BAD_NAME},{@link GSSException#BAD_MECH GSSException.BAD_MECH},{@link GSSException#FAILURE GSSException.FAILURE}
 */
 ...
 * a utility that does the equivalent of two steps: the {@link #createName(String,Oid) createName} and then also the {@link GSSName#canonicalize(Oid) GSSName.canonicalize}.
 * @param nameStr the string representing a printable form of the name to
 * create.
 * @param nameType the Oid specifying the namespace of the printable name
 * supplied. <code>null</code> can be used to specify
 ...
 * utility that does the equivalent of two steps: the {@link #createName(byte[],Oid) createName} and then also {@link GSSName#canonicalize(Oid) GSSName.canonicalize}.
 * @param name the byte array containing the name to create
 * @param nameType the Oid specifying the namespace of the name supplied
 * in the byte array. <code>null</code> can be used to specify that a
 * mechanism specific default syntax should be assumed by each mechanism
 ...
 * per-mechanism basis. A failed permission check might cause a {@link java.lang.SecurityException SecurityException} to be thrown from
 * this method.
 * @param usage The intended usage for this credential object. The value
 * of this parameter must be one of:{@link GSSCredential#INITIATE_AND_ACCEPTGSSCredential.INITIATE_AND_ACCEPT},{@link GSSCredential#ACCEPT_ONLY GSSCredential.ACCEPT_ONLY}, and{@link GSSCredential#INITIATE_ONLY GSSCredential.INITIATE_ONLY}.
 * @return a GSSCredential of the requested type.
 * @see GSSCredential
 * @throws GSSException containing the following
 * major error codes:{@link GSSException#BAD_MECH GSSException.BAD_MECH},{@link GSSException#BAD_NAMETYPE GSSException.BAD_NAMETYPE},{@link GSSException#BAD_NAME GSSException.BAD_NAME},{@link GSSException#CREDENTIALS_EXPIREDGSSException.CREDENTIALS_EXPIRED},{@link GSSException#NO_CRED GSSException.NO_CRED},{@link GSSException#FAILURE GSSException.FAILURE}
 */
 ...
 * underlying mechanisms, thus applications should be prepared to call{@link GSSCredential#getRemainingLifetime() getRemainingLifetime}on the returned credential.<p>
 ...
 * valid.  Use {@link GSSCredential#INDEFINITE_LIFETIMEGSSCredential.INDEFINITE_LIFETIME} to request that the credentials
 * have the maximum permitted lifetime.  Use {@link GSSCredential#DEFAULT_LIFETIME GSSCredential.DEFAULT_LIFETIME} to
 ...
 * credentials succeeded, the caller should use the {@link GSSCredential#getMechs() GSSCredential.getMechs} method.<p>
 * GSS-API mechanism providers must impose a local access-control
 * policy on callers to prevent unauthorized callers from acquiring
 * credentials to which they are not entitled. The kinds of permissions
 * needed by different mechanism providers will be documented on a
 ...
 * Non-default values for lifetime cannot always be honored by the
 * underlying mechanism, thus applications should be prepared to call{@link GSSContext#getLifetime() getLifetime} on the returned
 * context.<p>
 ...
 * context. Use {@link GSSContext#INDEFINITE_LIFETIMEGSSContext.INDEFINITE_LIFETIME} to request that the context have the
 * maximum permitted lifetime. Use {@link GSSContext#DEFAULT_LIFETIMEGSSContext.DEFAULT_LIFETIME} to request a default lifetime for the
 * context.
 * @return an unestablished GSSContext
 * @see GSSContext
 * @throws GSSException containing the following
 * major error codes:{@link GSSException#NO_CRED GSSException.NO_CRED}{@link GSSException#CREDENTIALS_EXPIREDGSSException.CREDENTIALS_EXPIRED}{@link GSSException#BAD_NAMETYPE GSSException.BAD_NAMETYPE}{@link GSSException#BAD_MECH GSSException.BAD_MECH}{@link GSSException#FAILURE GSSException.FAILURE}
 */
 ...
 * might cause a {@link java.lang.SecurityException SecurityException}to be thrown from this method.
 * @param myCred the credentials for the acceptor.  Use
 * <code>null</code> to act as a default acceptor principal.
 * @return an unestablished GSSContext
 * @see GSSContext
 * @throws GSSException containing the following
 * major error codes:{@link GSSException#NO_CRED GSSException.NO_CRED}{@link GSSException#CREDENTIALS_EXPIREDGSSException.CREDENTIALS_EXPIRED}{@link GSSException#BAD_MECH GSSException.BAD_MECH}{@link GSSException#FAILURE GSSException.FAILURE}
 */
 ...
 * the {@link GSSContext#isTransferable() GSSContext.isTransferable}will indicate if the context is transferable. Calling this method in
 ...
 * permission check might cause a {@link java.lang.SecurityExceptionSecurityException} to be thrown from this method.
 * @param interProcessToken the token previously emitted from the
 * export method.
 * @return the previously established GSSContext
 * @see GSSContext
 * @throws GSSException containing the following
 * major error codes:{@link GSSException#NO_CONTEXT GSSException.NO_CONTEXT},{@link GSSException#DEFECTIVE_TOKEN GSSException.DEFECTIVE_TOKEN},{@link GSSException#UNAVAILABLE GSSException.UNAVAILABLE},{@link GSSException#UNAUTHORIZED GSSException.UNAUTHORIZED},{@link GSSException#FAILURE GSSException.FAILURE}
 */
 ...
 * @throws GSSException containing the following
 * major error codes:{@link GSSException#UNAVAILABLE GSSException.UNAVAILABLE},{@link GSSException#FAILURE GSSException.FAILURE}
 */
