 ...
 */
  public void setIcon(  boolean b) throws PropertyVetoException {
    ...
    if (b)     fireInternalFrameEvent(InternalFrameEvent.INTERNAL_FRAME_ICONIFIED);
 else     fireInternalFrameEvent(InternalFrameEvent.INTERNAL_FRAME_DEICONIFIED);
  }
  /** 
 ...
 */
  public void setSelected(  boolean selected) throws PropertyVetoException {
    ...
    if (isSelected)     fireInternalFrameEvent(InternalFrameEvent.INTERNAL_FRAME_ACTIVATED);
 else     fireInternalFrameEvent(InternalFrameEvent.INTERNAL_FRAME_DEACTIVATED);
    repaint();
  }
  /** 
