 ...
 * @see #getModel
 * @beaninfodescription: The menu's model
 * bound: true
 * expert: true
 * hidden: true
 */
 ...
 * the menu
 * @beaninfodescription: When the menu is selected, its popup child is shown.
 * expert: true
 * hidden: true
 */
 ...
 * false to hide it
 * @beaninfodescription: The popup menu's visibility
 * expert: true
 * hidden: true
 */
 ...
 * is less than 0
 * @beaninfodescription: The delay between menu selection and making the popup menu visible
 * expert: true
 */
 ...
 */
  public MenuElement[] getSubElements(){
    if (popupMenu == null)     return new MenuElement[0];
 else {
 ...
 * Use <code>setMnemonic</code> instead
 * @beaninfodescription: The keystroke combination which will invoke the JMenuItem's
