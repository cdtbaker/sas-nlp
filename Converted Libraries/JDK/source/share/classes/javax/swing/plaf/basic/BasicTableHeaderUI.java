      ...
      if (resizingColumn != null) {
        ...
        if (0 <= newColumnIndex && newColumnIndex < cm.getColumnCount()) {
          ...
          if (Math.abs(draggedDistance) > (width / 2)) {
            ...
            int selectedIndex=SwingUtilities2.convertColumnIndexToModel(header.getColumnModel(),getSelectedColumnIndex());
            cm.moveColumn(columnIndex,newColumnIndex);
            selectColumn(SwingUtilities2.convertColumnIndexToView(header.getColumnModel(),selectedIndex),false);
            return;
          }
        }
...
private static class Actions extends UIAction {
    ...
    private boolean maybeMoveColumn(    boolean leftArrow,    JTableHeader th,    BasicTableHeaderUI ui,    boolean doIt){
