 ...
 */
  ...
  protected JButton createArrowButton(){
    ...
    JButton button=new MetalComboBoxButton(comboBox,new MetalComboBoxIcon(),iconOnly,currentValuePane,listBox);
  ...
  public void layoutComboBox(  Container parent,  MetalComboBoxLayoutManager manager){
    ...
    if (arrowButton != null) {
      if (MetalLookAndFeel.usingOcean()) {
        ...
        arrowButton.setBounds(MetalUtils.isLeftToRight(comboBox) ? (comboBox.getWidth() - insets.right - buttonWidth) : insets.left,insets.top,buttonWidth,comboBox.getHeight() - insets.top - insets.bottom);
      }
 else {
        Insets insets=comboBox.getInsets();
 ...
 * @deprecated As of Java 2 platform v1.4.
 */
@Deprecated public class MetalComboPopup extends BasicComboPopup {
