...
synchronized (SynthLookAndFeel.class) {
      ...
      if (!multipleApps && context != lastContext && lastContext != null) {
        multipleApps=true;
      }
      lastFactory=cache;
      lastContext=context;
 ...
 */
  @Override public UIDefaults getDefaults(){
    ...
    table.put("html.pendingImage",SwingUtilities2.makeIcon(getClass(),BasicLookAndFeel.class,"icons/image-delayed.png"));
    table.put("html.missingImage",SwingUtilities2.makeIcon(getClass(),BasicLookAndFeel.class,"icons/image-failed.png"));
