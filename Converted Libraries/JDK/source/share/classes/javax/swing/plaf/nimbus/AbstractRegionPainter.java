 ...
 * @inheritDoc
 */
  @Override public final void paint(  Graphics2D g,  JComponent c,  int w,  int h){
    if (w <= 0 || h <= 0)     return;
 ...
 * @throws IllegalArgumentExceptionif {@code x < 0} or {@code x > 3}
 */
 ...
 * @throws IllegalArgumentExceptionif {@code y < 0} or {@code y > 3}
 */
 ...
 * @throws NullPointerExceptionif {@code midpoints} array is null,
 * or {@code colors} array is null,
 * @throws IllegalArgumentExceptionif start and end points are the same points,
 ...
 * @throws NullPointerExceptionif {@code midpoints} array is null,
 * or {@code colors} array is null
 * @throws IllegalArgumentExceptionif {@code r} is non-positive,
 * or {@code midpoints.length != colors.length},
 * or {@code colors} is less than 2 in size,
 * or a {@code midpoints} value is less than 0.0 or greater than 1.0,
 * or the {@code midpoints} are not provided in strictly increasing order
...
protected static class PaintContext {
    protected static enum CacheMode {    NO_CACHING,     FIXED_SIZES,     NINE_SQUARE_SCALE}
