 ...
 */
  @Override public void initialize(){
    ...
    setStyleFactory(new SynthStyleFactory(){
      @Override public SynthStyle getStyle(      JComponent c,      Region r){
 ...
 * @since 1.7
 */
  @Override protected boolean shouldUpdateStyleOnEvent(  PropertyChangeEvent ev){
 ...
 */
  ...
  @Override public Icon getDisabledIcon(  JComponent component,  Icon icon){
