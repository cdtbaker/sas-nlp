 ...
 * used. This method passes the value of {@codeisNativeLookAndFeel()} as the last argument to {@code loadSystemColors}.
 ...
 * @param useNative whether the color is obtained from {@code SystemColor}or {@code Color.decode}
 * @throws NullPointerException if {@code systemColors} is {@code null}; or{@code systemColors} is not empty, and {@code table} is{@code null}; or one of the
 ...
 * @throws ArrayIndexOutOfBoundsException if {@code useNative} is{@code false} and {@code systemColors.length} is odd
 ...
 * @return      an {@code Action} used to play the source, or {@code null}if {@code key} is {@code null}
 * @see #playSound(Action)
 * @since 1.4
 */
 ...
 * ignored
 * @throws ClassCastException if {@code audioAction} is {@code non-null}and the value of the default {@code "AuditoryCues.playList"}is not an {@code Object[]}
 * @since 1.4
 */
