 ...
 * @inheritDoc
 */
@Override protected void setRolloverTab(int index){
...
updateTabContext(tabIndex,isSelected,isSelected && selectedTabIsPressed,(getRolloverTab() == tabIndex),(getFocusIndex() == tabIndex));
 ...
 * @inheritDoc
 */
@Override protected int calculateMaxTabHeight(int tabPlacement){
 ...
 * @inheritDoc
 */
@Override protected int calculateMaxTabWidth(int tabPlacement){
FontMetrics metrics=getFontMetrics(tabContext.getStyle().getFont(tabContext));
int tabCount=tabPane.getTabCount();
int result=0;
for (int i=0; i < tabCount; i++) {
 ...
 * @inheritDoc
 */
@Override protected FontMetrics getFontMetrics(){
...
@Override public void calculateLayoutInfo(){
