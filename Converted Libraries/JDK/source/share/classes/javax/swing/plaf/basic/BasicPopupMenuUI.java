...
synchronized (MOUSE_GRABBER_KEY) {
    ...
    void grabWindow(    MenuElement[] newPath){
      ...
      grabbedWindow=invoker instanceof Window ? (Window)invoker : SwingUtilities.getWindowAncestor(invoker);
...
case MouseEvent.MOUSE_PRESSED:
      ...
      if (!(src instanceof JComponent) || !(((JComponent)src).getClientProperty("doNotCancelPopup") == BasicComboBoxUI.HIDE_POPUP_KEY)) {
        cancelPopupMenu();
