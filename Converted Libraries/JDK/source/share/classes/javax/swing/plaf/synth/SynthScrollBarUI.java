 ...
 * @inheritDoc
 */
  @Override public boolean getSupportsAbsolutePositioning(){
 ...
 */
  protected void paintTrack(  SynthContext context,  Graphics g,  Rectangle trackBounds){
    ...
    context.getPainter().paintScrollBarTrackBackground(context,g,trackBounds.x,trackBounds.y,trackBounds.width,trackBounds.height,scrollbar.getOrientation());
    context.getPainter().paintScrollBarTrackBorder(context,g,trackBounds.x,trackBounds.y,trackBounds.width,trackBounds.height,scrollbar.getOrientation());
  }
  /** 
 ...
 */
  protected void paintThumb(  SynthContext context,  Graphics g,  Rectangle thumbBounds){
    ...
    context.getPainter().paintScrollBarThumbBackground(context,g,thumbBounds.x,thumbBounds.y,thumbBounds.width,thumbBounds.height,orientation);
    context.getPainter().paintScrollBarThumbBorder(context,g,thumbBounds.x,thumbBounds.y,thumbBounds.width,thumbBounds.height,orientation);
  }
  /** 
 ...
 */
  @Override public Dimension getPreferredSize(  JComponent c){
    ...
    return (scrollbar.getOrientation() == JScrollBar.VERTICAL) ? new Dimension(scrollBarWidth + insets.left + insets.right,48) : new Dimension(48,scrollBarWidth + insets.top + insets.bottom);
  }
  /** 
 * @inheritDoc
 */
