 ...
 */
  InputMap getInputMap(  int condition,  JComponent c){
    if (condition == JComponent.WHEN_FOCUSED) {
      BasicButtonUI ui=(BasicButtonUI)BasicLookAndFeel.getUIOfType(((AbstractButton)c).getUI(),BasicButtonUI.class);
      if (ui != null) {
 ...
 */
  ...
  public void focusGained(  FocusEvent e){
    ...
    if (b instanceof JButton && ((JButton)b).isDefaultCapable()) {
      ...
      if (root != null) {
        BasicButtonUI ui=(BasicButtonUI)BasicLookAndFeel.getUIOfType(b.getUI(),BasicButtonUI.class);
...
private static class Actions extends UIAction {
    ...
    public boolean isEnabled(    Object sender){
      if (sender != null && (sender instanceof AbstractButton) && !((AbstractButton)sender).getModel().isEnabled()) {
        return false;
      }
 else {
        return true;
