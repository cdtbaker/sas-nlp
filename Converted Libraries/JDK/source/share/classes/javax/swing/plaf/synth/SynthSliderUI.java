 ...
 * @inheritDoc
 */
  @Override protected TrackListener createTrackListener(  JSlider s){
 ...
 * @inheritDoc
 */
  @Override protected void calculateGeometry(){
    calculateThumbSize();
    layout();
 ...
 * @inheritDoc
 */
  @Override protected int xPositionForValue(  int value){
 ...
 * @inheritDoc
 */
  @Override protected int yPositionForValue(  int value,  int trackY,  int trackHeight){
    int min=slider.getMinimum();
    int max=slider.getMaximum();
 ...
 * @inheritDoc
 */
  @Override public int valueForYPosition(  int yPos){
    int value;
    int minValue=slider.getMinimum();
    int maxValue=slider.getMaximum();
 ...
 * @inheritDoc
 */
  @Override public int valueForXPosition(  int xPos){
    int value;
    int minValue=slider.getMinimum();
    int maxValue=slider.getMaximum();
    int trackLeft=trackRect.x + thumbRect.width / 2 + trackBorder;
 ...
 * @inheritDoc
 */
  @Override protected void recalculateIfInsetsChanged(){
    SynthContext context=getContext(slider);
