 ...
 * @see Insets
 * @beaninfodescription: The margin between the tool bar's border and contents
 * bound: true
 * expert: true
 */
 ...
 * @see #isBorderPainted
 * @beaninfodescription: Does the tool bar paint its borders?
 * bound: true
 * expert: true
 */
 ...
 * @see #isFloatable
 * @beaninfodescription: Can the tool bar be made to float by the user?
 * bound: true
 * preferred: true
 */
 ...
 * <code>HORIZONTAL</code> nor <code>VERTICAL</code>
 * @see #getOrientation
 * @beaninfodescription: The current orientation of the tool bar
 * bound: true
 * preferred: true
...
public void propertyChange(PropertyChangeEvent e){
  ...
  if (name.equals("orientation")) {
    ...
    if (o == JToolBar.VERTICAL)     lm=new BoxLayout(JToolBar.this,BoxLayout.PAGE_AXIS);
 else {
      lm=new BoxLayout(JToolBar.this,BoxLayout.LINE_AXIS);
    }
  }
