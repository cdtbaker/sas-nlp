 ...
 */
  public JSplitPane(){
    this(JSplitPane.HORIZONTAL_SPLIT,UIManager.getBoolean("SplitPane.continuousLayout"),new JButton(UIManager.getString("SplitPane.leftButtonText")),new JButton(UIManager.getString("SplitPane.rightButtonText")));
  }
  /** 
 ...
 * @param comp the <code>Component</code> to display in that position
 * @beaninfodescription: The component above, or to the left of the divider.
 */
 ...
 * @param comp the <code>Component</code> to display in that position
 * @beaninfodescription: The component below, or to the right of the divider.
 */
 ...
 * or > 1.0
 * @beaninfodescription: The location of the divider.
 */
 ...
 * <code>null</code>
 * @beaninfodescription: The minimum location of the divider from the L&F.
 */
