 ...
 * inserted or removed before the {@code Position} object's location, then the{@code Position} increments or decrements its offset, respectively,
 ...
 * <p>{@code Position} with an offset of 0 is a special case. It never changes its
