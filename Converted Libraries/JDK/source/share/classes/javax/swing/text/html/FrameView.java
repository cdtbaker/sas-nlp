 ...
 */
  public void paint(  Graphics g,  Shape allocation){
    ...
    if (host != null && htmlPane != null && htmlPane.isEditable() != ((JTextComponent)host).isEditable()) {
 ...
 */
  public void hyperlinkUpdate(  HyperlinkEvent evt){
    ...
    if (e.getEventType() == HyperlinkEvent.EventType.ACTIVATED) {
      ...
      if (!c.isEditable()) {
        c.fireHyperlinkUpdate(new HTMLFrameHyperlinkEvent(c,e.getEventType(),e.getURL(),e.getDescription(),getElement(),e.getInputEvent(),target));
      }
    }
  }
  /** 
