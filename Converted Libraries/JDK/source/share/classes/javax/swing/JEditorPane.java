 ...
 * @see #getPage
 * @beaninfodescription: the URL used to set content
 * bound: true
 * expert: true
 */
 ...
 * support
 * @see #getContentType
 * @beaninfodescription: the type of content
 ...
 * @see #getEditorKit
 * @beaninfodescription: the currently installed kit for handling content
 * bound: true
 * expert: true
 */
