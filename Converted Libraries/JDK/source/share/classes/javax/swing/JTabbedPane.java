 ...
 */
  @Transient public Component getSelectedComponent(){
 ...
 */
  public void removeTabAt(  int index){
    ...
    if (accessibleContext != null) {
      if (index == selected) {
        pages.get(index).firePropertyChange(AccessibleContext.ACCESSIBLE_STATE_PROPERTY,AccessibleState.SELECTED,null);
        oldName=accessibleContext.getAccessibleName();
      }
