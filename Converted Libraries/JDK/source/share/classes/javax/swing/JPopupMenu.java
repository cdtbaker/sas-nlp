 ...
 * @see SingleSelectionModel
 * @beaninfodescription: The selection model for the popup menu
 * expert: true
 */
 ...
 * @beaninfodescription: Determines whether lightweight popups are used when possible
 * expert: true
 ...
 * @see #setLabel
 * @beaninfodescription: The label for the popup menu.
 * bound: true
 */
 ...
 * in the screen's coordinate space
 * @beaninfodescription: The location of the popup menu.
 */
 ...
 * menu is displayed
 * @beaninfodescription: The invoking component for the popup menu
 * expert: true
 */
 ...
 * of this component.
 * @beaninfodescription: The size of the popup menu
 */
 ...
 * @beaninfodescription: The selected component on the popup menu
 * expert: true
 * hidden: true
 */
 ...
 * @see #isBorderPainted
 * @beaninfodescription: Is the border of the popup menu painted
 */
...
for (i=0; i < c; i++) {
m=getComponent(i);
if (m instanceof MenuElement) tmp.addElement((MenuElement)m);
}
