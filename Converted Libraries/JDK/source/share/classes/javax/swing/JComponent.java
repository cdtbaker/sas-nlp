 ...
 */
  public void paint(  Graphics g){
    ...
    try {
      ...
      int bw, bh;
      boolean printing=getFlag(IS_PRINTING);
      if (!printing && repaintManager.isDoubleBufferingEnabled() && !getFlag(ANCESTOR_USING_BUFFER)&& isDoubleBuffered()&& (getFlag(IS_REPAINTING) || repaintManager.isPainting())) {
 ...
 * @see ComponentUI
 */
  @Transient public Dimension getPreferredSize(){
 ...
 * @see ComponentUI
 */
  @Transient public Dimension getMaximumSize(){
    if (isMaximumSizeSet()) {
 ...
 * @see ComponentUI
 */
  @Transient public Dimension getMinimumSize(){
    if (isMinimumSizeSet()) {
 ...
 * @see #getAlignmentY
 * @beaninfodescription: The preferred vertical alignment of the component.
 */
 ...
 * @see #getAlignmentX
 * @beaninfodescription: The preferred horizontal alignment of the component.
 */
 ...
 */
  private void registerWithKeyboardManager(  boolean onlyIfNew){
    ...
    KeyStroke[] strokes;
    Hashtable<KeyStroke,KeyStroke> registered=(Hashtable)getClientProperty(WHEN_IN_FOCUSED_WINDOW_BINDINGS);
    if (inputMap != null) {
 ...
 * make it invisible
 * @beaninfoattribute: visualUpdate true
 */
...
ksE=KeyStroke.getKeyStroke(e.getExtendedKeyCode(),e.getModifiers(),(pressed ? false : true));
}
}
...
if (parent instanceof JComponent) {
if (ksE != null && ((JComponent)parent).processKeyBinding(ksE,e,WHEN_ANCESTOR_OF_FOCUSED_COMPONENT,pressed)) return true;
if (((JComponent)parent).processKeyBinding(ks,e,WHEN_ANCESTOR_OF_FOCUSED_COMPONENT,pressed)) return true;
}
...
AccessibleJComponent.this.firePropertyChange(AccessibleContext.ACCESSIBLE_CHILD_PROPERTY,null,c.getAccessibleContext());
}
}
public void componentRemoved(ContainerEvent e){
Component c=e.getChild();
if (c != null && c instanceof Accessible) {
AccessibleJComponent.this.firePropertyChange(AccessibleContext.ACCESSIBLE_CHILD_PROPERTY,c.getAccessibleContext(),null);
}
}
}
/** 
...
super.setFocusTraversalKeys(KeyboardFocusManager.FORWARD_TRAVERSAL_KEYS,(Set)value);
}
}
 else if (propertyName == "focusTraversalKeysBackward") {
if (!getFlag(FOCUS_TRAVERSAL_KEYS_BACKWARD_SET)) {
super.setFocusTraversalKeys(KeyboardFocusManager.BACKWARD_TRAVERSAL_KEYS,(Set)value);
}
}
 else {
