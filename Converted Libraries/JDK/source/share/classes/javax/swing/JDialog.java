 ...
 * @beaninfoattribute: isContainer true
 ...
 * @throws IllegalArgumentExceptionif the {@code owner} is not an instance of {@link java.awt.Dialog Dialog}or {@link java.awt.Frame Frame}
 * @throws IllegalArgumentExceptionif the {@code owner}'s {@code GraphicsConfiguration} is not from a screen device
 * @throws HeadlessExceptionwhen {@code GraphicsEnvironment.isHeadless()} returns {@code true}
 * @see java.awt.GraphicsEnvironment#isHeadless
 * @see JComponent#getDefaultLocale
 * @since 1.6
 */
 ...
 * @throws IllegalArgumentExceptionif the {@code owner}'s {@code GraphicsConfiguration} is not from a screen device
 * @throws HeadlessExceptionwhen {@code GraphicsEnvironment.isHeadless()} returns {@code true}
 * @throws SecurityExceptionif the calling thread does not have permission to create modal dialogs
 ...
 * @return true if {@code add} and {@code setLayout}are fowarded; false otherwise
 * @see #addImpl
 * @see #setLayout
 * @see #setRootPaneCheckingEnabled
 * @see javax.swing.RootPaneContainer
 ...
 * @param enabled  true if {@code add} and {@code setLayout}are forwarded, false if they should operate directly on the{@code JDialog}.
 * @see #addImpl
 * @see #setLayout
 * @see #isRootPaneCheckingEnabled
 * @see javax.swing.RootPaneContainer
