 ...
 * @since 1.3
 */
  @Transient public TableCellRenderer getDefaultRenderer(){
  ...
  public String getToolTipText(  MouseEvent event){
    ...
    if ((column=columnAtPoint(p)) != -1) {
      ...
      if (component instanceof JComponent) {
        ...
        newEvent=new MouseEvent(component,event.getID(),event.getWhen(),event.getModifiers(),p.x,p.y,event.getXOnScreen(),event.getYOnScreen(),event.getClickCount(),event.isPopupTrigger(),MouseEvent.NOBUTTON);
 ...
 * @exception IllegalArgumentExceptionif <code>newModel</code> is <code>null</code>
 * @see #getColumnModel
 * @beaninfobound: true
 ...
 */
      ...
      private AccessibleContext getCurrentAccessibleContext(){
        ...
        if (tcm != null) {
          ...
          Component c=renderer.getTableCellRendererComponent(JTableHeader.this.getTable(),aColumn.getHeaderValue(),false,false,-1,column);
      ...
      private Component getCurrentComponent(){
        ...
        if (tcm != null) {
          ...
          return renderer.getTableCellRendererComponent(JTableHeader.this.getTable(),aColumn.getHeaderValue(),false,false,-1,column);
        }
 else {
          return null;
        }
