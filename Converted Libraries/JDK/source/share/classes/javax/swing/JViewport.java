      ...
      if (!waitingForRepaint && isBlitting() && canUseWindowBlitter()) {
        ...
        if (dirty == null || !dirty.contains(jview.getVisibleRect())) {
          ...
          try {
            ...
            g.setClip(0,0,getWidth(),Math.min(getHeight(),jview.getHeight()));
 ...
 */
  @Transient public Dimension getExtentSize(){
    return getSize();
  }
  /** 
 ...
 */
  public void repaint(  long tm,  int x,  int y,  int w,  int h){
    ...
    if (parent != null)     parent.repaint(tm,x + getX(),y + getY(),w,h);
 else     super.repaint(tm,x,y,w,h);
  }
  /** 
