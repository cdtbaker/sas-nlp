 ...
 */
  public static void setCurrentManager(  FocusManager aFocusManager) throws SecurityException {
    KeyboardFocusManager toSet=(aFocusManager instanceof DelegatingDefaultFocusManager) ? ((DelegatingDefaultFocusManager)aFocusManager).getDelegate() : aFocusManager;
