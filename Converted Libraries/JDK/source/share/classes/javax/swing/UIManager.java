 ...
 * given locale.  If the value for{@code key} is not a {@code String}, {@code null} is returned.
 * @param key  an <code>Object</code> specifying the string
 * @param c {@code Component} used to determine the locale;{@code null} implies the default locale as
 ...
 * @param value  the <code>Object</code> to store; refer to{@code UIDefaults} for details on how {@code null} is
 * handled
