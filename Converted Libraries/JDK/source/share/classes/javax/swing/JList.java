 ...
 * @see #setCellRenderer
 */
  @Transient public ListCellRenderer<? super E> getCellRenderer(){
    return cellRenderer;
  }
  /** 
 ...
 * @beaninfodescription: The selection mode.
 ...
 * @beaninfodescription: The lead selection index.
 */
 ...
 * @see #addListSelectionListener
 */
@Transient public int[] getSelectedIndices(){
 ...
 * @see #isSelectedIndex
 * @see #addListSelectionListener
 * @beaninfodescription: The index of the selected cell.
 */
...
if (anObject == null) setSelectedIndex(-1);
 ...
 * @return an {@code AccessibleJList} that serves as the{@code AccessibleContext} of this {@code JList}
 */
