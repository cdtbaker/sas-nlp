 ...
 */
  ...
  private boolean checkParameters(  SslRMIServerSocketFactory that){
    if (context == null ? that.context != null : !context.equals(that.context))     return false;
    if (needClientAuth != that.needClientAuth)     return false;
    if ((enabledCipherSuites == null && that.enabledCipherSuites != null) || (enabledCipherSuites != null && that.enabledCipherSuites == null))     return false;
    if (enabledCipherSuites != null && that.enabledCipherSuites != null) {
      ...
      if (!enabledCipherSuitesList.equals(thatEnabledCipherSuitesList))       return false;
    }
    if ((enabledProtocols == null && that.enabledProtocols != null) || (enabledProtocols != null && that.enabledProtocols == null))     return false;
    if (enabledProtocols != null && that.enabledProtocols != null) {
      ...
      if (!enabledProtocolsList.equals(thatEnabledProtocolsList))       return false;
    }
    return true;
  }
  /** 
 ...
 */
  ...
  private static synchronized SSLSocketFactory getDefaultSSLSocketFactory(){
    if (defaultSSLSocketFactory == null)     defaultSSLSocketFactory=(SSLSocketFactory)SSLSocketFactory.getDefault();
