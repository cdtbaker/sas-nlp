 ...
 * src }, 0, 1, dst);}
 * </pre</blockquote>
 * @param srca <code>ByteBuffer</code> containing outbound application data
 * @param dsta <code>ByteBuffer</code> to hold outbound network data
 * @return  an <code>SSLEngineResult</code> describing the result
 * of this operation.
 * @throws SSLExceptionA problem was encountered while processing the
 * data that caused the <code>SSLEngine</code> to abort.
 * See the class description for more information on
 * engine closure.
 * @throws ReadOnlyBufferExceptionif the <code>dst</code> buffer is read-only.
 * @throws IllegalArgumentExceptionif either <code>src</code> or <code>dst</code>
 * is null.
 ...
 * @param srcsan array of <code>ByteBuffers</code> containing the
 ...
 * engine closure.
 * @throws ReadOnlyBufferExceptionif the <code>dst</code> buffer is read-only.
 * @throws IllegalArgumentExceptionif either <code>srcs</code> or <code>dst</code>
 ...
 * @param srcsan array of <code>ByteBuffers</code> containing the
 * outbound application data
 * @param offsetThe offset within the buffer array of the first buffer from
 * which bytes are to be retrieved; it must be non-negative
 * and no larger than <code>srcs.length</code>
 * @param lengthThe maximum number of buffers to be accessed; it must be
 ...
 * See the class description for more information on
 * engine closure.
 * @throws IndexOutOfBoundsExceptionif the preconditions on the <code>offset</code> and
 ...
 * dst }, 0, 1);}
 * </pre</blockquote>
 * @param srca <code>ByteBuffer</code> containing inbound network data.
 * @param dsta <code>ByteBuffer</code> to hold inbound application data.
 * @return  an <code>SSLEngineResult</code> describing the result
 * of this operation.
 * @throws SSLExceptionA problem was encountered while processing the
 * data that caused the <code>SSLEngine</code> to abort.
 ...
 * @param srca <code>ByteBuffer</code> containing inbound network data.
 * @param dstsan array of <code>ByteBuffer</code>s to hold inbound
 * application data.
 * @return  an <code>SSLEngineResult</code> describing the result
 * of this operation.
 * @throws SSLExceptionA problem was encountered while processing the
 ...
 * See the class description for more information on
 * engine closure.
 * @throws ReadOnlyBufferExceptionif any of the <code>dst</code> buffers are read-only.
 * @throws IllegalArgumentExceptionif either <code>src</code> or <code>dsts</code>
 ...
 * @throws SSLExceptionif this engine has not received the proper SSL/TLS close
 ...
 * @throws SSLExceptionif a problem was encountered while signaling the
