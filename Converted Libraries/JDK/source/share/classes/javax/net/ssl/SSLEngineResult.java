 ...
 * @param statusthe return value of the operation.
 * @param handshakeStatusthe current handshaking status.
 * @param bytesConsumedthe number of bytes consumed from the source ByteBuffer
 * @param bytesProducedthe number of bytes placed into the destination ByteBuffer
 * @throws IllegalArgumentExceptionif the <code>status</code> or <code>handshakeStatus</code>
