...
public class CardPermission extends Permission {
  ...
  private final static int[] ARRAY_MASKS={A_ALL,A_CONNECT,A_EXCLUSIVE,A_GET_BASIC_CHANNEL,A_OPEN_LOGICAL_CHANNEL,A_RESET,A_TRANSMIT_CONTROL};
  ...
  private final static String[] ARRAY_STRINGS={S_ALL,S_CONNECT,S_EXCLUSIVE,S_GET_BASIC_CHANNEL,S_OPEN_LOGICAL_CHANNEL,S_RESET,S_TRANSMIT_CONTROL};
