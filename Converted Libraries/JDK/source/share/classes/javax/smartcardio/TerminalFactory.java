...
public final class TerminalFactory {
  private final static String PROP_NAME="javax.smartcardio.TerminalFactory.DefaultType";
  private final static String defaultType;
  private final static TerminalFactory defaultFactory;
static {
    String type=AccessController.doPrivileged(new GetPropertyAction(PROP_NAME,"PC/SC")).trim();
    ...
    if (factory == null) {
      type="None";
      factory=new TerminalFactory(NoneFactorySpi.INSTANCE,NoneProvider.INSTANCE,"None");
    }
    defaultType=type;
