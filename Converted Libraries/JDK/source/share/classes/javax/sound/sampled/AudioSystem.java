 ...
 */
  public static AudioFileFormat.Type[] getAudioFileTypes(){
    ...
    AudioFileFormat.Type returnTypes[]=(AudioFileFormat.Type[])returnTypesSet.toArray(new AudioFileFormat.Type[0]);
    return returnTypes;
  }
  /** 
 ...
 * @return an array of{@link javax.sound.sampled.spi.FormatConversionProviderFormatConversionProvider}objects representing the available format converters.  If no format
 ...
 * @return a List of{@link javax.sound.sampled.spi.AudioFileReaderAudioFileReader}objects representing the installed audio file readers.  If no audio file
 ...
 * @return a List of{@link javax.sound.samples.spi.AudioFileWriter AudioFileWriter}objects representing the available audio file writers.  If no audio file
