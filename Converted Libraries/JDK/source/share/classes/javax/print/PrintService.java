 ...
 * @exception IllegalArgumentException(unchecked exception) if <CODE>category</CODE> is not a
 ...
 * @exception NullPointerException(unchecked exception) Thrown if <CODE>flavor</CODE> is null.
 */
 ...
 * @exception IllegalArgumentException(unchecked exception) Thrown if <CODE>category</CODE> is not a
 ...
 * for this attribute.
 * @exception NullPointerException(unchecked exception) Thrown if <CODE>category</CODE> is null.
 * @exception IllegalArgumentException(unchecked exception) Thrown if <CODE>category</CODE> is not a{@link java.lang.Class Class} that implements interface {@link javax.print.attribute.Attribute Attribute}.
 */
 ...
 * a Print Request.
 * @exception NullPointerException(unchecked exception) Thrown if <CODE>category</CODE> is null.
 * @exception IllegalArgumentException(unchecked exception) Thrown if <CODE>category</CODE> is not a{@link java.lang.Class Class} that implements interface {@link javax.print.attribute.Attribute Attribute}, or
 ...
 * @exception NullPointerException(unchecked exception)  if <CODE>attrval</CODE> is null.
