 ...
 * @exception IOExceptionThrown if the representation class is a stream and there was an I/O
 ...
 * @exception IOExceptionThrown if there was an I/O error while creating the reader.
 */
 ...
 * @exception IOExceptionThrown if there was an I/O error while creating the input stream.
 */
