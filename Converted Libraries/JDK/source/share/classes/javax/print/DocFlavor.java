...
static {
    hostEncoding=(String)java.security.AccessController.doPrivileged(new sun.security.action.GetPropertyAction("file.encoding"));
  }
  /** 
 * MIME type.
 */
 ...
 * @exception NullPointerException(unchecked exception) Thrown if <CODE>mimeType</CODE> is null or
 * <CODE>className</CODE> is null.
 * @exception IllegalArgumentException(unchecked exception) Thrown if <CODE>mimeType</CODE> does not
 ...
 * @serialDataThe serialised form of a DocFlavor is the String naming the
 ...
 * @param mimeType   MIME media type string.
 * @exception NullPointerException(unchecked exception) Thrown if <CODE>mimeType</CODE> is null.
 * @exception IllegalArgumentException(unchecked exception) Thrown if <CODE>mimeType</CODE> does not
 * obey the syntax for a MIME media type string.
 */
 ...
 * representation class name.
 * @param className  Fully-qualified representation class name.
 * @exception NullPointerException(unchecked exception) Thrown if <CODE>className</CODE> is
 * null.
 */
