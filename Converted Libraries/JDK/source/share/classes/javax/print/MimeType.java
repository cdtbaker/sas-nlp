...
private class ParameterMapEntry implements Map.Entry {
    ...
    public boolean equals(    Object o){
      return (o != null && o instanceof Map.Entry && getKey().equals(((Map.Entry)o).getKey()) && getValue().equals(((Map.Entry)o).getValue()));
    }
    public int hashCode(){
 ...
 * @exception NullPointerException(unchecked exception) Thrown if <CODE>s</CODE> is null.
 * @exception IllegalArgumentException(unchecked exception) Thrown if <CODE>s</CODE> does not obey the
