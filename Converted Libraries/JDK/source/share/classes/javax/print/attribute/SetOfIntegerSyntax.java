 ...
 * constructed.
 * @exception IllegalArgumentException(Unchecked exception) Thrown if <CODE>members</CODE> does not
 ...
 * @exception IllegalArgumentException(Unchecked exception) Thrown if any element of
 ...
 * @exception IllegalArgumentException(Unchecked exception) Thrown if <CODE>member</CODE> is less than
 * zero.
 */
 ...
 * @exception IllegalArgumentException(Unchecked exception) Thrown if the range is non-null and
