 ...
 * @param x  X dimension.
 * @param y  Y dimension.
 * @param unitsUnit conversion factor, e.g. {@link #INCH <CODE>INCH</CODE>} or{@link #MM <CODE>MM</CODE>}.
 ...
 * @param xValue (micrometers) to convert.
 * @param unitsUnit conversion factor, e.g. {@link #INCH <CODE>INCH</CODE>} or{@link #MM <CODE>MM</CODE>}.
 ...
 * floating point.
 * @param unitsUnit conversion factor, e.g. {@link #INCH <CODE>INCH</CODE>} or{@link #MM <CODE>MM</CODE>}.
 * @param unitsNameUnits name string, e.g. <CODE>"in"</CODE> or <CODE>"mm"</CODE>. If
