 ...
 * @param crossFeedResolutionCross feed direction resolution.
 * @param feedResolutionFeed direction resolution.
 * @param unitsUnit conversion factor, e.g. {@link #DPI <CODE>DPI</CODE>} or{@link #DPCM <CODE>DPCM</CODE>}.
 * @exception IllegalArgumentException(unchecked exception) Thrown if <CODE>crossFeedResolution</CODE> <
 ...
 * the nearest integer.
 * @param dphiValue (dphi) to convert.
 * @param unitsUnit conversion factor, e.g. {@link #DPI <CODE>DPI</CODE>} or{@link #DPCM <CODE>DPCM</CODE>}.
 * @return  The value of <CODE>dphi</CODE> converted to the desired units.
 * @exception IllegalArgumentException(unchecked exception) Thrown if <CODE>units</CODE> < 1.
 */
 ...
 * @param unitsUnit conversion factor, e.g. {@link #DPI <CODE>DPI</CODE>} or {@link #DPCM <CODE>DPCM</CODE>}.
 * @param unitsNameUnits name string, e.g. <CODE>"dpi"</CODE> or <CODE>"dpcm"</CODE>. If
 ...
 * @exception NullPointerException(unchecked exception) Thrown if <CODE>other</CODE> is null.
 */
  public boolean lessThanOrEquals(  ResolutionSyntax other){
    return (this.crossFeedResolution <= other.crossFeedResolution && this.feedResolution <= other.feedResolution);
  }
  /** 
