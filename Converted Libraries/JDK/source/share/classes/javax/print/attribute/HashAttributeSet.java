 ...
 * @serialDataThe serialized form of an attribute set explicitly writes the
 ...
 * @exception NullPointerException(unchecked exception) Thrown if <CODE>attribute</CODE> is null.
 */
 ...
 * @exception NullPointerException(unchecked exception) Thrown if any element of
 ...
 * @exception NullPointerException(unchecked exception) Thrown if <CODE>attribute</CODE> is null.
 * @exception NullPointerException if interfaceName is null.
 * @exception ClassCastException(unchecked exception) Thrown if <CODE>attribute</CODE> is not an
 ...
 * <CODE>attributes</CODE> is null.
 * @exception NullPointerException if interfaceName is null.
 * @exception ClassCastException(unchecked exception) Thrown if any element of
 ...
 * @throws ClassCastException(unchecked exception) Thrown if the <CODE>category</CODE> is not a{@link java.lang.Class Class} that implements interface {@link Attribute Attribute}.
 */
  public Attribute get(  Class<?> category){
    return (Attribute)attrMap.get(AttributeSetUtilities.verifyAttributeCategory(category,Attribute.class));
  }
  /** 
