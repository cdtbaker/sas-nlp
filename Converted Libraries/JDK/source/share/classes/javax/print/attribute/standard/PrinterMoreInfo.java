 ...
 * assistance).
 * <P>
 * In contrast, the {@link PrinterMoreInfoManufacturerPrinterMoreInfoManufacturer} attribute is used to find out more information
 ...
 * @param uri  URI.
 * @exception NullPointerException(unchecked exception) Thrown if <CODE>uri</CODE> is null.
 */
