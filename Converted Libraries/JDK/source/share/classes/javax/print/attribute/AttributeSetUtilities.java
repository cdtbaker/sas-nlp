 ...
 * implementations of interface {@link AttributeSet AttributeSet}</ul>
 * <P>
 ...
 * @exception NullPointerExceptionThrown if <CODE>attributeSet</CODE> is null. Null is never a
 */
 ...
 * @return  Unmodifiable view of <CODE>attributeSet</CODE>.
 * @exception NullPointerExceptionThrown if <CODE>attributeSet</CODE> is null.
 */
 ...
 * implements the given interface, which is assumed to be interface {@link Attribute Attribute} or a subinterface thereof.
 * @param object     Object to test.
 * @param interfaceName  Interface the object must implement.
 * @return  If <CODE>object</CODE> is a {@link java.lang.Class Class}that implements <CODE>interfaceName</CODE>,
 * <CODE>object</CODE> is returned downcast to type {@link java.lang.Class Class}; otherwise an exception is thrown.
 * @exception NullPointerException(unchecked exception) Thrown if <CODE>object</CODE> is null.
 * @exception ClassCastException(unchecked exception) Thrown if <CODE>object</CODE> is not a{@link java.lang.Class Class} that implements
 ...
 * exception is thrown.
 * @exception NullPointerException(unchecked exception) Thrown if <CODE>object</CODE> is null.
 * @exception ClassCastException(unchecked exception) Thrown if <CODE>object</CODE> is not an
 ...
 * @exception NullPointerException(unchecked exception) Thrown if the <CODE>category</CODE> is
 * null or if the <CODE>attribute</CODE> is null.
 * @exception IllegalArgumentException(unchecked exception) Thrown if the <CODE>category</CODE> is not
