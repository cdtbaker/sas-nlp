 ...
 * @exception NullPointerException(unchecked exception) Thrown if <CODE>map</CODE> is null or if any
 ...
 * @return  Set view of the individual {@link PrinterStateReasonPrinterStateReason} attributes at the given {@link SeveritySeverity} level.
 * @exception NullPointerException(unchecked exception) Thrown if <CODE>severity</CODE> is null.
 */
