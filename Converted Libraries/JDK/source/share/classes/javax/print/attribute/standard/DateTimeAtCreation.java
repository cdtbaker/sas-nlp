 ...
 * the year, month, day, hour, minute, and so on, create a {@link java.util.Calendar Calendar} object and set it to the {@link java.util.DateDate} from the DateTimeAtCreation attribute.
 * <P>
...
public final class DateTimeAtCreation extends DateTimeSyntax implements PrintJobAttribute {
  ...
  /** 
 * Construct a new date-time at creation attribute with the given {@link java.util.Date Date} value.
