 ...
 * for a job that has not started processing must be 0. When the job's {@link JobState JobState} is PROCESSING or PROCESSING_STOPPED, the
 ...
 * JobKOctetsProcessed attribute must be equal to the value of the {@link JobKOctets JobKOctets} attribute. For implementations where multiple copies
 * are produced by the interpreter by processing the data for each copy, the
 * final value must be a multiple of the value of the {@link JobKOctetsJobKOctets} attribute.
 * <P>
