 ...
 * If such is not available, the printer uses the value of the{@link RequestingUserName RequestingUserName}attribute supplied by the client in the Print Request's attribute set.
 ...
 * @exception NullPointerException(unchecked exception) Thrown if <CODE>userName</CODE> is null.
 */
