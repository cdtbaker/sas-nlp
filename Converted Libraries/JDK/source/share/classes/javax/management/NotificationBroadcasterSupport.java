 ...
 */
  ...
  public void removeNotificationListener(  NotificationListener listener) throws ListenerNotFoundException {
    ...
    if (!removed)     throw new ListenerNotFoundException("Listener not registered");
  }
...
private static class ListenerInfo {
    ...
    public boolean equals(    Object o){
      ...
      if (li instanceof WildcardListenerInfo)       return (li.listener == listener);
 else       return (li.listener == listener && li.filter == filter && li.handback == handback);
    }
  }
