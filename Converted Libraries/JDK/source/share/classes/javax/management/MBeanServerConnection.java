 ...
 * @exception RuntimeMBeanException If the MBean's constructor or its{@code preRegister} or {@code postRegister} method threw
 ...
 * interface) method of the MBean has thrown an exception. The
 * MBean will not be registered.
 * @exception RuntimeMBeanException The MBean's constructor or its{@code preRegister} or {@code postRegister} method threw
 * a {@code RuntimeException}. If the <CODE>postRegister</CODE>
 * (<CODE>MBeanRegistration</CODE> interface) method of the MBean throws a
 * <CODE>RuntimeException</CODE>, the <CODE>createMBean</CODE> method will
 * throw a <CODE>RuntimeMBeanException</CODE>, although the MBean creation
 ...
 * @exception RuntimeOperationsException Wraps an {@link IllegalArgumentException}.  The MBean named by
