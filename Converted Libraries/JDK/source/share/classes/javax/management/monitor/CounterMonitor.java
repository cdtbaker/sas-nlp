 ...
 */
  ...
  private static final String[] types={RUNTIME_ERROR,OBSERVED_OBJECT_ERROR,OBSERVED_ATTRIBUTE_ERROR,OBSERVED_ATTRIBUTE_TYPE_ERROR,THRESHOLD_ERROR,THRESHOLD_VALUE_EXCEEDED};
 ...
 */
  public synchronized Number getThreshold(  ObjectName object){
    ...
    if (offset.longValue() > 0L && modulus.longValue() > 0L && o.getThreshold().longValue() > modulus.longValue()) {
 ...
 */
  public synchronized void setInitThreshold(  Number value) throws IllegalArgumentException {
    ...
    if (initThreshold.equals(value))     return;
    initThreshold=value;
    int index=0;
    for (    ObservedObject o : observedObjects) {
 ...
 */
  @Deprecated public synchronized Number getThreshold(){
 ...
 */
  @Deprecated public synchronized void setThreshold(  Number value) throws IllegalArgumentException {
 ...
 */
  public synchronized void setModulus(  Number value) throws IllegalArgumentException {
    ...
    if (modulus.equals(value))     return;
    modulus=value;
    int index=0;
    for (    ObservedObject o : observedObjects) {
      resetAlreadyNotified(o,index++,THRESHOLD_ERROR_NOTIFIED);
...
break;
default :
MONITOR_LOGGER.logp(Level.FINEST,CounterMonitor.class.getName(),"updateThreshold","the threshold type is invalid");
break;
}
if (!differenceMode) {
if (modulus.longValue() > 0L) {
...
if (mod != null) derived+=modulus.longValue();
switch (o.getType()) {
case INTEGER:
...
break;
default :
MONITOR_LOGGER.logp(Level.FINEST,CounterMonitor.class.getName(),"setDerivedGaugeWithDifference","the threshold type is invalid");
break;
}
}
/** 
...
final CounterMonitorObservedObject o=(CounterMonitorObservedObject)getObservedObject(notification.getObservedObject());
if (o == null) return;
o.setModulusExceeded(false);
o.setEventAlreadyNotified(false);
