 ...
 * @exception RuntimeOperationsException Wraps a {@link RuntimeException} during the construction of the object.
 */
 ...
 * Exception.
 * @exception RuntimeOperationsException<ul><li>Wraps an {@link IllegalArgumentException} if
 ...
 */
  public void setModelMBeanInfo(  ModelMBeanInfo mbi) throws MBeanException, RuntimeOperationsException {
    ...
    if (MODELMBEAN_LOGGER.isLoggable(Level.FINER)) {
      ...
      MODELMBEAN_LOGGER.logp(Level.FINER,RequiredModelMBean.class.getName(),"setModelMBeanInfo(ModelMBeanInfo)","ModelMBeanInfo notifications has " + (mbi.getNotifications()).length + " elements");
    }
 ...
 * @exception RuntimeOperationsException Wraps a {@link RuntimeException} when setting the resource.
 */
  public void setManagedResource(  Object mr,  String mr_type) throws MBeanException, RuntimeOperationsException, InstanceNotFoundException, InvalidTargetObjectTypeException {
    ...
    if ((mr_type == null) || (!mr_type.equalsIgnoreCase("objectReference"))) {
      if (MODELMBEAN_LOGGER.isLoggable(Level.FINER)) {
        MODELMBEAN_LOGGER.logp(Level.FINER,RequiredModelMBean.class.getName(),"setManagedResource(Object,String)","Managed Resouce Type is not supported: " + mr_type);
      }
      throw new InvalidTargetObjectTypeException(mr_type);
    }
    if (MODELMBEAN_LOGGER.isLoggable(Level.FINER)) {
      MODELMBEAN_LOGGER.logp(Level.FINER,RequiredModelMBean.class.getName(),"setManagedResource(Object,String)","Managed Resouce is valid");
    }
    managedResource=mr;
    if (MODELMBEAN_LOGGER.isLoggable(Level.FINER)) {
 ...
 * </UL>
 * @exception ReflectionException  Wraps an {@link java.lang.Exception}thrown while trying to invoke the method.
 * @exception RuntimeOperationsException Wraps an{@link IllegalArgumentException} Method name is null.
 */
  public Object invoke(  String opName,  Object[] opArgs,  String[] sig) throws MBeanException, ReflectionException {
 ...
 else     opMethodName=opName;
    opSplitter=opMethodName.indexOf("(");
    if (opSplitter > 0)     opMethodName=opMethodName.substring(0,opSplitter);
    if (tracing) {
    ...
    if (opClassName == null)     opClassName=(String)opDescr.getFieldValue("class");
    ...
    if (tracing && targetObjectField != null)     MODELMBEAN_LOGGER.logp(Level.FINER,RequiredModelMBean.class.getName(),mth,"Found target object in descriptor");
    Method method;
    Object targetObject;
    method=findRMMBMethod(opMethodName,targetObjectField,opClassName,sig);
    if (method != null)     targetObject=this;
 else {
      if (tracing) {
        MODELMBEAN_LOGGER.logp(Level.FINER,RequiredModelMBean.class.getName(),mth,"looking for method in managedResource class");
      }
      if (targetObjectField != null)       targetObject=targetObjectField;
 else {
 ...
 else       targetClass=targetObject.getClass();
    ...
    if (result != null)     cacheResult(opInfo,opDescr,result);
    return result;
  }
...
static {
  ...
  private static Method findRMMBMethod(  String opMethodName,  Object targetObjectField,  String opClassName,  String[] sig){
    final boolean tracing=MODELMBEAN_LOGGER.isLoggable(Level.FINER);
    if (tracing) {
  ...
  private Object invokeMethod(  String opName,  Method method,  Object targetObject,  Object[] opArgs) throws MBeanException, ReflectionException {
    try {
 ...
 * @exception RuntimeOperationsException Wraps an{@link IllegalArgumentException}: The attribute name in
 * parameter is null.
 ...
 */
  public Object getAttribute(  String attrName) throws AttributeNotFoundException, MBeanException, ReflectionException {
    if (attrName == null)     throw new RuntimeOperationsException(new IllegalArgumentException("attributeName must not be null"),"Exception occurred trying to get attribute of a " + "RequiredModelMBean");
    ...
    Object response;
    try {
      if (modelMBeanInfo == null)       throw new AttributeNotFoundException("getAttribute failed: ModelMBeanInfo not found for " + attrName);
      ModelMBeanAttributeInfo attrInfo=modelMBeanInfo.getAttribute(attrName);
      Descriptor mmbDesc=modelMBeanInfo.getMBeanDescriptor();
      if (attrInfo == null)       throw new AttributeNotFoundException("getAttribute failed:" + " ModelMBeanAttributeInfo not found for " + attrName);
      Descriptor attrDescr=attrInfo.getDescriptor();
      if (attrDescr != null) {
        if (!attrInfo.isReadable())         throw new AttributeNotFoundException("getAttribute failed: " + attrName + " is not readable ");
          ...
          if (!respType.equals(responseClass)) {
            ...
            for (int i=0; i < primitiveTypes.length; i++) {
              if (respType.equals(primitiveTypes[i])) {
                primitiveType=true;
                if (responseClass.equals(primitiveWrappers[i]))                 correspondingTypes=true;
                break;
              }
            }
            if (primitiveType) {
              if (!correspondingTypes)               wrongType=true;
            }
 else {
              boolean subtype;
              try {
 ...
 * @exception RuntimeOperationsException Wraps an{@link IllegalArgumentException}: The object name in parameter is
 ...
 */
  public AttributeList getAttributes(  String[] attrNames){
    ...
    if (attrNames == null)     throw new RuntimeOperationsException(new IllegalArgumentException("attributeNames must not be null"),"Exception occurred trying to get attributes of a " + "RequiredModelMBean");
 ...
 * <LI> An Exception thrown by the managed object's getter.</LI>
 * </UL>
 * @exception ReflectionException  Wraps an {@link java.lang.Exception}thrown while trying to invoke the setter.
 * @exception RuntimeOperationsException Wraps an{@link IllegalArgumentException}: The attribute in parameter is
 * null.
 ...
 */
  public void setAttribute(  Attribute attribute) throws AttributeNotFoundException, InvalidAttributeValueException, MBeanException, ReflectionException {
    ...
    if (attribute == null)     throw new RuntimeOperationsException(new IllegalArgumentException("attribute must not be null"),"Exception occurred trying to set an attribute of a " + "RequiredModelMBean");
    String attrName=attribute.getName();
    Object attrValue=attribute.getValue();
    boolean updateDescriptor=false;
    ModelMBeanAttributeInfo attrInfo=modelMBeanInfo.getAttribute(attrName);
    if (attrInfo == null)     throw new AttributeNotFoundException("setAttribute failed: " + attrName + " is not found ");
    Descriptor mmbDesc=modelMBeanInfo.getMBeanDescriptor();
    Descriptor attrDescr=attrInfo.getDescriptor();
    if (attrDescr != null) {
      if (!attrInfo.isWritable())       throw new AttributeNotFoundException("setAttribute failed: " + attrName + " is not writable ");
      ...
      if (attrSetMethod == null) {
        if (attrValue != null) {
          try {
            ...
            if (!clazz.isInstance(attrValue))             throw new InvalidAttributeValueException(clazz.getName() + " expected, " + attrValue.getClass().getName()+ " received.");
          }
      ...
      if (attrSetMethod == null && !updateCache && attrGetMethod != null)       throw new MBeanException(new ServiceNotFoundException("No " + "setMethod field is defined in the descriptor for " + attrName + " attribute and caching is not enabled "+ "for it"));
 ...
 * @exception RuntimeOperationsException Wraps an{@link IllegalArgumentException}: The object name in parameter
 ...
 */
  public AttributeList setAttributes(  AttributeList attributes){
    ...
    if (attributes == null)     throw new RuntimeOperationsException(new IllegalArgumentException("attributes must not be null"),"Exception occurred trying to set attributes of a " + "RequiredModelMBean");
 ...
 */
  public void addNotificationListener(  NotificationListener listener,  NotificationFilter filter,  Object handback) throws java.lang.IllegalArgumentException {
    ...
    if (listener == null)     throw new IllegalArgumentException("notification listener must not be null");
 ...
 */
  public void removeNotificationListener(  NotificationListener listener) throws ListenerNotFoundException {
    if (listener == null)     throw new ListenerNotFoundException("Notification listener is null");
  ...
  public void sendNotification(  Notification ntfyObj) throws MBeanException, RuntimeOperationsException {
    ...
    if (ntfyObj == null)     throw new RuntimeOperationsException(new IllegalArgumentException("notification object must not be " + "null"),"Exception occurred trying to send a notification from a " + "RequiredModelMBean");
    ...
    if (ntfyDesc != null) {
      ...
      if (logging == null) {
        if (mmbDesc != null)         logging=(String)mmbDesc.getFieldValue("log");
      }
      if ((logging != null) && (logging.equalsIgnoreCase("t") || logging.equalsIgnoreCase("true"))) {
        ...
        if (logfile == null) {
          if (mmbDesc != null)           logfile=(String)mmbDesc.getFieldValue("logfile");
        }
        if (logfile != null) {
          try {
  ...
  public void sendNotification(  String ntfyText) throws MBeanException, RuntimeOperationsException {
    ...
    if (ntfyText == null)     throw new RuntimeOperationsException(new IllegalArgumentException("notification message must not " + "be null"),"Exception occurred trying to send a text notification " + "from a ModelMBean");
 ...
 */
  public MBeanNotificationInfo[] getNotificationInfo(){
    ...
    int inserted=0;
    if (!hasGeneric)     respInfo[inserted++]=makeGenericInfo();
    if (!hasAttributeChange)     respInfo[inserted++]=makeAttributeChangeInfo();
  ...
  public void addAttributeChangeNotificationListener(  NotificationListener inlistener,  String inAttributeName,  Object inhandback) throws MBeanException, RuntimeOperationsException, IllegalArgumentException {
    ...
    if (inlistener == null)     throw new IllegalArgumentException("Listener to be registered must not be null");
    if (attributeBroadcaster == null)     attributeBroadcaster=new NotificationBroadcasterSupport();
  ...
  public void removeAttributeChangeNotificationListener(  NotificationListener inlistener,  String inAttributeName) throws MBeanException, RuntimeOperationsException, ListenerNotFoundException {
    if (inlistener == null)     throw new ListenerNotFoundException("Notification listener is null");
    final String mth="removeAttributeChangeNotificationListener(" + "NotificationListener, String)";
    if (MODELMBEAN_LOGGER.isLoggable(Level.FINER)) {
      MODELMBEAN_LOGGER.logp(Level.FINER,RequiredModelMBean.class.getName(),mth,"Entry");
    }
    if (attributeBroadcaster == null)     throw new ListenerNotFoundException("No attribute change notification listeners registered");
    MBeanAttributeInfo[] attrInfo=modelMBeanInfo.getAttributes();
    boolean found=false;
    if ((attrInfo != null) && (attrInfo.length > 0)) {
      for (int i=0; i < attrInfo.length; i++) {
  ...
  public void sendAttributeChangeNotification(  AttributeChangeNotification ntfyObj) throws MBeanException, RuntimeOperationsException {
    ...
    if (ntfyObj == null)     throw new RuntimeOperationsException(new IllegalArgumentException("attribute change notification object must not be null"),"Exception occurred trying to send " + "attribute change notification of a ModelMBean");
  ...
  public void sendAttributeChangeNotification(  Attribute inOldVal,  Attribute inNewVal) throws MBeanException, RuntimeOperationsException {
    ...
    if ((inOldVal == null) || (inNewVal == null))     throw new RuntimeOperationsException(new IllegalArgumentException("Attribute object must not be null"),"Exception occurred trying to send " + "attribute change notification of a ModelMBean");
    if (!(inOldVal.getName().equals(inNewVal.getName())))     throw new RuntimeOperationsException(new IllegalArgumentException("Attribute names are not the same"),"Exception occurred trying to send " + "attribute change notification of a ModelMBean");
    Object newVal=inNewVal.getValue();
    Object oldVal=inOldVal.getValue();
    String className="unknown";
    if (newVal != null)     className=newVal.getClass().getName();
    if (oldVal != null)     className=oldVal.getClass().getName();
