 ...
 * @since 1.5
 */
@SuppressWarnings("serial") public class ModelMBeanOperationInfo extends MBeanOperationInfo implements DescriptorAccess {
 ...
 * on the {@code Method} object that contain the {@link DescriptorKey} meta-annotation.
 ...
 */
  ...
  /** 
 * Constructs a ModelMBeanOperationInfo object. The {@link Descriptor} of the constructed object will include fields
 ...
 */
  public ModelMBeanOperationInfo(  ModelMBeanOperationInfo inInfo){
    ...
    if (MODELMBEAN_LOGGER.isLoggable(Level.FINER)) {
      MODELMBEAN_LOGGER.logp(Level.FINER,ModelMBeanOperationInfo.class.getName(),"ModelMBeanOperationInfo(ModelMBeanOperationInfo)","Entry");
    }
 ...
 */
  public Descriptor getDescriptor(){
    if (MODELMBEAN_LOGGER.isLoggable(Level.FINER)) {
      MODELMBEAN_LOGGER.logp(Level.FINER,ModelMBeanOperationInfo.class.getName(),"getDescriptor()","Entry");
    }
 ...
 */
  public void setDescriptor(  Descriptor inDescriptor){
    if (MODELMBEAN_LOGGER.isLoggable(Level.FINER)) {
      MODELMBEAN_LOGGER.logp(Level.FINER,ModelMBeanOperationInfo.class.getName(),"setDescriptor(Descriptor)","Entry");
    }
 ...
 */
  public String toString(){
    if (MODELMBEAN_LOGGER.isLoggable(Level.FINER)) {
      MODELMBEAN_LOGGER.logp(Level.FINER,ModelMBeanOperationInfo.class.getName(),"toString()","Entry");
    }
