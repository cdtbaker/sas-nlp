 ...
 */
  ...
  public synchronized void setMBeanServerForwarder(  MBeanServerForwarder mbsf){
    if (mbsf == null)     throw new IllegalArgumentException("Invalid null argument: mbsf");
 ...
 */
  @Override public MBeanNotificationInfo[] getNotificationInfo(){
    final String[] types={JMXConnectionNotification.OPENED,JMXConnectionNotification.CLOSED,JMXConnectionNotification.FAILED};
 ...
 * @param message the message for the emitted {@link JMXConnectionNotification}.  Can be null.  See {@link Notification#getMessage()}.
 * @param userData the <code>userData</code> for the emitted{@link JMXConnectionNotification}.  Can be null.  See {@link Notification#getUserData()}.
