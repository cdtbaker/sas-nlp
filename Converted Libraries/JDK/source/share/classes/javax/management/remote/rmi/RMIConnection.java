 ...
 * @since 1.5
 */
@SuppressWarnings("rawtypes") public interface RMIConnection extends Closeable, Remote {
  /** 
 ...
 * if any, does not have permission to perform this operation.
 * @throws IOException if a general communication exception occurred.
 * @throws RuntimeOperationsException Wraps an {@link IllegalArgumentException} when <code>name</code> or
 ...
 * @throws RuntimeOperationsException Wraps an {@link IllegalArgumentException}.  The MBean named by
