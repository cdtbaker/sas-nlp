 ...
 */
  public TargetedNotification(  Notification notification,  Integer listenerID){
    if (notification == null)     throw new IllegalArgumentException("Invalid notification: null");
    if (listenerID == null)     throw new IllegalArgumentException("Invalid listener ID: null");
