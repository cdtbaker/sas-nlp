      ...
      if (c == '<') {
        ...
        if (c == '/') {
          ...
          if (nm.equalsIgnoreCase("arg")) {
            ...
            if (att == null) {
              MLET_LOGGER.logp(Level.FINER,MLetParser.class.getName(),mth,requiresTypeWarning);
              ...
              if (atts != null) {
                ...
                MLET_LOGGER.logp(Level.FINER,MLetParser.class.getName(),mth,paramOutsideWarning);
                throw new IOException(paramOutsideWarning);
              }
            }
            String val=t.get("value");
            if (val == null) {
              MLET_LOGGER.logp(Level.FINER,MLetParser.class.getName(),mth,requiresValueWarning);
            ...
            if (nm.equalsIgnoreCase(tag)) {
              ...
              if (atts.get("code") == null && atts.get("object") == null) {
                MLET_LOGGER.logp(Level.FINER,MLetParser.class.getName(),mth,requiresCodeWarning);
                throw new IOException(requiresCodeWarning);
              }
              if (atts.get("archive") == null) {
                MLET_LOGGER.logp(Level.FINER,MLetParser.class.getName(),mth,requiresJarsWarning);
