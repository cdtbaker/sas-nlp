 ...
 * @throws IllegalArgumentExceptionif the name is empty or if the scope is invalid.
 ...
 * @throws IllegalArgumentExceptionif the name is empty or if the value of scope is invalid.
 * @throws NullPointerException if the name is null.
 */
