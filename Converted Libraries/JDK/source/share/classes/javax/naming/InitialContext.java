 ...
 * @see Context
 * @see NamingManager#setInitialContextFactoryBuilderNamingManager.setInitialContextFactoryBuilder
 ...
 * @param lazytrue means do not initialize the initial context; false
 ...
 * @param environmentenvironment used to create the initial context.
 ...
 * concurrently).
 * @param namethe name of the object to look up
 ...
 */
  protected Context getDefaultInitCtx() throws NamingException {
    ...
    if (defaultInitCtx == null)     throw new NoInitialContextException();
