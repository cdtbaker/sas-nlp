 ...
 * @param factoryLocationThe possibly null location from which to load
 * the factory (e.g. URL)
 ...
 */
  public RefAddr get(  String addrType){
    ...
    for (int i=0; i < len; i++) {
      ...
      if (addr.getType().compareTo(addrType) == 0)       return addr;
    }
    return null;
  }
  /** 
  ...
  public boolean equals(  Object obj){
    if ((obj != null) && (obj instanceof Reference)) {
      ...
      if (target.className.equals(this.className) && target.size() == this.size()) {
        ...
        while (mycomps.hasMoreElements())         if (!(mycomps.nextElement().equals(comps.nextElement())))         return false;
        return true;
      }
    }
    return false;
 ...
 */
  public int hashCode(){
    ...
    for (Enumeration e=getAll(); e.hasMoreElements(); )     hash+=e.nextElement().hashCode();
    return hash;
  }
  /** 
 ...
 */
  public String toString(){
    ...
    int len=addrs.size();
    for (int i=0; i < len; i++)     buf.append(get(i).toString());
    return buf.toString();
  }
  /** 
 ...
 */
  public Object clone(){
    ...
    r.addrs=new Vector();
    while (a.hasMoreElements())     r.addrs.addElement(a.nextElement());
    return r;
  }
  /** 
