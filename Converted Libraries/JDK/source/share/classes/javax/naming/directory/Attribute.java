 ...
 * is returned.
 * @exception NamingExceptionIf a naming exception was encountered while retrieving
 * the values.
 * @see #isOrdered
 */
 ...
 * @exception NamingExceptionIf a naming exception was encountered while retrieving
 * the value.
 * @exception java.util.NoSuchElementExceptionIf this attribute has no values.
 */
