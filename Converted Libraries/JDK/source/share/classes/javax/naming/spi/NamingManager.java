 ...
 */
  public static Context getInitialContext(  Hashtable<?,?> env) throws NamingException {
    ...
    if (builder == null) {
      ...
      if (className == null) {
        NoInitialContextException ne=new NoInitialContextException("Need to specify class name in environment or system " + "property, or as an applet parameter, or in an " + "application resource file:  "+ Context.INITIAL_CONTEXT_FACTORY);
        throw ne;
      }
      try {
 ...
 * @param cpeThe non-null exception that triggered this continuation.
