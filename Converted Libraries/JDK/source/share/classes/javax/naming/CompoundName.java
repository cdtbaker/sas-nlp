 ...
 * the range [0,posn).
 * @exception ArrayIndexOutOfBoundsExceptionIf posn is outside the specified range.
 */
 ...
 * @exception ArrayIndexOutOfBoundsExceptionIf posn is outside the specified range (includes case where
