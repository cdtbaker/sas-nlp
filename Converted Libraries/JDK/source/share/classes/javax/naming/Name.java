 ...
 * @param posnthe 0-based index of the component to retrieve.
 * Must be in the range [0,size()).
 * @return  the component at index posn
 * @throws ArrayIndexOutOfBoundsExceptionif posn is outside the specified range
 */
 ...
 * @param posnthe 0-based index of the component at which to stop.
 * Must be in the range [0,size()].
 ...
 * @param posnthe 0-based index of the component at which to start.
 * Must be in the range [0,size()].
 * @return  a name consisting of the components at indexes in
 ...
 * @param suffixthe components to add
 ...
 * components.
 * @param nthe components to add
 * @param posnthe index in this name at which to add the new
 ...
 * @param compthe component to add
 * @return  the updated name (not a new one)
 ...
 * component.
 * @param compthe component to add
 * @param posnthe index at which to add the new component.
 * Must be in the range [0,size()].
 * @return  the updated name (not a new one)
 * @throws ArrayIndexOutOfBoundsExceptionif posn is outside the specified range
 * @throws InvalidNameException if adding <tt>comp</tt> would violate
 ...
 * @param posnthe index of the component to remove.
 * Must be in the range [0,size()).
