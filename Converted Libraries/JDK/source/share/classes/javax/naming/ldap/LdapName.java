 ...
 * @exception IndexOutOfBoundsExceptionIf posn is outside the specified range.
 */
  ...
  public Name addAll(  int posn,  Name suffix) throws InvalidNameException {
    ...
    if (suffix instanceof LdapName) {
      ...
      while (comps.hasMoreElements()) {
        rdns.add(posn++,(new Rfc2253Parser((String)comps.nextElement()).parseRdn()));
      }
    }
    return this;
  }
 ...
 * @return          The updated LdapName, not a new instance.
 * Cannot be null.
 * @exception IndexOutOfBoundsException.If posn is outside the specified range.
 ...
 * @throws IndexOutOfBoundsExceptionif posn is outside the specified range.
