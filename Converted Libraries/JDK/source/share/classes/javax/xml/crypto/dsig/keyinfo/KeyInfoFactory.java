 ...
 * X.509 content.
 * @param content a list of one or more X.509 content types. Valid types are{@link String} (subject names), <code>byte[]</code> (subject key ids),{@link java.security.cert.X509Certificate}, {@link X509CRL},
