 ...
 * &lt;/complexType&gt;
 * </pre>
 * A <code>PGPData</code> instance may be created by invoking one of the{@link KeyInfoFactory#newPGPData newPGPData} methods of the {@link KeyInfoFactory} class, and passing it
 ...
 * value of the <code>type</code> parameter of the {@link RetrievalMethod}class to describe a remote <code>PGPData</code> structure.
 */
 ...
 */
  byte[] getKeyPacket();
  /** 
 * Returns an {@link Collections#unmodifiableList unmodifiable list}of {@link XMLStructure}s representing elements from an external
 * namespace.
