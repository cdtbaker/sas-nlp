 ...
 * &lt;/complexType&gt;
 * </pre>
 * An <code>X509Data</code> instance may be created by invoking the{@link KeyInfoFactory#newX509Data newX509Data} methods of the{@link KeyInfoFactory} class and passing it a list of one or more{@link XMLStructure}s representing X.509 content; for example:
 * <pre>
 ...
 * specified as the value of the <code>type</code> parameter of the{@link RetrievalMethod} class to describe a remote X509 Certificate.
 */
  final static String RAW_X509_CERTIFICATE_TYPE="http://www.w3.org/2000/09/xmldsig#rawX509Certificate";
  /** 
 * Returns an {@link java.util.Collections#unmodifiableList unmodifiable
 * list} of the content in this <code>X509Data</code>. Valid types are{@link String} (subject names), <code>byte[]</code> (subject key ids),{@link java.security.cert.X509Certificate}, {@link X509CRL},
 * or {@link XMLStructure} ({@link X509IssuerSerial}objects or elements from an external namespace).
