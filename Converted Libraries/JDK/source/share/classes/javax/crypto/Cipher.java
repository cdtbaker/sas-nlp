 ...
 */
  ...
  private Cipher(  CipherSpi firstSpi,  Service firstService,  Iterator serviceIterator,  String transformation,  List transforms){
...
private static class Transform {
    ...
    private final static Map patternCache=Collections.synchronizedMap(new HashMap());
...
if (debug != null) {
debug.println("Cannot determine whether " + exmech.getName() + " has been enforced");
eme.printStackTrace();
}
return false;
}
