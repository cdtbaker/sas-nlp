 ...
 * @deprecated no replacement
 */
  @Deprecated public static synchronized PrintStream getDefaultStream(){
 ...
 * @deprecated no replacement
 */
  @Deprecated public static synchronized void setDefaultStream(  PrintStream newDefault){
 ...
 * @deprecated no replacement
 */
  @Deprecated public synchronized OutputStream getOutputStream(){
    return logOut;
  }
  /** 
 ...
 * @deprecated no replacement
 */
  @Deprecated public synchronized void setOutputStream(  OutputStream out){
    logOut=out;
 ...
 */
  @Deprecated public static int parseLevel(  String s){
    ...
    if ("SILENT".startsWith(s.toUpperCase()))     return SILENT;
 else     if ("BRIEF".startsWith(s.toUpperCase()))     return BRIEF;
