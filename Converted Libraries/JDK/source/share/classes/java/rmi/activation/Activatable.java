 ...
 * the stub for a remote object being exported is obtained as described in{@link java.rmi.server.UnicastRemoteObject}.
 ...
 * <p>This method invokes the {@link #exportObject(Remote,String,MarshalledObject,boolean,int)exportObject} method with this object, and the specified location,
 * data, restart mode, and port.  Subsequent calls to {@link #getID}will return the activation identifier returned from the call to
 ...
 * descriptor and export a remote object separately, so that exceptions
 * can be handled properly.
 * <p>This method invokes the {@link #exportObject(Remote,String,MarshalledObject,boolean,int,RMIClientSocketFactory,RMIServerSocketFactory)exportObject} method with this object, and the specified location,
 ...
 * <p>This method invokes the {@link #exportObject(Remote,String,MarshalledObject,boolean,int,RMIClientSocketFactory,RMIServerSocketFactory)exportObject} method with the specified object, location, data,
 ...
 * invoking the method {@link ActivationGroup#getSystemActivationGroup.getSystem}.  This method then obtains an {@link ActivationID} for the object by invoking the activation system's{@link ActivationSystem#registerObject registerObject} method with
 ...
 * <p>Next, this method exports the object by invoking the {@link #exportObject(Remote,ActivationID,int,RMIClientSocketFactory,RMIServerSocketFactory)exportObject} method with the specified remote object, the
 ...
 * invoking the activation system's {@link ActivationSystem#unregisterObject unregisterObject} method with the
 ...
 * <p>Finally, this method invokes the {@link ActivationGroup#activeObject activeObject} method on the activation
