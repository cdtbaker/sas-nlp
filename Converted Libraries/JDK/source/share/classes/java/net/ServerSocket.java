 ...
 * @exception SecurityExceptionif a security manager exists and its <code>checkListen</code>
 ...
 * @exception java.nio.channels.IllegalBlockingModeExceptionif this socket has an associated channel, the channel is in
 ...
 * @param s the Socket
 * @throws java.nio.channels.IllegalBlockingModeExceptionif this socket has an associated channel,
 ...
 * @param connectionTimeAn <tt>int</tt> expressing the relative importance of a short
 * connection time
 * @param latencyAn <tt>int</tt> expressing the relative importance of low
 * latency
 * @param bandwidthAn <tt>int</tt> expressing the relative importance of high
 * bandwidth
 * @since 1.5
 */
