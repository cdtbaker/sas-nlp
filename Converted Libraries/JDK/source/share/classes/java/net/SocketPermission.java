...
if (addr.length == 4) return authorizedIPv4(cname,addr);
 else if (addr.length == 16) return authorizedIPv6(cname,addr);
 else return false;
}
...
if (thisHost == null) return false;
 else return thisHost.equalsIgnoreCase(thatHost);
}
/** 
...
if (invalid || cname == null) return this.getName().hashCode();
 else return this.cname.hashCode();
}
/** 
