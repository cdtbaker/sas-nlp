 ...
 * <p> In this release, the socket options defined here are used by {@link java.nio.channels.NetworkChannel network} channels in the {@link java.nio.channels channels} package.
 * @since 1.7
 */
 ...
 * datagram-oriented sockets sending to {@link java.net.Inet4Address IPv4}broadcast addresses. When the socket option is enabled then the socket
 ...
 * <p> The value of this socket option is a {@code Boolean} that represents
 * whether the option is enabled or disabled. When the {@code SO_KEEPALIVE}option is enabled the operating system may use a <em>keep-alive</em>
 ...
 * the value of the ToS octet in IP packets sent by sockets to an {@link StandardProtocolFamily#INET IPv4} socket. The interpretation of the ToS
 ...
 * <p> The behavior of this socket option on a stream-oriented socket, or an{@link StandardProtocolFamily#INET6 IPv6} socket, is not defined in this
 * release.
 ...
 * datagram-oriented socket. For {@link StandardProtocolFamily#INET6 IPv6}sockets then it is system dependent whether setting this option also
 * sets the outgoing interface for multlicast datagrams sent to IPv4
 * addresses.
 * <p> The initial/default value of this socket option may be {@code null}to indicate that outgoing interface will be selected by the operating
 ...
 * but may be delivered locally. In the case of an {@link StandardProtocolFamily#INET6 IPv6} socket the option is the
 ...
 * <p> The initial/default value of the time-to-live setting is typically{@code 1}. An implementation allows this socket option to be set after
