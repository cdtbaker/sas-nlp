 ...
 * @throws SecurityExceptionIf a security manager has been installed and it denies{@link NetPermission}<tt>("getResponseCache")</tt>
 * @see #setDefault(ResponseCache)
 ...
 * @throws SecurityExceptionIf a security manager has been installed and it denies{@link NetPermission}<tt>("setResponseCache")</tt>
 * @see #getDefault()
 * @since 1.5
 */
