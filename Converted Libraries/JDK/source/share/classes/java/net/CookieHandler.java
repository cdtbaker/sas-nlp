 ...
 * @throws SecurityExceptionIf a security manager has been installed and it denies{@link NetPermission}<tt>("getCookieHandler")</tt>
 * @see #setDefault(CookieHandler)
 */
 ...
 * @throws SecurityExceptionIf a security manager has been installed and it denies{@link NetPermission}<tt>("setCookieHandler")</tt>
 * @see #getDefault()
 */
