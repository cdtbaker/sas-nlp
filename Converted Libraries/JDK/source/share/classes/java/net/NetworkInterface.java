 ...
 * @param nameThe name of the network interface.
 * @return  A <tt>NetworkInterface</tt> with the specified name,
 * or <tt>null</tt> if there is no network interface
 * with the specified name.
 * @throws SocketExceptionIf an I/O error occurs.
 * @throws NullPointerExceptionIf the specified name is <tt>null</tt>.
 */
 ...
 * returned.
 * @param addrThe <tt>InetAddress</tt> to search with.
 * @return  A <tt>NetworkInterface</tt>
 * or <tt>null</tt> if there is no network interface
 * with the specified IP address.
 * @throws SocketExceptionIf an I/O error occurs.
 * @throws NullPointerExceptionIf the specified address is <tt>null</tt>.
 */
