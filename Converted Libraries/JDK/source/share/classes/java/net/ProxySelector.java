 ...
 * @throws SecurityExceptionIf a security manager has been installed and it denies{@link NetPermission}<tt>("getProxySelector")</tt>
 * @see #setDefault(ProxySelector)
 ...
 * @throws SecurityExceptionIf a security manager has been installed and it denies{@link NetPermission}<tt>("setProxySelector")</tt>
 * @see #getDefault()
 * @since 1.5
 */
 ...
 * </UL>
 * @param uriThe URI that a connection is required to
 ...
 * @param uriThe URI that the proxy at sa failed to serve.
 * @param saThe socket address of the proxy/SOCKS server
 * @param ioeThe I/O exception thrown when the connect failed.
