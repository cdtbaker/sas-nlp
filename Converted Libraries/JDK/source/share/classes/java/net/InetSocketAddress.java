 ...
 */
  public InetSocketAddress(  InetAddress addr,  int port){
    ...
    this.port=port;
    if (addr == null)     this.addr=InetAddress.anyLocalAddress();
 else     this.addr=addr;
  }
  /** 
 ...
 */
  public final String getHostString(){
    if (hostname != null)     return hostname;
    if (addr != null) {
      if (addr.hostName != null)       return addr.hostName;
 ...
 */
  public final boolean equals(  Object obj){
    ...
    if (this.addr != null)     sameIP=this.addr.equals(sockAddr.addr);
 else     if (this.hostname != null)     sameIP=(sockAddr.addr == null) && this.hostname.equalsIgnoreCase(sockAddr.hostname);
