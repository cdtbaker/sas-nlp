 ...
 * @param inAn InputStream
 * @param charsetNameThe name of a supported{@link java.nio.charset.Charset </code>charset<code>}
 * @exception UnsupportedEncodingExceptionIf the named charset is not supported
 */
