 ...
 * size.
 * @param inA Reader object to provide the underlying stream
 */
 ...
 * the given size.
 * @param inA Reader object to provide the underlying stream
 * @param szAn int specifying the size of the buffer
 */
 ...
 * @param lineNumberAn int specifying the line number
 * @see #getLineNumber
 */
 ...
 * incremented.
 * @param cbufDestination buffer
 * @param offOffset at which to start storing characters
 * @param lenMaximum number of characters to read
...
/** 
 * Skip characters.
 * @param nThe number of characters to skip
 * @return  The number of characters actually skipped
 * @throws IOExceptionIf an I/O error occurs
 * @throws IllegalArgumentExceptionIf <tt>n</tt> is negative
 */
 ...
 * @param readAheadLimitLimit on the number of characters that may be read while still
 ...
 * @throws IOExceptionIf the stream has not been marked, or if the mark has been
 * invalidated
 */
