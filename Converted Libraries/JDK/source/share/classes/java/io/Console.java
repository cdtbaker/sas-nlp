 ...
 * @param fmtA format string as described in <a
...
static {
    try {
      sun.misc.SharedSecrets.getJavaLangAccess().registerShutdownHook(0,false,new Runnable(){
        public void run(){
          try {
            if (echoOff) {
              echo(true);
