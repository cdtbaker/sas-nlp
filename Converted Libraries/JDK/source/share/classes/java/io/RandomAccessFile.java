 ...
 * <tt>"rwd"</tt>
 * @exception FileNotFoundExceptionif the mode is <tt>"r"</tt> but the given string does not
 ...
 * to one of <tt>"r"</tt>, <tt>"rw"</tt>, <tt>"rws"</tt>, or
 * <tt>"rwd"</tt>
 * @exception FileNotFoundExceptionif the mode is <tt>"r"</tt> but the given file object does
 ...
 */
  public RandomAccessFile(  File file,  String mode) throws FileNotFoundException {
    ...
    int imode=-1;
    if (mode.equals("r"))     imode=O_RDONLY;
 else     if (mode.startsWith("rw")) {
      imode=O_RDWR;
      rw=true;
      if (mode.length() > 2) {
        if (mode.equals("rws"))         imode|=O_SYNC;
 else         if (mode.equals("rwd"))         imode|=O_DSYNC;
 else         imode=-1;
      }
    }
