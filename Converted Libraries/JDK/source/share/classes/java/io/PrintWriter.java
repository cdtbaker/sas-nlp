 ...
 * @param fileNameThe name of the file to use as the destination of this writer.
 * If the file exists then it will be truncated to zero size;
 * otherwise, a new file will be created.  The output will be
 * written to the file and is buffered.
 * @throws FileNotFoundExceptionIf the given string does not denote an existing, writable
 ...
 * which will encode characters using the {@linkplain java.nio.charset.Charset#defaultCharset() default charset} for this
 * instance of the Java virtual machine.
 * @param fileThe file to use as the destination of this writer.  If the file
