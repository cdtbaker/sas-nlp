 ...
 * <i>cause</i>, and may be accessed via the {@link Throwable#getCause()}method, as well as the aforementioned "legacy field."
 * @author  unascribed
 * @since   JDK1.1
 */
 ...
 */
 ...
 else     return super.getMessage() + "; " + detail.toString();
  }
  /** 
