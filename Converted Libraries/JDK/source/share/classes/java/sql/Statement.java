 ...
 * the entire batch of SQL commands invoked by the {@code executeBatch}method (consult your driver vendor documentation for details).
 ...
 * @exception SQLException if a database access error occurs,
 * this method is called on a closed <code>Statement</code> or the
 * driver does not support batch statements. Throws {@link BatchUpdateException}(a subclass of <code>SQLException</code>) if one of the commands sent to the
 ...
 * dependent result sets are closed. If execution of the {@code Statement}does not produce any result sets, this method has no effect.
 * <p>
 * <strong>Note:</strong> Multiple calls to {@code closeOnCompletion} do
 * not toggle the effect on this {@code Statement}. However, a call to{@code closeOnCompletion} does effect both the subsequent execution of
