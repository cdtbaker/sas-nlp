 ...
 * @return {@code true} if this BigInteger is probably prime,{@code false} if it's definitely composite.
 */
 ...
 * remainder computed.
 * @return an array of two BigIntegers: the quotient {@code (this / val)}is the initial element, and the remainder {@code (this % val)}is the final element.
 * @throws ArithmeticException if {@code val} is zero.
 */
 ...
 * @return {@code this << n}
 * @throws ArithmeticException if the shift distance is {@codeInteger.MIN_VALUE}.
 * @see #shiftRight
 */
 ...
 * @return the BigInteger whose value is the lesser of this BigInteger and{@code val}.  If they are equal, either may be returned.
 */
 ...
 * @return the BigInteger whose value is the greater of this and{@code val}.  If they are equal, either may be returned.
 */
