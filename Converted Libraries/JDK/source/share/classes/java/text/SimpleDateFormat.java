...
if (count != 2) zeroPaddingNumber(value,count,maxIntCount,buffer);
 else zeroPaddingNumber(value,2,2,buffer);
}
 else {
if (current == null) {
...
if (current == null) {
if (value == 0) zeroPaddingNumber(calendar.getMaximum(Calendar.HOUR_OF_DAY) + 1,count,maxIntCount,buffer);
...
case PATTERN_HOUR1:
if (current == null) {
if (value == 0) zeroPaddingNumber(calendar.getLeastMaximum(Calendar.HOUR) + 1,count,maxIntCount,buffer);
 else zeroPaddingNumber(value,count,maxIntCount,buffer);
}
break;
