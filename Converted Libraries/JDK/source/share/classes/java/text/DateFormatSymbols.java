 ...
 * @see #getInstance()
 * @exception java.util.MissingResourceExceptionif the resources for the default locale cannot be
 ...
 * @exception java.util.MissingResourceExceptionif the resources for the specified locale cannot be
 * found or cannot be loaded.
 */
