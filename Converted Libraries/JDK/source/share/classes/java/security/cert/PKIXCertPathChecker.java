 ...
 * using the {@link PKIXParameters#setCertPathCheckers setCertPathCheckers}or {@link PKIXParameters#addCertPathChecker addCertPathChecker} methods
 * of the <code>PKIXParameters</code> and <code>PKIXBuilderParameters</code>
 * class. Each of the <code>PKIXCertPathChecker</code>s {@link #check check}methods will be called, in turn, for each certificate processed by a PKIX
 ...
 * presented with certificates in the forward direction). The{@link #isForwardCheckingSupported isForwardCheckingSupported} method
