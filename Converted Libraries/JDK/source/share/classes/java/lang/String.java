 ...
 * @param valueThe initial value of the string
 */
 ...
 * @param valueArray that is the source of characters
 * @param offsetThe initial offset
 * @param countThe length
 * @throws IndexOutOfBoundsExceptionIf the {@code offset} and {@code count} arguments index
 ...
 * @param codePointsArray that is the source of Unicode code points
 * @param offsetThe initial offset
 * @param countThe length
 * @throws IllegalArgumentExceptionIf any invalid Unicode code point is found in {@codecodePoints}
 * @throws IndexOutOfBoundsExceptionIf the {@code offset} and {@code count} arguments index
 ...
 */
 ...
 else       if (Character.isValidCodePoint(c))       n++;
 else       throw new IllegalArgumentException(Integer.toString(c));
    }
    final char[] v=new char[n];
    for (int i=offset, j=0; i < end; i++, j++) {
      int c=codePoints[i];
      if (Character.isBmpCodePoint(c))       v[j]=(char)c;
 else       Character.toSurrogates(c,v,j++);
    }
    this.value=v;
    this.count=n;
    this.offset=0;
 ...
 * default charset.
 * @param asciiThe bytes to be converted to characters
 * @param hibyteThe top 8 bits of each 16-bit Unicode code unit
 * @param offsetThe initial offset
 * @param countThe length
 * @throws IndexOutOfBoundsExceptionIf the {@code offset} or {@code count} argument is invalid
 * @see #String(byte[],int)
 ...
 * @param bytesThe bytes to be decoded into characters
 * @param offsetThe index of the first byte to decode
 * @param lengthThe number of bytes to decode
 * @param charsetNameThe name of a supported {@linkplain java.nio.charset.Charsetcharset}
 * @throws UnsupportedEncodingExceptionIf the named charset is not supported
 * @throws IndexOutOfBoundsExceptionIf the {@code offset} and {@code length} arguments index
 ...
 * @param offsetThe index of the first byte to decode
 * @param lengthThe number of bytes to decode
 * @param charsetThe {@linkplain java.nio.charset.Charset charset} to be used to
 ...
 * @param offsetThe index of the first byte to decode
 * @param lengthThe number of bytes to decode
 * @throws IndexOutOfBoundsExceptionIf the {@code offset} and the {@code length} arguments index
 * characters outside the bounds of the {@code bytes} array
 * @since  JDK1.1
 */
 ...
 * @param bufferA {@code StringBuffer}
 */
 ...
 * @param builderA {@code StringBuilder}
 * @since  1.5
 */
 ...
 * @param srcBeginIndex of the first character in the string to copy
 * @param srcEndIndex after the last character in the string to copy
 * @param dstThe destination array
 * @param dstBeginThe start offset in the destination array
 * @throws IndexOutOfBoundsExceptionIf any of the following is true:
 * <ul>
 ...
 * @param charsetThe {@linkplain java.nio.charset.Charset} to be used to encode
 * the {@code String}
 * @return  The resultant byte array
 * @since  1.6
 */
 ...
 * object.
 * @param anObjectThe object to compare this {@code String} against
 ...
 * @param sbThe {@code StringBuffer} to compare this {@code String} against
 ...
 * @param csThe sequence to compare this {@code String} against
 * @return  {@code true} if this {@code String} represents the same
 ...
 * produces the same result
 * </ul>
 * @param anotherStringThe {@code String} to compare this {@code String} against
 ...
 * @throws IndexOutOfBoundsExceptionif <tt>beginIndex</tt> or <tt>endIndex</tt> are negative,
 ...
 * @param regexthe regular expression to which this string is to be matched
 * @return  <tt>true</tt> if, and only if, this string matches the
 * given regular expression
 * @throws PatternSyntaxExceptionif the regular expression's syntax is invalid
 ...
 * @param regexthe regular expression to which this string is to be matched
 * @param replacementthe string to be substituted for the first match
 ...
 * meaning of these characters, if desired.
 * @param regexthe regular expression to which this string is to be matched
 * @param replacementthe string to be substituted for each match
 * @return  The resulting <tt>String</tt>
 * @throws PatternSyntaxExceptionif the regular expression's syntax is invalid
 * @see java.util.regex.Pattern
 * @since 1.4
 ...
 * </blockquote>
 * @param regexthe delimiting regular expression
 * @param limitthe result threshold, as described above
 ...
 */
  public String[] split(  String regex,  int limit){
    char ch=0;
    if (((regex.count == 1 && ".$|()[{^?*+\\".indexOf(ch=regex.charAt(0)) == -1) || (regex.length() == 2 && regex.charAt(0) == '\\' && (((ch=regex.charAt(1)) - '0') | ('9' - ch)) < 0 && ((ch - 'a') | ('z' - ch)) < 0 && ((ch - 'A') | ('Z' - ch)) < 0)) && (ch < Character.MIN_HIGH_SURROGATE || ch > Character.MAX_LOW_SURROGATE)) {
      int off=0;
      int next=0;
 ...
 * @param formatA <a href="../util/Formatter.html#syntax">format string</a>
 * @param argsArguments referenced by the format specifiers in the format
 ...
 * @throws IllegalFormatExceptionIf a format string contains an illegal syntax, a format
 ...
 * @throws NullPointerExceptionIf the <tt>format</tt> is <tt>null</tt>
 ...
 * and arguments.
 * @param lThe {@linkplain java.util.Locale locale} to apply during
