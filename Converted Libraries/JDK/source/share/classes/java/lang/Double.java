 ...
 */
  public static String toHexString(  double d){
    if (!FpUtils.isFinite(d))     return Double.toString(d);
 else {
 ...
 */
  public static long doubleToLongBits(  double value){
    ...
    if (((result & DoubleConsts.EXP_BIT_MASK) == DoubleConsts.EXP_BIT_MASK) && (result & DoubleConsts.SIGNIF_BIT_MASK) != 0L)     result=0x7ff8000000000000L;
    return result;
  }
  /** 
 * Returns a representation of the specified floating-point value
