 ...
 * @param i   a {@code long} to be converted to a string.
 * @return  the string representation of the unsigned {@code long}value represented by the argument in hexadecimal
 * (base&nbsp;16).
 * @since   JDK 1.0.2
 */
 ...
 * <code>'&#92;u0037'</code>.
 * @param i   a {@code long} to be converted to a string.
 * @return  the string representation of the unsigned {@code long}value represented by the argument in octal (base&nbsp;8).
 * @since   JDK 1.0.2
 */
 ...
 * @param i   a {@code long} to be converted to a string.
 * @return  the string representation of the unsigned {@code long}value represented by the argument in binary (base&nbsp;2).
 * @since   JDK 1.0.2
 */
