 ...
 * @param statusTermination status.  By convention, a nonzero status code
 * indicates abnormal termination.
 * @throws SecurityExceptionIf a security manager is present and its <tt>{@link SecurityManager#checkExit checkExit}</tt> method does not permit
 ...
 * will be run. <p>
 * @param hookAn initialized but unstarted <tt>{@link Thread}</tt> object
 * @throws IllegalArgumentExceptionIf the specified hook has already been registered,
 * or if it can be determined that the hook is already running or
 * has already been run
 * @throws IllegalStateExceptionIf the virtual machine is already in the process
 * of shutting down
 * @throws SecurityExceptionIf a security manager is present and it denies
 ...
 * otherwise.
 * @throws IllegalStateExceptionIf the virtual machine is already in the process of shutting
 * down
 * @throws SecurityExceptionIf a security manager is present and it denies
 * <tt>{@link RuntimePermission}("shutdownHooks")</tt>
 * @see #addShutdownHook
 ...
 * @throws SecurityExceptionif a security manager exists and its <code>checkExit</code>
 ...
 * @throws SecurityExceptionIf a security manager exists and its{@link SecurityManager#checkExec checkExec}method doesn't allow creation of the subprocess
 * @throws IOExceptionIf an I/O error occurs
 * @throws NullPointerExceptionIf <code>command</code> is <code>null</code>
 * @throws IllegalArgumentExceptionIf <code>command</code> is empty
 ...
 * @throws SecurityExceptionIf a security manager exists and its{@link SecurityManager#checkExec checkExec}method doesn't allow creation of the subprocess
 * @throws IOExceptionIf an I/O error occurs
 * @throws NullPointerExceptionIf <code>cmdarray</code> is <code>null</code>,
 * or one of the elements of <code>cmdarray</code> is <code>null</code>
 * @throws IndexOutOfBoundsExceptionIf <code>cmdarray</code> is an empty array
