 ...
 * @param millisthe length of time to sleep in milliseconds
 * @throws IllegalArgumentExceptionif the value of {@code millis} is negative
 * @throws InterruptedExceptionif any thread has interrupted the current thread. The
 ...
 * @throws IllegalArgumentExceptionif the value of {@code millis} is negative, or the value of{@code nanos} is not in the range {@code 0-999999}
 * @throws InterruptedExceptionif any thread has interrupted the current thread. The
 * <i>interrupted status</i> of the current thread is
 * cleared when this exception is thrown.
 */
 ...
 * @throws CloneNotSupportedExceptionalways
 */
 ...
 * name. Automatically generated names are of the form{@code "Thread-"+}<i>n</i>, where <i>n</i> is an integer.
 * @param targetthe object whose {@code run} method is invoked when this thread
 ...
 * name. Automatically generated names are of the form{@code "Thread-"+}<i>n</i>, where <i>n</i> is an integer.
 * @param groupthe thread group. If {@code null} and there is a security
 ...
 * @throws SecurityExceptionif the current thread cannot create a thread in the specified
 * thread group
 */
 ...
 * @param namethe name of the new thread
 */
 ...
 * is started. If {@code null}, this thread's run method is invoked.
 * @param namethe name of the new thread
 * @param stackSizethe desired stack size for the new thread, or zero to indicate
 ...
 * @see SecurityManager#checkAccess(Thread)
 * @see SecurityManager#checkPermission
 * @deprecated This method is inherently unsafe.  See {@link #stop()}for details.  An additional danger of this
 ...
 * are Thread.stop, Thread.suspend and Thread.resume Deprecated?</a>.
 */
  @Deprecated public final synchronized void stop(  Throwable obj){
 ...
 * @throws SecurityExceptionif the current thread cannot modify this thread
 * @revised 6.0
 * @spec JSR-51
 */
 ...
 * @param tarrayan array into which to put the list of threads
 * @return  the number of threads put into the array
 * @throws SecurityExceptionif {@link java.lang.ThreadGroup#checkAccess} determines that
 ...
 * @param millisthe time to wait in milliseconds
 * @throws IllegalArgumentExceptionif the value of {@code millis} is negative
 * @throws InterruptedExceptionif any thread has interrupted the current thread. The
 * <i>interrupted status</i> of the current thread is
 * cleared when this exception is thrown.
 ...
 * @throws IllegalArgumentExceptionif the value of {@code millis} is negative, or the value
 ...
 * @param onif {@code true}, marks this thread as a daemon thread
 * @throws IllegalThreadStateExceptionif this thread is {@linkplain #isAlive alive}
 * @throws SecurityExceptionif {@link #checkAccess} determines that the current
 ...
 * @return  the context ClassLoader for this Thread, or {@code null}indicating the system class loader (or, failing that, the
 * bootstrap class loader)
 * @throws SecurityExceptionif the current thread cannot get the context ClassLoader
 * @since 1.2
 */
 ...
 * @param clthe context ClassLoader for this Thread, or null  indicating the
 * system class loader (or, failing that, the bootstrap class loader)
 * @throws SecurityExceptionif the current thread cannot set the context ClassLoader
 * @since 1.2
 */
