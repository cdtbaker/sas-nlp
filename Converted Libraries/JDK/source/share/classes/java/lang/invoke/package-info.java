 ...
 * and which must produce a {@link java.lang.invoke.MethodHandle method handle}that gives the behavior of the call site.
 * <p>
 ...
 * </ul>
 * Invocation is as if by{@link java.lang.invoke.MethodHandle#invoke MethodHandle.invoke}.
 ...
 * mutable behaviors, their bootstrap methods should produce distinct{@link java.lang.invoke.CallSite CallSite} objects, one for each linkage request.
 ...
 * For example, the first argument could be {@code Object}instead of {@code MethodHandles.Lookup}, and the return type
 ...
 * The bootstrap method will be invoked as if by either {@code MethodHandle.invoke}or {@code invokeWithArguments}.  (There is no way to tell the difference.)
 * <p>
 ...
 * The second-to-last example assumes that all extra arguments are of type{@code CONSTANT_String}.
 ...
 * constant as an {@code Object}, but the type matching machinery of {@code MethodHandle.invoke}will cast the reference back to {@code MethodHandle} before invoking the bootstrap method.
