 ...
 */
  ...
  static MethodHandle makeAllocator(  MethodHandle rawConstructor){
    ...
    assert (allocator.type().equals(rawConType.dropParameterTypes(0,1).changeReturnType(rawConType.parameterType(0))));
    return allocator;
  }
static final class AllocateObject<C> extends BoundMethodHandle {
    ...
    @SuppressWarnings("unchecked") private C allocate() throws InstantiationException {
...
static final class FieldAccessor<C,V> extends BoundMethodHandle {
    ...
    @Override String debugString(){
      return addTypeString(name,this);
    }
    int getFieldI(    C obj){
    ...
    @SuppressWarnings("unchecked") V getFieldL(    C obj){
      return (V)unsafe.getObject(obj,offset);
    }
    @SuppressWarnings("unchecked") void setFieldL(    C obj,    V x){
    ...
    static String fname(    Class<?> vclass,    boolean isSetter,    boolean isStatic){
      String stem;
      if (!isStatic)       stem=(!isSetter ? "getField" : "setField");
 else       stem=(!isSetter ? "getStatic" : "setStatic");
    ...
    static MethodType ftype(    Class<?> cclass,    Class<?> vclass,    boolean isSetter,    boolean isStatic){
      MethodType type;
      if (!isStatic) {
        if (!isSetter)         return MethodType.methodType(vclass,cclass);
 else         return MethodType.methodType(void.class,cclass,vclass);
      }
 else {
        if (!isSetter)         return MethodType.methodType(vclass);
 else         return MethodType.methodType(void.class,vclass);
      }
    }
    ...
    static MethodType atype(    Class<?> aclass,    boolean isSetter){
      Class<?> vclass=aclass.getComponentType();
      if (!isSetter)       return MethodType.methodType(vclass,aclass,int.class);
 else       return MethodType.methodType(void.class,aclass,int.class,vclass);
    }
 ...
 */
  static MethodHandle bindReceiver(  MethodHandle target,  Object receiver){
    ...
    if (target instanceof AdapterMethodHandle && ((AdapterMethodHandle)target).conversionOp() == MethodHandleNatives.Constants.OP_RETYPE_ONLY) {
    ...
    if (target instanceof DirectMethodHandle)     return new BoundMethodHandle((DirectMethodHandle)target,receiver,0);
    return null;
  }
  /** 
 ...
 */
  ...
  static MethodHandle permuteArguments(  MethodHandle target,  MethodType newType,  MethodType oldType,  int[] permutationOrNull){
    ...
    if (permutationOrNull.length != outargs)     throw newIllegalArgumentException("wrong number of arguments in permutation");
    ...
    while (!state.equals(goal)) {
      ...
      for (int i=0; i < size; i++) {
        ...
        if (arg == thisRotArg + TOKEN) {
          ...
          if (arg != wantArg && arg >= wantArg - TOKEN * MAX_ARG_ROTATION && arg <= wantArg + TOKEN * MAX_ARG_ROTATION) {
            thisRotArg=arg;
            thisRotLen=1;
          }
        }
  ...
  static MethodHandle convertArguments(  MethodHandle target,  MethodType newType,  MethodType oldType,  int level){
    ...
    if (oldType.parameterCount() != newType.parameterCount())     throw newIllegalArgumentException("mismatched parameter count",oldType,newType);
  ...
  static MethodHandle collectArguments(  MethodHandle target,  int collectArg,  MethodHandle collector){
    ...
    if (collectType != type.parameterType(collectArg))     target=target.asType(type.changeParameterType(collectArg,collectType));
...
private static class GuardWithTest extends BoundMethodHandle {
    ...
    static MethodHandle make(    MethodHandle test,    MethodHandle target,    MethodHandle fallback){
      ...
      if (nargs < INVOKES.length) {
        if (preferRicochetFrame(type))         assert (MethodHandleNatives.workaroundWithoutRicochetFrames());
        MethodHandle invoke=INVOKES[nargs];
    ...
    private Object invoke_L6(    Object a0,    Object a1,    Object a2,    Object a3,    Object a4,    Object a5) throws Throwable {
      if ((boolean)test.invokeExact(a0,a1,a2,a3,a4,a5))       return target.invokeExact(a0,a1,a2,a3,a4,a5);
      return fallback.invokeExact(a0,a1,a2,a3,a4,a5);
    }
    private Object invoke_L7(    Object a0,    Object a1,    Object a2,    Object a3,    Object a4,    Object a5,    Object a6) throws Throwable {
      if ((boolean)test.invokeExact(a0,a1,a2,a3,a4,a5,a6))       return target.invokeExact(a0,a1,a2,a3,a4,a5,a6);
      return fallback.invokeExact(a0,a1,a2,a3,a4,a5,a6);
    }
    private Object invoke_L8(    Object a0,    Object a1,    Object a2,    Object a3,    Object a4,    Object a5,    Object a6,    Object a7) throws Throwable {
      if ((boolean)test.invokeExact(a0,a1,a2,a3,a4,a5,a6,a7))       return target.invokeExact(a0,a1,a2,a3,a4,a5,a6,a7);
