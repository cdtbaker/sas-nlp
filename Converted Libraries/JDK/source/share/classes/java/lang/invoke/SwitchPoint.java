 ...
 * to call {@code s.guardWithTest} on{@link MethodHandles#constant constant} true and false method handles.
 ...
 */
  public MethodHandle guardWithTest(  MethodHandle target,  MethodHandle fallback){
    if (mcs.getTarget() == K_false)     return fallback;
 ...
 * simply change the call site's target, and issue one call to{@linkplain MutableCallSite#syncAll synchronize} all the
 * private call sites.
