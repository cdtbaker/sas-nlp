 ...
 * <p>
 * To avoid race conditions, calls to {@code setTarget} and {@code syncAll}should generally be performed under some sort of mutual exclusion.
 ...
 * If {@code T} executes a synchronization action {@code A}after the volatile write to {@code V} (in the global synchronization order),
 ...
 * relation.  Regardless of this fact, the volatile {@code V}will not be elided, even though its written value is
 * indeterminate and its read value is not used.
 * </ul>
 * Because of the last point, the implementation behaves as if a
 * volatile read of {@code V} were performed by {@code T}immediately after its action {@code A}.  In the local ordering
 ...
 * implementations may delay the completion of a {@code syncAll}operation while other threads ({@code T} above) continue to
