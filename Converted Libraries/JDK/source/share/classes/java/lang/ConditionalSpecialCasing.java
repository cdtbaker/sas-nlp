...
final class ConditionalSpecialCasing {
  ...
  static Entry[] entry={new Entry(0x03A3,new char[]{0x03C2},new char[]{0x03A3},null,FINAL_CASED),new Entry(0x0307,new char[]{0x0307},new char[]{},"lt",AFTER_SOFT_DOTTED),new Entry(0x0049,new char[]{0x0069,0x0307},new char[]{0x0049},"lt",MORE_ABOVE),new Entry(0x004A,new char[]{0x006A,0x0307},new char[]{0x004A},"lt",MORE_ABOVE),new Entry(0x012E,new char[]{0x012F,0x0307},new char[]{0x012E},"lt",MORE_ABOVE),new Entry(0x00CC,new char[]{0x0069,0x0307,0x0300},new char[]{0x00CC},"lt",0),new Entry(0x00CD,new char[]{0x0069,0x0307,0x0301},new char[]{0x00CD},"lt",0),new Entry(0x0128,new char[]{0x0069,0x0307,0x0303},new char[]{0x0128},"lt",0),new Entry(0x0130,new char[]{0x0069,0x0307},new char[]{0x0130},"lt",0),new Entry(0x0307,new char[]{},new char[]{0x0307},"tr",AFTER_I),new Entry(0x0307,new char[]{},new char[]{0x0307},"az",AFTER_I),new Entry(0x0049,new char[]{0x0131},new char[]{0x0049},"tr",NOT_BEFORE_DOT),new Entry(0x0049,new char[]{0x0131},new char[]{0x0049},"az",NOT_BEFORE_DOT),new Entry(0x0069,new char[]{0x0069},new char[]{0x0130},"tr",0),new Entry(0x0069,new char[]{0x0069},new char[]{0x0130},"az",0),new Entry(0x0130,new char[]{0x0069,0x0307},new char[]{0x0130},"en",0)};
