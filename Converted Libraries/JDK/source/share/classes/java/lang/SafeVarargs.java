 ...
 * sites.
 * <p> In addition to the usage restrictions imposed by its {@link Target @Target} meta-annotation, compilers are required to implement
 ...
 * <li> the declaration is a variable arity method that is neither{@code static} nor {@code final}.
 * </ul>
