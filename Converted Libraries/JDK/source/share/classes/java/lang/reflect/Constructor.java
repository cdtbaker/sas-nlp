 ...
 */
  public Type[] getGenericParameterTypes(){
    if (getSignature() != null)     return getGenericInfo().getParameterTypes();
 ...
 */
  public Type[] getGenericExceptionTypes(){
    Type[] result;
    if (getSignature() != null && ((result=getGenericInfo().getExceptionTypes()).length > 0))     return result;
  ...
  public Annotation[][] getParameterAnnotations(){
    ...
    if (result.length != numParameters) {
      ...
      if (declaringClass.isEnum() || declaringClass.isAnonymousClass() || declaringClass.isLocalClass())       ;
        ...
        if (!declaringClass.isMemberClass() || (declaringClass.isMemberClass() && ((declaringClass.getModifiers() & Modifier.STATIC) == 0) && result.length + 1 != numParameters)) {
