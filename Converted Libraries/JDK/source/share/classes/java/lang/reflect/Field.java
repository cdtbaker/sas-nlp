 ...
 */
  public Type getGenericType(){
    if (getGenericSignature() != null)     return getGenericInfo().getGenericType();
 else     return getType();
  }
  /** 
 ...
 */
  ...
  private FieldAccessor acquireFieldAccessor(  boolean overrideFinalCheck){
    ...
    if (tmp != null) {
      if (overrideFinalCheck)       overrideFieldAccessor=tmp;
 else       fieldAccessor=tmp;
    }
 else {
  ...
  private void setFieldAccessor(  FieldAccessor accessor,  boolean overrideFinalCheck){
    if (overrideFinalCheck)     overrideFieldAccessor=accessor;
 else     fieldAccessor=accessor;
    if (root != null) {
