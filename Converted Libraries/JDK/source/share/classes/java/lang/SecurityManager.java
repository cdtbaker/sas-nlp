 ...
 * call be used instead.
 */
  @Deprecated protected native int classDepth(  String name);
  /** 
 ...
 */
  public void checkConnect(  String host,  int port,  Object context){
    ...
    if (port == -1)     checkPermission(new SocketPermission(host,SecurityConstants.SOCKET_RESOLVE_ACTION),context);
 else     checkPermission(new SocketPermission(host + ":" + port,SecurityConstants.SOCKET_CONNECT_ACTION),context);
  }
  /** 
 * Throws a <code>SecurityException</code> if the
