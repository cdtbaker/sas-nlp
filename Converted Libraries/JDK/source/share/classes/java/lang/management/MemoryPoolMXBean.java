 ...
 * <blockquote>{@link ManagementFactory#MEMORY_POOL_MXBEAN_DOMAIN_TYPE<tt>java.lang:type=MemoryPool</tt>}<tt>,name=</tt><i>pool's name</i>
 * </blockquote>
 ...
 * The usage threshold can be set via the{@link #setUsageThreshold setUsageThreshold} method.
 ...
 * Each memory pool maintains a {@link #getUsageThresholdCountusage threshold count} that will get incremented
 ...
 * the virtual machine will trigger the <tt>MemoryMXBean</tt> to emit an{@link MemoryNotificationInfo#MEMORY_THRESHOLD_EXCEEDEDusage threshold exceeded notification}.
 ...
 * a {@link MemoryNotificationInfo#MEMORY_THRESHOLD_EXCEEDEDcollection usage threshold exceeded notification}will be emitted by the {@link MemoryMXBean}.
 * In addition, the {@link #getCollectionUsageThresholdCountcollection usage threshold count} will then be incremented.
 * <p>
 ...
 * The current usage threshold can be changed via the{@link #setUsageThreshold setUsageThreshold} method.
 ...
 * threshold can be changed via the{@link #setCollectionUsageThreshold setCollectionUsageThreshold} method.
