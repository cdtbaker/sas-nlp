 ...
 * objects to free up memory space.  A garbage collector is one type of{@link MemoryManagerMXBean memory manager}.
 ...
 * <blockquote>{@link ManagementFactory#GARBAGE_COLLECTOR_MXBEAN_DOMAIN_TYPE<tt>java.lang:type=GarbageCollector</tt>}<tt>,name=</tt><i>collector's name</i>
 * </blockquote>
