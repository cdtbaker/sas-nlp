 ...
 * <blockquote>{@link ManagementFactory#MEMORY_MXBEAN_NAME<tt>java.lang:type=Memory</tt>}</blockquote>
 ...
 * high performance.
 * <h4>Memory Pools and Memory Managers</h4>{@link MemoryPoolMXBean Memory pools} and{@link MemoryManagerMXBean memory managers} are the abstract entities
 ...
 * <h4>Notifications</h4>
 * <p>This <tt>MemoryMXBean</tt> is a{@link javax.management.NotificationEmitter NotificationEmitter}that emits two types of memory {@link javax.management.Notificationnotifications} if any one of the memory pools
 ...
 * threshold</a> which can be determined by calling the{@link MemoryPoolMXBean#isUsageThresholdSupported} and{@link MemoryPoolMXBean#isCollectionUsageThresholdSupported} methods.
 * <ul>
 * <li>{@link MemoryNotificationInfo#MEMORY_THRESHOLD_EXCEEDEDusage threshold exceeded notification} - for notifying that
 * the memory usage of a memory pool is increased and has reached
 * or exceeded its
 * <a href="MemoryPoolMXBean.html#UsageThreshold"> usage threshold</a> value.
 * </li>
 * <li>{@link MemoryNotificationInfo#MEMORY_COLLECTION_THRESHOLD_EXCEEDEDcollection usage threshold exceeded notification} - for notifying that
 ...
 * </ul>
 * <p>
 * The notification emitted is a {@link javax.management.Notification}instance whose {@link javax.management.Notification#setUserDatauser data} is set to a {@link CompositeData CompositeData}that represents a {@link MemoryNotificationInfo} object
 ...
 * as described in {@link MemoryNotificationInfo#fromMemoryNotificationInfo}.
 * <hr>
 * <h4>NotificationEmitter</h4>
 * The <tt>MemoryMXBean</tt> object returned by{@link ManagementFactory#getMemoryMXBean} implements
 * the {@link javax.management.NotificationEmitter NotificationEmitter}interface that allows a listener to be registered within the
 ...
 * <tt>CompositeData</tt> with attributes as specified in{@link MemoryUsage#from MemoryUsage}.
