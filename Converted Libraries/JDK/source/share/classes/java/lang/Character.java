 ...
 * @since   1.1
 */
  @SuppressWarnings("unchecked") public static final Class<Character> TYPE=Class.getPrimitiveClass("char");
  /** 
 ...
 */
    @Deprecated public static final UnicodeBlock SURROGATES_AREA=new UnicodeBlock("SURROGATES_AREA");
    /** 
 ...
 */
    ...
    private static final int blockStarts[]={0x0000,0x0080,0x0100,0x0180,0x0250,0x02B0,0x0300,0x0370,0x0400,0x0500,0x0530,0x0590,0x0600,0x0700,0x0750,0x0780,0x07C0,0x0800,0x0840,0x0860,0x0900,0x0980,0x0A00,0x0A80,0x0B00,0x0B80,0x0C00,0x0C80,0x0D00,0x0D80,0x0E00,0x0E80,0x0F00,0x1000,0x10A0,0x1100,0x1200,0x1380,0x13A0,0x1400,0x1680,0x16A0,0x1700,0x1720,0x1740,0x1760,0x1780,0x1800,0x18B0,0x1900,0x1950,0x1980,0x19E0,0x1A00,0x1A20,0x1AB0,0x1B00,0x1B80,0x1BC0,0x1C00,0x1C50,0x1C80,0x1CD0,0x1D00,0x1D80,0x1DC0,0x1E00,0x1F00,0x2000,0x2070,0x20A0,0x20D0,0x2100,0x2150,0x2190,0x2200,0x2300,0x2400,0x2440,0x2460,0x2500,0x2580,0x25A0,0x2600,0x2700,0x27C0,0x27F0,0x2800,0x2900,0x2980,0x2A00,0x2B00,0x2C00,0x2C60,0x2C80,0x2D00,0x2D30,0x2D80,0x2DE0,0x2E00,0x2E80,0x2F00,0x2FE0,0x2FF0,0x3000,0x3040,0x30A0,0x3100,0x3130,0x3190,0x31A0,0x31C0,0x31F0,0x3200,0x3300,0x3400,0x4DC0,0x4E00,0xA000,0xA490,0xA4D0,0xA500,0xA640,0xA6A0,0xA700,0xA720,0xA800,0xA830,0xA840,0xA880,0xA8E0,0xA900,0xA930,0xA960,0xA980,0xA9E0,0xAA00,0xAA60,0xAA80,0xAAE0,0xAB00,0xAB30,0xABC0,0xAC00,0xD7B0,0xD800,0xDB80,0xDC00,0xE000,0xF900,0xFB00,0xFB50,0xFE00,0xFE10,0xFE20,0xFE30,0xFE50,0xFE70,0xFF00,0xFFF0,0x10000,0x10080,0x10100,0x10140,0x10190,0x101D0,0x10200,0x10280,0x102A0,0x102E0,0x10300,0x10330,0x10350,0x10380,0x103A0,0x103E0,0x10400,0x10450,0x10480,0x104B0,0x10800,0x10840,0x10860,0x10900,0x10920,0x10940,0x10A00,0x10A60,0x10A80,0x10B00,0x10B40,0x10B60,0x10B80,0x10C00,0x10C50,0x10E60,0x10E80,0x11000,0x11080,0x110D0,0x12000,0x12400,0x12480,0x13000,0x13430,0x16800,0x16A40,0x1B000,0x1B100,0x1D000,0x1D100,0x1D200,0x1D250,0x1D300,0x1D360,0x1D380,0x1D400,0x1D800,0x1F000,0x1F030,0x1F0A0,0x1F100,0x1F200,0x1F300,0x1F600,0x1F650,0x1F680,0x1F700,0x1F780,0x20000,0x2A6E0,0x2A700,0x2B740,0x2B820,0x2F800,0x2FA20,0xE0000,0xE0080,0xE0100,0xE01F0,0xF0000,0x100000};
 ...
 * Unicode block of which this character is a member, or{@code null} if the character is not a member of any
 * Unicode block
 * @exception IllegalArgumentException if the specified{@code codePoint} is an invalid Unicode code point.
 ...
 * @param codePoint the character (Unicode code point) to be tested
 * @return {@code true} if the specified code point is between{@link #MIN_SUPPLEMENTARY_CODE_POINT} and{@link #MAX_CODE_POINT} inclusive;{@code false} otherwise.
 * @since  1.5
 */
 ...
 * @return {@code true} if the {@code char} value is between{@link #MIN_HIGH_SURROGATE} and{@link #MAX_HIGH_SURROGATE} inclusive;{@code false} otherwise.
 ...
 * in the UTF-16 encoding.
 * @param ch the {@code char} value to be tested.
 * @return {@code true} if the {@code char} value is between{@link #MIN_LOW_SURROGATE} and{@link #MAX_LOW_SURROGATE} inclusive;{@code false} otherwise.
 ...
 * @exception IndexOutOfBoundsException if the value{@code index} is negative or not less than{@link CharSequence#length() seq.length()}.
 * @since  1.5
 */
 ...
 * @return the Unicode code point at the given index
 * @exception NullPointerException if {@code a} is null.
 * @exception IndexOutOfBoundsException if the {@code index}argument is negative or not less than the {@code limit}argument, or if the {@code limit} argument is negative or
 ...
 * @exception NullPointerException if {@code seq} is null.
 * @exception IndexOutOfBoundsException if the {@code index}argument is less than 1 or greater than {@link CharSequence#length() seq.length()}.
 * @since  1.5
 */
 ...
 * @return the Unicode code point value before the given index.
 * @exception NullPointerException if {@code a} is null.
 * @exception IndexOutOfBoundsException if the {@code index}argument is less than 1 or greater than the length of the{@code char} array
 * @since  1.5
 */
 ...
 * @return the Unicode code point value before the given index.
 * @exception NullPointerException if {@code a} is null.
 * @exception IndexOutOfBoundsException if the {@code index}argument is not greater than the {@code start} argument or
 ...
 * @param dstIndex the start index into the {@code dst}array where the converted value is stored.
 * @return 1 if the code point is a BMP code point, 2 if the
 * code point is a supplementary code point.
 * @exception IllegalArgumentException if the specified{@code codePoint} is not a valid Unicode code point.
 * @exception NullPointerException if the specified {@code dst} is null.
 * @exception IndexOutOfBoundsException if {@code dstIndex}is negative or not less than {@code dst.length}, or if{@code dst} at {@code dstIndex} doesn't have enough
 ...
 * range
 * @exception NullPointerException if {@code seq} is null.
 * @exception IndexOutOfBoundsException if the{@code beginIndex} is negative, or {@code endIndex}is larger than the length of the given sequence, or{@code beginIndex} is larger than {@code endIndex}.
 * @since  1.5
 */
 ...
 * @exception NullPointerException if {@code a} is null.
 * @exception IndexOutOfBoundsException if {@code offset} or{@code count} is negative, or if {@code offset +
 ...
 * @exception NullPointerException if {@code seq} is null.
 * @exception IndexOutOfBoundsException if {@code index}is negative or larger then the length of the char sequence,
 ...
 * @exception NullPointerException if {@code a} is null.
 * @exception IndexOutOfBoundsExceptionif {@code start} or {@code count} is negative,
 ...
 * @param ch      the character to be converted.
 * @return  the numeric value of the character, as a nonnegative {@code int}value; -2 if the character has a numeric value that is not a
 ...
 * @return  the value {@code 0} if the argument {@code Character}is equal to this {@code Character}; a value less than{@code 0} if this {@code Character} is numerically less
 ...
 */
  public static String getName(  int codePoint){
    ...
    if (block != null)     return block.toString().replace('_',' ') + " " + Integer.toHexString(codePoint).toUpperCase(Locale.ENGLISH);
