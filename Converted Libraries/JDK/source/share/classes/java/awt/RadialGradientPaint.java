 ...
 * @throws NullPointerExceptionif {@code fractions} array is null,
 * or {@code colors} array is null
 * @throws IllegalArgumentExceptionif {@code radius} is non-positive,
 ...
 * is used at the focus point, the last color around the
 * perimeter of the circle.
 * @throws NullPointerExceptionif {@code center} point is null,
 ...
 * @param cycleMethod either {@code NO_CYCLE}, {@code REFLECT},
 * or {@code REPEAT}
 * @throws NullPointerExceptionif one of the points is null,
 * or {@code fractions} array is null,
 * or {@code colors} array is null,
 * or {@code cycleMethod} is null
 * @throws IllegalArgumentExceptionif {@code radius} is non-positive,
 ...
 * @param cycleMethod either {@code NO_CYCLE}, {@code REFLECT},
 * or {@code REPEAT}
 * @throws NullPointerExceptionif {@code gradientBounds} is null,
 * or {@code fractions} array is null,
 * or {@code colors} array is null,
 * or {@code cycleMethod} is null
 * @throws IllegalArgumentExceptionif {@code gradientBounds} is empty,
 * or {@code fractions.length != colors.length},
 * or {@code colors} is less than 2 in size,
 * or a {@code fractions} value is less than 0.0 or greater than 1.0,
 * or the {@code fractions} are not provided in strictly increasing order
