 ...
 * to this path
 * @param connect a boolean to control whether or not to turn an initial{@code moveTo} segment into a {@code lineTo} segment
 ...
 * winding rule
 * @exception IllegalArgumentException if{@code rule} is not either{@link #WIND_EVEN_ODD} or{@link #WIND_NON_ZERO}
 * @see #getWindingRule
 * @since 1.6
 */
