 ...
 * <P>
 * @throws java.awt.dnd.InvalidDnDOperationExceptionif the Drag and Drop
 ...
 */
  public static int getDragThreshold(){
    int ts=((Integer)AccessController.doPrivileged(new GetIntegerAction("awt.dnd.drag.threshold",0))).intValue();
    if (ts > 0) {
      return ts;
    }
 else {
