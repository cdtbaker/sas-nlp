 ...
 * @throws IllegalArgumentExceptionif {@code fractions.length != colors.length},
 ...
 * @return {@code OPAQUE} if all colors used by this{@code Paint} object are opaque,{@code TRANSLUCENT} if at least one of the
