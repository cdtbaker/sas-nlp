 ...
 * @since     1.1
 */
  @Transient public Rectangle getBounds(){
 ...
 * @return    <code>true</code> if the <code>Rectangle</code> specified by{@code (X, Y, W, H)}is entirely enclosed inside this <code>Rectangle</code>;
 * <code>false</code> otherwise.
 * @since     1.1
 */
