 ...
 * @exception ArrayIndexOutOfBoundsExceptionif the n<sup>th</sup> value does not exist.
 * @see Component#getTreeLock()
 */
...
synchronized (getTreeLock()) {
  ...
  @Override boolean updateGraphicsData(  GraphicsConfiguration gc){
    checkTreeLock();
 ...
 * is a validate root.
 */
@Override void invalidateParent(){
...
@Override void mixOnHiding(boolean isLightweight){
synchronized (getTreeLock()) {
if (mixingLog.isLoggable(PlatformLogger.FINE)) {
...
@Override void mixOnZOrderChanging(int oldZorder,int newZorder){
synchronized (getTreeLock()) {
if (mixingLog.isLoggable(PlatformLogger.FINE)) {
