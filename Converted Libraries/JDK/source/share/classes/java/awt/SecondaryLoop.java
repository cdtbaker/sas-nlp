 ...
 * <p>
 * Objects that implement this interface are created with the{@link EventQueue#createSecondaryLoop} method. The interface
 ...
 * thread is blocked until the loop is terminated by the{@link #exit} method. Also, a new event loop is started
 ...
 * jButton.addActionListener(new ActionListener() {{@code @Override}public void actionPerformed(ActionEvent e) {
 ...
 * }
 * });
 * class WorkerThread extends Thread {{@code @Override}public void run() {
 ...
 * dispatch thread. This thread will be blocked until the {@link #exit} method is called or the loop is terminated. A new
 ...
 * if the secondary loop was started by this call,{@code false} otherwise
 */
  public boolean enter();
  /** 
 * Unblocks the execution of the thread blocked by the {@link #enter} method and exits the secondary loop.
 * <p>
 * This method resumes the thread that called the {@link #enter}method and exits the secondary loop that was created when
 ...
 * <p>
 * If this secondary loop has not been started with the {@link #enter} method, or this secondary loop has already finished
 * with the {@link #exit} method, this method returns {@codefalse}, otherwise {@code true} is returned.
 * @return {@code true} if this loop was previously started and
 * has not yet been finished with the {@link #exit} method,{@code false} otherwise
 */
  public boolean exit();
}
