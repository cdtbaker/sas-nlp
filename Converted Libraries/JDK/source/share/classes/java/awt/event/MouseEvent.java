 ...
 * @throws IllegalArgumentException if {@code button} is greater then the{@link java.awt.MouseInfo#getNumberOfButtons() current number of buttons} and the support
 ...
 * @return one of the values from 0 to {@link java.awt.MouseInfo#getNumberOfButtons() MouseInfo.getNumberOfButtons()}if support for the extended mouse buttons is {@link Toolkit#areExtraMouseButtonsEnabled() enabled} by Java.
 ...
 */
  public static String getMouseModifiersText(  int modifiers){
    ...
    for (int i=1; i <= cachedNumberOfButtons; i++) {
      ...
      if ((modifiers & mask) != 0 && buf.indexOf(Toolkit.getProperty("AWT.button" + i,"Button" + i)) == -1) {
