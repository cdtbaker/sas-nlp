...
if (fArray != null) pixels=fArray;
 else pixels=new float[numBands];
...
if (dArray != null) pixels=dArray;
 else pixels=new double[numBands];
...
if (iArray != null) pixels=iArray;
 else pixels=new int[numBands * w * h];
for (int i=y; i < y1; i++) {
for (int j=x; j < x1; j++) {
...
if (fArray != null) pixels=fArray;
 else pixels=new float[numBands * w * h];
for (int i=y; i < y1; i++) {
for (int j=x; j < x1; j++) {
for (int k=0; k < numBands; k++) {
