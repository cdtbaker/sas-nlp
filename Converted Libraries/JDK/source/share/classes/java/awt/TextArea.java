 ...
 */
  @Deprecated public synchronized void insertText(  String str,  int pos){
 ...
 */
  @Deprecated public synchronized void appendText(  String str){
    if (peer != null) {
 ...
 */
  @Deprecated public synchronized void replaceText(  String str,  int start,  int end){
    TextAreaPeer peer=(TextAreaPeer)this.peer;
    if (peer != null) {
