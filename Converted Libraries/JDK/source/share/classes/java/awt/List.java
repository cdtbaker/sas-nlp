 ...
 */
  @Deprecated public synchronized void addItem(  String item,  int index){
 ...
 * @exception IllegalArgumentExceptionif the item doesn't exist in the list
 * @since        JDK1.1
 */
 ...
 * @see #add(String,int)
 * @since      JDK1.1
 * @exception ArrayIndexOutOfBoundsExceptionif the <code>position</code> is less than 0 or
 ...
 */
  @Deprecated public synchronized void setMultipleSelections(  boolean b){
    if (b != multipleMode) {
      multipleMode=b;
      ListPeer peer=(ListPeer)this.peer;
      if (peer != null) {
