...
import java.io.*;
/** 
 * The <code>GraphicsConfigTemplate</code> class is used to obtain a valid{@link GraphicsConfiguration}.  A user instantiates one of these
 * objects and then sets all non-default attributes as desired.  The{@link GraphicsDevice#getBestConfiguration} method found in the{@link GraphicsDevice} class is then called with this
