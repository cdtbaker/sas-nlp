 ...
 */
@Deprecated public synchronized void setLineIncrement(int v){
int tmp=(v < 1) ? 1 : v;
 ...
 */
@Deprecated public synchronized void setPageIncrement(int v){
int tmp=(v < 1) ? 1 : v;
...
if (adjustmentListenerK == key) addAdjustmentListener((AdjustmentListener)(s.readObject()));
 else s.readObject();
}
}
/** 
