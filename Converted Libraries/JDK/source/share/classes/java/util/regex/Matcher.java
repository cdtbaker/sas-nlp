 ...
 * @param newPatternThe new pattern used by this matcher
 * @return  This matcher
 * @throws IllegalArgumentExceptionIf newPattern is <tt>null</tt>
 * @since 1.5
 */
 ...
 * unaffected.
 * @param inputThe new input character sequence
 * @return  This matcher
 */
 ...
 * @throws IllegalStateExceptionIf no match has yet been attempted,
 ...
 * <i>m.</i><tt>start()</tt>.  </p>
 * @param groupThe index of a capturing group in this matcher's pattern
 * @return  The index of the first character captured by the group,
 * or <tt>-1</tt> if the match was successful but the group
 * itself did not match anything
 * @throws IllegalStateExceptionIf no match has yet been attempted,
 * or if the previous match operation failed
 * @throws IndexOutOfBoundsExceptionIf there is no capturing group in the pattern
 ...
 * This method will return the empty string when such a group successfully
 * matches the empty string in the input.  </p>
 * @param nameThe name of a named-capturing group in this matcher's pattern
 * @return  The (possibly empty) subsequence captured by the named group
 * during the previous match, or <tt>null</tt> if the group
 * failed to match part of the input
 * @throws IllegalStateExceptionIf no match has yet been attempted,
 * or if the previous match operation failed
 * @throws IllegalArgumentExceptionIf there is no capturing group in the pattern
 * with the given name
 */
  public String group(  String name){
    if (name == null)     throw new NullPointerException("Null group name");
    if (first < 0)     throw new IllegalStateException("No match found");
    if (!parentPattern.namedGroups().containsKey(name))     throw new IllegalArgumentException("No group with name <" + name + ">");
 ...
 * @throws IndexOutOfBoundsExceptionIf start is less than zero or if start is greater than the
 ...
 * @param sbThe target string buffer
 * @param replacementThe replacement string
 * @return  This matcher
 * @throws IllegalStateExceptionIf no match has yet been attempted,
 * or if the previous match operation failed
 * @throws IllegalArgumentExceptionIf the replacement string refers to a named-capturing
 * group that does not exist in the pattern
 * @throws IndexOutOfBoundsExceptionIf the replacement string refers to a capturing group
    ...
    while (cursor < replacement.length()) {
      ...
      if (nextChar == '\\') {
        ...
        if (nextChar == '{') {
          ...
          if (ASCII.isDigit(gname.charAt(0)))           throw new IllegalArgumentException("capturing group name {" + gname + "} starts with digit character");
          if (!parentPattern.namedGroups().containsKey(gname))           throw new IllegalArgumentException("No group with name {" + gname + "}");
 ...
 * region.
 * @param startThe index to start searching at (inclusive)
 * @param endThe index to end searching at (exclusive)
 * @throws IndexOutOfBoundsExceptionIf start or end is less than zero, if
