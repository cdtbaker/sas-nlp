 ...
 * the {@code UUID}.
 * @param mostSigBitsThe most significant bits of the {@code UUID}
 * @param leastSigBitsThe least significant bits of the {@code UUID}
 */
 ...
 * @param nameA byte array to be used to construct a {@code UUID}
 ...
 * @param nameA string that specifies a {@code UUID}
 * @return  A {@code UUID} with the specified value
 * @throws IllegalArgumentExceptionIf name does not conform to the string representation as
 ...
 * @throws UnsupportedOperationExceptionIf this UUID is not a version 1 UUID
 */
 ...
 * as this {@code UUID}.
 * @param objThe object to be compared
