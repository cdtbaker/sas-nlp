 ...
 * @param classNamethe name of the resource class
 * @param keythe key for the missing resource.
 * @param causethe cause (which is saved for later retrieval by the{@link Throwable.getCause()} method). (A null value is
