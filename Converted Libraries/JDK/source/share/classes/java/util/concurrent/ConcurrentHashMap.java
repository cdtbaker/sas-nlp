 ...
 */
    @SuppressWarnings("unchecked") private void rehash(    HashEntry<K,V> node){
 ...
 */
  @SuppressWarnings("unchecked") private Segment<K,V> segmentForHash(  int h){
 ...
 */
  @SuppressWarnings("unchecked") static final <K,V>HashEntry<K,V> entryForHash(  Segment<K,V> seg,  int h){
    HashEntry<K,V>[] tab;
 ...
 * @param s the stream
 * @serialDatathe key (Object) and value (Object)
