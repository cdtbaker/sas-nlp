 ...
 * @exception java.lang.NullPointerExceptionif <code>baseName</code> is <code>null</code>
 * @exception MissingResourceExceptionif no resource bundle for the specified base name can be found
 ...
 * @param baseNamethe base name of the resource bundle, a fully qualified class
 * name
 * @param controlthe control which gives information for the resource bundle
 * loading process
 * @return a resource bundle for the given base name and the default
 * locale
 * @exception NullPointerExceptionif <code>baseName</code> or <code>control</code> is
 * <code>null</code>
 * @exception MissingResourceExceptionif no resource bundle for the specified base name can be found
 * @exception IllegalArgumentExceptionif the given <code>control</code> doesn't perform properly
 ...
 * privileges of <code>ResourceBundle</code>.
 * See {@link #getBundle(String,Locale,ClassLoader) getBundle}for a complete description of the search and instantiation strategy.
 * @param baseNamethe base name of the resource bundle, a fully qualified class name
 * @param localethe locale for which a resource bundle is desired
 * @exception NullPointerExceptionif <code>baseName</code> or <code>locale</code> is <code>null</code>
 * @exception MissingResourceExceptionif no resource bundle for the specified base name can be found
 ...
 * complete description of the resource bundle loading process with a
 * <code>ResourceBundle.Control</code>.
 * @param baseNamethe base name of the resource bundle, a fully qualified
 * class name
 * @param targetLocalethe locale for which a resource bundle is desired
 * @param controlthe control which gives information for the resource
 * bundle loading process
 * @return a resource bundle for the given base name and a
 * <code>Locale</code> in <code>locales</code>
 * @exception NullPointerExceptionif <code>baseName</code>, <code>locales</code> or
 * <code>control</code> is <code>null</code>
 * @exception MissingResourceExceptionif no resource bundle for the specified base name in any
 ...
 * @return a resource bundle for the given base name and locale
 * @exception java.lang.NullPointerExceptionif <code>baseName</code>, <code>locale</code>, or <code>loader</code> is <code>null</code>
 * @exception MissingResourceExceptionif no resource bundle for the specified base name can be found
 * @since 1.2
 */
 ...
 * class name
 * @param targetLocalethe locale for which a resource bundle is desired
 * @param loaderthe class loader from which to load the resource bundle
 * @param controlthe control which gives information for the resource
 * bundle loading process
 * @return a resource bundle for the given base name and locale
 * @exception NullPointerExceptionif <code>baseName</code>, <code>targetLocale</code>,
 ...
 * @param keythe resource <code>key</code>
 * @return <code>true</code> if the given <code>key</code> is
 * contained in this <code>ResourceBundle</code> or its
 * parent bundles; <code>false</code> otherwise.
 * @exception NullPointerExceptionif <code>key</code> is <code>null</code>
 * @since 1.6
 */
 ...
 * @param formatsthe formats to be returned by the
 ...
 * @exception NullPointerExceptionif <code>formats</code> is <code>null</code>
 * @exception IllegalArgumentExceptionif <code>formats</code> is unknown
 */
 ...
 * @exception NullPointerExceptionif <code>baseName</code> is null
 * @see #FORMAT_DEFAULT
 * @see #FORMAT_CLASS
 ...
 * </pre>
 * @param baseNamethe base name of the resource bundle, a fully
 * qualified class name
 * @param localethe locale for which a resource bundle is desired
 * @return a <code>List</code> of candidate
 * <code>Locale</code>s for the given <code>locale</code>
 * @exception NullPointerExceptionif <code>baseName</code> or <code>locale</code> is
 * <code>null</code>
 */
 ...
 * base bundle)
 * @param localethe <code>Locale</code> for which
 * <code>ResourceBundle.getBundle</code> has been
 * unable to find any resource bundles (except for the
 * base bundle)
 ...
 * is desired.
 * @exception NullPointerExceptionif <code>baseName</code> or <code>locale</code>
 * is <code>null</code>
 */
 ...
 * </ul>
 * @param baseNamethe base bundle name of the resource bundle, a fully
 * qualified class name
 * @param localethe locale for which the resource bundle should be
 * instantiated
 * @param formatthe resource bundle format to be loaded
 * @param loaderthe <code>ClassLoader</code> to use to load the bundle
 * @param reloadthe flag to indicate bundle reloading; <code>true</code>
 * if reloading an expired resource bundle,
 * <code>false</code> otherwise
 * @return the resource bundle instance,
 * or <code>null</code> if none could be found.
 * @exception NullPointerExceptionif <code>bundleName</code>, <code>locale</code>,
 ...
 * @exception IllegalArgumentExceptionif <code>format</code> is unknown, or if the resource
 * found for the given parameters contains malformed data.
 * @exception ClassCastExceptionif the loaded class cannot be cast to <code>ResourceBundle</code>
 * @exception IllegalAccessExceptionif the class or its nullary constructor is not
 * accessible.
 * @exception InstantiationExceptionif the instantiation of a class fails for some other
 * reason.
 * @exception ExceptionInInitializerErrorif the initialization provoked by this method fails.
 * @exception SecurityExceptionIf a security manager is present and creation of new
 * instances is denied. See {@link Class#newInstance()}for details.
 * @exception IOExceptionif an error occurred when reading resources using
 * any I/O operations
 */
 ...
 * @param baseNamethe base name of the resource bundle for which the
 * expiration value is specified.
 * @param localethe locale of the resource bundle for which the
 * expiration value is specified.
 ...
 * @param baseNamethe base bundle name of the resource bundle, a
 * fully qualified class name
 * @param localethe locale for which the resource bundle
 * should be instantiated
 * @param formatthe resource bundle format to be loaded
 * @param loaderthe <code>ClassLoader</code> to use to load the bundle
 * @param bundlethe resource bundle instance that has been expired
 * in the cache
 * @param loadTimethe time when <code>bundle</code> was loaded and put
 * in the cache
 * @return <code>true</code> if the expired bundle needs to be
 * reloaded; <code>false</code> otherwise.
 * @exception NullPointerExceptionif <code>baseName</code>, <code>locale</code>,
 ...
 * @param baseNamethe base name of the resource bundle, a fully
 * qualified class name
 * @param localethe locale for which a resource bundle should be
 * loaded
 ...
 * @param bundleNamethe bundle name
 * @param suffixthe file type suffix
 * @return the converted resource name
 * @exception NullPointerExceptionif <code>bundleName</code> or <code>suffix</code>
 * is <code>null</code>
 */
