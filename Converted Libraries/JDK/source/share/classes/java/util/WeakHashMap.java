 ...
 */
  int modCount;
  @SuppressWarnings("unchecked") private Entry<K,V>[] newTable(  int n){
 ...
 */
  public boolean containsValue(  Object value){
    ...
    Entry<K,V>[] tab=getTable();
    for (int i=tab.length; i-- > 0; )     for (Entry<K,V> e=tab[i]; e != null; e=e.next)     if (value.equals(e.value))     return true;
    return false;
  }
  /** 
 ...
 */
  private boolean containsNullValue(){
    Entry<K,V>[] tab=getTable();
    for (int i=tab.length; i-- > 0; )     for (Entry<K,V> e=tab[i]; e != null; e=e.next)     if (e.value == null)     return true;
    return false;
  }
  /** 
