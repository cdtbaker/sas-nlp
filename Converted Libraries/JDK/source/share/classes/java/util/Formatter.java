 ...
 * @param aDestination for the formatted output.  If {@code a} is{@code null} then a {@link StringBuilder} will be created.
 */
 ...
 * <p> The locale used is the {@linkplain Locale#getDefault() default
 * locale} for this instance of the Java virtual machine.
 * @param fileNameThe name of the file to use as the destination of this
 ...
 * access to the file
 * @throws FileNotFoundExceptionIf the given file name does not denote an existing, writable
 ...
 * <p> The locale used is the {@linkplain Locale#getDefault() default
 * locale} for this instance of the Java virtual machine.
 * @param fileThe file to use as the destination of this formatter.  If the
 * file exists then it will be truncated to zero size; otherwise,
 * a new file will be created.  The output will be written to the
 * file and is buffered.
 * @throws SecurityExceptionIf a security manager is present and {@link SecurityManager#checkWrite checkWrite(file.getPath())} denies
 ...
 * charset.
 * @param psThe stream to use as the destination of this formatter.
 */
 ...
 * <p> The locale used is the {@linkplain Locale#getDefault() default
 * locale} for this instance of the Java virtual machine.
 * @param osThe output stream to use as the destination of this formatter.
 ...
 * locale
 * @throws FormatterClosedExceptionIf this formatter has been closed by invoking its {@link #close()} method
 */
 ...
 * @param formatA format string as described in <a href="#syntax">Format string
 * syntax</a>.
...
if (!FpUtils.isFinite(d) || d == 0.0 || prec == 0 || prec >= 13) return Double.toHexString(d).substring(2);
 else {
...
len=sb.length();
if (width != -1 && f.contains(Flags.ZERO_PAD)) for (int k=0; k < width - len; k++) sb.insert(begin,zero);
return sb;
}
}
