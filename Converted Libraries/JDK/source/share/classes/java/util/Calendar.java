 ...
 * <code>locale</code>.
 * @param fieldthe calendar field for which the string representation
 * is returned
 * @param stylethe style applied to the string representation; one of{@link #SHORT} or {@link #LONG}.
 * @param localethe locale for the string representation
 * @return the string representation of the given
 * <code>field</code> in the given <code>style</code>, or
 * <code>null</code> if no string representation is
 * applicable.
 * @exception IllegalArgumentExceptionif <code>field</code> or <code>style</code> is invalid,
 * or if this <code>Calendar</code> is non-lenient and any
 * of the calendar fields have invalid values
 * @exception NullPointerExceptionif <code>locale</code> is null
 * @since 1.6
 */
 ...
 * @param fieldthe calendar field for which the display names are returned
 * @param stylethe style applied to the display names; one of {@link #SHORT}, {@link #LONG}, or {@link #ALL_STYLES}.
 * @param localethe locale for the display names
 ...
 * @exception UnsupportedOperationExceptionif any week year numbering isn't supported
 ...
 * @exception UnsupportedOperationExceptionif any week year numbering isn't supported in this{@code Calendar}.
 * @see #isWeekDateSupported()
 * @see #getFirstDayOfWeek()
 * @see #getMinimalDaysInFirstWeek()
 * @since 1.7
