 ...
 * @param o an object
 * @return the result of calling {@code toString} for a non-{@codenull} argument and {@code "null"} for a {@code null} argument
 * @see Object#toString
 ...
 * @return 0 if the arguments are identical and {@codec.compare(a, b)} otherwise.
 * @see Comparable
 * @see Comparator
 */
 ...
 * </pre></blockquote>
 * @param obj     the object reference to check for nullity
 * @param message detail message to be used in the event that a {@codeNullPointerException} is thrown
 * @param<T>
 *  the type of the reference
 * @return {@code obj} if not {@code null}
 * @throws NullPointerException if {@code obj} is {@code null}
