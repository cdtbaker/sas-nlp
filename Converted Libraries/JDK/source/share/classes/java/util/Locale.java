...
private static class Cache extends LocaleObjectCache<LocaleKey,Locale> {
    ...
    @Override protected Locale createObject(    LocaleKey key){
...
Object[] displayNames={new Integer(qualifierNames.length != 0 ? 2 : 1),mainName,qualifierNames.length != 0 ? formatList(qualifierNames,listPattern,listCompositionPattern) : null};
 ...
 */
FORMAT("user.language.format","user.script.format","user.country.format","user.variant.format"); Category(String languageKey,String scriptKey,String countryKey,String variantKey){
