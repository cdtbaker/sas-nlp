 ...
 * @param formatterThe {@link Formatter formatter}.  Implementing classes may call{@link Formatter#out() formatter.out()} or {@link Formatter#locale() formatter.locale()} to obtain the {@link Appendable} or {@link Locale} used by this
 * <tt>formatter</tt> respectively.
 * @param flagsThe flags modify the output format.  The value is interpreted as
 ...
 * @param widthThe minimum number of characters to be written to the output.
 ...
 * @param precisionThe maximum number of characters to be written to the output.
 ...
 * @throws IllegalFormatExceptionIf any of the parameters are invalid.  For specification of all
