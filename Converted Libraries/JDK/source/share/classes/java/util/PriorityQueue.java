 ...
 */
  ...
  private void initElementsFromCollection(  Collection<? extends E> c){
    ...
    int len=a.length;
    if (len == 1 || this.comparator != null)     for (int i=0; i < len; i++)     if (a[i] == null)     throw new NullPointerException();
    this.queue=a;
    this.size=a.length;
  }
  /** 
 ...
 * @return the comparator used to order this queue, or{@code null} if this queue is sorted according to the
