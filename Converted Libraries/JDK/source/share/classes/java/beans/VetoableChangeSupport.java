 ...
 */
    @Override protected VetoableChangeListener[] newArray(    int length){
 ...
 */
    @Override protected VetoableChangeListener newProxy(    String name,    VetoableChangeListener listener){
