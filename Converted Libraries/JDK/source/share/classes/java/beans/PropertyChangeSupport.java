 ...
 */
    @Override protected PropertyChangeListener[] newArray(    int length){
 ...
 */
    @Override protected PropertyChangeListener newProxy(    String name,    PropertyChangeListener listener){
