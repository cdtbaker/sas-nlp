 ...
 * connected.
 * @param familyThe protocol family
 * @return  A new datagram channel
 * @throws UnsupportedOperationExceptionIf the specified protocol family is not supported. For example,
 ...
 * @throws SecurityExceptionIf a security manager has been installed and its {@link SecurityManager#checkListen checkListen} method denies the
 * operation
 * @since 1.7
 */
 ...
 * automatically, as if invoking the {@link #bind bind} method with a
 * parameter of {@code null}. </p>
 * @param dstThe buffer into which the datagram is to be transferred
 ...
 * parameter of {@code null}. </p>
 * @param srcThe buffer containing the datagram to be sent
 * @param targetThe address to which the datagram is to be sent
 ...
 * @throws NotYetConnectedExceptionIf this channel's socket is not connected
 */
