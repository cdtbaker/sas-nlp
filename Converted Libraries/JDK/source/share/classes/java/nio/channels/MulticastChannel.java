 ...
 * @param groupThe multicast address to join
 * @param interfThe network interface on which to join the group
 * @return  The membership key
 * @throws IllegalArgumentExceptionIf the group parameter is not a {@link InetAddress#isMulticastAddressmulticast} address, or the group parameter is an address type
 * that is not supported by this channel
 * @throws IllegalStateExceptionIf the channel already has source-specific membership of the
 * group on the interface
 * @throws UnsupportedOperationExceptionIf the channel's socket is not an Internet Protocol socket
 * @throws ClosedChannelExceptionIf this channel is closed
 * @throws IOExceptionIf an I/O error occurs
 * @throws SecurityExceptionIf a security manager is set, and its{@link SecurityManager#checkMulticast(InetAddress) checkMulticast}method denies access to the multiast group
 */
 ...
 * @param groupThe multicast address to join
 * @param interfThe network interface on which to join the group
 * @param sourceThe source address
 * @return  The membership key
 * @throws IllegalArgumentExceptionIf the group parameter is not a {@link InetAddress#isMulticastAddress multicast} address, the
 ...
 * @throws IllegalStateExceptionIf the channel is currently a member of the group on the given
 * interface to receive all datagrams
 * @throws UnsupportedOperationExceptionIf the channel's socket is not an Internet Protocol socket or
