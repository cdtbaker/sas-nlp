 ...
 * @param handlerThe completion handler
 * @throws IllegalArgumentExceptionIf the buffer is read-only
 * @throws ReadPendingExceptionIf the channel does not allow more than one read to be outstanding
 * and a previous read has not completed
 * @throws ShutdownChannelGroupExceptionIf the channel is associated with a {@link AsynchronousChannelGroupgroup} that has terminated
 */
 ...
 * @param attachmentThe object to attach to the I/O operation; can be {@code null}
 * @param handlerThe completion handler object
 * @throws WritePendingExceptionIf the channel does not allow more than one write to be outstanding
