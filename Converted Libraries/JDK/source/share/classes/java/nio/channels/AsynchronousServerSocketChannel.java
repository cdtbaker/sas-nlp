 ...
 * bind(local, 0);
 * </pre></blockquote>
 * @param localThe local address to bind the socket, or <tt>null</tt> to bind
 ...
 * default is used.
 * @param localThe local address to bind the socket, or {@code null} to bind
 * to an automatically assigned socket address
 * @param backlogThe maximum number of pending connections
 * @return  This channel
 ...
 * @throws SecurityExceptionIf a security manager has been installed and its {@link SecurityManager#checkListen checkListen} method denies the operation
 ...
 * @throws AcceptPendingExceptionIf an accept operation is already in progress on this channel
 * @throws NotYetBoundExceptionIf this channel's socket has not yet been bound
