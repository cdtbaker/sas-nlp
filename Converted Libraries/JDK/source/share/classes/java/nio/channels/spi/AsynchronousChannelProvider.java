 ...
 * @throws SecurityExceptionIf a security manager has been installed and it denies{@link RuntimePermission}<tt>("asynchronousChannelProvider")</tt>
 */
 ...
 * @param nThreadsThe number of threads in the pool
 * @param threadFactoryThe factory to use when creating new threads
 * @throws IllegalArgumentExceptionIf {@code nThreads <= 0}
 ...
 * @param executorThe thread pool
 * @param initialSizeA value {@code >=0} or a negative value for implementation
 * specific default
 * @throws IOExceptionIf an I/O error occurs
 ...
 * @param groupThe group to which the channel is bound, or {@code null} to
 * bind to the default group
 * @return  The new channel
 * @throws IllegalChannelGroupExceptionIf the provider that created the group differs from this provider
 * @throws ShutdownChannelGroupExceptionThe group is shutdown
 * @throws IOExceptionIf an I/O error occurs
 */
