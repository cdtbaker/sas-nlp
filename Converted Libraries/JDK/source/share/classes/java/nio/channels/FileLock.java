 ...
 * @param channelThe file channel upon whose file this lock is held
 * @param positionThe position within the file at which the locked region starts;
 ...
 * @param channelThe channel upon whose file this lock is held
 * @param positionThe position within the file at which the locked region starts;
 * must be non-negative
 * @param sizeThe size of the locked region; must be non-negative, and the sum
 * <tt>position</tt>&nbsp;+&nbsp;<tt>size</tt> must be non-negative
 ...
 * @throws ClosedChannelExceptionIf the channel that was used to acquire this lock
 * is no longer open
