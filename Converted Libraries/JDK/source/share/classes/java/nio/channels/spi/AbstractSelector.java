 ...
 * @throws IOExceptionIf an I/O error occurs while closing the selector
 */
 ...
 * @param chThe channel to be registered
 * @param opsThe initial interest set, which must be valid
 * @param attThe initial attachment for the resulting key
 ...
 * deregisters.  </p>
 * @param keyThe selection key to be removed
 */
