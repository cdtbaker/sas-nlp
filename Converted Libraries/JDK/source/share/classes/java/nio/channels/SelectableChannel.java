 ...
 * @param selThe selector with which this channel is to be registered
 * @param opsThe interest set for the resulting key
 * @param attThe attachment for the resulting key; may be <tt>null</tt>
 * @throws ClosedChannelExceptionIf this channel is closed
 * @throws ClosedSelectorExceptionIf the selector is closed
 * @throws IllegalBlockingModeExceptionIf this channel is in blocking mode
 * @throws IllegalSelectorExceptionIf this channel was not created by the same provider
 * as the given selector
 * @throws CancelledKeyExceptionIf this channel is currently registered with the given selector
 * but the corresponding key has already been cancelled
 * @throws IllegalArgumentExceptionIf a bit in the <tt>ops</tt> set does not correspond to an
 ...
 * @throws CancelledKeyExceptionIf this channel is currently registered with the given selector
 * but the corresponding key has already been cancelled
 * @throws IllegalArgumentExceptionIf a bit in <tt>ops</tt> does not correspond to an operation
 ...
 * @throws ClosedChannelExceptionIf this channel is closed
 * @throws IllegalBlockingModeExceptionIf <tt>block</tt> is <tt>true</tt> and this channel is
