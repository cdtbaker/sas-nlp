 ...
 * @param providerThe asynchronous channel provider for this group
 */
 ...
 * default {@link AsynchronousChannelProvider} object.
 * @param executorThe thread pool for the resulting group
 ...
 * @param timeoutThe maximum time to wait, or zero or less to not wait
 * @param unitThe time unit of the timeout argument
