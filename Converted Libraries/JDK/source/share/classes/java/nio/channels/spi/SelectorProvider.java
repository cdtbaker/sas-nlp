 ...
 * @throws SecurityExceptionIf a security manager has been installed and it denies{@link RuntimePermission}<tt>("selectorProvider")</tt>
 */
 ...
 * @throws UnsupportedOperationExceptionIf the specified protocol family is not supported
 ...
 * @throws IOExceptionIf an I/O error occurs
 * @throws SecurityExceptionIf a security manager has been installed and it denies{@link RuntimePermission}<tt>("inheritedChannel")</tt>
 * @since 1.5
 */
