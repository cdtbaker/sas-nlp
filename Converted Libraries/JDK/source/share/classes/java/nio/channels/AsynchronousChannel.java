 ...
 * <li><pre>void <em>operation</em>(<em>...</em> A attachment, {@link CompletionHandler}&lt;V,? super A&gt; handler)</pre></li>
 * </ol>
 ...
 * <p> In the first form, the methods defined by the {@link Future Future}interface may be used to check if the operation has completed, wait for its
 * completion, and to retrieve the result. In the second form, a {@link CompletionHandler} is invoked to consume the result of the I/O operation when
 ...
 * any given time.
 * <h4>Cancellation</h4>
 * <p> The {@code Future} interface defines the {@link Future#cancel cancel}method to cancel execution. This causes all threads waiting on the result of
 ...
 * <p> Where the {@link Future#cancel cancel} method is invoked with the {@codemayInterruptIfRunning} parameter set to {@code true} then the I/O operation
