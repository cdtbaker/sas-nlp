 ...
 * @param sA purported charset name
 * @throws IllegalCharsetNameExceptionIf the given name is not a legal charset name
 */
 ...
 * @param charsetNameThe name of the requested charset; may be either
 * a canonical name or an alias
 * @return  <tt>true</tt> if, and only if, support for the named charset
 * is available in the current Java virtual machine
 * @throws IllegalCharsetNameExceptionIf the given charset name is illegal
 * @throws IllegalArgumentExceptionIf the given <tt>charsetName</tt> is null
 */
 ...
 * @throws IllegalCharsetNameExceptionIf the given charset name is illegal
 * @throws IllegalArgumentExceptionIf the given <tt>charsetName</tt> is null
 * @throws UnsupportedCharsetExceptionIf no support for the named charset is available
 ...
 * set. </p>
 * @param canonicalNameThe canonical name of this charset
 * @param aliasesAn array of this charset's aliases, or null if it has no aliases
 * @throws IllegalCharsetNameExceptionIf the canonical name or any of the aliases are illegal
 */
 ...
 * charset's canonical name.  Concrete subclasses of this class may
 * override this method in order to provide a localized display name. </p>
 * @param localeThe locale for which the display name is to be retrieved
 ...
 * @throws UnsupportedOperationExceptionIf this charset does not support encoding
 */
 ...
 * case. </p>
 * @param thatThe charset to which this charset is to be compared
