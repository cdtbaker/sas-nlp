 ...
 * a {@link UserPrincipalLookupService}, or returned by {@link FileAttributeView} implementations that provide access to identity related
 * attributes. For example, the {@link AclFileAttributeView} and {@link PosixFileAttributeView} provide access to a file's {@link PosixFileAttributes#owner owner}.
 * @since 1.7
 */
