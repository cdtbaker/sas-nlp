 ...
 * @param causethe {@code IOException} that caused the directory iteration
 * to fail
 * @throws NullPointerExceptionif the cause is {@code null}
 */
 ...
 * @throws InvalidObjectExceptionif the object is invalid or has a cause that is not
 * an {@code IOException}
 */
