 ...
 * <ol>
 * <li> It is cancelled, explicitly, by invoking its {@link #cancel cancel}method, or</li>
 ...
 * and queued so that it can be retrieved by invoking the watch service's {@link WatchService#poll() poll} or {@link WatchService#take() take} methods. Once
 ...
 * @return  {@code true} if the watch key is valid and has been reset, and{@code false} if the watch key could not be reset because it is
