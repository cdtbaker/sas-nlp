 ...
 * @throws SecurityExceptionIf a security manager has been installed and it denies{@link RuntimePermission}<tt>("fileTypeDetector")</tt>
 */
 ...
 * recognized
 * @throws IOExceptionAn I/O error occurs
 * @throws SecurityExceptionIf the implementation requires to access the file, and a
