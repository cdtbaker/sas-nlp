 ...
 * @param namethe string representation of the user principal to lookup
 * @return  a user principal
 * @throws UserPrincipalNotFoundExceptionthe principal does not exist
 ...
 * @param groupthe string representation of the group to lookup
 * @return  a group principal
 * @throws UserPrincipalNotFoundExceptionthe principal does not exist or is not a group
 * @throws IOExceptionif an I/O error occurs
 * @throws SecurityExceptionIn the case of the default provider, and a security manager is
 * installed, it checks {@link RuntimePermission}<tt>("lookupUserInformation")</tt>
 */
