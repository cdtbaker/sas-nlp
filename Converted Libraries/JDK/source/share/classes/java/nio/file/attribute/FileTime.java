 ...
 * granularity.
 * @param valuethe value since the epoch (1970-01-01T00:00:00Z); can be
 * negative
 * @param unitthe unit of granularity to interpret the value
 ...
 * @param valuethe value, in milliseconds, since the epoch
 ...
 * @param unitthe unit of granularity for the return value
 ...
 * @param objthe object to compare with
 * @return  {@code true} if, and only if, the given object is a {@codeFileTime} that represents the same time
 */
 ...
 * @param otherthe other {@code FileTime} to be compared
 ...
 */
  @Override public int compareTo(  FileTime other){
    if (unit == other.unit) {
...
@Override public int compareTo(DaysAndNanos other){
