 ...
 * attributes. {@code FileAttributeViews} are selected by invoking the {@link java.nio.file.Files#getFileAttributeView} method with a
 ...
 * a given type is obtained by invoking the {@link java.nio.file.FileStore#getFileStoreAttributeView} method.
 * <p> The {@link java.nio.file.attribute.BasicFileAttributeView}class defines methods to read and update a <em>basic</em> set of file
 * attributes that are common to many file systems.
 * <p> The {@link java.nio.file.attribute.PosixFileAttributeView}interface extends {@code BasicFileAttributeView} by defining methods
 * to access the file attributes commonly used by file systems and operating systems
 * that implement the Portable Operating System Interface (POSIX) family of
 * standards.
 * <p> The {@link java.nio.file.attribute.DosFileAttributeView}class extends {@code BasicFileAttributeView} by defining methods to
 ...
 * <p> The {@link java.nio.file.attribute.AclFileAttributeView}class defines methods to read and write the Access Control List (ACL)
 ...
 * <ul>
 * <p><li> The {@link java.nio.file.attribute.UserPrincipal} and{@link java.nio.file.attribute.GroupPrincipal} interfaces represent an
 * identity or group identity. </li>
 * <p><li> The {@link java.nio.file.attribute.UserPrincipalLookupService}interface defines methods to lookup user or group principals. </li>
