 ...
 * channel.
 * @param paththe path of the file to open open or create
 * @param optionsoptions specifying how the file is opened
 * @param attrsan optional list of attributes to set atomically when creating
 * the file
 * @throws ClosedDirectoryStreamExceptionif the directory stream is closed
 ...
 * this open directory.
 * @param paththe path of the file to delete
 * @throws ClosedDirectoryStreamExceptionif the directory stream is closed
 ...
 * @param paththe path of the directory to delete
 * @throws ClosedDirectoryStreamExceptionif the directory stream is closed
 * @throws NoSuchFileExceptionif the directory does not exist <i>(optional specific exception)</i>
 * @throws DirectoryNotEmptyExceptionif the directory could not otherwise be deleted because it is
 ...
 * method fails.
 * @param srcpaththe name of the file to move
 * @param targetdirthe destination directory
 * @param targetpaththe name to give the file in the destination directory
 * @throws ClosedDirectoryStreamExceptionif this or the target directory stream is closed
 * @throws FileAlreadyExistsExceptionif the file already exists in the target directory and cannot
 * be replaced <i>(optional specific exception)</i>
 * @throws AtomicMoveNotSupportedExceptionif the file cannot be moved as an atomic file system operation
 * @throws IOExceptionif an I/O error occurs
 * @throws SecurityExceptionIn the case of the default provider, and a security manager is
 ...
 * @param paththe path of the file
 * @param typethe {@code Class} object corresponding to the file attribute view
 * @param optionsoptions indicating how symbolic links are handled
