...
/** 
 * Unchecked exception thrown when path string cannot be converted into a{@link Path} because the path string contains invalid characters, or
 ...
 * @throws NullPointerExceptionif either the input or reason strings are <tt>null</tt>
 * @throws IllegalArgumentExceptionif the error index is less than <tt>-1</tt>
 */
