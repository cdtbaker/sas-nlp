 ...
 * <p> The default file system, obtained by invoking the {@link FileSystems#getDefaultFileSystems.getDefault} method, provides access to the file system that is
 ...
 * @throws UnsupportedOperationExceptionThrown in the case of the default file system
 */
 ...
 * @throws InvalidPathExceptionIf the path string cannot be converted
 */
 ...
 * after the {@code [} is a {@code !} then it is used for negation so {@code[!a-c]} matches any character except {@code "a"}, {@code "b"}, or {@code"c"}.
 ...
 * @param syntaxAndPatternThe syntax and pattern
 * @return  A path matcher that may be used to match paths against the pattern
 * @throws IllegalArgumentExceptionIf the parameter does not take the form: {@code syntax:pattern}
 * @throws java.util.regex.PatternSyntaxExceptionIf the pattern is invalid
 * @throws UnsupportedOperationExceptionIf the pattern syntax is not known to the implementation
 ...
 * </pre>
 * @throws UnsupportedOperationExceptionIf this {@code FileSystem} does not does have a lookup service
 ...
 * @throws UnsupportedOperationExceptionIf this {@code FileSystem} does not support watching file system
