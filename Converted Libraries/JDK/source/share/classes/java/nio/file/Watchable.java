 ...
 * @throws IllegalArgumentExceptionif an invalid of combination of events are modifiers are specified
 ...
 * @throws IllegalArgumentExceptionif an invalid of combination of events are specified
 * @throws ClosedWatchServiceExceptionif the watch service is closed
 * @throws IOExceptionif an I/O error occurs
 * @throws SecurityExceptionif a security manager is installed and it denies an unspecified
 * permission required to monitor this object. Implementations of
