 ...
 * @param namethe name of the permission. It must be "hard" or "symbolic".
 * @throws IllegalArgumentExceptionif name is empty or invalid
 */
  ...
  /** 
 * Constructs a {@code LinkPermission} with the specified name.
 * @param namethe name of the permission; must be "hard" or "symbolic".
 * @param actionsthe actions for the permission; must be the empty string or{@code null}
 * @throws IllegalArgumentExceptionif name is empty or invalid, or actions is a non-empty string
 */
