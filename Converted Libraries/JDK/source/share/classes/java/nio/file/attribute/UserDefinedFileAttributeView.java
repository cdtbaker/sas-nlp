 ...
 * @throws ArithmeticExceptionIf the size of the attribute is larger than {@link Integer#MAX_VALUE}
 * @throws IOExceptionIf an I/O error occurs
 * @throws SecurityExceptionIn the case of the default provider, a security manager is
 * installed, and it denies {@link RuntimePermission}<tt>("accessUserDefinedAttributes")</tt>
 * or its {@link SecurityManager#checkRead(String) checkRead} method
 ...
 * </pre>
 * @param nameThe attribute name
 * @param dstThe destination buffer
 * @return  The number of bytes read, possibly zero
 * @throws IllegalArgumentExceptionIf the destination buffer is read-only
 * @throws IOExceptionIf an I/O error occurs or there is insufficient space in the
 ...
 * </pre>
 * @param nameThe attribute name
 * @param srcThe buffer containing the attribute value
 ...
 * @param nameThe attribute name
 * @throws IOExceptionIf an I/O error occurs or the attribute does not exist
 * @throws SecurityExceptionIn the case of the default provider, a security manager is
 * installed, and it denies {@link RuntimePermission}<tt>("accessUserDefinedAttributes")</tt>
 * or its {@link SecurityManager#checkWrite(String) checkWrite}method denies write access to the file.
 */
