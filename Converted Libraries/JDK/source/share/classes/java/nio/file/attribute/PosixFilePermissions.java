 ...
 * @param permsthe set of permissions
 ...
 * </pre>
 * @param permsstring representing a set of permissions
 * @return  the resulting set of permissions
 * @throws IllegalArgumentExceptionif the string cannot be converted to a set of permissions
 * @see #toString(Set)
 */
 ...
 * @param permsthe set of permissions
 * @return  an attribute encapsulating the given file permissions with{@link FileAttribute#name name} {@code "posix:permissions"}
 * @throws ClassCastExceptionif the set contains elements that are not of type {@codePosixFilePermission}
 */
  public static FileAttribute<Set<PosixFilePermission>> asFileAttribute(  Set<PosixFilePermission> perms){
    ...
    return new FileAttribute<Set<PosixFilePermission>>(){
      ...
      @Override public Set<PosixFilePermission> value(){
