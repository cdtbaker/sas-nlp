...
public class Result {
  ...
  public static void init(){
    ...
    String workStrings[]={"units","kilounits","megaunits","autounits","ops","kiloops","megaops","autoops"};
    String workDescriptions[]={"Test Units","Thousands of Test Units","Millions of Test Units","Auto-scaled Test Units","Operations","Thousands of Operations","Millions of Operations","Auto-scaled Operations"};
    Integer workObjects[]={new Integer(WORK_UNITS),new Integer(WORK_THOUSANDS),new Integer(WORK_MILLIONS),new Integer(WORK_AUTO),new Integer(WORK_OPS | WORK_UNITS),new Integer(WORK_OPS | WORK_THOUSANDS),new Integer(WORK_OPS | WORK_MILLIONS),new Integer(WORK_OPS | WORK_AUTO)};
    workOpt=new Option.ObjectChoice(resultoptroot,"workunits","Work Units",workStrings,workObjects,workStrings,workDescriptions,0);
    String timeStrings[]={"sec","msec","usec","nsec","autosec"};
    String timeDescriptions[]={"Seconds","Milliseconds","Microseconds","Nanoseconds","Auto-scaled seconds"};
    Integer timeObjects[]={new Integer(TIME_SECONDS),new Integer(TIME_MILLIS),new Integer(TIME_MICROS),new Integer(TIME_NANOS),new Integer(TIME_AUTO)};
    timeOpt=new Option.ObjectChoice(resultoptroot,"timeunits","Time Units",timeStrings,timeObjects,timeStrings,timeDescriptions,0);
    String rateStrings[]={"unitspersec","secsperunit"};
    String rateDescriptions[]={"Work units per Time","Time units per Work"};
    Boolean rateObjects[]={Boolean.FALSE,Boolean.TRUE};
    rateOpt=new Option.ObjectChoice(resultoptroot,"ratio","Rate Ratio",rateStrings,rateObjects,rateStrings,rateDescriptions,0);
  }
...
static {
  ...
  public void addTime(  long time){
    if (J2DBench.printresults.isEnabled()) {
      System.out.println(test + " took " + time+ "ms for "+ getRepsPerRun()+ " reps");
    }
