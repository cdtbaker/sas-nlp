...
String[] hexColor={"#fc9505","#fcd805","#fc5c05","#b5fc05","1cfc05","#05fc7a","#44ff88","#77ff77","#aaff66","#ddff55","#ffff44","#ffdd33"};
...
;
  ...
  for (int k=0; k < sorted.length; ++k) {
    ...
    w.println("   <div style='width: " + pix + "%; height: 15; font-size: smaller; valign: center; background-color: "+ color+ "'>"+ "<div align='right' style='height: 15'>"+ (int)score+ "&nbsp;</div></div>");
  }
  w.println("</td></tr>");
}
}
