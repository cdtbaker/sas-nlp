 ...
 * @author Jeff Dinkins
 */
@SuppressWarnings("serial") public class FileChooserDemo extends JPanel implements ActionListener {
...
private static class SupportedLaF {
  ...
  @SuppressWarnings("LeakingThisInConstructor") public FileChooserDemo(){
...
private class WizardDialog extends JDialog implements ActionListener {
    ...
    @SuppressWarnings("LeakingThisInConstructor") WizardDialog(    JFrame frame,    boolean modal){
  ...
  private String getResultString(){
    ...
    if (path != null) {
      ...
      resultString="<html>You chose " + (isMulti ? "these" : "this") + " "+ (isDirMode ? (isMulti ? "directories" : "directory") : (isMulti ? "files" : "file"))+ ": <code>"+ path+ "</code><br><br>with filter: <br><code>"+ filter;
    }
 else {
...
private class FilePreviewer extends JComponent implements PropertyChangeListener {
    ...
    @SuppressWarnings("LeakingThisInConstructor") public FilePreviewer(    JFileChooser fc){
