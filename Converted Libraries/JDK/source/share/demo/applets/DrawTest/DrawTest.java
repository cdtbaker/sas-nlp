...
@SuppressWarnings("serial") public class DrawTest extends Applet {
  DrawPanel panel;
...
@SuppressWarnings("serial") class DrawPanel extends Panel implements MouseListener, MouseMotionListener {
  ...
  int x1, y1;
  int x2, y2;
  @SuppressWarnings("LeakingThisInConstructor") public DrawPanel(){
...
DrawPanel target;
@SuppressWarnings("LeakingThisInConstructor") public DrawControls(DrawPanel target){
this.target=target;
