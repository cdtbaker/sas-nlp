...
@SuppressWarnings("serial") final class CardPanel extends Panel {
...
@SuppressWarnings("serial") public class CardTest extends Applet implements ActionListener, ItemListener {
  CardPanel cards;
  @SuppressWarnings("LeakingThisInConstructor") public CardTest(){
