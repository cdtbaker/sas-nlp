 ...
 */
@SuppressWarnings("serial") public class ArcTest extends Applet {
...
@SuppressWarnings("serial") class ArcCanvas extends Canvas {
  int startAngle=0;
  int extent=45;
...
@SuppressWarnings("serial") class ArcControls extends Panel implements ActionListener {
  TextField startTF;
  TextField extentTF;
  ArcCanvas canvas;
  @SuppressWarnings("LeakingThisInConstructor") public ArcControls(  ArcCanvas canvas){
    Button b=null;
    this.canvas=canvas;
...
@SuppressWarnings("serial") class IntegerTextField extends TextField {
  String oldText=null;
