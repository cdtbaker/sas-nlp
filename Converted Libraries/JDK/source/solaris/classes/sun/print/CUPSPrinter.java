  ...
  public static String getDefaultPrinter(){
    try {
      ...
      if (urlConnection != null) {
        ...
        AttributeClass attCl[]={AttributeClass.ATTRIBUTES_CHARSET,AttributeClass.ATTRIBUTES_NATURAL_LANGUAGE,new AttributeClass("requested-attributes",AttributeClass.TAG_KEYWORD,"printer-name")};
  ...
  public static String[] getAllPrinters(){
    try {
      ...
      if (urlConnection != null) {
        ...
        AttributeClass attCl[]={AttributeClass.ATTRIBUTES_CHARSET,AttributeClass.ATTRIBUTES_NATURAL_LANGUAGE,new AttributeClass("requested-attributes",AttributeClass.TAG_KEYWORD,"printer-uri-supported")};
 ...
 */
  public static boolean isCupsRunning(){
    ...
    if (libFound) {
      IPPPrintService.debug_println(debugPrefix + "CUPS server " + getServer()+ " port "+ getPort());
