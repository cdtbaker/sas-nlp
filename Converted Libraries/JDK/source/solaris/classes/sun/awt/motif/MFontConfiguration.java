...
public class MFontConfiguration extends FontConfiguration {
  ...
  private void initReorderMapForSolaris(){
    ...
    reorderMap.put("UTF-8.ja",split("japanese-x0201,japanese-x0208,japanese-x0212"));
    ...
    if (FontUtilities.isSolaris8) {
      ...
      reorderMap.put("UTF-8.zh.CN",split("chinese-gb18030-0,chinese-gb18030-1"));
    }
    reorderMap.put("UTF-8.zh",split("chinese-big5,chinese-hkscs,chinese-gb18030-0,chinese-gb18030-1"));
    ...
    reorderMap.put("x-EUC-TW",split("chinese-cns11643-1,chinese-cns11643-2,chinese-cns11643-3"));
    ...
    reorderMap.put("x-PCK",split("japanese-x0201,japanese-x0208,japanese-x0212"));
    reorderMap.put("x-eucJP-Open",split("japanese-x0201,japanese-x0208,japanese-x0212"));
  ...
  private void initReorderMapForLinux(){
    ...
    reorderMap.put("x-euc-jp-linux",split("japanese-x0201,japanese-x0208"));
 ...
 */
  ...
  protected String getFileNameFromComponentFontName(  String componentFontName){
    ...
    if (fileName != null && fileName.charAt(0) == '/' && !needToSearchForFile(fileName)) {
      return fileName;
    }
