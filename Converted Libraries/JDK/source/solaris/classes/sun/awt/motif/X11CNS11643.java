...
super(cs);
if (plane == 0) this.plane=plane;
 else if (plane == 2 || plane == 3) this.plane=plane - 1;
 else throw new IllegalArgumentException("Only planes 1, 2, and 3 supported");
}
...
if (cc == null || cc.length == 2) return CoderResult.unmappableForLength(2);
