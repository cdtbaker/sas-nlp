...
static {
    ...
    motifdnd=((Boolean)java.security.AccessController.doPrivileged(new GetBooleanAction("awt.dnd.motifdnd"))).booleanValue();
  }
  public MToolkit(){
    super();
 ...
 */
  ...
  protected Object lazilyLoadDesktopProperty(  String name){
    ...
    if (!loadedXSettings && (name.startsWith("gnome.") || name.equals(SunToolkit.DESKTOPFONTHINTS) || name.startsWith(dndPrefix))) {
 ...
 */
  ...
  public final static int UNDETERMINED_WM=1, NO_WM=2, OTHER_WM=3, OPENLOOK_WM=4, MOTIF_WM=5, CDE_WM=6, ENLIGHTEN_WM=7, KDE2_WM=8, SAWFISH_WM=9, ICE_WM=10, METACITY_WM=11, COMPIZ_WM=12, LG3D_WM=13;
