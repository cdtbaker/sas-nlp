...
public int getAbsoluteX(){
  Point absoluteLoc=XlibUtil.translateCoordinates(getWindow(),XToolkit.getDefaultRootWindow(),new Point(0,0));
...
public void synthesizeFocusInOut(boolean doFocus){
  ...
  try {
    ...
    XlibWrapper.XSendEvent(XToolkit.getDisplay(),getFocusProxy().getWindow(),false,NoEventMask,xev.pData);
  }
  finally {
    XToolkit.awtUnlock();
    xev.dispose();
