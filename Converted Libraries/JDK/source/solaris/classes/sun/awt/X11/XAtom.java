 ...
 */
  ...
  public long get32Property(  long window,  long property_type){
    ...
    checkWindow(window);
    WindowPropertyGetter getter=new WindowPropertyGetter(window,this,0,1,false,property_type);
    try {
 ...
 */
  public void setCard32Property(  long window,  long value){
    ...
    try {
      ...
      XlibWrapper.XChangeProperty(XToolkit.getDisplay(),window,atom,XA_CARDINAL,32,XConstants.PropModeReplace,XlibWrapper.larg1,1);
    }
  finally {
      XToolkit.awtUnlock();
    }
 ...
 */
  public boolean getAtomData(  long window,  long data_ptr,  int length){
    ...
    checkWindow(window);
    WindowPropertyGetter getter=new WindowPropertyGetter(window,this,0,(long)length,false,this);
    try {
      int status=getter.execute();
      if (status != XConstants.Success || getter.getData() == 0) {
        return false;
      }
      if (getter.getActualType() != atom || getter.getActualFormat() != 32 || getter.getNumberOfItems() != length) {
        return false;
      }
 ...
 */
  public boolean getAtomData(  long window,  long type,  long data_ptr,  int length){
    ...
    checkWindow(window);
    WindowPropertyGetter getter=new WindowPropertyGetter(window,this,0,(long)length,false,type);
    try {
      int status=getter.execute();
      if (status != XConstants.Success || getter.getData() == 0) {
        return false;
 ...
 */
  public void setAtomData(  long window,  long data_ptr,  int length){
    ...
    XToolkit.awtLock();
    try {
      XlibWrapper.XChangeProperty(XToolkit.getDisplay(),window,atom,atom,32,XConstants.PropModeReplace,data_ptr,length);
    }
  finally {
      XToolkit.awtUnlock();
    }
 ...
 */
  public void setAtomData(  long window,  long type,  long data_ptr,  int length){
    ...
    XToolkit.awtLock();
    try {
      XlibWrapper.XChangeProperty(XToolkit.getDisplay(),window,atom,type,32,XConstants.PropModeReplace,data_ptr,length);
    }
  finally {
      XToolkit.awtUnlock();
    }
 ...
 */
  public void setAtomData8(  long window,  long type,  long data_ptr,  int length){
    ...
    XToolkit.awtLock();
    try {
      XlibWrapper.XChangeProperty(XToolkit.getDisplay(),window,atom,type,8,XConstants.PropModeReplace,data_ptr,length);
    }
  finally {
      XToolkit.awtUnlock();
    }
 ...
 */
  public void DeleteProperty(  XBaseWindow window){
    ...
    XToolkit.awtLock();
    try {
      XlibWrapper.XDeleteProperty(XToolkit.getDisplay(),window.getWindow(),atom);
    }
  finally {
      XToolkit.awtUnlock();
    }
  ...
  public byte[] getByteArrayProperty(  long window,  long property_type){
    ...
    checkWindow(window);
    WindowPropertyGetter getter=new WindowPropertyGetter(window,this,0,0xFFFF,false,property_type);
    try {
      int status=getter.execute();
      if (status != XConstants.Success || getter.getData() == 0) {
        return null;
 ...
 */
  ...
  XAtom[] getAtomListProperty(  long window){
    ...
    checkWindow(window);
    WindowPropertyGetter getter=new WindowPropertyGetter(window,this,0,0xFFFF,false,XA_ATOM);
    try {
      int status=getter.execute();
      if (status != XConstants.Success || getter.getData() == 0) {
        return emptyList;
 ...
 */
  public void setWindowProperty(  long window,  long window_value){
    ...
    try {
      ...
      XlibWrapper.XChangeProperty(XToolkit.getDisplay(),window,atom,XA_WINDOW,32,XConstants.PropModeReplace,XlibWrapper.larg1,1);
    }
  finally {
      XToolkit.awtUnlock();
    }
 ...
 */
  public long getWindowProperty(  long window){
    ...
    checkWindow(window);
    WindowPropertyGetter getter=new WindowPropertyGetter(window,this,0,1,false,XA_WINDOW);
    try {
      int status=getter.execute();
      if (status != XConstants.Success || getter.getData() == 0) {
        return 0;
