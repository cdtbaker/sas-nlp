 ...
 */
  public final void initializeDrag(  int actions,  Transferable contents,  Map formatMap,  long[] formats) throws InvalidDnDOperationException, IllegalArgumentException, XException {
    XToolkit.awtLock();
    try {
      try {
        if (initialized) {
  ...
  protected abstract void initializeDragImpl(  int actions,  Transferable contents,  Map formatMap,  long[] formats) throws InvalidDnDOperationException, IllegalArgumentException, XException ;
  /** 
 ...
 */
  public abstract boolean processClientMessage(  XClientMessageEvent xclient) throws XException ;
  ...
  public abstract void sendEnterMessage(  long[] formats,  int sourceAction,  int sourceActions,  long time);
  public abstract void sendMoveMessage(  int xRoot,  int yRoot,  int sourceAction,  int sourceActions,  long time);
  public abstract void sendLeaveMessage(  long time);
  protected abstract void sendDropMessage(  int xRoot,  int yRoot,  int sourceAction,  int sourceActions,  long time);
  public final void initiateDrop(  int xRoot,  int yRoot,  int sourceAction,  int sourceActions,  long time){
    XWindowAttributes wattr=new XWindowAttributes();
    try {
      XToolkit.WITH_XERROR_HANDLER(XErrorHandler.IgnoreBadWindowHandler.getInstance());
      int status=XlibWrapper.XGetWindowAttributes(XToolkit.getDisplay(),targetWindow,wattr.pData);
    ...
    XToolkit.WITH_XERROR_HANDLER(XErrorHandler.IgnoreBadWindowHandler.getInstance());
    XlibWrapper.XSelectInput(XToolkit.getDisplay(),targetWindow,targetWindowMask | XConstants.StructureNotifyMask);
    XToolkit.RESTORE_XERROR_HANDLER();
  ...
  protected final void finalizeDrop(){
    XToolkit.WITH_XERROR_HANDLER(XErrorHandler.IgnoreBadWindowHandler.getInstance());
    XlibWrapper.XSelectInput(XToolkit.getDisplay(),targetWindow,targetWindowMask);
    XToolkit.RESTORE_XERROR_HANDLER();
  }
  public abstract boolean processProxyModeEvent(  XClientMessageEvent xclient,  long sourceWindow);
