...
class MotifColorUtilities {
  ...
  static int brightness(  int red,  int green,  int blue){
    ...
    luminosity=(int)((XmRED_LUMINOSITY * (float)red) + (XmGREEN_LUMINOSITY * (float)green) + (XmBLUE_LUMINOSITY * (float)blue));
    maxprimary=((red > green) ? ((red > blue) ? red : blue) : ((green > blue) ? green : blue));
    minprimary=((red < green) ? ((red < blue) ? red : blue) : ((green < blue) ? green : blue));
  ...
  static int calculateTopShadowFromBackground(  int r,  int g,  int b){
    ...
    if (brightness < XmCOLOR_DARK_THRESHOLD) {
      color_value=br;
      color_value+=XmCOLOR_DARK_TS_FACTOR * (XmMAX_SHORT - color_value) / 100;
      red=color_value;
      color_value=bg;
      color_value+=XmCOLOR_DARK_TS_FACTOR * (XmMAX_SHORT - color_value) / 100;
      green=color_value;
  ...
  static int calculateBottomShadowFromBackground(  int r,  int g,  int b){
    ...
    if (brightness < XmCOLOR_DARK_THRESHOLD) {
      color_value=br;
      color_value+=XmCOLOR_DARK_BS_FACTOR * (XmMAX_SHORT - color_value) / 100;
      red=color_value;
      color_value=bg;
      color_value+=XmCOLOR_DARK_BS_FACTOR * (XmMAX_SHORT - color_value) / 100;
      green=color_value;
  ...
  static int calculateSelectFromBackground(  int r,  int g,  int b){
    ...
    if (brightness < XmCOLOR_DARK_THRESHOLD) {
      color_value=br;
      color_value+=XmCOLOR_DARK_SEL_FACTOR * (XmMAX_SHORT - color_value) / 100;
      red=color_value;
      color_value=bg;
      color_value+=XmCOLOR_DARK_SEL_FACTOR * (XmMAX_SHORT - color_value) / 100;
      green=color_value;
