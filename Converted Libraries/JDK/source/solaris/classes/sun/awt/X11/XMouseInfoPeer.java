 ...
 */
  ...
  public int fillPointWithCoords(  Point point){
    ...
    try {
      for (int i=0; i < gdslen; i++) {
        ...
        boolean pointerFound=XlibWrapper.XQueryPointer(display,screenRoot,XlibWrapper.larg1,XlibWrapper.larg2,XlibWrapper.larg3,XlibWrapper.larg4,XlibWrapper.larg5,XlibWrapper.larg6,XlibWrapper.larg7);
        if (pointerFound) {
  ...
  public boolean isWindowUnderMouse(  Window w){
    ...
    XToolkit.awtLock();
    try {
      boolean windowOnTheSameScreen=XlibWrapper.XQueryPointer(display,parent,XlibWrapper.larg1,XlibWrapper.larg8,XlibWrapper.larg3,XlibWrapper.larg4,XlibWrapper.larg5,XlibWrapper.larg6,XlibWrapper.larg7);
