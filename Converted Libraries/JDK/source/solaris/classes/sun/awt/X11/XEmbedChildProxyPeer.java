...
public class XEmbedChildProxyPeer implements ComponentPeer, XEventDispatcher {
  ...
  void initDispatching(){
    ...
    try {
      ...
      XlibWrapper.XSelectInput(XToolkit.getDisplay(),handle,XConstants.StructureNotifyMask | XConstants.PropertyChangeMask);
    }
  finally {
      XToolkit.awtUnlock();
    }
...
int result=XKeyboardFocusManagerPeer.shouldNativelyFocusHeavyweight(proxy,lightweightChild,temporary,false,time,cause);
switch (result) {
