...
log.finer("mousePressed() on " + target.getName() + " : armed = "+ armed+ ", pressed = "+ pressed+ ", selected = "+ selected+ ", enabled = "+ isEnabled());
}
if (!isEnabled()) {
return;
}
...
if (log.isLoggable(PlatformLogger.FINER)) {
log.finer("mouseReleased() on " + target.getName() + ": armed = "+ armed+ ", pressed = "+ pressed+ ", selected = "+ selected+ ", enabled = "+ isEnabled());
}
...
if (log.isLoggable(PlatformLogger.FINER)) {
log.finer("mouseEntered() on " + target.getName() + ": armed = "+ armed+ ", pressed = "+ pressed+ ", selected = "+ selected+ ", enabled = "+ isEnabled());
}
if (pressed) {
armed=true;
repaint();
...
if (log.isLoggable(PlatformLogger.FINER)) {
log.finer("mouseExited() on " + target.getName() + ": armed = "+ armed+ ", pressed = "+ pressed+ ", selected = "+ selected+ ", enabled = "+ isEnabled());
}
if (armed) {
armed=false;
repaint();
...
if (hasFocus()) {
paintFocus(g,focusRect.x,focusRect.y,focusRect.width,focusRect.height);
}
...
ItemEvent e=new ItemEvent(cb,ItemEvent.ITEM_STATE_CHANGED,cb.getLabel(),state ? ItemEvent.SELECTED : ItemEvent.DESELECTED);
postEvent(e);
}
}
