 ...
 */
  public void setEchoChar(  char c){
    if (xtext != null) {
      xtext.setEchoChar(c);
      xtext.putClientProperty("JPasswordField.cutCopyAllowed",xtext.echoCharIsSet() ? Boolean.FALSE : Boolean.TRUE);
    }
  }
  /** 
 * @see java.awt.peer.TextComponentPeer
 ...
 */
  ...
  public Dimension getMinimumSize(  int cols){
    ...
    return new Dimension(fm.charWidth('0') * cols + 10,fm.getMaxDescent() + fm.getMaxAscent() + PADDING);
  }
  ...
  public void handleJavaMouseEvent(  MouseEvent mouseEvent){
    ...
    if (xtext != null) {
      ...
      if (id == MouseEvent.MOUSE_DRAGGED || id == MouseEvent.MOUSE_MOVED)       xtext.processMouseMotionEventImpl(mouseEvent);
...
class XAWTTextField extends JPasswordField implements ActionListener, DocumentListener {
    ...
    public void actionPerformed(    ActionEvent actionEvent){
      peer.postEvent(new ActionEvent(peer.target,ActionEvent.ACTION_PERFORMED,getText(),actionEvent.getWhen(),actionEvent.getModifiers()));
    }
