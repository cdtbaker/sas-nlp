...
synchronized (XWarningWindow.class) {
  ...
  private void updateIconSize(){
    ...
    try {
      if (newSize != currentSize) {
        ...
        XlibWrapper.SetBitmapShape(XToolkit.getDisplay(),getWindow(),ico.getWidth(),ico.getHeight(),ico.getIntData());
        AWTAccessor.getWindowAccessor().setSecurityWarningSize(ownerWindow,ico.getWidth(),ico.getHeight());
      }
    }
  finally {
      XToolkit.awtUnlock();
  ...
  XWarningWindow(  final Window ownerWindow,  long parentWindow,  XWindowPeer ownerPeer){
    super(new XCreateWindowParams(new Object[]{TARGET,ownerWindow,OWNER,Long.valueOf(parentWindow)}));
    this.ownerWindow=ownerWindow;
    this.parentWindow=parentWindow;
    this.tooltip=new InfoWindow.Tooltip(null,getTarget(),new InfoWindow.Tooltip.LiveArguments(){
  ...
  @Override void postInit(  XCreateWindowParams params){
    ...
    try {
      ...
      XlibWrapper.XSetTransientFor(XToolkit.getDisplay(),getWindow(),parentWindow);
 ...
 */
  ...
  public Graphics getGraphics(){
    ...
    return getGraphics(surfaceData,getColor(),getBackground(),getFont());
  }
  ...
  @Override public void handleExposeEvent(  XEvent xev){
  ...
  @Override protected boolean isEventDisabled(  XEvent e){
    return true;
  }
  /** 
 ...
 */
  ...
  @Override protected void enterNotify(  long window){
    super.enterNotify(window);
    if (window == getWindow()) {
      tooltip.enter();
    }
  }
  @Override protected void leaveNotify(  long window){
