 ...
 */
  ...
  FontMetrics getFontMetrics(){
    if (cachedFontMetrics != null)     return cachedFontMetrics;
 ...
 */
  public Dimension getMinimumSize(){
    ...
    return new Dimension(w + TEXT_XPAD,fm.getAscent() + fm.getMaxDescent() + TEXT_YPAD);
  }
  /** 
 * Paint the label
 */
  public void paint(  Graphics g){
    ...
    if (cachedFontMetrics == null) {
      ...
      if (oldfont != f)       cachedFontMetrics=fm;
    }
switch (alignment) {
case Label.LEFT:
      textX=2;
