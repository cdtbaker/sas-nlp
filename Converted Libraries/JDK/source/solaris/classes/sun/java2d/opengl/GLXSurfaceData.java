...
public abstract class GLXSurfaceData extends OGLSurfaceData {
  ...
  protected native boolean initPbuffer(  long pData,  long pConfigInfo,  boolean isOpaque,  int width,  int height);
 ...
 */
  public static GLXOffScreenSurfaceData createData(  X11ComponentPeer peer,  Image image,  int type){
    ...
    if (type == FLIP_BACKBUFFER) {
      return new GLXOffScreenSurfaceData(peer,gc,r.width,r.height,image,peer.getColorModel(),FLIP_BACKBUFFER);
    }
 else {
