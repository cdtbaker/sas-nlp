...
public class GLXGraphicsConfig extends X11GraphicsConfig implements OGLGraphicsConfig {
  ...
  @Override public Object getProxyKey(){
    return this;
  }
  @Override public SurfaceData createManagedSurface(  int w,  int h,  int transparency){
    return GLXSurfaceData.createData(this,w,h,getColorModel(transparency),null,OGLSurfaceData.TEXTURE);
  }
 ...
 */
  ...
  @Override public final long getNativeConfigInfo(){
    return pConfigInfo;
  }
  /** 
 * {@inheritDoc}
 ...
 */
  @Override public final OGLContext getContext(){
    return context;
  }
  @Override public BufferedImage createCompatibleImage(  int width,  int height){
...
return new DirectColorModel(cs,32,0xff0000,0xff00,0xff,0xff000000,true,DataBuffer.TYPE_INT);
default :
return null;
}
}
public String toString(){
return ("GLXGraphicsConfig[dev=" + screen + ",vis=0x"+ Integer.toHexString(visual)+ "]");
}
/** 
 * Creates a new SurfaceData that will be associated with the given
 * X11ComponentPeer.
 */
@Override public SurfaceData createSurfaceData(X11ComponentPeer peer){
 ...
 */
@Override public Image createAcceleratedImage(Component target,int width,int height){
 ...
 */
@Override public long createBackBuffer(X11ComponentPeer peer,int numBuffers,BufferCapabilities caps) throws AWTException {
if (numBuffers > 2) {
 ...
 */
@Override public void destroyBackBuffer(long backBuffer){
}
/** 
 * Creates a VolatileImage that essentially wraps the target Component's
 * backbuffer (the provided backbuffer handle is essentially ignored).
 */
@Override public VolatileImage createBackBufferImage(Component target,long backBuffer){
...
super(imageCaps,imageCaps,dblBuf ? FlipContents.UNDEFINED : null);
}
}
@Override public BufferCapabilities getBufferCapabilities(){
if (bufferCaps == null) {
...
@Override public ImageCapabilities getImageCapabilities(){
return imageCaps;
}
/** 
 * {@inheritDoc}
 ...
 */
@Override public VolatileImage createCompatibleVolatileImage(int width,int height,int transparency,int type){
 ...
 */
@Override public ContextCapabilities getContextCapabilities(){
return oglCaps;
}
@Override public void addDeviceEventListener(AccelDeviceEventListener l){
AccelDeviceEventNotifier.addListener(l,screen.getScreen());
}
@Override public void removeDeviceEventListener(AccelDeviceEventListener l){
