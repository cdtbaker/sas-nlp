 ...
 * accelerated Blit.
 */
  private native void nativeBlitBg(  long srcData,  long dstData,  long xgc,  int pixel,  int sx,  int sy,  int dx,  int dy,  int w,  int h);
}
