...
public class XRMaskFill extends MaskFill {
  ...
  protected native void maskFill(  long xsdo,  int x,  int y,  int w,  int h,  int maskoff,  int maskscan,  int masklen,  byte[] mask);
