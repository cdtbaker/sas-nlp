 ...
 */
public class SctpPeerAddrChange extends PeerAddressChangeNotification implements SctpNotification {
...
@Override public int assocId(){
return assocId;
}
@Override public void setAssociation(Association association){
...
@Override public AddressChangeEvent event(){
assert event != null;
return event;
}
