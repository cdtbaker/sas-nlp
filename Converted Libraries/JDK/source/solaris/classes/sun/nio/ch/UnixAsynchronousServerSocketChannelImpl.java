...
,acc);
  ...
  @Override Future<AsynchronousSocketChannel> implAccept(  Object att,  CompletionHandler<AsynchronousSocketChannel,Object> handler){
    if (!isOpen()) {
    ...
    if (isAcceptKilled())     throw new RuntimeException("Accept not allowed due cancellation");
