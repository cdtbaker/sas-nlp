...
private static final class ControlSequence {
    ...
    public boolean equals(    Object obj){
      ...
      if (encoding != rhs.encoding) {
        if (encoding == null || rhs.encoding == null || encoding.length != rhs.encoding.length) {
          return false;
        }
        for (int i=0; i < encoding.length; i++) {
    ...
    ControlSequence concatenate(    ControlSequence rhs){
      ...
      System.arraycopy(escSequence,0,newEscSequence,0,escSequence.length);
      System.arraycopy(rhs.escSequence,0,newEscSequence,escSequence.length,rhs.escSequence.length);
...
static {
    HashMap<ControlSequence,String> tSequenceToEncodingMap=new HashMap<>(33,1.0f);
    HashMap<ControlSequence,Boolean> tHighBitsMap=new HashMap<>(31,1.0f);
    HashMap<String,ControlSequence> tEncodingToSequenceMap=new HashMap<>(21,1.0f);
    ArrayList<String> tEncodings=new ArrayList<>(21);
    if (!(isEncodingSupported("US-ASCII") && isEncodingSupported("ISO-8859-1"))) {
      throw new ExceptionInInitializerError("US-ASCII and ISO-8859-1 unsupported");
    }
    ControlSequence leftAscii=new ControlSequence(new byte[]{0x1B,0x28,0x42});
    tSequenceToEncodingMap.put(leftAscii,"US-ASCII");
    tHighBitsMap.put(leftAscii,Boolean.FALSE);
{
      ControlSequence rightAscii=new ControlSequence(new byte[]{0x1B,0x29,0x42});
      tSequenceToEncodingMap.put(rightAscii,"US-ASCII");
      tHighBitsMap.put(rightAscii,Boolean.FALSE);
    }
{
      ControlSequence rightHalf=new ControlSequence(new byte[]{0x1B,0x2D,0x41});
    ...
    if (isEncodingSupported("ISO-8859-2")) {
      ControlSequence rightHalf=new ControlSequence(new byte[]{0x1B,0x2D,0x42});
    ...
    if (isEncodingSupported("ISO-8859-3")) {
      ControlSequence rightHalf=new ControlSequence(new byte[]{0x1B,0x2D,0x43});
    ...
    if (isEncodingSupported("ISO-8859-4")) {
      ControlSequence rightHalf=new ControlSequence(new byte[]{0x1B,0x2D,0x44});
    ...
    if (isEncodingSupported("ISO-8859-5")) {
      ControlSequence rightHalf=new ControlSequence(new byte[]{0x1B,0x2D,0x4C});
    ...
    if (isEncodingSupported("ISO-8859-6")) {
      ControlSequence rightHalf=new ControlSequence(new byte[]{0x1B,0x2D,0x47});
    ...
    if (isEncodingSupported("ISO-8859-7")) {
      ControlSequence rightHalf=new ControlSequence(new byte[]{0x1B,0x2D,0x46});
    ...
    if (isEncodingSupported("ISO-8859-8")) {
      ControlSequence rightHalf=new ControlSequence(new byte[]{0x1B,0x2D,0x48});
    ...
    if (isEncodingSupported("ISO-8859-9")) {
      ControlSequence rightHalf=new ControlSequence(new byte[]{0x1B,0x2D,0x4D});
    ...
    if (isEncodingSupported("JIS_X0201")) {
      ControlSequence glLeft=new ControlSequence(new byte[]{0x1B,0x28,0x4A});
      ControlSequence glRight=new ControlSequence(new byte[]{0x1B,0x28,0x49});
      ControlSequence grLeft=new ControlSequence(new byte[]{0x1B,0x29,0x4A});
      ControlSequence grRight=new ControlSequence(new byte[]{0x1B,0x29,0x49});
    ...
    if (isEncodingSupported("X11GB2312")) {
      ControlSequence leftHalf=new ControlSequence(new byte[]{0x1B,0x24,0x28,0x41});
      ControlSequence rightHalf=new ControlSequence(new byte[]{0x1B,0x24,0x29,0x41});
    ...
    if (isEncodingSupported("x-JIS0208")) {
      ControlSequence leftHalf=new ControlSequence(new byte[]{0x1B,0x24,0x28,0x42});
      ControlSequence rightHalf=new ControlSequence(new byte[]{0x1B,0x24,0x29,0x42});
    ...
    if (isEncodingSupported("X11KSC5601")) {
      ControlSequence leftHalf=new ControlSequence(new byte[]{0x1B,0x24,0x28,0x43});
      ControlSequence rightHalf=new ControlSequence(new byte[]{0x1B,0x24,0x29,0x43});
    ...
    if (isEncodingSupported("ISO-8859-15")) {
      ControlSequence rightHalf=new ControlSequence(new byte[]{0x1B,0x2D,0x62});
    ...
    if (isEncodingSupported("TIS-620")) {
      ControlSequence rightHalf=new ControlSequence(new byte[]{0x1B,0x2D,0x54});
    ...
    if (isEncodingSupported("JIS_X0212-1990")) {
      ControlSequence leftHalf=new ControlSequence(new byte[]{0x1B,0x24,0x28,0x44});
      ControlSequence rightHalf=new ControlSequence(new byte[]{0x1B,0x24,0x29,0x44});
    ...
    if (isEncodingSupported("X11CNS11643P1")) {
      ControlSequence leftHalf=new ControlSequence(new byte[]{0x1B,0x24,0x28,0x47});
      ControlSequence rightHalf=new ControlSequence(new byte[]{0x1B,0x24,0x29,0x47});
    ...
    if (isEncodingSupported("X11CNS11643P2")) {
      ControlSequence leftHalf=new ControlSequence(new byte[]{0x1B,0x24,0x28,0x48});
      ControlSequence rightHalf=new ControlSequence(new byte[]{0x1B,0x24,0x29,0x48});
    ...
    if (isEncodingSupported("X11CNS11643P3")) {
      ControlSequence leftHalf=new ControlSequence(new byte[]{0x1B,0x24,0x28,0x49});
      ControlSequence rightHalf=new ControlSequence(new byte[]{0x1B,0x24,0x29,0x49});
    ...
    if (isEncodingSupported("x-Johab")) {
      ControlSequence johab=new ControlSequence(new byte[]{0x1b,0x25,0x2f,0x32},new byte[]{0x53,0x55,0x4e,0x2d,0x4b,0x53,0x43,0x35,0x36,0x30,0x31,0x2e,0x31,0x39,0x39,0x32,0x2d,0x33});
    ...
    if (isEncodingSupported("Big5")) {
      ControlSequence big5=new ControlSequence(new byte[]{0x1b,0x25,0x2f,0x32},new byte[]{0x53,0x55,0x4e,0x2d,0x42,0x49,0x47,0x35,0x2d,0x31});
  ...
  private static boolean isEncodingSupported(  String encoding){
    try {
      if (Charset.isSupported(encoding))       return true;
    }
 catch (    IllegalArgumentException x) {
    }
    return (getDecoder(encoding) != null && getEncoder(encoding) != null);
  }
  ...
  static CharsetDecoder getNonStandardDecoder(  byte[] escSequence,  byte[] encoding){
    return getDecoder(sequenceToEncodingMap.get(new ControlSequence(escSequence,encoding)));
  }
