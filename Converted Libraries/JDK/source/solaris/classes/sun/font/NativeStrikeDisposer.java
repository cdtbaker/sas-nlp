...
class NativeStrikeDisposer extends FontStrikeDisposer {
  ...
  public NativeStrikeDisposer(  Font2D font2D,  FontStrikeDesc desc,  long pContext,  int[] images){
    super(font2D,desc,0L,images);
    pNativeScalerContext=pContext;
  }
  public NativeStrikeDisposer(  Font2D font2D,  FontStrikeDesc desc,  long pContext,  long[] images){
    super(font2D,desc,0L,images);
    pNativeScalerContext=pContext;
  }
  public NativeStrikeDisposer(  Font2D font2D,  FontStrikeDesc desc,  long pContext){
