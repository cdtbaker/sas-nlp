 ...
 */
  ...
  @Override public String getFallbackFamilyName(  String fontName,  String defaultFallback){
  ...
  @Override protected String getFaceNameFromComponentFontName(  String componentFontName){
    return null;
  }
  @Override protected String getFileNameFromComponentFontName(  String componentFontName){
    return null;
  }
  @Override public String getFileNameFromPlatformName(  String platformName){
    return null;
  }
  @Override protected Charset getDefaultFontCharset(  String fontName){
    return Charset.forName("ISO8859_1");
  }
  @Override protected String getEncoding(  String awtFontName,  String characterSubsetName){
    return "default";
  }
  @Override protected void initReorderMap(){
    reorderMap=new HashMap();
  }
  @Override public FontDescriptor[] getFontDescriptors(  String fontName,  int style){
    return new FontDescriptor[0];
  }
  @Override public int getNumberCoreFonts(){
    return 1;
  }
  @Override public String[] getPlatformFontNames(){
  ...
  @Override public String getExtraFontPath(){
    return null;
  }
  @Override public boolean needToSearchForFile(  String fileName){
    return false;
  }
  private FontConfigFont[] getFcFontList(  FcCompFont[] fcFonts,  String fontname,  int style){
    ...
    for (int i=0; i < fcFonts.length; i++) {
      if (fontname.equals(fcFonts[i].jdkName) && style == fcFonts[i].style) {
  ...
  @Override public CompositeFontDescriptor[] get2DCompositeFontInfo(){
    ...
    for (int fontIndex=0; fontIndex < NUM_FONTS; fontIndex++) {
      ...
      for (int styleIndex=0; styleIndex < NUM_STYLES; styleIndex++) {
        ...
        result[fontIndex * NUM_STYLES + styleIndex]=new CompositeFontDescriptor(faceName,1,null,fileNames,null,null);
      }
    }
    return result;
  }
 ...
 */
  @Override protected void setOsNameAndVersion(){
  ...
  private File getFcInfoFile(){
    if (fcInfoFileName == null) {
      ...
      String name="fcinfo-" + fileVersion + "-"+ hostname+ "-"+ osName+ "-"+ osVersion+ "-"+ lang+ ".properties";
