...
public class ResolverConfigurationImpl extends ResolverConfiguration {
  ...
  private LinkedList<String> resolvconf(  String keyword,  int maxperkeyword,  int maxkeywords){
    ...
    try {
      ...
      while ((line=in.readLine()) != null) {
        ...
        if (value.charAt(0) != ' ' && value.charAt(0) != '\t')         continue;
  ...
  private void loadConfig(){
    ...
    nameservers=java.security.AccessController.doPrivileged(new java.security.PrivilegedAction<LinkedList<String>>(){
  ...
  private LinkedList<String> getSearchList(){
    ...
    sl=java.security.AccessController.doPrivileged(new java.security.PrivilegedAction<LinkedList<String>>(){
      public LinkedList<String> run(){
        LinkedList ll;
