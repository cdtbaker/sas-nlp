...
static {
    defaultDomain=java.security.AccessController.doPrivileged(new sun.security.action.GetPropertyAction("http.auth.ntlm.domain","domain"));
  }
 ...
 */
  ...
  private void init(  PasswordAuthentication pw){
    ...
    init0();
    try {
      client=new Client(System.getProperty("ntlm.version"),hostname,username,ntdomain,password);
    }
