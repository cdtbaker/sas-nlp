...
public class WCustomCursor extends CustomCursor {
  public WCustomCursor(  Image cursor,  Point hotSpot,  String name) throws IndexOutOfBoundsException {
    ...
    }
{
  ...
  private native void createCursorIndirect(  int[] rData,  byte[] andMask,  int nScanStride,  int width,  int height,  int xHotSpot,  int yHotSpot);
  /** 
