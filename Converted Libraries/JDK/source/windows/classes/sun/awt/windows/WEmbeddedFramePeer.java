...
public class WEmbeddedFramePeer extends WFramePeer {
  ...
  @Override public void modalDisable(  Dialog blocker,  long blockerHWnd){
    super.modalDisable(blocker,blockerHWnd);
    ((EmbeddedFrame)target).notifyModalBlocked(blocker,true);
  }
  @Override public void modalEnable(  Dialog blocker){
  ...
  @Override public boolean isAccelCapable(){
