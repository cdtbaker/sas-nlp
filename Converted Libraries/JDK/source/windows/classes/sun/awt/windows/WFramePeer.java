...
static {
  ...
  private static final boolean keepOnMinimize="true".equals((String)java.security.AccessController.doPrivileged(new sun.security.action.GetPropertyAction("sun.awt.keepWorkingSetOnMinimize")));
 ...
 */
  private void adjustMaximizedBounds(  Rectangle b){
    ...
    GraphicsDevice primaryDev=GraphicsEnvironment.getLocalGraphicsEnvironment().getDefaultScreenDevice();
    ...
    if (currentDevGC != null && currentDevGC != primaryDevGC) {
      ...
      boolean isCurrentDevLarger=((currentDevBounds.width - primaryDevBounds.width > 0) || (currentDevBounds.height - primaryDevBounds.height > 0));
  ...
  @Override public boolean updateGraphicsData(  GraphicsConfiguration gc){
