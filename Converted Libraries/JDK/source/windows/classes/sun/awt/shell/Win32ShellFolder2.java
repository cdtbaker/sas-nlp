...
static {
  ...
  public enum SystemIcon {  IDI_APPLICATION(32512),   IDI_HAND(32513),   IDI_ERROR(32513),   IDI_QUESTION(32514),   IDI_EXCLAMATION(32515),   IDI_WARNING(32515),   IDI_ASTERISK(32516),   IDI_INFORMATION(32516),   IDI_WINLOGO(32517);   private final int iconID;
 ...
 */
  Win32ShellFolder2(  final Win32ShellFolder2 parent,  final long relativePIDL) throws InterruptedException {
    super(parent,invoke(new Callable<String>(){
      public String call(){
 ...
 */
  ...
  private static String getFileSystemPath(  final long parentIShellFolder,  final long relativePIDL){
    ...
    if (parentIShellFolder == Win32ShellFolderManager2.getNetwork().getIShellFolder() && getAttributes0(parentIShellFolder,relativePIDL,linkedFolder) == linkedFolder) {
      String s=getFileSystemPath(Win32ShellFolderManager2.getDesktop().getIShellFolder(),getLinkLocation(parentIShellFolder,relativePIDL,false));
...
,RuntimeException.class);
  ...
  private native long getEnumObjects(  long pIShellFolder,  boolean isDesktop,  boolean includeHiddenFiles);
          ...
          if (pEnumObjects != 0) {
            try {
              ...
              do {
                ...
                if (childPIDL != 0 && (getAttributes0(pIShellFolder,childPIDL,testedAttrs) & testedAttrs) != 0) {
                  Win32ShellFolder2 childFolder;
                  if (Win32ShellFolder2.this.equals(desktop) && personal != null && pidlsEqual(pIShellFolder,childPIDL,personal.disposer.relativePIDL)) {
...
,IOException.class);
  ...
  private static native String getDisplayNameOf(  long parentIShellFolder,  long relativePIDL,  int attrs);
  /** 
 * @return The name used to display this shell folder
 */
  public String getDisplayName(){
    if (displayName == null) {
      displayName=invoke(new Callable<String>(){
        public String call(){
          return getDisplayNameOf(getParentIShellFolder(),getRelativePIDL(),SHGDN_NORMAL);
        }
      }
);
    }
 ...
 */
  public String getFolderType(){
    if (folderType == null) {
      ...
      folderType=invoke(new Callable<String>(){
        public String call(){
 ...
 */
  ...
  private static native long extractIcon(  long parentIShellFolder,  long relativePIDL,  boolean getLargeIcon);
  private static native long getSystemIcon(  int iconID);
  private static native long getIconResource(  String libName,  int iconID,  int cxDesired,  int cyDesired,  boolean useVGAColors);
 ...
 */
  public Image getIcon(  final boolean getLargeIcon){
    ...
    if (icon == null) {
      icon=invoke(new Callable<Image>(){
        public Image call(){
          Image newIcon=null;
          if (isFileSystem()) {
      ...
      public ShellFolderColumnInfo[] call(){
        ...
        if (columns != null) {
          ...
          for (int i=0; i < columns.length; i++) {
            ...
            if (column != null) {
              column.setAlignment(column.getAlignment() == LVCFMT_RIGHT ? SwingConstants.RIGHT : column.getAlignment() == LVCFMT_CENTER ? SwingConstants.CENTER : SwingConstants.LEADING);
      ...
      Integer result=invoke(new Callable<Integer>(){
        public Integer call(){
          if (o instanceof Win32ShellFolder2 && o1 instanceof Win32ShellFolder2) {
            return compareIDsByColumn(parentIShellFolder,((Win32ShellFolder2)o).getRelativePIDL(),((Win32ShellFolder2)o1).getRelativePIDL(),columnIdx);
          }
          return 0;
        }
      }
