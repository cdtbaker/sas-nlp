...
public class SctpChannelImpl extends SctpChannel {
  ...
  @Override public boolean connect(  SocketAddress remote,  int maxOutStreams,  int maxInStreams) throws IOException {
    throw new UnsupportedOperationException(message);
  }
  ...
  @Override public <T>MessageInfo receive(  ByteBuffer dst,  T attachment,  NotificationHandler<T> handler) throws IOException {
    throw new UnsupportedOperationException(message);
  }
  @Override public int send(  ByteBuffer src,  MessageInfo messageInfo) throws IOException {
    throw new UnsupportedOperationException(message);
  }
