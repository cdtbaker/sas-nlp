 ...
 */
  static FirstStream FindFirstStream(  String path) throws WindowsException {
    ...
    try {
      ...
      if (data.handle() == WindowsConstants.INVALID_HANDLE_VALUE)       return null;
      return data;
    }
  finally {
      buffer.release();
 ...
 * @return  AccessRights
 */
  static native int GetEffectiveRightsFromAcl(  long pAcl,  long pTrustee) throws WindowsException ;
  /** 
 * CreateSymbolicLink(
 ...
 */
  ...
  private static native void CreateHardLink0(  long newFileBuffer,  long existingFiletBuffer) throws WindowsException ;
  /** 
 * GetFullPathName(
 * LPCTSTR lpFileName,
 * DWORD nBufferLength,
 ...
 * )
 */
  static native long CreateIoCompletionPort(  long fileHandle,  long existingPort,  int completionKey) throws WindowsException ;
  /** 
 ...
 * )
 */
  static native void PostQueuedCompletionStatus(  long completionPort,  int completionKey) throws WindowsException ;
  /** 
 ...
 * )
 */
  static BackupResult BackupRead(  long hFile,  long bufferAddress,  int bufferSize,  boolean abort,  long context) throws WindowsException {
...
static class BackupResult {
  ...
  private static native void BackupRead0(  long hFile,  long bufferAddress,  int bufferSize,  boolean abort,  long context,  BackupResult result) throws WindowsException ;
  /** 
 * BackupSeek(
 * HANDLE hFile,
 ...
 * )
 */
  static native void BackupSeek(  long hFile,  long bytesToSeek,  long context) throws WindowsException ;
  ...
  static NativeBuffer asNativeBuffer(  String s){
    ...
    if (buffer == null) {
      ...
      if (buffer.owner() == s)       return buffer;
    }
