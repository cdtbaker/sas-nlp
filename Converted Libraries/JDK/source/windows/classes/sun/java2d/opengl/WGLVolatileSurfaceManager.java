...
public class WGLVolatileSurfaceManager extends VolatileSurfaceManager {
  ...
  public WGLVolatileSurfaceManager(  SunVolatileImage vImg,  Object context){
    ...
    accelerationEnabled=(transparency == Transparency.OPAQUE) || ((transparency == Transparency.TRANSLUCENT) && (gc.isCapPresent(CAPS_EXT_FBOBJECT) || gc.isCapPresent(CAPS_STORED_ALPHA)));
  }
 ...
 */
  ...
  @Override protected boolean isConfigValid(  GraphicsConfiguration gc){
    return ((gc == null) || ((gc instanceof WGLGraphicsConfig) && (gc == vImg.getGraphicsConfig())));
  }
  @Override public void initContents(){
