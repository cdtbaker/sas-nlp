...
public class D3DGraphicsConfig extends Win32GraphicsConfig implements AccelGraphicsConfig {
  ...
  public SurfaceData createManagedSurface(  int w,  int h,  int transparency){
    return D3DSurfaceData.createData(this,w,h,getColorModel(transparency),null,D3DSurfaceData.TEXTURE);
  }
...
throw new AWTException("FlipContents.COPIED is only" + "supported for 2 buffers");
}
}
/** 
...
@Override public boolean isMultiBufferAvailable(){
return true;
}
}
 ...
 */
@Override public D3DContext getContext(){
