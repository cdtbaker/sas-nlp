...
public class D3DVolatileSurfaceManager extends VolatileSurfaceManager {
  ...
  public D3DVolatileSurfaceManager(  SunVolatileImage vImg,  Object context){
    ...
    accelerationEnabled=(transparency == Transparency.OPAQUE) || (transparency == Transparency.TRANSLUCENT && (gd.isCapPresent(CAPS_RT_PLAIN_ALPHA) || gd.isCapPresent(CAPS_RT_TEXTURE_ALPHA)));
  }
 ...
 */
  @Override protected void restoreAcceleratedSurface(){
synchronized (this) {
