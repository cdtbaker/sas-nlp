 ...
 */
private native void initOps(WComponentPeer peer,int depth,int redMask,int greenMask,int blueMask,int screen);
...
Win32GraphicsDevice gd=(Win32GraphicsDevice)graphicsConfig.getDevice();
