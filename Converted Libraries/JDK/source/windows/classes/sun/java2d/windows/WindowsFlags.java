...
static {
  ...
  private static boolean getBooleanProp(  String p,  boolean defaultVal){
    ...
    if (propString != null) {
      if (propString.equals("true") || propString.equals("t") || propString.equals("True")|| propString.equals("T")|| propString.equals("")) {
        returnVal=true;
      }
  ...
  private static boolean isBooleanPropTrueVerbose(  String p){
    String propString=System.getProperty(p);
    if (propString != null) {
      if (propString.equals("True") || propString.equals("T")) {
        return true;
      }
    }
    return false;
  ...
  private static void initJavaFlags(){
    java.security.AccessController.doPrivileged(new java.security.PrivilegedAction(){
      public Object run(){
        magPresent=getBooleanProp("javax.accessibility.screen_magnifier_present",false);
        boolean ddEnabled=!getBooleanProp("sun.java2d.noddraw",magPresent);
        boolean ddOffscreenEnabled=getBooleanProp("sun.java2d.ddoffscreen",ddEnabled);
        d3dEnabled=getBooleanProp("sun.java2d.d3d",ddEnabled && ddOffscreenEnabled);
        d3dOnScreenEnabled=getBooleanProp("sun.java2d.d3d.onscreen",d3dEnabled);
        ...
        offscreenSharingEnabled=getBooleanProp("sun.java2d.offscreenSharing",false);
