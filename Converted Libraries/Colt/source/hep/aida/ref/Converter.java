 ...
 */
  public String toString(  IHistogram1D h){
    ...
    return title + sep + "Heights:"+ sep+ new cern.colt.matrix.doublealgo.Formatter().toTitleString(heights,yEdges,xEdges,rowAxisName,columnAxisName,null,aggr);
  }
  /** 
 * Returns a string representation of the given argument.
 */
 ...
 */
  public String toString(  IHistogram3D h){
    ...
    new cern.colt.list.ObjectArrayList(zEdges).reverse();
    ...
    return title + sep + "Heights:"+ sep+ new cern.colt.matrix.doublealgo.Formatter().toTitleString(heights,zEdges,yEdges,xEdges,sliceAxisName,rowAxisName,columnAxisName,"",aggr);
  }
  /** 
 ...
 */
  public String toXML(  IHistogram2D h){
    ...
    out.append(sep);
    for (int i=0; i < h.xAxis().bins(); i++)     for (int j=0; j < h.yAxis().bins(); j++) {
