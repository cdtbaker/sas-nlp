...
public class PoissonSlow extends AbstractDiscreteDistribution {
  ...
  protected static final double[] cof={76.18009172947146,-86.50532032941677,24.01409824083091,-1.231739572450155,0.1208650973866179e-2,-0.5395239384953e-5};
 ...
 */
  protected int nextIntSlow(){
    ...
    if (product <= 0.0 && bound > 0.0)     return (int)Math.round(mean);
    return count - 1;
  }
  /** 
 * Sets the mean.
